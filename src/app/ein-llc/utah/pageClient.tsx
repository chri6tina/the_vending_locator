  ...
  const faqItems = [
    {
      ...
      a: `The total cost to form an LLC in Utah is $${totalPrice.toFixed(2)}, which includes the $${stateFee.toFixed(2)} state filing fee paid to the Utah Division of Corporations plus our $${SERVICE_FEE.toFixed(2)} service fee. This covers all necessary filings and documentation to properly establish your Utah LLC.`
    },
    {
      q: "How long does it take to form an LLC in Utah?",
      a: "The Utah Division of Corporations typically processes LLC filings within 2-3 business days for standard processing. With our expedited service, you can expect your Utah LLC to be formed within 1-2 business days. EIN (Employer Identification Number) assignment from the IRS typically takes just a few minutes to a few hours once applied for online."
    },
    {
      q: "What information do I need to form an LLC in Utah?",
      a: "To form your Utah LLC, you'll need: your desired LLC name (must be unique and include 'LLC' or 'Limited Liability Company'), the name and address of your registered agent (can be a Utah resident or registered agent service), the names and addresses of all members/managers, the principal business address, and your business purpose. We'll guide you through collecting all necessary information."
    },
    {
      q: "Do I need a registered agent for my Utah LLC?",
      a: "Yes, Utah requires all LLCs to maintain a registered agent with a physical street address in Utah (not a P.O. box). The registered agent must be available during normal business hours to receive legal documents and official notices on behalf of your LLC. You can serve as your own registered agent if you have a Utah address, or use a professional registered agent service."
    },
    {
      q: "What is an EIN and do I need one for my Utah LLC?",
      a: "An EIN (Employer Identification Number) is a federal tax ID number issued by the IRS. While single-member LLCs can use the owner's Social Security Number, we recommend getting an EIN for your Utah LLC for several reasons: it protects your personal SSN, allows you to open business bank accounts, hire employees, build business credit, and simplifies tax filing. Multi-member LLCs must have an EIN."
    },
    {
      q: "Can I form a Utah LLC if I don't live in Utah?",
      a: "Yes, you can form a Utah LLC even if you don't live in Utah. There are no residency requirements for LLC members or managers in Utah. However, you will need a Utah registered agent with a physical Utah address. Many out-of-state business owners use professional registered agent services to meet this requirement."
    },
    {
      q: "What ongoing requirements does a Utah LLC have?",
      a: "Utah LLCs must file an Annual Report with the Utah Division of Corporations each year by May 1st, with a fee of $138.75. You'll also need to maintain a registered agent, keep proper business records, file federal and state tax returns, and comply with any local business licenses or permits required for your specific business type."
    },
    {
      q: "What are the tax benefits of a Utah LLC?",
      a: "Utah LLCs offer several tax advantages: pass-through taxation (profits and losses pass through to members' personal tax returns), no state income tax (Utah doesn't tax personal income), flexibility in how the LLC is taxed (can elect to be taxed as a partnership, S-corp, or C-corp), and the ability to deduct business expenses. Consult with a tax professional for advice specific to your situation."
    },
    {
      q: "Can I change my Utah LLC name after formation?",
      a: "Yes, you can change your Utah LLC name by filing Articles of Amendment with the Utah Division of Corporations and paying a $25 fee. You'll also need to update your EIN information with the IRS, notify banks and other institutions, update business licenses and permits, and update your operating agreement if applicable. We can assist with the name change process."
    },
    {
      q: "What's the difference between a member-managed and manager-managed Utah LLC?",
      a: "In a member-managed Utah LLC, all members participate in daily business decisions and management. In a manager-managed LLC, members appoint one or more managers (who may or may not be members) to handle daily operations. This structure is specified in your Articles of Organization and Operating Agreement. Most single-member and small multi-member LLCs are member-managed."
    },
    {
      q: "Do I need an operating agreement for my Utah LLC?",
      a: "While Utah doesn't legally require an operating agreement, it's highly recommended for multi-member LLCs and beneficial even for single-member LLCs. An operating agreement establishes ownership percentages, member roles and responsibilities, profit distribution, management structure, and procedures for adding/removing members. It helps protect your limited liability status and prevents disputes."
    },
    {
      q: "What business licenses do I need for my Utah LLC?",
    ...
    {
      q: "Can I use my home address for my Utah LLC?",
      a: "You can use your home address as the principal business address on your Articles of Organization, but you cannot use it as your registered agent address unless it's a physical street address in Utah (not a P.O. box). However, using your home address makes it publicly available. Many business owners prefer using a registered agent service or commercial address for privacy."
    },
    {
      q: "What happens after I file my Utah LLC?",
      a: "After filing, you'll receive a Certificate of Status from Utah confirming your LLC is active. You should then: get your EIN from the IRS, open a business bank account, obtain necessary business licenses and permits, create an operating agreement, set up business accounting, obtain business insurance if needed, and begin operating your business. We'll provide a checklist of next steps after your LLC is formed."
    }
  ]
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 border-b border-stone/20">
                    <span className="text-charcoal">Utah State LLC Filing Fee</span>
