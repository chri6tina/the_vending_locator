...
export default function NewHampshireEinLLCPage() {
  ...
  const faqItems = [
    {
      ...
      a: `The total cost to form an LLC in New Hampshire is $${totalPrice.toFixed(2)}, which includes the $${stateFee.toFixed(2)} state filing fee paid to the New Hampshire Hampshire Secretary of State plus our $${SERVICE_FEE.toFixed(2)} service fee. This covers all necessary filings and documentation to properly establish your New Hampshire LLC.`
    },
    {
      q: "How long does it take to form an LLC in New Hampshire?",
      a: "The New Hampshire Hampshire Secretary of State typically processes LLC filings within 2-3 business days for standard processing. With our expedited service, you can expect your New Hampshire LLC to be formed within 1-2 business days. EIN (Employer Identification Number) assignment from the IRS typically takes just a few minutes to a few hours once applied for online."
    },
    {
      q: "What information do I need to form an LLC in New Hampshire?",
      a: "To form your New Hampshire LLC, you'll need: your desired LLC name (must be unique and include 'LLC' or 'Limited Liability Company'), the name and address of your registered agent (can be a New Hampshire resident or registered agent service), the names and addresses of all members/managers, the principal business address, and your business purpose. We'll guide you through collecting all necessary information."
    },
    {
      q: "Do I need a registered agent for my New Hampshire LLC?",
      a: "Yes, New Hampshire requires all LLCs to maintain a registered agent with a physical street address in New Hampshire (not a P.O. box). The registered agent must be available during normal business hours to receive legal documents and official notices on behalf of your LLC. You can serve as your own registered agent if you have a New Hampshire address, or use a professional registered agent service."
    },
    {
      q: "What is an EIN and do I need one for my New Hampshire LLC?",
      a: "An EIN (Employer Identification Number) is a federal tax ID number issued by the IRS. While single-member LLCs can use the owner's Social Security Number, we recommend getting an EIN for your New Hampshire LLC for several reasons: it protects your personal SSN, allows you to open business bank accounts, hire employees, build business credit, and simplifies tax filing. Multi-member LLCs must have an EIN."
    },
    {
      q: "Can I form a New Hampshire LLC if I don't live in New Hampshire?",
      a: "Yes, you can form a New Hampshire LLC even if you don't live in New Hampshire. There are no residency requirements for LLC members or managers in New Hampshire. However, you will need a New Hampshire registered agent with a physical New Hampshire address. Many out-of-state business owners use professional registered agent services to meet this requirement."
    },
    {
      q: "What ongoing requirements does a New Hampshire LLC have?",
      a: "New Hampshire LLCs must file an Annual Report with the New Hampshire Hampshire Secretary of State each year by May 1st, with a fee of $138.75. You'll also need to maintain a registered agent, keep proper business records, file federal and state tax returns, and comply with any local business licenses or permits required for your specific business type."
    },
    {
      q: "What are the tax benefits of a New Hampshire LLC?",
      a: "New Hampshire LLCs offer several tax advantages: pass-through taxation (profits and losses pass through to members' personal tax returns), no state income tax (New Hampshire doesn't tax personal income), flexibility in how the LLC is taxed (can elect to be taxed as a partnership, S-corp, or C-corp), and the ability to deduct business expenses. Consult with a tax professional for advice specific to your situation."
    },
    {
      q: "Can I change my New Hampshire LLC name after formation?",
      a: "Yes, you can change your New Hampshire LLC name by filing Articles of Amendment with the New Hampshire Hampshire Secretary of State and paying a $25 fee. You'll also need to update your EIN information with the IRS, notify banks and other institutions, update business licenses and permits, and update your operating agreement if applicable. We can assist with the name change process."
    },
    {
      q: "What's the difference between a member-managed and manager-managed New Hampshire LLC?",
      a: "In a member-managed New Hampshire LLC, all members participate in daily business decisions and management. In a manager-managed LLC, members appoint one or more managers (who may or may not be members) to handle daily operations. This structure is specified in your Articles of Organization and Operating Agreement. Most single-member and small multi-member LLCs are member-managed."
    },
    {
      q: "Do I need an operating agreement for my New Hampshire LLC?",
      a: "While New Hampshire doesn't legally require an operating agreement, it's highly recommended for multi-member LLCs and beneficial even for single-member LLCs. An operating agreement establishes ownership percentages, member roles and responsibilities, profit distribution, management structure, and procedures for adding/removing members. It helps protect your limited liability status and prevents disputes."
    },
    {
      q: "What business licenses do I need for my New Hampshire LLC?",
    ...
    {
      q: "Can I use my home address for my New Hampshire LLC?",
      a: "You can use your home address as the principal business address on your Articles of Organization, but you cannot use it as your registered agent address unless it's a physical street address in New Hampshire (not a P.O. box). However, using your home address makes it publicly available. Many business owners prefer using a registered agent service or commercial address for privacy."
    },
    {
      q: "What happens after I file my New Hampshire LLC?",
      a: "After filing, you'll receive a Certificate of Status from New Hampshire confirming your LLC is active. You should then: get your EIN from the IRS, open a business bank account, obtain necessary business licenses and permits, create an operating agreement, set up business accounting, obtain business insurance if needed, and begin operating your business. We'll provide a checklist of next steps after your LLC is formed."
    }
  ]
                ...
                <div>
                  ...
                  >
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-charcoal/80">Complete {stateDisplayName} LLC filing with the Hampshire Secretary of State</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircleIcon className="h-6 w-6 text-coral flex-shrink-0 mt-0.5" />
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 border-b border-stone/20">
                    <span className="text-charcoal">New Hampshire State LLC Filing Fee</span>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-charcoal/80 text-sm leading-relaxed">
                        Complete preparation and filing of your {stateDisplayName} LLC Articles of Organization with the Hampshire Secretary of State. We ensure all information is accurate and compliant with state requirements.
                      </p>
                    </div>
                  </div>
                </motion.div>
