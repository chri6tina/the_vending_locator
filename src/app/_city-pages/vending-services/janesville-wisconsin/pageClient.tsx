...
export default function JanesvilleWisconsinVendingServicesPage() {
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="text-navy">{cityDisplayName}, WI</span>
                  </motion.h1>
                  ...
                  >
                    Connect with professional vending machine operators serving {cityDisplayName}'s automotive manufacturing and industrial sector. Get free installation, regular stocking, and full maintenance—at no cost to your business.
                  </motion.p>
