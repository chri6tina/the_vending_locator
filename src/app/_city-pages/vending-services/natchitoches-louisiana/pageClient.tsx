...
export default function NatchitochesLouisianaVendingServicesPage() {
        ...
        <nav className="bg-white border-b border-gray-200 py-3">
          <div className="container mx-auto px-4">
            <div className="flex items-center space-x-2 text-sm text-stone">
              ...
              <span>/</span>
              <Link href="/vending-services/louisiana" className="hover:text-navy transition-colors">
                Louisiana
              </Link>
              <span>/</span>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="text-navy">{cityDisplayName}, Louisiana</span>
                  </motion.h1>
                  ...
                  {formSubmitted ? (
                    ...
                    <>
                      <h3 className="text-2xl font-playfair font-bold text-navy mb-2 text-center">
                        Get Vending Services in {cityDisplayName}, LA
                      </h3>
