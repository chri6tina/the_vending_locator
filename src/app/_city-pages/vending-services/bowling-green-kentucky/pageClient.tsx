...
export default function BowlingGreenKentuckyVendingServicesPage() {
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="text-navy">{cityDisplayName}, Kentucky</span>
                  </motion.h1>
                  ...
                  >
                    Connect with professional vending machine operators serving {cityDisplayName}'s General Motors Corvette plant and Western Kentucky University. Get free installation, regular stocking, and full maintenance—at no cost to your business.
                  </motion.p>
