...
export default function SanAntonioFloridaTaxServicesPage() {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'San Antonio', item: 'https://www.thevendinglocator.com/tax-services/san-antonio-florida' }
            ]
          })
        }}
      />
