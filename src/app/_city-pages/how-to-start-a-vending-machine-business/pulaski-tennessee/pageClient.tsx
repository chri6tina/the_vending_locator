...
export default function PulaskiTennesseeHowToStartPage() {
  const cityDisplayName = 'Pulaski'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Pulaski may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Pulaski.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Pulaski business licenses or permits.",
  "additionalNotes": "Check with the City of Pulaski for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Pulaski Hospital and medical facilities",
  "Downtown Pulaski office buildings and businesses",
  "Pulaski school district and educational facilities",
  "Pulaski municipal and county government buildings",
