...
export default function TacomaWashingtonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington requires a sales tax permit. Register your business and collect/remit tax on vending sales. Tacoma may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Tacoma County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Washington Secretary of State and obtain any required Tacoma business licenses or permits.',
    additionalNotes: 'Check with the City of Tacoma for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Tacoma Hospital and medical facilities',
    'Downtown Tacoma office buildings and businesses',
    'Tacoma school district and educational facilities',
    'Tacoma municipal and county government buildings',
