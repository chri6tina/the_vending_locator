...
export default function SouthOrangeNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. South Orange may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in South Orange.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required South Orange business licenses or permits.",
  "additionalNotes": "Check with the City of South Orange for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "South Orange Hospital and medical facilities",
  "Downtown South Orange office buildings and businesses",
  "South Orange school district and educational facilities",
  "South Orange municipal and county government buildings",
