...
export default function WilsonNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Wilson may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Wilson.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Wilson business licenses or permits.",
  "additionalNotes": "Check with the City of Wilson for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Wilson Hospital and medical facilities",
  "Downtown Wilson office buildings and businesses",
  "Wilson school district and educational facilities",
  "Wilson municipal and county government buildings",
