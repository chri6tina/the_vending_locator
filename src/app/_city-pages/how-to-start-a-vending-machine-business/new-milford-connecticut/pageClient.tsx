...
export default function NewMilfordConnecticutHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in New Milford.",
  "businessLicense": "Register your LLC with the Connecticut Secretary of State and obtain any required local business licenses in New Milford.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in New Milford",
