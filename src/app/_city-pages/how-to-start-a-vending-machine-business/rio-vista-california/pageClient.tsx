...
export default function RioVistaCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rio Vista.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Rio Vista.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rio Vista",
