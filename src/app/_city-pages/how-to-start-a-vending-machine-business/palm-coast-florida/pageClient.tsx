...
export default function PalmCoastFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Palm Coast.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Palm Coast.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Palm Coast",
