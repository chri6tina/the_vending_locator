...
export default function FortOglethorpeGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Fort Oglethorpe.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Fort Oglethorpe.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Fort Oglethorpe",
