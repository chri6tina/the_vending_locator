...
export default function SeymourIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Seymour.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Seymour.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Seymour",
