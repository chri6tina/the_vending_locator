...
export default function MountDoraFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mount Dora.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Mount Dora.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mount Dora",
