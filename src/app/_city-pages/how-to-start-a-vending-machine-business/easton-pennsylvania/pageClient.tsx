...
export default function EastonPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Easton may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Easton.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Easton business licenses or permits.",
  "additionalNotes": "Check with the City of Easton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Easton Hospital and medical facilities",
  "Downtown Easton office buildings and businesses",
  "Easton school district and educational facilities",
  "Easton municipal and county government buildings",
