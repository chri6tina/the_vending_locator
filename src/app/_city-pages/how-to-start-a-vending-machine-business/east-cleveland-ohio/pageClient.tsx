...
export default function EastClevelandOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. East Cleveland may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in East Cleveland.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required East Cleveland business licenses or permits.",
  "additionalNotes": "Check with the City of East Cleveland for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "East Cleveland Hospital and medical facilities",
  "Downtown East Cleveland office buildings and businesses",
  "East Cleveland school district and educational facilities",
  "East Cleveland municipal and county government buildings",
