...
export default function AsheboroNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Asheboro may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Asheboro.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Asheboro business licenses or permits.",
  "additionalNotes": "Check with the City of Asheboro for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Asheboro Hospital and medical facilities",
  "Downtown Asheboro office buildings and businesses",
  "Asheboro school district and educational facilities",
  "Asheboro municipal and county government buildings",
