...
export default function BarnstableMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Barnstable.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Barnstable.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Barnstable",
