...
export default function NewberrySouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Newberry'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Newberry may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Newberry.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Newberry business licenses or permits.",
  "additionalNotes": "Check with the City of Newberry for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Newberry Hospital and medical facilities",
  "Downtown Newberry office buildings and businesses",
  "Newberry school district and educational facilities",
  "Newberry municipal and county government buildings",
