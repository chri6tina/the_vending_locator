...
export default function SeasideOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Seaside may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Seaside.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Seaside business licenses or permits.",
  "additionalNotes": "Check with the City of Seaside for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Seaside Hospital and medical facilities",
  "Downtown Seaside office buildings and businesses",
  "Seaside school district and educational facilities",
  "Seaside municipal and county government buildings",
