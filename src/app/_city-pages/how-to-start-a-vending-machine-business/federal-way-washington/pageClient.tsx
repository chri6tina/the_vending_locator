...
export default function FederalWayWashingtonHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Federal Way.",
  "businessLicense": "Register your LLC with the Washington Secretary of State and obtain any required local business licenses in Federal Way.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Federal Way",
