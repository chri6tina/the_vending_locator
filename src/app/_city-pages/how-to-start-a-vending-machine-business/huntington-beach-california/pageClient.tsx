...
export default function HuntingtonBeachCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Huntington Beach may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Huntington Beach County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Huntington Beach business licenses or permits.',
    additionalNotes: 'Check with the City of Huntington Beach for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Huntington Beach Hospital and medical facilities',
    'Downtown Huntington Beach office buildings and businesses',
    'Huntington Beach school district and educational facilities',
    'Huntington Beach municipal and county government buildings',
