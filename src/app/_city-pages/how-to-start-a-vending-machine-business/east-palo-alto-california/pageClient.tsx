...
export default function EastPaloAltoCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in East Palo Alto.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in East Palo Alto.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in East Palo Alto",
