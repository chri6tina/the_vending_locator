...
export default function WatertownMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Watertown.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Watertown.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Watertown",
