...
export default function GreenvilleMississippiHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required local business licenses in Greenville.",
