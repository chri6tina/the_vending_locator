...
export default function EstesParkColoradoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Estes Park.",
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in Estes Park.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Estes Park",
