...
export default function MadisonNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Madison may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Madison.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Madison business licenses or permits.",
  ...
  const demandDrivers = [
  "Madison Hospital and medical facilities",
  "Downtown Madison office buildings and businesses",
  "Madison school district and educational facilities",
  "Madison municipal and county government buildings",
