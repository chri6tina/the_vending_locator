...
export default function BelmontNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Belmont may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Belmont.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Belmont business licenses or permits.",
  "additionalNotes": "Check with the City of Belmont for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Belmont Hospital and medical facilities",
  "Downtown Belmont office buildings and businesses",
  "Belmont school district and educational facilities",
  "Belmont municipal and county government buildings",
