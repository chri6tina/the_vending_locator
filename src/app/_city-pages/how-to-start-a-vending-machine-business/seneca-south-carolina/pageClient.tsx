...
export default function SenecaSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Seneca'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Seneca may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Seneca.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Seneca business licenses or permits.",
  "additionalNotes": "Check with the City of Seneca for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Seneca Hospital and medical facilities",
  "Downtown Seneca office buildings and businesses",
  "Seneca school district and educational facilities",
  "Seneca municipal and county government buildings",
