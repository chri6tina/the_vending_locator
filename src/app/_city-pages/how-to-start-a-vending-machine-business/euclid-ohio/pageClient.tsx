...
export default function EuclidOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Euclid may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Euclid.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Euclid business licenses or permits.",
  "additionalNotes": "Check with the City of Euclid for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Euclid Hospital and medical facilities",
  "Downtown Euclid office buildings and businesses",
  "Euclid school district and educational facilities",
  "Euclid municipal and county government buildings",
