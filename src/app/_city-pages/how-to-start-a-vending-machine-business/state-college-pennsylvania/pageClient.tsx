...
export default function StateCollegePennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. State College may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in State College.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required State College business licenses or permits.",
  "additionalNotes": "Check with the City of State College for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "State College Hospital and medical facilities",
  "Downtown State College office buildings and businesses",
  "State College school district and educational facilities",
  "State College municipal and county government buildings",
