...
export default function DuBoisPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. DuBois may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in DuBois.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required DuBois business licenses or permits.",
  "additionalNotes": "Check with the City of DuBois for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "DuBois Hospital and medical facilities",
  "Downtown DuBois office buildings and businesses",
  "DuBois school district and educational facilities",
  "DuBois municipal and county government buildings",
