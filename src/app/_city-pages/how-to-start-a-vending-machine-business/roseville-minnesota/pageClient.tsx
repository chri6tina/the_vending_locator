...
export default function RosevilleMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Roseville.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Roseville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Roseville",
