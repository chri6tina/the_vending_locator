...
export default function SebastianFloridaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Florida requires a sales tax permit through the Department of Revenue. Sebastian also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Sebastian.',
    additionalNotes: 'Some locations like the Port of Sebastian or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Sebastian Port facilities and logistics operations',
      'Naval Air Station Sebastian and military contractors',
      ...
      'Sebastian Beach and coastal tourism areas',
