...
export default function WailukuHawaiiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Wailuku.",
  "businessLicense": "Register your LLC with the Hawaii Secretary of State and obtain any required local business licenses in Wailuku.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Wailuku",
