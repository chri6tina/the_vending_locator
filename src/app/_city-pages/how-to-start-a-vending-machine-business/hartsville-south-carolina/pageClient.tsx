...
export default function HartsvilleSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Hartsville'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hartsville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Hartsville.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Hartsville business licenses or permits.",
  "additionalNotes": "Check with the City of Hartsville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Hartsville Hospital and medical facilities",
  "Downtown Hartsville office buildings and businesses",
  "Hartsville school district and educational facilities",
  "Hartsville municipal and county government buildings",
