...
export default function OrmondBeachFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Ormond Beach.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Ormond Beach.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Ormond Beach",
