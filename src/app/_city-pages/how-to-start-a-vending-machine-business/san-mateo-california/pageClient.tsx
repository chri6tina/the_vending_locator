...
export default function SanMateoCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. San Mateo may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the San Mateo County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required San Mateo business licenses or permits.',
    additionalNotes: 'Check with the City of San Mateo for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'San Mateo Hospital and medical facilities',
    'Downtown San Mateo office buildings and businesses',
    'San Mateo school district and educational facilities',
    'San Mateo municipal and county government buildings',
