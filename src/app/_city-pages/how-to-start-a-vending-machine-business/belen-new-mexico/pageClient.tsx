...
export default function BelenNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Belen may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Belen.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Belen business licenses or permits.",
  "additionalNotes": "Check with the City of Belen for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Belen Hospital and medical facilities",
  "Downtown Belen office buildings and businesses",
  "Belen school district and educational facilities",
  "Belen municipal and county government buildings",
