...
export default function MadisonIndianaHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Madison.",
