...
export default function MarionOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Marion may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Marion.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Marion business licenses or permits.",
  "additionalNotes": "Check with the City of Marion for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Marion Hospital and medical facilities",
  "Downtown Marion office buildings and businesses",
  "Marion school district and educational facilities",
  "Marion municipal and county government buildings",
