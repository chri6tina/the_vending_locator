...
export default function AltusOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Altus may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Altus.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required Altus business licenses or permits.",
  "additionalNotes": "Check with the City of Altus for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Altus Hospital and medical facilities",
  "Downtown Altus office buildings and businesses",
  "Altus school district and educational facilities",
  "Altus municipal and county government buildings",
