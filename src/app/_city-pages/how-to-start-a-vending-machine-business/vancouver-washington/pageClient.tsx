...
export default function VancouverWashingtonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington requires a sales tax permit. Register your business and collect/remit tax on vending sales. Vancouver may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Clark County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Washington Secretary of State and obtain any required Vancouver business licenses or permits.',
    additionalNotes: 'Check with the City of Vancouver for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'PeaceHealth Southwest Medical Center',
      'Portland International Airport (across river)',
      'Shared Hospital Services',
      'Wafertech semiconductor plant',
      'SEH America silicon wafer manufacturing',
      'Nautilus fitness equipment headquarters',
      'Downtown Vancouver Waterfront',
      'Vancouver Mall and Cascade Park businesses'
  ]
