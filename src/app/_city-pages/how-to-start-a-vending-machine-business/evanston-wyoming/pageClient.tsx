...
export default function EvanstonWyomingHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Evanston.",
  "businessLicense": "Register your LLC with the Wyoming Secretary of State and obtain any required local business licenses in Evanston.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Evanston",
