...
export default function CorcoranCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Corcoran.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Corcoran.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Corcoran",
