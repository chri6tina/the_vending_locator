...
export default function WestDesMoinesIowaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Iowa requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in West Des Moines.",
  "businessLicense": "Register your LLC with the Iowa Secretary of State and obtain any required local business licenses in West Des Moines.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in West Des Moines",
