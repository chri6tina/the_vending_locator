...
export default function CorneliusNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Cornelius may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Cornelius.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Cornelius business licenses or permits.",
  "additionalNotes": "Check with the City of Cornelius for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Cornelius Hospital and medical facilities",
  "Downtown Cornelius office buildings and businesses",
  "Cornelius school district and educational facilities",
  "Cornelius municipal and county government buildings",
