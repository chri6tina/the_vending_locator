...
export default function LaredoTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Laredo may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Laredo County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required Laredo business licenses or permits.',
    additionalNotes: 'Check with the City of Laredo for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Laredo Hospital and medical facilities',
    'Downtown Laredo office buildings and businesses',
    'Laredo school district and educational facilities',
    'Laredo municipal and county government buildings',
