...
export default function RollingHillsCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rolling Hills.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Rolling Hills.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rolling Hills",
