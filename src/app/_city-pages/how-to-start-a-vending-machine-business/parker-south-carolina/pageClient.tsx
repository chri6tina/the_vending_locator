...
export default function ParkerSouthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Parker may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Parker.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Parker business licenses or permits.",
  "additionalNotes": "Check with the City of Parker for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Parker Hospital and medical facilities",
  "Downtown Parker office buildings and businesses",
  "Parker school district and educational facilities",
  "Parker municipal and county government buildings",
