...
export default function LasVegasNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Las Vegas may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Las Vegas.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Las Vegas business licenses or permits.",
  "additionalNotes": "Check with the City of Las Vegas for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Las Vegas Hospital and medical facilities",
  "Downtown Las Vegas office buildings and businesses",
  "Las Vegas school district and educational facilities",
  "Las Vegas municipal and county government buildings",
