...
export default function LakewoodColoradoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Colorado requires a sales tax permit. Register your business and collect/remit tax on vending sales. Lakewood may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Colorado Secretary of State and obtain any required Lakewood business licenses or permits.',
