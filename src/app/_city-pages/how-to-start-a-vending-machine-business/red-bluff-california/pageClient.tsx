...
export default function RedBluffCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Red Bluff.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Red Bluff.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Red Bluff",
