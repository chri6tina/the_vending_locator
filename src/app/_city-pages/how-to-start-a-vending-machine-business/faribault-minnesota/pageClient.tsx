...
export default function FaribaultMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Faribault.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Faribault.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Faribault",
