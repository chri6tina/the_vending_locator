...
export default function MadisonWisconsinHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Wisconsin requires a sales tax permit. Register your business and collect/remit tax on vending sales. Madison may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Dane County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Wisconsin Secretary of State and obtain any required Madison business licenses or permits.',
    additionalNotes: 'Check with the City of Madison for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'University of Wisconsin-Madison (45,000 students)',
      'UW Health and UnityPoint Meriter hospitals',
      'Wisconsin State Capitol and government complex',
      'Epic Systems headquarters (Verona)',
      'American Family Insurance headquarters',
      'Exact Sciences biotechnology',
      'Dane County Regional Airport',
      'State Street and downtown businesses'
  ]
