...
export default function AlcoaTennesseeHowToStartPage() {
  const cityDisplayName = 'Alcoa'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Alcoa may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Alcoa.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Alcoa business licenses or permits.",
  "additionalNotes": "Check with the City of Alcoa for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Alcoa Hospital and medical facilities",
  "Downtown Alcoa office buildings and businesses",
  "Alcoa school district and educational facilities",
  "Alcoa municipal and county government buildings",
