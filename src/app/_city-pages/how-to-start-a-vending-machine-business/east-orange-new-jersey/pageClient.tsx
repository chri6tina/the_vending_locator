...
export default function EastOrangeNewJerseyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in East Orange.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required local business licenses in East Orange.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in East Orange",
