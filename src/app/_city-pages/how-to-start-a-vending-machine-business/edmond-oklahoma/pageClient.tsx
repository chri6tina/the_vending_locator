...
export default function EdmondOklahomaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Edmond.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required local business licenses in Edmond.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Edmond",
