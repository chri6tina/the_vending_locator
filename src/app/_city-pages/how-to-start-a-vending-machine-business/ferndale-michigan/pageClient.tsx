...
export default function FerndaleMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Ferndale.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Ferndale.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Ferndale",
