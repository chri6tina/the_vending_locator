...
export default function GaryIndianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Indiana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Gary may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Gary County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Indiana Secretary of State and obtain any required Gary business licenses or permits.',
    additionalNotes: 'Check with the City of Gary for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Gary Hospital and medical facilities',
    'Downtown Gary office buildings and businesses',
    'Gary school district and educational facilities',
    'Gary municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Gary',
