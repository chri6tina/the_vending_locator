...
export default function JunctionCityKansasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Junction City.",
  "businessLicense": "Register your LLC with the Kansas Secretary of State and obtain any required local business licenses in Junction City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Junction City",
