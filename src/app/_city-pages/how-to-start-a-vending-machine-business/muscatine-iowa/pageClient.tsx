...
export default function MuscatineIowaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Muscatine.",
  "businessLicense": "Register your LLC with the Iowa Secretary of State and obtain any required local business licenses in Muscatine.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Muscatine",
