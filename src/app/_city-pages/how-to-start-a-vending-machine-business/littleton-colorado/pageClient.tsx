...
export default function LittletonColoradoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Littleton.",
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in Littleton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Littleton",
