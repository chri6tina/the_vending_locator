...
export default function SunburyPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Sunbury may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Sunbury.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Sunbury business licenses or permits.",
  "additionalNotes": "Check with the City of Sunbury for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Sunbury Hospital and medical facilities",
  "Downtown Sunbury office buildings and businesses",
  "Sunbury school district and educational facilities",
  "Sunbury municipal and county government buildings",
