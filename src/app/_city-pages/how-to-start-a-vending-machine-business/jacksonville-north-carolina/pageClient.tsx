...
export default function JacksonvilleNorthCarolinaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Jacksonville.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required local business licenses in Jacksonville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Jacksonville",
