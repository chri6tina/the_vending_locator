...
export default function MalvernArkansasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Malvern.",
  "businessLicense": "Register your LLC with the Arkansas Secretary of State and obtain any required local business licenses in Malvern.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Malvern",
