...
export default function FarmingtonMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Farmington.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Farmington.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Farmington",
