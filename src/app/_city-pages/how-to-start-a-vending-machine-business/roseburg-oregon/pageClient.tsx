...
export default function RoseburgOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Roseburg may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Roseburg.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Roseburg business licenses or permits.",
  "additionalNotes": "Check with the City of Roseburg for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Roseburg Hospital and medical facilities",
  "Downtown Roseburg office buildings and businesses",
  "Roseburg school district and educational facilities",
  "Roseburg municipal and county government buildings",
