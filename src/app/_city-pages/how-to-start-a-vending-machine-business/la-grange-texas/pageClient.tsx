...
export default function LaGrangeTexasHowToStartPage() {
  const cityDisplayName = 'La Grange'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. La Grange may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in La Grange.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required La Grange business licenses or permits.",
  "additionalNotes": "Check with the City of La Grange for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "La Grange Hospital and medical facilities",
  "Downtown La Grange office buildings and businesses",
  "La Grange school district and educational facilities",
  "La Grange municipal and county government buildings",
