...
export default function BoulderCityNevadaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Nevada requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Boulder City.",
  "businessLicense": "Register your LLC with the Nevada Secretary of State and obtain any required local business licenses in Boulder City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Boulder City",
