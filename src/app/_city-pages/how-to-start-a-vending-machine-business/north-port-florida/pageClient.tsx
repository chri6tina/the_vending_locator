...
export default function NorthPortFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in North Port.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in North Port.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in North Port",
