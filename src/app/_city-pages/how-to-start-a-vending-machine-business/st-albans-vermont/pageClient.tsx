...
export default function StAlbansVermontHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in St. Albans.",
  "businessLicense": "Register your LLC with the Vermont Secretary of State and obtain any required local business licenses in St. Albans.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in St. Albans",
