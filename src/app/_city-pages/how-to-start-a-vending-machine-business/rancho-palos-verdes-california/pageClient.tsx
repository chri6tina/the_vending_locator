...
export default function RanchoPalosVerdesCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rancho Palos Verdes.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Rancho Palos Verdes.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rancho Palos Verdes",
