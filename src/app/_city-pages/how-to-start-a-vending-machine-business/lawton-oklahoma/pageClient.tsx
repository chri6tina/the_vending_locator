...
export default function LawtonOklahomaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lawton.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required local business licenses in Lawton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lawton",
