...
export default function LakevilleMinnesotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Minnesota requires a sales tax permit. Register your business and collect/remit tax on vending sales. Lakeville may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Lakeville County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Minnesota Secretary of State and obtain any required Lakeville business licenses or permits.',
    additionalNotes: 'Check with the City of Lakeville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Lakeville Hospital and medical facilities',
    'Downtown Lakeville office buildings and businesses',
    'Lakeville school district and educational facilities',
    'Lakeville municipal and county government buildings',
