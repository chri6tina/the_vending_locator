...
export default function WoodstockIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Woodstock.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Woodstock.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Woodstock",
