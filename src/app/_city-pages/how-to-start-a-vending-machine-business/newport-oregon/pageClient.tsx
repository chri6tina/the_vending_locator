...
export default function NewportOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Newport may have additional local sales taxes.",
  ...
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Newport business licenses or permits.",
