...
export default function GrantsPassOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Grants Pass may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Grants Pass.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Grants Pass business licenses or permits.",
  "additionalNotes": "Check with the City of Grants Pass for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Grants Pass Hospital and medical facilities",
  "Downtown Grants Pass office buildings and businesses",
  "Grants Pass school district and educational facilities",
  "Grants Pass municipal and county government buildings",
