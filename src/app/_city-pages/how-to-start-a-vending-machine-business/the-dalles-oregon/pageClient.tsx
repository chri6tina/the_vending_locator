...
export default function TheDallesOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. The Dalles may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in The Dalles.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required The Dalles business licenses or permits.",
  "additionalNotes": "Check with the City of The Dalles for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "The Dalles Hospital and medical facilities",
  "Downtown The Dalles office buildings and businesses",
  "The Dalles school district and educational facilities",
  "The Dalles municipal and county government buildings",
