...
export default function SitkaAlaskaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Alaska requires a sales tax permit. Register your business and collect/remit tax on vending sales. Sitka may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Sitka County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Alaska Secretary of State and obtain any required Sitka business licenses or permits.',
    additionalNotes: 'Check with the City of Sitka for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Sitka Hospital and medical facilities',
    'Downtown Sitka office buildings and businesses',
    'Sitka school district and educational facilities',
    'Sitka municipal and county government buildings',
