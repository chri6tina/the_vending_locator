...
export default function EspaolaNewMexicoHowToStartPage() {
  const cityDisplayName = 'Española'
  const stateDisplayName = 'New Mexico'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Española may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Española.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Española business licenses or permits.",
  "additionalNotes": "Check with the City of Española for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Española Hospital and medical facilities",
  "Downtown Española office buildings and businesses",
  "Española school district and educational facilities",
  "Española municipal and county government buildings",
