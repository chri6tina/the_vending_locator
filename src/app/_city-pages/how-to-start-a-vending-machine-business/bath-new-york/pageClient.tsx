...
export default function BathNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Bath may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Bath.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Bath business licenses or permits.",
  "additionalNotes": "Check with the City of Bath for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Bath Hospital and medical facilities",
  "Downtown Bath office buildings and businesses",
  "Bath school district and educational facilities",
  "Bath municipal and county government buildings",
