...
export default function NewburyportMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Newburyport.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Newburyport.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Newburyport",
