...
export default function MountVernonOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Mount Vernon may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Mount Vernon.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Mount Vernon business licenses or permits.",
  "additionalNotes": "Check with the City of Mount Vernon for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Mount Vernon Hospital and medical facilities",
  "Downtown Mount Vernon office buildings and businesses",
  "Mount Vernon school district and educational facilities",
  "Mount Vernon municipal and county government buildings",
