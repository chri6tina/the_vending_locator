...
export default function BrenhamTexasHowToStartPage() {
  const cityDisplayName = 'Brenham'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Brenham may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Brenham.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Brenham business licenses or permits.",
  "additionalNotes": "Check with the City of Brenham for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Brenham Hospital and medical facilities",
  "Downtown Brenham office buildings and businesses",
  "Brenham school district and educational facilities",
  "Brenham municipal and county government buildings",
