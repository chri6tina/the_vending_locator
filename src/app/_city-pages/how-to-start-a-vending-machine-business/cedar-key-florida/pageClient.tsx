...
export default function CedarKeyFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Cedar Key.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Cedar Key.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Cedar Key",
