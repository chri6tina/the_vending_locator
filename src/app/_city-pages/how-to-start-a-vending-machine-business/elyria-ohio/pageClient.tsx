...
export default function ElyriaOhioHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Elyria.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required local business licenses in Elyria.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Elyria",
