...
export default function LumbertonNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Lumberton may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Lumberton.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Lumberton business licenses or permits.",
  "additionalNotes": "Check with the City of Lumberton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Lumberton Hospital and medical facilities",
  "Downtown Lumberton office buildings and businesses",
  "Lumberton school district and educational facilities",
  "Lumberton municipal and county government buildings",
