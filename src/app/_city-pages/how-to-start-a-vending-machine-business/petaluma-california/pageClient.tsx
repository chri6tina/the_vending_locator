...
export default function PetalumaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Petaluma also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Petaluma.',
    additionalNotes: 'Some locations like the Port of Petaluma or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Petaluma Port facilities and logistics operations',
      'Naval Air Station Petaluma and military contractors',
      ...
      'Petaluma Beach and coastal tourism areas',
