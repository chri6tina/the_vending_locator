...
export default function ElkGroveVillageIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Elk Grove Village.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Elk Grove Village.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Elk Grove Village",
