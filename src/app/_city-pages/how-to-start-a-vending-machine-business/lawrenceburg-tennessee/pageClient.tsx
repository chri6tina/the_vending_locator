...
export default function LawrenceburgTennesseeHowToStartPage() {
  const cityDisplayName = 'Lawrenceburg'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Lawrenceburg may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Lawrenceburg.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Lawrenceburg business licenses or permits.",
  "additionalNotes": "Check with the City of Lawrenceburg for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Lawrenceburg Hospital and medical facilities",
  "Downtown Lawrenceburg office buildings and businesses",
  "Lawrenceburg school district and educational facilities",
  "Lawrenceburg municipal and county government buildings",
