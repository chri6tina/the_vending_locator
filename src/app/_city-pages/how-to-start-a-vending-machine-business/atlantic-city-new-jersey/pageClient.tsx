...
export default function AtlanticCityNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Atlantic City may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Atlantic City.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Atlantic City business licenses or permits.",
  "additionalNotes": "Check with the City of Atlantic City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Atlantic City Hospital and medical facilities",
  "Downtown Atlantic City office buildings and businesses",
  "Atlantic City school district and educational facilities",
  "Atlantic City municipal and county government buildings",
