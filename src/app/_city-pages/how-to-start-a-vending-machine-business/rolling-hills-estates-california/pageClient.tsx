...
export default function RollingHillsEstatesCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rolling Hills Estates.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Rolling Hills Estates.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rolling Hills Estates",
