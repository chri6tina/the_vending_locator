...
export default function AshtabulaOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Ashtabula may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Ashtabula.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Ashtabula business licenses or permits.",
  "additionalNotes": "Check with the City of Ashtabula for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Ashtabula Hospital and medical facilities",
  "Downtown Ashtabula office buildings and businesses",
  "Ashtabula school district and educational facilities",
  "Ashtabula municipal and county government buildings",
