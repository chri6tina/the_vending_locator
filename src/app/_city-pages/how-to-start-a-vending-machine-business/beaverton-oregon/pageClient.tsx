...
export default function BeavertonOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Oregon requires a sales tax permit. Register your business and collect/remit tax on vending sales. Beaverton may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Beaverton County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Oregon Secretary of State and obtain any required Beaverton business licenses or permits.',
    additionalNotes: 'Check with the City of Beaverton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Beaverton Hospital and medical facilities',
    'Downtown Beaverton office buildings and businesses',
    'Beaverton school district and educational facilities',
    'Beaverton municipal and county government buildings',
