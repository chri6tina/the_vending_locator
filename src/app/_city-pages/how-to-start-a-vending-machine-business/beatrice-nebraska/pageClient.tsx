...
export default function BeatriceNebraskaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Beatrice.",
  "businessLicense": "Register your LLC with the Nebraska Secretary of State and obtain any required local business licenses in Beatrice.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Beatrice",
