...
export default function FortMillSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Fort Mill'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Fort Mill may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Fort Mill.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Fort Mill business licenses or permits.",
  "additionalNotes": "Check with the City of Fort Mill for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Fort Mill Hospital and medical facilities",
  "Downtown Fort Mill office buildings and businesses",
  "Fort Mill school district and educational facilities",
  "Fort Mill municipal and county government buildings",
