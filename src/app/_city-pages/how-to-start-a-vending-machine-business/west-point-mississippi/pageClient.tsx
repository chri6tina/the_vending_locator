...
export default function WestPointMississippiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in West Point.",
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required local business licenses in West Point.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in West Point",
