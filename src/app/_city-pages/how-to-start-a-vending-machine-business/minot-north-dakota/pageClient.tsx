...
export default function MinotNorthDakotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'North Dakota requires a sales tax permit. Register your business and collect/remit tax on vending sales. Minot may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Minot County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the North Dakota Secretary of State and obtain any required Minot business licenses or permits.',
    additionalNotes: 'Check with the City of Minot for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Minot Hospital and medical facilities',
    'Downtown Minot office buildings and businesses',
    'Minot school district and educational facilities',
    'Minot municipal and county government buildings',
