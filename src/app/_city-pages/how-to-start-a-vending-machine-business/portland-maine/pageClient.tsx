...
export default function PortlandMaineHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Maine requires a sales tax permit. Register your business and collect/remit tax on vending sales. Portland may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Portland County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Maine Secretary of State and obtain any required Portland business licenses or permits.',
    additionalNotes: 'Check with the City of Portland for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Portland Hospital and medical facilities',
    'Downtown Portland office buildings and businesses',
    'Portland school district and educational facilities',
    'Portland municipal and county government buildings',
