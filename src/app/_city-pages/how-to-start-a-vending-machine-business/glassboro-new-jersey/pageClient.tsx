...
export default function GlassboroNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Glassboro may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Glassboro.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Glassboro business licenses or permits.",
  "additionalNotes": "Check with the City of Glassboro for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Glassboro Hospital and medical facilities",
  "Downtown Glassboro office buildings and businesses",
  "Glassboro school district and educational facilities",
  "Glassboro municipal and county government buildings",
