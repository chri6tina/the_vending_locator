...
export default function HobbsNewMexicoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Hobbs.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required local business licenses in Hobbs.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Hobbs",
