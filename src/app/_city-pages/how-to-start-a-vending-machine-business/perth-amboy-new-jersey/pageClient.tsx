...
export default function PerthAmboyNewJerseyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Perth Amboy.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required local business licenses in Perth Amboy.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Perth Amboy",
