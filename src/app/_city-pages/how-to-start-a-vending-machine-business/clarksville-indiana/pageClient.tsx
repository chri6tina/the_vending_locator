...
export default function ClarksvilleIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Clarksville.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Clarksville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Clarksville",
