...
export default function StuartFloridaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Florida requires a sales tax permit through the Department of Revenue. Stuart also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Stuart.',
    additionalNotes: 'Some locations like the Port of Stuart or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Stuart Port facilities and logistics operations',
      'Naval Air Station Stuart and military contractors',
      ...
      'Stuart Beach and coastal tourism areas',
