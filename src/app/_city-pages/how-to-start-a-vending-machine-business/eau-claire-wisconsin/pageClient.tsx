...
export default function EauClaireWisconsinHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Wisconsin requires a sales tax permit. Register your business and collect/remit tax on vending sales. Eau Claire may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Eau Claire County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Wisconsin Secretary of State and obtain any required Eau Claire business licenses or permits.',
    additionalNotes: 'Check with the City of Eau Claire for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Eau Claire Hospital and medical facilities',
    'Downtown Eau Claire office buildings and businesses',
    'Eau Claire school district and educational facilities',
    'Eau Claire municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Eau Claire',
