...
export default function LaurensSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Laurens'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Laurens may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Laurens.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Laurens business licenses or permits.",
  "additionalNotes": "Check with the City of Laurens for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Laurens Hospital and medical facilities",
  "Downtown Laurens office buildings and businesses",
  "Laurens school district and educational facilities",
  "Laurens municipal and county government buildings",
