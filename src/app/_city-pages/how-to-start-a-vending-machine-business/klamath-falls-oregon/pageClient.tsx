...
export default function KlamathFallsOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Klamath Falls may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Klamath Falls.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Klamath Falls business licenses or permits.",
  "additionalNotes": "Check with the City of Klamath Falls for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Klamath Falls Hospital and medical facilities",
  "Downtown Klamath Falls office buildings and businesses",
  "Klamath Falls school district and educational facilities",
  "Klamath Falls municipal and county government buildings",
