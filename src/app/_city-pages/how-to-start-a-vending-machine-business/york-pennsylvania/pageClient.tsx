...
export default function YorkPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Pennsylvania requires a sales tax permit. Register your business and collect/remit tax on vending sales. York may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the York County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Pennsylvania Secretary of State and obtain any required York business licenses or permits.',
