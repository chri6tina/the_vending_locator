...
export default function ErlangerKentuckyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Erlanger.",
  "businessLicense": "Register your LLC with the Kentucky Secretary of State and obtain any required local business licenses in Erlanger.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Erlanger",
