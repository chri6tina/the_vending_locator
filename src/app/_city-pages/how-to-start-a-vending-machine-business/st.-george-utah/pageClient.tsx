...
export default function StGeorgeUtahHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in St. George.",
  "businessLicense": "Register your LLC with the Utah Secretary of State and obtain any required local business licenses in St. George.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in St. George",
