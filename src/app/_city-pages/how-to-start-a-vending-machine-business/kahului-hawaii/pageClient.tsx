...
export default function KahuluiHawaiiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Kahului.",
  "businessLicense": "Register your LLC with the Hawaii Secretary of State and obtain any required local business licenses in Kahului.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Kahului",
