...
export default function HermistonOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hermiston may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Hermiston.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Hermiston business licenses or permits.",
  "additionalNotes": "Check with the City of Hermiston for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Hermiston Hospital and medical facilities",
  "Downtown Hermiston office buildings and businesses",
  "Hermiston school district and educational facilities",
  "Hermiston municipal and county government buildings",
