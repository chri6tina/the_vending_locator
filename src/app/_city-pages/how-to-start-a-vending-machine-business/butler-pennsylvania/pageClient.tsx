...
export default function ButlerPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Butler may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Butler.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Butler business licenses or permits.",
  "additionalNotes": "Check with the City of Butler for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Butler Hospital and medical facilities",
  "Downtown Butler office buildings and businesses",
  "Butler school district and educational facilities",
  "Butler municipal and county government buildings",
