...
export default function DenisonTexasHowToStartPage() {
  const cityDisplayName = 'Denison'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Denison may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Denison.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Denison business licenses or permits.",
  "additionalNotes": "Check with the City of Denison for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Denison Hospital and medical facilities",
  "Downtown Denison office buildings and businesses",
  "Denison school district and educational facilities",
  "Denison municipal and county government buildings",
