...
export default function RoundLakeBeachIllinoisHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Illinois requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Round Lake Beach.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Round Lake Beach.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Round Lake Beach",
