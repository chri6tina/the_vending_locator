...
export default function MidlandMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Midland.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Midland.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Midland",
