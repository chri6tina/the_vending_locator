...
export default function BurkburnettTexasHowToStartPage() {
  const cityDisplayName = 'Burkburnett'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Burkburnett may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Burkburnett.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Burkburnett business licenses or permits.",
  "additionalNotes": "Check with the City of Burkburnett for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Burkburnett Hospital and medical facilities",
  "Downtown Burkburnett office buildings and businesses",
  "Burkburnett school district and educational facilities",
  "Burkburnett municipal and county government buildings",
