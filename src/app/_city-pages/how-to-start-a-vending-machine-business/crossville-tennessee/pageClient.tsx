...
export default function CrossvilleTennesseeHowToStartPage() {
  const cityDisplayName = 'Crossville'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Crossville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Crossville.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Crossville business licenses or permits.",
  "additionalNotes": "Check with the City of Crossville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Crossville Hospital and medical facilities",
  "Downtown Crossville office buildings and businesses",
  "Crossville school district and educational facilities",
  "Crossville municipal and county government buildings",
