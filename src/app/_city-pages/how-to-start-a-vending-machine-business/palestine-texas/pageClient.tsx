...
export default function PalestineTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Palestine may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Palestine.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Palestine business licenses or permits.",
  "additionalNotes": "Check with the City of Palestine for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Palestine Hospital and medical facilities",
  "Downtown Palestine office buildings and businesses",
  "Palestine school district and educational facilities",
  "Palestine municipal and county government buildings",
