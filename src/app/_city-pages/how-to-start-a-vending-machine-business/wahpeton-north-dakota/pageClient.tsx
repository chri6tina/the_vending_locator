...
export default function WahpetonNorthDakotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Wahpeton.",
  "businessLicense": "Register your LLC with the North Dakota Secretary of State and obtain any required local business licenses in Wahpeton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Wahpeton",
