...
export default function ClovisCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Clovis may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Clovis County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Clovis business licenses or permits.',
    additionalNotes: 'Check with the City of Clovis for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Clovis Hospital and medical facilities',
    'Downtown Clovis office buildings and businesses',
    'Clovis school district and educational facilities',
    'Clovis municipal and county government buildings',
