...
export default function McKeesportPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. McKeesport may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in McKeesport.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required McKeesport business licenses or permits.",
  "additionalNotes": "Check with the City of McKeesport for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "McKeesport Hospital and medical facilities",
  "Downtown McKeesport office buildings and businesses",
  "McKeesport school district and educational facilities",
  "McKeesport municipal and county government buildings",
