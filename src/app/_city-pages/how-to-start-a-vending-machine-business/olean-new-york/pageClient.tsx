...
export default function OleanNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Olean may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Olean.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Olean business licenses or permits.",
  "additionalNotes": "Check with the City of Olean for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Olean Hospital and medical facilities",
  "Downtown Olean office buildings and businesses",
  "Olean school district and educational facilities",
  "Olean municipal and county government buildings",
