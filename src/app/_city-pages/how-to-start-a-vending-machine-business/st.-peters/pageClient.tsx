...
export default function StPetersMontanaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Montana requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. St. Peters may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in St. Peters.",
  "businessLicense": "Register your LLC with the Montana Secretary of State and obtain any required St. Peters business licenses or permits.",
  "additionalNotes": "Check with the City of St. Peters for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "St. Peters Hospital and medical facilities",
  "Downtown St. Peters office buildings and businesses",
  "St. Peters school district and educational facilities",
  "St. Peters municipal and county government buildings",
