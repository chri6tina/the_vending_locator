...
export default function TaosNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Taos may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Taos.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Taos business licenses or permits.",
  "additionalNotes": "Check with the City of Taos for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Taos Hospital and medical facilities",
  "Downtown Taos office buildings and businesses",
  "Taos school district and educational facilities",
  "Taos municipal and county government buildings",
