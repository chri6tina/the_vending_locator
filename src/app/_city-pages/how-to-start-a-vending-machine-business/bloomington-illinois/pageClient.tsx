...
export default function BloomingtonIllinoisHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Illinois requires a sales tax permit. Register your business and collect/remit tax on vending sales. Bloomington may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Illinois Secretary of State and obtain any required Bloomington business licenses or permits.',
