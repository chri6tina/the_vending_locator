...
export default function RoselleNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Roselle may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Roselle.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Roselle business licenses or permits.",
  "additionalNotes": "Check with the City of Roselle for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Roselle Hospital and medical facilities",
  "Downtown Roselle office buildings and businesses",
  "Roselle school district and educational facilities",
  "Roselle municipal and county government buildings",
