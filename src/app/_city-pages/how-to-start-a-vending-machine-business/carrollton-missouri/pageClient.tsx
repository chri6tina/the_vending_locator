...
export default function CarrolltonMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Carrollton.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Carrollton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Carrollton",
