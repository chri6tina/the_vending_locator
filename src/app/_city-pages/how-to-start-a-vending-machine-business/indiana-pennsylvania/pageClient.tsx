...
export default function IndianaPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Indiana may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Indiana.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Indiana business licenses or permits.",
  "additionalNotes": "Check with the City of Indiana for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Indiana Hospital and medical facilities",
  "Downtown Indiana office buildings and businesses",
  "Indiana school district and educational facilities",
  "Indiana municipal and county government buildings",
