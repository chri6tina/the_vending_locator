...
export default function NewBrunswickNewJerseyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in New Brunswick.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required local business licenses in New Brunswick.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in New Brunswick",
