...
export default function OceansideCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Oceanside may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Oceanside County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Oceanside business licenses or permits.',
    additionalNotes: 'Check with the City of Oceanside for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Oceanside Hospital and medical facilities',
    'Downtown Oceanside office buildings and businesses',
    'Oceanside school district and educational facilities',
    'Oceanside municipal and county government buildings',
