...
export default function WestWarwickRhodeIslandHowToStartPage() {
  const cityDisplayName = 'West Warwick'
  const stateDisplayName = 'Rhode Island'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Rhode Island requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. West Warwick may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in West Warwick.",
  "businessLicense": "Register your LLC with the Rhode Island Secretary of State and obtain any required West Warwick business licenses or permits.",
  "additionalNotes": "Check with the City of West Warwick for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "West Warwick Hospital and medical facilities",
  "Downtown West Warwick office buildings and businesses",
  "West Warwick school district and educational facilities",
  "West Warwick municipal and county government buildings",
