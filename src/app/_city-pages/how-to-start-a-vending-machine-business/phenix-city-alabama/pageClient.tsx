...
export default function PhenixCityAlabamaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Phenix City.",
  "businessLicense": "Register your LLC with the Alabama Secretary of State and obtain any required local business licenses in Phenix City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Phenix City",
