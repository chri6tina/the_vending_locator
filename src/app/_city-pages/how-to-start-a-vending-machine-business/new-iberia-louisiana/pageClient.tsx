...
export default function NewIberiaLouisianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in New Iberia.",
  "businessLicense": "Register your LLC with the Louisiana Secretary of State and obtain any required local business licenses in New Iberia.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in New Iberia",
