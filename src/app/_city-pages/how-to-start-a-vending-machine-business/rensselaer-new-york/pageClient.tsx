...
export default function RensselaerNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Rensselaer may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Rensselaer.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Rensselaer business licenses or permits.",
  "additionalNotes": "Check with the City of Rensselaer for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Rensselaer Hospital and medical facilities",
  "Downtown Rensselaer office buildings and businesses",
  "Rensselaer school district and educational facilities",
  "Rensselaer municipal and county government buildings",
