...
export default function WellesleyMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Wellesley.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Wellesley.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Wellesley",
