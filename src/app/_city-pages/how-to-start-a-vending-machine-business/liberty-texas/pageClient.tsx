...
export default function LibertyTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Liberty may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Liberty.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Liberty business licenses or permits.",
  "additionalNotes": "Check with the City of Liberty for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Liberty Hospital and medical facilities",
  "Downtown Liberty office buildings and businesses",
  "Liberty school district and educational facilities",
  "Liberty municipal and county government buildings",
