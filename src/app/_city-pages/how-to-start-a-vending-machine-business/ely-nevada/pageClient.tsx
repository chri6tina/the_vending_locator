...
export default function ElyNevadaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Nevada requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Ely may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Ely.",
  "businessLicense": "Register your LLC with the Nevada Secretary of State and obtain any required Ely business licenses or permits.",
  "additionalNotes": "Check with the City of Ely for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Ely Hospital and medical facilities",
  "Downtown Ely office buildings and businesses",
  "Ely school district and educational facilities",
  "Ely municipal and county government buildings",
