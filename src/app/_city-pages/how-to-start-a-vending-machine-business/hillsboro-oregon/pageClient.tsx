...
export default function HillsboroOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Oregon requires a sales tax permit. Register your business and collect/remit tax on vending sales. Hillsboro may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Hillsboro County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Oregon Secretary of State and obtain any required Hillsboro business licenses or permits.',
    additionalNotes: 'Check with the City of Hillsboro for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Hillsboro Hospital and medical facilities',
    'Downtown Hillsboro office buildings and businesses',
    'Hillsboro school district and educational facilities',
    'Hillsboro municipal and county government buildings',
