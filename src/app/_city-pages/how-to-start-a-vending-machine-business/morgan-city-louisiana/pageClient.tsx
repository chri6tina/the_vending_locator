...
export default function MorganCityLouisianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Morgan City.",
  "businessLicense": "Register your LLC with the Louisiana Secretary of State and obtain any required local business licenses in Morgan City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Morgan City",
