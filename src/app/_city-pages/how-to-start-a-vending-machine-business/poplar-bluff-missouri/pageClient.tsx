...
export default function PoplarBluffMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Poplar Bluff.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Poplar Bluff.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Poplar Bluff",
