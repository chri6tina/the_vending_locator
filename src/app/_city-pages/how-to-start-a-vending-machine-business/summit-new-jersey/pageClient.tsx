...
export default function SummitNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Summit may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Summit.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Summit business licenses or permits.",
  "additionalNotes": "Check with the City of Summit for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Summit Hospital and medical facilities",
  "Downtown Summit office buildings and businesses",
  "Summit school district and educational facilities",
  "Summit municipal and county government buildings",
