...
export default function WildwoodFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Wildwood.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Wildwood.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Wildwood",
