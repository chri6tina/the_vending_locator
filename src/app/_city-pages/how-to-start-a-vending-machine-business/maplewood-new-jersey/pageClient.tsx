...
export default function MaplewoodNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Maplewood may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Maplewood.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Maplewood business licenses or permits.",
  "additionalNotes": "Check with the City of Maplewood for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Maplewood Hospital and medical facilities",
  "Downtown Maplewood office buildings and businesses",
  "Maplewood school district and educational facilities",
  "Maplewood municipal and county government buildings",
