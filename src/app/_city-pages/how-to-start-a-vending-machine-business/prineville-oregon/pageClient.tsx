...
export default function PrinevilleOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Prineville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Prineville.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Prineville business licenses or permits.",
  "additionalNotes": "Check with the City of Prineville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Prineville Hospital and medical facilities",
  "Downtown Prineville office buildings and businesses",
  "Prineville school district and educational facilities",
  "Prineville municipal and county government buildings",
