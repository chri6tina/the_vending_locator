...
export default function OldOrchardBeachMaineHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Old Orchard Beach.",
  "businessLicense": "Register your LLC with the Maine Secretary of State and obtain any required local business licenses in Old Orchard Beach.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Old Orchard Beach",
