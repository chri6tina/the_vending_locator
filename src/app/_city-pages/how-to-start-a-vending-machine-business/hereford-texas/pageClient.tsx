...
export default function HerefordTexasHowToStartPage() {
  const cityDisplayName = 'Hereford'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hereford may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Hereford.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Hereford business licenses or permits.",
  "additionalNotes": "Check with the City of Hereford for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Hereford Hospital and medical facilities",
  "Downtown Hereford office buildings and businesses",
  "Hereford school district and educational facilities",
  "Hereford municipal and county government buildings",
