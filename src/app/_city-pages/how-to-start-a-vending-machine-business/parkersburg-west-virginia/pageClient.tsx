...
export default function ParkersburgWestVirginiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "West Virginia requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Parkersburg.",
  "businessLicense": "Register your LLC with the West Virginia Secretary of State and obtain any required local business licenses in Parkersburg.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Parkersburg",
