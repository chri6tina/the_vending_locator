...
export default function KansasCityKansasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Kansas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Kansas City may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Kansas Secretary of State and obtain any required Kansas City business licenses or permits.',
