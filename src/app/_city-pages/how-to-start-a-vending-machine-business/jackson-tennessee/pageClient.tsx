...
export default function JacksonTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Tennessee requires a sales tax permit. Register your business and collect/remit tax on vending sales. Jackson may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Tennessee Secretary of State and obtain any required Jackson business licenses or permits.',
  ...
  const demandDrivers = [
    ...
    'Jackson municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Jackson',
