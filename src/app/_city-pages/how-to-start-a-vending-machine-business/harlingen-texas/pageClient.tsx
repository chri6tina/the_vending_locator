...
export default function HarlingenTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Harlingen may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Harlingen.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Harlingen business licenses or permits.",
  "additionalNotes": "Check with the City of Harlingen for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Harlingen Hospital and medical facilities",
  "Downtown Harlingen office buildings and businesses",
  "Harlingen school district and educational facilities",
  "Harlingen municipal and county government buildings",
