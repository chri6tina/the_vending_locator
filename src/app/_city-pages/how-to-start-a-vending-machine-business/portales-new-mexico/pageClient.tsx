...
export default function PortalesNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Portales may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Portales.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Portales business licenses or permits.",
  "additionalNotes": "Check with the City of Portales for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Portales Hospital and medical facilities",
  "Downtown Portales office buildings and businesses",
  "Portales school district and educational facilities",
  "Portales municipal and county government buildings",
