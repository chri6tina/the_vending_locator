...
export default function LancasterSouthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Lancaster may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Lancaster.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Lancaster business licenses or permits.",
  "additionalNotes": "Check with the City of Lancaster for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Lancaster Hospital and medical facilities",
  "Downtown Lancaster office buildings and businesses",
  "Lancaster school district and educational facilities",
  "Lancaster municipal and county government buildings",
