...
export default function MorgantonNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Morganton may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Morganton.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Morganton business licenses or permits.",
  "additionalNotes": "Check with the City of Morganton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Morganton Hospital and medical facilities",
  "Downtown Morganton office buildings and businesses",
  "Morganton school district and educational facilities",
  "Morganton municipal and county government buildings",
