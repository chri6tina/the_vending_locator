...
export default function VallejoCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Vallejo may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Vallejo County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Vallejo business licenses or permits.',
    additionalNotes: 'Check with the City of Vallejo for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Vallejo Hospital and medical facilities',
    'Downtown Vallejo office buildings and businesses',
    'Vallejo school district and educational facilities',
    'Vallejo municipal and county government buildings',
