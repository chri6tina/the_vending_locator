...
export default function StJosephMontanaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in St. Joseph.",
  "businessLicense": "Register your LLC with the Montana Secretary of State and obtain any required local business licenses in St. Joseph.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in St. Joseph",
