...
export default function CottageGroveMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Cottage Grove.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Cottage Grove.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Cottage Grove",
