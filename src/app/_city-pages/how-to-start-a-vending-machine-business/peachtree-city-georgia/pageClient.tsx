...
export default function PeachtreeCityGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Peachtree City.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Peachtree City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Peachtree City",
