...
export default function KeizerOregonHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Keizer.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required local business licenses in Keizer.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Keizer",
