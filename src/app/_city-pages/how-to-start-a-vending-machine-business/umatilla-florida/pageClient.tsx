...
export default function UmatillaFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Umatilla.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Umatilla.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Umatilla",
