...
export default function MorgantownWestVirginiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Morgantown.",
  "businessLicense": "Register your LLC with the West Virginia Secretary of State and obtain any required local business licenses in Morgantown.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Morgantown",
