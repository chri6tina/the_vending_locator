...
export default function BryanTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Bryan may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Bryan.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Bryan business licenses or permits.",
  "additionalNotes": "Check with the City of Bryan for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Bryan Hospital and medical facilities",
  "Downtown Bryan office buildings and businesses",
  "Bryan school district and educational facilities",
  "Bryan municipal and county government buildings",
