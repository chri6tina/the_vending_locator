...
export default function HuronSouthDakotaHowToStartPage() {
  const cityDisplayName = 'Huron'
  const stateDisplayName = 'South Dakota'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Dakota requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Huron may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Huron.",
  "businessLicense": "Register your LLC with the South Dakota Secretary of State and obtain any required Huron business licenses or permits.",
  "additionalNotes": "Check with the City of Huron for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Huron Hospital and medical facilities",
  "Downtown Huron office buildings and businesses",
  "Huron school district and educational facilities",
  "Huron municipal and county government buildings",
