...
export default function RedWingMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Red Wing.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Red Wing.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Red Wing",
