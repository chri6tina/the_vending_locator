...
export default function OrangeCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Orange may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Orange business licenses or permits.',
    additionalNotes: 'Check with the City of Orange for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Orange Hospital and medical facilities',
    'Downtown Orange office buildings and businesses',
    'Orange school district and educational facilities',
    'Orange municipal and county government buildings',
