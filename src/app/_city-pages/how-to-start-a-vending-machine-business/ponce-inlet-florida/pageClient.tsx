...
export default function PonceInletFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Ponce Inlet.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Ponce Inlet.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Ponce Inlet",
