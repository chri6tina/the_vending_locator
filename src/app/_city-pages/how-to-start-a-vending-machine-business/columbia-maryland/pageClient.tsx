...
export default function ColumbiaMarylandHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Maryland requires a sales tax permit. Register your business and collect/remit tax on vending sales. Columbia may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Maryland Secretary of State and obtain any required Columbia business licenses or permits.',
  ...
  const demandDrivers = [
    ...
    'Columbia municipal and county government buildings',
