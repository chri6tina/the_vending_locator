...
export default function PrairieVillageKansasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Kansas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Prairie Village.",
  "businessLicense": "Register your LLC with the Kansas Secretary of State and obtain any required local business licenses in Prairie Village.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Prairie Village",
