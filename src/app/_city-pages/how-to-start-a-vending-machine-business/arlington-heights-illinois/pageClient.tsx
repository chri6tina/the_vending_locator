...
export default function ArlingtonHeightsIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Arlington Heights.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Arlington Heights.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Arlington Heights",
