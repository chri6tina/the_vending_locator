...
export default function AnacondaMontanaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Anaconda.",
  "businessLicense": "Register your LLC with the Montana Secretary of State and obtain any required local business licenses in Anaconda.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Anaconda",
