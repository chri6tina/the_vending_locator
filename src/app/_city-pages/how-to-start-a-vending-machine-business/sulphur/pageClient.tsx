...
export default function SulphurLouisianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Louisiana requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Sulphur may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Sulphur.",
  "businessLicense": "Register your LLC with the Louisiana Secretary of State and obtain any required Sulphur business licenses or permits.",
  "additionalNotes": "Check with the City of Sulphur for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Sulphur Hospital and medical facilities",
  "Downtown Sulphur office buildings and businesses",
  "Sulphur school district and educational facilities",
  "Sulphur municipal and county government buildings",
