...
export default function TivertonRhodeIslandHowToStartPage() {
  const cityDisplayName = 'Tiverton'
  const stateDisplayName = 'Rhode Island'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Rhode Island requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Tiverton may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Tiverton.",
  "businessLicense": "Register your LLC with the Rhode Island Secretary of State and obtain any required Tiverton business licenses or permits.",
  "additionalNotes": "Check with the City of Tiverton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Tiverton Hospital and medical facilities",
  "Downtown Tiverton office buildings and businesses",
  "Tiverton school district and educational facilities",
  "Tiverton municipal and county government buildings",
