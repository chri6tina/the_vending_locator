...
export default function TuscaloosaAlabamaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Alabama requires a sales tax permit. Register your business and collect/remit tax on vending sales. Tuscaloosa may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Tuscaloosa County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Alabama Secretary of State and obtain any required Tuscaloosa business licenses or permits.',
    additionalNotes: 'Check with the City of Tuscaloosa for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Tuscaloosa Hospital and medical facilities',
    'Downtown Tuscaloosa office buildings and businesses',
    'University of Alabama campus and facilities',
    'Tuscaloosa municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Tuscaloosa',
