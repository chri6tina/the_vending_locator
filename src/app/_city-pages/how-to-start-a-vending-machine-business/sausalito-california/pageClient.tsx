...
export default function SausalitoCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Sausalito.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Sausalito.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Sausalito",
