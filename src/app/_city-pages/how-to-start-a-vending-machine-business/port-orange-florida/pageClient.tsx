...
export default function PortOrangeFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Port Orange.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Port Orange.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Port Orange",
