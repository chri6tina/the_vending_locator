...
export default function CharlotteNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'North Carolina requires a sales tax permit. Register your business and collect/remit tax on vending sales. Charlotte may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Mecklenburg County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the North Carolina Secretary of State and obtain any required Charlotte business licenses or permits.',
    additionalNotes: 'Check with the City of Charlotte for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Bank of America Corporate Center (tallest building in NC)',
      'Truist Financial (formerly BB&T and SunTrust) headquarters',
      'Charlotte Douglas International Airport (CLT - 6th busiest)',
      'Atrium Health Carolinas Medical Center',
      'University of North Carolina at Charlotte',
      'Wells Fargo East Coast Operations',
      'NASCAR Hall of Fame and Team Penske Racing',
      'Lowes corporate headquarters (Mooresville nearby)'
  ]
