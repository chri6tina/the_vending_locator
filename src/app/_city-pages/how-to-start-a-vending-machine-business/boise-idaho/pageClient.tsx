...
export default function BoiseIdahoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Idaho requires a sales tax permit. Register your business and collect/remit tax on vending sales. Boise may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Ada County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Idaho Secretary of State and obtain any required Boise business licenses or permits.',
    additionalNotes: 'Check with the City of Boise for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'St. Luke\'s Health System and St. Alphonsus hospitals',
      'Boise Airport (BOI)',
      'Idaho State Capitol and government offices',
      'Boise State University (Bronco Stadium)',
      'Micron Technology headquarters',
      'HP Inc. operations center',
      'Albertsons Companies headquarters',
      'Downtown Boise and Boise Towne Square'
  ]
