...
export default function VermillionSouthDakotaHowToStartPage() {
  const cityDisplayName = 'Vermillion'
  const stateDisplayName = 'South Dakota'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Dakota requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Vermillion may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Vermillion.",
  "businessLicense": "Register your LLC with the South Dakota Secretary of State and obtain any required Vermillion business licenses or permits.",
  "additionalNotes": "Check with the City of Vermillion for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Vermillion Hospital and medical facilities",
  "Downtown Vermillion office buildings and businesses",
  "Vermillion school district and educational facilities",
  "Vermillion municipal and county government buildings",
