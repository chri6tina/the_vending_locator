...
export default function FayettevilleTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Fayetteville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Fayetteville.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Fayetteville business licenses or permits.",
