...
export default function ChicoCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Chico may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Chico County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Chico business licenses or permits.',
    additionalNotes: 'Check with the City of Chico for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Chico Hospital and medical facilities',
    'Downtown Chico office buildings and businesses',
    'Chico school district and educational facilities',
    'Chico municipal and county government buildings',
