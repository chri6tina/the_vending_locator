...
export default function ReadingMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Reading.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Reading.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Reading",
