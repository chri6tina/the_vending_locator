...
export default function WesterlyRhodeIslandHowToStartPage() {
  const cityDisplayName = 'Westerly'
  const stateDisplayName = 'Rhode Island'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Rhode Island requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Westerly may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Westerly.",
  "businessLicense": "Register your LLC with the Rhode Island Secretary of State and obtain any required Westerly business licenses or permits.",
  "additionalNotes": "Check with the City of Westerly for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Westerly Hospital and medical facilities",
  "Downtown Westerly office buildings and businesses",
  "Westerly school district and educational facilities",
  "Westerly municipal and county government buildings",
