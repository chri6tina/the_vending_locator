...
export default function SalemNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Hampshire requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Salem may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Salem.",
