...
export default function RockIslandIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rock Island.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Rock Island.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rock Island",
