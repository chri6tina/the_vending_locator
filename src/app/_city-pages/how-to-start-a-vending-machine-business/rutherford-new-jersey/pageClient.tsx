...
export default function RutherfordNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Rutherford may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Rutherford.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Rutherford business licenses or permits.",
  "additionalNotes": "Check with the City of Rutherford for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Rutherford Hospital and medical facilities",
  "Downtown Rutherford office buildings and businesses",
  "Rutherford school district and educational facilities",
  "Rutherford municipal and county government buildings",
