...
export default function JacksonMississippiHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Mississippi requires a sales tax permit. Register your business and collect/remit tax on vending sales. Jackson may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Jackson County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Mississippi Secretary of State and obtain any required Jackson business licenses or permits.',
    additionalNotes: 'Check with the City of Jackson for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Jackson Hospital and medical facilities',
    'Downtown Jackson office buildings and businesses',
    'Jackson school district and educational facilities',
    'Mississippi state government offices and capitol complex',
    ...
    'Jackson Airport and related businesses'
  ]
