...
export default function WrenthamMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Wrentham.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Wrentham.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Wrentham",
