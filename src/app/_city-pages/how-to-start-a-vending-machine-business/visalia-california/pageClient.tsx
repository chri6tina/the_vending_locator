...
export default function VisaliaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Visalia may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Visalia County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Visalia business licenses or permits.',
    additionalNotes: 'Check with the City of Visalia for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Visalia Hospital and medical facilities',
    'Downtown Visalia office buildings and businesses',
    'Visalia school district and educational facilities',
    'Visalia municipal and county government buildings',
