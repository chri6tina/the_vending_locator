...
export default function WillistonNorthDakotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Dakota requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Williston may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Williston.",
  "businessLicense": "Register your LLC with the North Dakota Secretary of State and obtain any required Williston business licenses or permits.",
  "additionalNotes": "Check with the City of Williston for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Williston Hospital and medical facilities",
  "Downtown Williston office buildings and businesses",
  "Williston school district and educational facilities",
  "Williston municipal and county government buildings",
