...
export default function CutlerBayFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Cutler Bay.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Cutler Bay.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Cutler Bay",
