...
export default function NorthAdamsMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in North Adams.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in North Adams.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in North Adams",
