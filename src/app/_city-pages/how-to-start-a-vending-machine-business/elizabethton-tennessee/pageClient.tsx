...
export default function ElizabethtonTennesseeHowToStartPage() {
  const cityDisplayName = 'Elizabethton'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Elizabethton may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Elizabethton.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Elizabethton business licenses or permits.",
  "additionalNotes": "Check with the City of Elizabethton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Elizabethton Hospital and medical facilities",
  "Downtown Elizabethton office buildings and businesses",
  "Elizabethton school district and educational facilities",
  "Elizabethton municipal and county government buildings",
