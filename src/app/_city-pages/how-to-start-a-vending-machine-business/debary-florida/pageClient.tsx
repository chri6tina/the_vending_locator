...
export default function DeBaryFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in DeBary.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in DeBary.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in DeBary",
