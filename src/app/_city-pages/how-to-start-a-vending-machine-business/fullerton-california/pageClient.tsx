...
export default function FullertonCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Fullerton may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Fullerton County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Fullerton business licenses or permits.',
    additionalNotes: 'Check with the City of Fullerton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Fullerton Hospital and medical facilities',
    'Downtown Fullerton office buildings and businesses',
    'Fullerton school district and educational facilities',
    'Fullerton municipal and county government buildings',
