...
export default function PleasantHillCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Pleasant Hill.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Pleasant Hill.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Pleasant Hill",
