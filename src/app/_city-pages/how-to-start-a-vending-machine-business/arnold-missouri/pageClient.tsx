...
export default function ArnoldMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Arnold.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Arnold.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Arnold",
