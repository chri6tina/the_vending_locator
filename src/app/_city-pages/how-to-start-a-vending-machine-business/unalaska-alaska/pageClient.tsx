...
export default function UnalaskaAlaskaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Unalaska.",
  "businessLicense": "Register your LLC with the Alaska Secretary of State and obtain any required local business licenses in Unalaska.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Unalaska",
