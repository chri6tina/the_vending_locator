...
export default function SteubenvilleOhioHowToStartPage() {
  const cityDisplayName = 'Steubenville'
  const stateDisplayName = 'Ohio'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Steubenville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Steubenville.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Steubenville business licenses or permits.",
  "additionalNotes": "Check with the City of Steubenville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Steubenville Hospital and medical facilities",
  "Downtown Steubenville office buildings and businesses",
  "Steubenville school district and educational facilities",
  "Steubenville municipal and county government buildings",
