...
export default function BozemanMontanaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Montana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Bozeman may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Bozeman County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Montana Secretary of State and obtain any required Bozeman business licenses or permits.',
    additionalNotes: 'Check with the City of Bozeman for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Bozeman Hospital and medical facilities',
    'Downtown Bozeman office buildings and businesses',
    'Bozeman school district and educational facilities',
    'Bozeman municipal and county government buildings',
