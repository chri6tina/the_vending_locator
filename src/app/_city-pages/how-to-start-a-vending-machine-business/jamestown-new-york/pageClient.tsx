...
export default function JamestownNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Jamestown may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Jamestown.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Jamestown business licenses or permits.",
  "additionalNotes": "Check with the City of Jamestown for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Jamestown Hospital and medical facilities",
  "Downtown Jamestown office buildings and businesses",
  "Jamestown school district and educational facilities",
  "Jamestown municipal and county government buildings",
