...
export default function LewesDelawareHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lewes.",
  "businessLicense": "Register your LLC with the Delaware Secretary of State and obtain any required local business licenses in Lewes.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lewes",
