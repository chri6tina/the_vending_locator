...
export default function DicksonTennesseeHowToStartPage() {
  const cityDisplayName = 'Dickson'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Dickson may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Dickson.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Dickson business licenses or permits.",
  "additionalNotes": "Check with the City of Dickson for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Dickson Hospital and medical facilities",
  "Downtown Dickson office buildings and businesses",
  "Dickson school district and educational facilities",
  "Dickson municipal and county government buildings",
