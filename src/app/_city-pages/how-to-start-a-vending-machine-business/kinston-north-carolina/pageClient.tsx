...
export default function KinstonNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Kinston may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Kinston.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Kinston business licenses or permits.",
  "additionalNotes": "Check with the City of Kinston for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Kinston Hospital and medical facilities",
  "Downtown Kinston office buildings and businesses",
  "Kinston school district and educational facilities",
  "Kinston municipal and county government buildings",
