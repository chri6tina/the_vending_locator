...
export default function MarquetteMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Marquette.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Marquette.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Marquette",
