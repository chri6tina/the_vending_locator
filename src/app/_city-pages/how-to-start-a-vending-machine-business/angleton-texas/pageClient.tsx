...
export default function AngletonTexasHowToStartPage() {
  const cityDisplayName = 'Angleton'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Angleton may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Angleton.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Angleton business licenses or permits.",
  "additionalNotes": "Check with the City of Angleton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Angleton Hospital and medical facilities",
  "Downtown Angleton office buildings and businesses",
  "Angleton school district and educational facilities",
  "Angleton municipal and county government buildings",
