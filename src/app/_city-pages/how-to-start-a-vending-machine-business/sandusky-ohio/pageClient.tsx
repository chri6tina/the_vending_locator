...
export default function SanduskyOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Sandusky may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Sandusky.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Sandusky business licenses or permits.",
  "additionalNotes": "Check with the City of Sandusky for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Sandusky Hospital and medical facilities",
  "Downtown Sandusky office buildings and businesses",
  "Sandusky school district and educational facilities",
  "Sandusky municipal and county government buildings",
