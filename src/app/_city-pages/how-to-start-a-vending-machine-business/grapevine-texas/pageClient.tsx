...
export default function GrapevineTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Grapevine may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Grapevine.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Grapevine business licenses or permits.",
  "additionalNotes": "Check with the City of Grapevine for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Grapevine Hospital and medical facilities",
  "Downtown Grapevine office buildings and businesses",
  "Grapevine school district and educational facilities",
  "Grapevine municipal and county government buildings",
