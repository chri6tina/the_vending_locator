...
export default function KearnyNewJerseyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Kearny.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required local business licenses in Kearny.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Kearny",
