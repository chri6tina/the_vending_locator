...
export default function OrovilleCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Oroville.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Oroville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Oroville",
