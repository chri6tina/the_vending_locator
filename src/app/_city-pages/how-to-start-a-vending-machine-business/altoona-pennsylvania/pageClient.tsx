...
export default function AltoonaPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Altoona may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Altoona.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Altoona business licenses or permits.",
  "additionalNotes": "Check with the City of Altoona for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Altoona Hospital and medical facilities",
  "Downtown Altoona office buildings and businesses",
  "Altoona school district and educational facilities",
  "Altoona municipal and county government buildings",
