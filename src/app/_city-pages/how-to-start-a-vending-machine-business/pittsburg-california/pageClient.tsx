...
export default function PittsburgCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Pittsburg also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Pittsburg.',
    additionalNotes: 'Some locations like the Port of Pittsburg or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Pittsburg Port facilities and logistics operations',
      'Naval Air Station Pittsburg and military contractors',
      ...
      'Pittsburg Beach and coastal tourism areas',
