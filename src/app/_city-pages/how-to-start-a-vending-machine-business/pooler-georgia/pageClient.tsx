...
export default function PoolerGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Pooler.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Pooler.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Pooler",
