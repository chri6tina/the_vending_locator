...
export default function ParisTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Paris may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Paris.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Paris business licenses or permits.",
  "additionalNotes": "Check with the City of Paris for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Paris Hospital and medical facilities",
  "Downtown Paris office buildings and businesses",
  "Paris school district and educational facilities",
  "Paris municipal and county government buildings",
