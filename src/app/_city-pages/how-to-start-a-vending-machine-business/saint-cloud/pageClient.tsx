...
export default function SaintCloudMinnesotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Minnesota requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Saint Cloud may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Saint Cloud.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required Saint Cloud business licenses or permits.",
  "additionalNotes": "Check with the City of Saint Cloud for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Saint Cloud Hospital and medical facilities",
  "Downtown Saint Cloud office buildings and businesses",
  "Saint Cloud school district and educational facilities",
  "Saint Cloud municipal and county government buildings",
