...
export default function BartlettTennesseeHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Bartlett.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required local business licenses in Bartlett.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Bartlett",
