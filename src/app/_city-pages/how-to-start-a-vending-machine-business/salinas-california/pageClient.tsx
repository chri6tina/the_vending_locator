...
export default function SalinasCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Salinas may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Salinas County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Salinas business licenses or permits.',
    additionalNotes: 'Check with the City of Salinas for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Salinas Hospital and medical facilities',
    'Downtown Salinas office buildings and businesses',
    'Salinas school district and educational facilities',
    'Salinas municipal and county government buildings',
