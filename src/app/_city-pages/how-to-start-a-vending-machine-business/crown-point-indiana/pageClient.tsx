...
export default function CrownPointIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Crown Point.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Crown Point.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Crown Point",
