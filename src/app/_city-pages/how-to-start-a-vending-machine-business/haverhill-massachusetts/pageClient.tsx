...
export default function HaverhillMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Haverhill.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Haverhill.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Haverhill",
