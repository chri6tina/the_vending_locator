...
export default function LighthousePointFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lighthouse Point.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Lighthouse Point.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lighthouse Point",
