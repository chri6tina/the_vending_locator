...
export default function RidgelandMississippiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Ridgeland.",
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required local business licenses in Ridgeland.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Ridgeland",
