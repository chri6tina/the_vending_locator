...
export default function MorroBayCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Morro Bay.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Morro Bay.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Morro Bay",
