...
export default function BurbankIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Burbank.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Burbank.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Burbank",
