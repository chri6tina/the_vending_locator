...
export default function OregonCityOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Oregon City may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Oregon City.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Oregon City business licenses or permits.",
  "additionalNotes": "Check with the City of Oregon City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Oregon City Hospital and medical facilities",
  "Downtown Oregon City office buildings and businesses",
  "Oregon City school district and educational facilities",
  "Oregon City municipal and county government buildings",
