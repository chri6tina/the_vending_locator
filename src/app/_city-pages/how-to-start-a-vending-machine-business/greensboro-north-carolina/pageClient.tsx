...
export default function GreensboroNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'North Carolina requires a sales tax permit. Register your business and collect/remit tax on vending sales. Greensboro may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Greensboro County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the North Carolina Secretary of State and obtain any required Greensboro business licenses or permits.',
    additionalNotes: 'Check with the City of Greensboro for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Greensboro Hospital and medical facilities',
    'Downtown Greensboro office buildings and businesses',
    'Greensboro school district and educational facilities',
    'Greensboro municipal and county government buildings',
