...
export default function IthacaNewYorkHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Ithaca.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required local business licenses in Ithaca.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Ithaca",
