...
export default function JeffersonCityTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Jefferson City may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Jefferson City.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Jefferson City business licenses or permits.",
  "additionalNotes": "Check with the City of Jefferson City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Jefferson City Hospital and medical facilities",
  "Downtown Jefferson City office buildings and businesses",
  "Jefferson City school district and educational facilities",
  "Jefferson City municipal and county government buildings",
