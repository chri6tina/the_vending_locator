...
export default function NoviMichiganHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Michigan requires a sales tax permit. Register your business and collect/remit tax on vending sales. Novi may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Novi County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Michigan Secretary of State and obtain any required Novi business licenses or permits.',
    additionalNotes: 'Check with the City of Novi for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Novi Hospital and medical facilities',
    'Downtown Novi office buildings and businesses',
    'Novi school district and educational facilities',
    'Novi municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Novi',
