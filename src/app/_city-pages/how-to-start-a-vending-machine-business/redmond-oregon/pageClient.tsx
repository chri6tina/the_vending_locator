...
export default function RedmondOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Redmond may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Redmond.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Redmond business licenses or permits.",
  "additionalNotes": "Check with the City of Redmond for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Redmond Hospital and medical facilities",
  "Downtown Redmond office buildings and businesses",
  "Redmond school district and educational facilities",
  "Redmond municipal and county government buildings",
