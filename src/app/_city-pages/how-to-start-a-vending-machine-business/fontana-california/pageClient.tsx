...
export default function FontanaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Fontana may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Fontana County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Fontana business licenses or permits.',
    additionalNotes: 'Check with the City of Fontana for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Fontana Hospital and medical facilities',
    'Downtown Fontana office buildings and businesses',
    'Fontana school district and educational facilities',
    'Fontana municipal and county government buildings',
