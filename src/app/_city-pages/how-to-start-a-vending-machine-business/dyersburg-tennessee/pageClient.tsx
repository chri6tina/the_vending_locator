...
export default function DyersburgTennesseeHowToStartPage() {
  const cityDisplayName = 'Dyersburg'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Dyersburg may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Dyersburg.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Dyersburg business licenses or permits.",
  "additionalNotes": "Check with the City of Dyersburg for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Dyersburg Hospital and medical facilities",
  "Downtown Dyersburg office buildings and businesses",
  "Dyersburg school district and educational facilities",
  "Dyersburg municipal and county government buildings",
