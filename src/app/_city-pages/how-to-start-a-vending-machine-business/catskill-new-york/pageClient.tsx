...
export default function CatskillNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Catskill may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Catskill.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Catskill business licenses or permits.",
  "additionalNotes": "Check with the City of Catskill for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Catskill Hospital and medical facilities",
  "Downtown Catskill office buildings and businesses",
  "Catskill school district and educational facilities",
  "Catskill municipal and county government buildings",
