...
export default function ColumbusNebraskaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Columbus.",
  "businessLicense": "Register your LLC with the Nebraska Secretary of State and obtain any required local business licenses in Columbus.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Columbus",
