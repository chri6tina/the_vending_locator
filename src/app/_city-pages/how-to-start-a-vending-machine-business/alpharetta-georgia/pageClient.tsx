...
export default function AlpharettaGeorgiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Georgia requires a sales tax permit through the Department of Revenue. Alpharetta also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Alpharetta.',
    additionalNotes: 'Some locations like the Port of Alpharetta or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Alpharetta Port facilities and logistics operations',
      'Naval Air Station Alpharetta and military contractors',
      ...
      'Alpharetta Beach and coastal tourism areas',
