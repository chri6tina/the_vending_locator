...
export default function HotSpringsArkansasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Arkansas requires a sales tax permit through the Department of Revenue. Hot Springs also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Hot Springs.',
    additionalNotes: 'Some locations like the Port of Hot Springs or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Hot Springs Port facilities and logistics operations',
      'Naval Air Station Hot Springs and military contractors',
      'Major healthcare systems (local healthcare systems)',
      'Downtown office buildings and financial services',
      'Manufacturing and distribution centers',
      'University of North Arkansas campus',
      'Hot Springs Beach and coastal tourism areas',
  ...
  const faqs = [
    {
      ...
      a: `You'll need a Arkansas sales tax permit, a ${cityDisplayName} business tax receipt, and if selling food/beverages, a local county health permit for each machine. Also register your LLC with the state.`
    },
    {
    ...
    },
    {
      ...
      a: `You need a business tax receipt from ${cityDisplayName}, a Arkansas sales tax permit, and health permits if selling food. No special vending-specific license is required beyond standard business registration.`
    },
    {
