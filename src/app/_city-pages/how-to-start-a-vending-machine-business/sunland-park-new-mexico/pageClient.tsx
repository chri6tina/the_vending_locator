...
export default function SunlandParkNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Sunland Park may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Sunland Park.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Sunland Park business licenses or permits.",
  "additionalNotes": "Check with the City of Sunland Park for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Sunland Park Hospital and medical facilities",
  "Downtown Sunland Park office buildings and businesses",
  "Sunland Park school district and educational facilities",
  "Sunland Park municipal and county government buildings",
