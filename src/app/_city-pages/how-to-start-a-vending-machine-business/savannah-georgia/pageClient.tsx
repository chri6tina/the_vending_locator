...
export default function SavannahGeorgiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Georgia requires a sales tax permit. Register your business and collect/remit tax on vending sales. Savannah may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Savannah County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Georgia Secretary of State and obtain any required Savannah business licenses or permits.',
    additionalNotes: 'Check with the City of Savannah for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Savannah Hospital and medical facilities',
    'Downtown Savannah office buildings and businesses',
    'Savannah school district and educational facilities',
    'Savannah municipal and county government buildings',
