...
export default function WatertownSouthDakotaHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the South Dakota Secretary of State and obtain any required local business licenses in Watertown.",
