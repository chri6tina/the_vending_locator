...
export default function AthensTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Athens may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Athens.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Athens business licenses or permits.",
  "additionalNotes": "Check with the City of Athens for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Athens Hospital and medical facilities",
  "Downtown Athens office buildings and businesses",
  "Athens school district and educational facilities",
  "Athens municipal and county government buildings",
