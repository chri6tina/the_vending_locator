...
export default function PolsonMontanaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Polson.",
  "businessLicense": "Register your LLC with the Montana Secretary of State and obtain any required local business licenses in Polson.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Polson",
