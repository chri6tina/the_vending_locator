...
export default function WilmingtonMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Wilmington.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Wilmington.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Wilmington",
