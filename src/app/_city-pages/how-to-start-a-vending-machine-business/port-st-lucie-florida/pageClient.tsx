...
export default function PortStLucieFloridaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Florida requires a sales tax permit. Register your business and collect/remit tax on vending sales. Port St Lucie may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the St. Lucie County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Florida Secretary of State and obtain any required Port St Lucie business licenses or permits.',
    additionalNotes: 'Check with the City of Port St Lucie for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }
  ...
  const demandDrivers = [
      ...
      'Tradition Field and sports complex',
      'Treasure Coast International Airport',
      'St. Lucie County government offices',
      'The Crosstown Parkway business corridor',
      'Tradition Town Center and shopping'
  ]
