...
export default function CupertinoCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Cupertino also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Cupertino.',
    additionalNotes: 'Some locations like the Port of Cupertino or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Cupertino Port facilities and logistics operations',
      'Naval Air Station Cupertino and military contractors',
      ...
      'Cupertino Beach and coastal tourism areas',
