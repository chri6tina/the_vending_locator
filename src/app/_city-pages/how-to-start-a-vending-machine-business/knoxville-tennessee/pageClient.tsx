...
export default function KnoxvilleTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Tennessee requires a sales tax permit. Register your business and collect/remit tax on vending sales. Knoxville may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Knoxville County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Tennessee Secretary of State and obtain any required Knoxville business licenses or permits.',
    additionalNotes: 'Check with the City of Knoxville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Knoxville Hospital and medical facilities',
    'Downtown Knoxville office buildings and businesses',
    'Knoxville University campus and facilities',
    'Knoxville municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Knoxville',
