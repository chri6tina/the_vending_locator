...
export default function NationalCityCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in National City.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in National City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in National City",
