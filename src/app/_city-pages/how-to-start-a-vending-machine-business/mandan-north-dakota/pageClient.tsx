...
export default function MandanNorthDakotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Dakota requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Mandan may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Mandan.",
  "businessLicense": "Register your LLC with the North Dakota Secretary of State and obtain any required Mandan business licenses or permits.",
  "additionalNotes": "Check with the City of Mandan for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Mandan Hospital and medical facilities",
  "Downtown Mandan office buildings and businesses",
  "Mandan school district and educational facilities",
  "Mandan municipal and county government buildings",
