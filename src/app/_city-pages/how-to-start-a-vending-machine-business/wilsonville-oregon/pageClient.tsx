...
export default function WilsonvilleOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Wilsonville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Wilsonville.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Wilsonville business licenses or permits.",
  "additionalNotes": "Check with the City of Wilsonville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Wilsonville Hospital and medical facilities",
  "Downtown Wilsonville office buildings and businesses",
  "Wilsonville school district and educational facilities",
  "Wilsonville municipal and county government buildings",
