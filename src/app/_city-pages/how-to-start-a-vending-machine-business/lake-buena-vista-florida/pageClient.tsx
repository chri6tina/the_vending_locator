...
export default function LakeBuenaVistaFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lake Buena Vista.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Lake Buena Vista.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lake Buena Vista",
