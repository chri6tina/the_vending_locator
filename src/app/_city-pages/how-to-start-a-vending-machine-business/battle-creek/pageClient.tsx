...
export default function BattleCreekMichiganHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Michigan requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Battle Creek may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Battle Creek.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required Battle Creek business licenses or permits.",
  "additionalNotes": "Check with the City of Battle Creek for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Battle Creek Hospital and medical facilities",
  "Downtown Battle Creek office buildings and businesses",
  "Battle Creek school district and educational facilities",
  "Battle Creek municipal and county government buildings",
