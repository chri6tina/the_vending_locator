...
export default function SaultSteMarieMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Sault Ste. Marie.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Sault Ste. Marie.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Sault Ste. Marie",
