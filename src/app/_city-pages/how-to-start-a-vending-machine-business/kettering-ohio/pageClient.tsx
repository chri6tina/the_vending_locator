...
export default function KetteringOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Kettering may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Kettering.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Kettering business licenses or permits.",
  "additionalNotes": "Check with the City of Kettering for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Kettering Hospital and medical facilities",
  "Downtown Kettering office buildings and businesses",
  "Kettering school district and educational facilities",
  "Kettering municipal and county government buildings",
