...
export default function CapeGirardeauMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Cape Girardeau.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Cape Girardeau.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Cape Girardeau",
