...
export default function MentorOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Mentor may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Mentor.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Mentor business licenses or permits.",
  "additionalNotes": "Check with the City of Mentor for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Mentor Hospital and medical facilities",
  "Downtown Mentor office buildings and businesses",
  "Mentor school district and educational facilities",
  "Mentor municipal and county government buildings",
