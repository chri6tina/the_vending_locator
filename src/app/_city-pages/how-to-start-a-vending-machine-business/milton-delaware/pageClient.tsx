...
export default function MiltonDelawareHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Delaware Secretary of State and obtain any required local business licenses in Milton.",
