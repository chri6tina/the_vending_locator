...
export default function WestlakeOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Westlake may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Westlake.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Westlake business licenses or permits.",
  "additionalNotes": "Check with the City of Westlake for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Westlake Hospital and medical facilities",
  "Downtown Westlake office buildings and businesses",
  "Westlake school district and educational facilities",
  "Westlake municipal and county government buildings",
