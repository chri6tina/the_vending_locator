...
export default function CordeleGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Cordele.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Cordele.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Cordele",
