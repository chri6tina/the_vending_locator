...
export default function YanktonSouthDakotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Yankton.",
  "businessLicense": "Register your LLC with the South Dakota Secretary of State and obtain any required local business licenses in Yankton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Yankton",
