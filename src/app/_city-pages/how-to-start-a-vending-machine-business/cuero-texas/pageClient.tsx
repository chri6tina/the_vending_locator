...
export default function CueroTexasHowToStartPage() {
  const cityDisplayName = 'Cuero'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Cuero may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Cuero.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Cuero business licenses or permits.",
  "additionalNotes": "Check with the City of Cuero for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Cuero Hospital and medical facilities",
  "Downtown Cuero office buildings and businesses",
  "Cuero school district and educational facilities",
  "Cuero municipal and county government buildings",
