...
export default function OxfordAlabamaHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Alabama Secretary of State and obtain any required local business licenses in Oxford.",
