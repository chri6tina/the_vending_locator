...
export default function HilliardOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hilliard may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Hilliard.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Hilliard business licenses or permits.",
  "additionalNotes": "Check with the City of Hilliard for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Hilliard Hospital and medical facilities",
  "Downtown Hilliard office buildings and businesses",
  "Hilliard school district and educational facilities",
  "Hilliard municipal and county government buildings",
