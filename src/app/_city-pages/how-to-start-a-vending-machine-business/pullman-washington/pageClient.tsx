...
export default function PullmanWashingtonHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Pullman.",
  "businessLicense": "Register your LLC with the Washington Secretary of State and obtain any required local business licenses in Pullman.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Pullman",
