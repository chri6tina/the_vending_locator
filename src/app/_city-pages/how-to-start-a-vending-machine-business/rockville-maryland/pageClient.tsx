...
export default function RockvilleMarylandHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Maryland requires a sales tax permit. Register your business and collect/remit tax on vending sales. Rockville may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Rockville County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Maryland Secretary of State and obtain any required Rockville business licenses or permits.',
    additionalNotes: 'Check with the City of Rockville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Rockville Hospital and medical facilities',
    'Downtown Rockville office buildings and businesses',
    'Rockville school district and educational facilities',
    'Rockville municipal and county government buildings',
