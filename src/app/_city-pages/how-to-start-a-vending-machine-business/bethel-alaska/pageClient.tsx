...
export default function BethelAlaskaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Bethel.",
  "businessLicense": "Register your LLC with the Alaska Secretary of State and obtain any required local business licenses in Bethel.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Bethel",
