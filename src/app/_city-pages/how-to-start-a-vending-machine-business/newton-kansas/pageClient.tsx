...
export default function NewtonMaineHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Maine Secretary of State and obtain any required local business licenses in Newton.",
