...
export default function LockHavenPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Lock Haven may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Lock Haven.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Lock Haven business licenses or permits.",
  "additionalNotes": "Check with the City of Lock Haven for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Lock Haven Hospital and medical facilities",
  "Downtown Lock Haven office buildings and businesses",
  "Lock Haven school district and educational facilities",
  "Lock Haven municipal and county government buildings",
