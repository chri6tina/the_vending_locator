...
export default function EaglePassTexasHowToStartPage() {
  const cityDisplayName = 'Eagle Pass'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Eagle Pass may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Eagle Pass.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Eagle Pass business licenses or permits.",
  "additionalNotes": "Check with the City of Eagle Pass for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Eagle Pass Hospital and medical facilities",
  "Downtown Eagle Pass office buildings and businesses",
  "Eagle Pass school district and educational facilities",
  "Eagle Pass municipal and county government buildings",
