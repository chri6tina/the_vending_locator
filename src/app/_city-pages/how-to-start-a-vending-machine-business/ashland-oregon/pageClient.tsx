...
export default function AshlandOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Ashland may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Ashland.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Ashland business licenses or permits.",
  "additionalNotes": "Check with the City of Ashland for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Ashland Hospital and medical facilities",
  "Downtown Ashland office buildings and businesses",
  "Ashland school district and educational facilities",
  "Ashland municipal and county government buildings",
