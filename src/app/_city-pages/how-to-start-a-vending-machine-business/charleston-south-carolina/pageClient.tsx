...
export default function CharlestonSouthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'South Carolina requires a sales tax permit. Register your business and collect/remit tax on vending sales. Charleston may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the South Carolina Secretary of State and obtain any required Charleston business licenses or permits.',
  ...
  const demandDrivers = [
    ...
    'Joint Base Charleston and military facilities',
    'Manufacturing facilities and industrial parks in Charleston',
