...
export default function CoosBayOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Coos Bay may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Coos Bay.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Coos Bay business licenses or permits.",
  "additionalNotes": "Check with the City of Coos Bay for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Coos Bay Hospital and medical facilities",
  "Downtown Coos Bay office buildings and businesses",
  "Coos Bay school district and educational facilities",
  "Coos Bay municipal and county government buildings",
