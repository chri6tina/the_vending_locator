...
export default function ConwayNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Hampshire requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Conway may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Conway.",
  "businessLicense": "Register your LLC with the New Hampshire Secretary of State and obtain any required Conway business licenses or permits.",
  "additionalNotes": "Check with the City of Conway for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Conway Hospital and medical facilities",
  "Downtown Conway office buildings and businesses",
  "Conway school district and educational facilities",
  "Conway municipal and county government buildings",
