...
export default function WindsorCaliforniaHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Windsor.",
