...
export default function StHelensOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. St. Helens may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in St. Helens.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required St. Helens business licenses or permits.",
  "additionalNotes": "Check with the City of St. Helens for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "St. Helens Hospital and medical facilities",
  "Downtown St. Helens office buildings and businesses",
  "St. Helens school district and educational facilities",
  "St. Helens municipal and county government buildings",
