...
export default function SanDiegoCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. San Diego may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the San Diego County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required San Diego business licenses or permits.',
    additionalNotes: 'Check with the City of San Diego for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Naval Base San Diego and Marine Corps facilities',
      'UC San Diego and Scripps Research Institute',
      'Sharp HealthCare and UC San Diego Medical Center',
      'San Diego International Airport (Lindbergh Field)',
      'Qualcomm, Illumina, and biotech companies',
      'Downtown San Diego Convention Center and Gaslamp',
      'Naval Air Station North Island',
      'La Jolla pharmaceutical and research companies'
  ]
