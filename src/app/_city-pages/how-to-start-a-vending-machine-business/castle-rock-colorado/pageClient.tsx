...
export default function CastleRockColoradoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Castle Rock.",
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in Castle Rock.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Castle Rock",
