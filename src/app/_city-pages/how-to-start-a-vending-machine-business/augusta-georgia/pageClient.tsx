...
export default function AugustaGeorgiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Georgia requires a sales tax permit. Register your business and collect/remit tax on vending sales. Augusta may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Georgia Secretary of State and obtain any required Augusta business licenses or permits.',
  ...
  const demandDrivers = [
    ...
    'Augusta military installations',
