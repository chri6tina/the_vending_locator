...
export default function CortezColoradoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Cortez.",
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in Cortez.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Cortez",
