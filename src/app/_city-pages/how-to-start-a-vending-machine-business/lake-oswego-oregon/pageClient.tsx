...
export default function LakeOswegoOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Lake Oswego may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Lake Oswego.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Lake Oswego business licenses or permits.",
  "additionalNotes": "Check with the City of Lake Oswego for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Lake Oswego Hospital and medical facilities",
  "Downtown Lake Oswego office buildings and businesses",
  "Lake Oswego school district and educational facilities",
  "Lake Oswego municipal and county government buildings",
