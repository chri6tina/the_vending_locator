...
export default function HermitagePennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hermitage may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Hermitage.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Hermitage business licenses or permits.",
  "additionalNotes": "Check with the City of Hermitage for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Hermitage Hospital and medical facilities",
  "Downtown Hermitage office buildings and businesses",
  "Hermitage school district and educational facilities",
  "Hermitage municipal and county government buildings",
