...
export default function LebanonNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Hampshire requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Lebanon may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Lebanon.",
  "businessLicense": "Register your LLC with the New Hampshire Secretary of State and obtain any required Lebanon business licenses or permits.",
  "additionalNotes": "Check with the City of Lebanon for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Lebanon Hospital and medical facilities",
  "Downtown Lebanon office buildings and businesses",
  "Lebanon school district and educational facilities",
  "Lebanon municipal and county government buildings",
