...
export default function MontroseColoradoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Montrose.",
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in Montrose.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Montrose",
