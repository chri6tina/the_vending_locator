...
export default function LasCrucesNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Mexico requires a sales tax permit. Register your business and collect/remit tax on vending sales. Las Cruces may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Las Cruces County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Mexico Secretary of State and obtain any required Las Cruces business licenses or permits.',
    additionalNotes: 'Check with the City of Las Cruces for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Las Cruces Hospital and medical facilities',
    'Downtown Las Cruces office buildings and businesses',
    'Las Cruces school district and educational facilities',
    'Las Cruces municipal and county government buildings',
