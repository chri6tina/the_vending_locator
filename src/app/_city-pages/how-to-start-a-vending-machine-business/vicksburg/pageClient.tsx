...
export default function VicksburgMississippiHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Mississippi requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Vicksburg may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Vicksburg.",
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required Vicksburg business licenses or permits.",
  "additionalNotes": "Check with the City of Vicksburg for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Vicksburg Hospital and medical facilities",
  "Downtown Vicksburg office buildings and businesses",
  "Vicksburg school district and educational facilities",
  "Vicksburg municipal and county government buildings",
