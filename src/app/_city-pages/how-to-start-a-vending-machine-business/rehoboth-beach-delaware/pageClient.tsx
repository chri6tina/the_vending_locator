...
export default function RehobothBeachDelawareHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Delaware requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rehoboth Beach.",
  "businessLicense": "Register your LLC with the Delaware Secretary of State and obtain any required local business licenses in Rehoboth Beach.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rehoboth Beach",
