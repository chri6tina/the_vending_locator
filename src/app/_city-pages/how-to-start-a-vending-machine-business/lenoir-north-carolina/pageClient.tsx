...
export default function LenoirNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Lenoir may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Lenoir.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Lenoir business licenses or permits.",
  "additionalNotes": "Check with the City of Lenoir for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Lenoir Hospital and medical facilities",
  "Downtown Lenoir office buildings and businesses",
  "Lenoir school district and educational facilities",
  "Lenoir municipal and county government buildings",
