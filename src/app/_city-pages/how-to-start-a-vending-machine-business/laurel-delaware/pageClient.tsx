...
export default function LaurelDelawareHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Delaware Secretary of State and obtain any required local business licenses in Laurel.",
