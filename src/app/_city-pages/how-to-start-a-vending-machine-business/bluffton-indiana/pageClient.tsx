...
export default function BlufftonIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Bluffton.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Bluffton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Bluffton",
