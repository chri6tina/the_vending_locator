...
export default function LakeCityFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lake City.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Lake City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lake City",
