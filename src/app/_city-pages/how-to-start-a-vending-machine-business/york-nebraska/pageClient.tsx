...
export default function YorkNebraskaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Nebraska requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. York may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in York.",
  "businessLicense": "Register your LLC with the Nebraska Secretary of State and obtain any required York business licenses or permits.",
  "additionalNotes": "Check with the City of York for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "York Hospital and medical facilities",
  "Downtown York office buildings and businesses",
  "York school district and educational facilities",
  "York municipal and county government buildings",
