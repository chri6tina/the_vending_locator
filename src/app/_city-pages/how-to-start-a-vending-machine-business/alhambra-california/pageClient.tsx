...
export default function AlhambraCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Alhambra may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Alhambra County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Alhambra business licenses or permits.',
    additionalNotes: 'Check with the City of Alhambra for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Alhambra Hospital and medical facilities',
    'Downtown Alhambra office buildings and businesses',
    'Alhambra school district and educational facilities',
    'Alhambra municipal and county government buildings',
