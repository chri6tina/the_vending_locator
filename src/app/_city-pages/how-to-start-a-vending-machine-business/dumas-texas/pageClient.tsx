...
export default function DumasTexasHowToStartPage() {
  const cityDisplayName = 'Dumas'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Dumas may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Dumas.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Dumas business licenses or permits.",
  "additionalNotes": "Check with the City of Dumas for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Dumas Hospital and medical facilities",
  "Downtown Dumas office buildings and businesses",
  "Dumas school district and educational facilities",
  "Dumas municipal and county government buildings",
