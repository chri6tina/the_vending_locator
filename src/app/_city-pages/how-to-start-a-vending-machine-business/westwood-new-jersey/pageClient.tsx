...
export default function WestwoodNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Westwood may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Westwood.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Westwood business licenses or permits.",
  "additionalNotes": "Check with the City of Westwood for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Westwood Hospital and medical facilities",
  "Downtown Westwood office buildings and businesses",
  "Westwood school district and educational facilities",
  "Westwood municipal and county government buildings",
