...
export default function TigardOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Tigard may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Tigard.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Tigard business licenses or permits.",
  "additionalNotes": "Check with the City of Tigard for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Tigard Hospital and medical facilities",
  "Downtown Tigard office buildings and businesses",
  "Tigard school district and educational facilities",
  "Tigard municipal and county government buildings",
