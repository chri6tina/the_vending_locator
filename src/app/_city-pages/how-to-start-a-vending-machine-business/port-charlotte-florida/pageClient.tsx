...
export default function PortCharlotteFloridaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Florida requires a sales tax permit through the Department of Revenue. Port Charlotte also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Port Charlotte.',
    additionalNotes: 'Some locations like the Port of Port Charlotte or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Port Charlotte Port facilities and logistics operations',
      'Naval Air Station Port Charlotte and military contractors',
      'Major healthcare systems (local healthcare systems)',
      'Downtown office buildings and financial services',
      'Manufacturing and distribution centers',
      'local universities campus',
      'Port Charlotte Beach and coastal tourism areas',
      'Corporate parks in local business districts'
  ]

  const neighborhoods = [
      'Downtown Port Charlotte',
  ...
  const faqs = [
    {
      ...
      a: `You'll need a Florida sales tax permit, a ${cityDisplayName} business tax receipt, and if selling food/beverages, a local county health permit for each machine. Also register your LLC with the state.`
    },
    {
