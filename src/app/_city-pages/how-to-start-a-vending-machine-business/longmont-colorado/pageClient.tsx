...
export default function LongmontColoradoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Longmont.",
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in Longmont.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Longmont",
