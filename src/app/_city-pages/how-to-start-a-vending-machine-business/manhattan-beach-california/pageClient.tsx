...
export default function ManhattanBeachCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Manhattan Beach.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Manhattan Beach.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Manhattan Beach",
