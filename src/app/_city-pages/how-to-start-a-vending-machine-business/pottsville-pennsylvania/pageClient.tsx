...
export default function PottsvillePennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Pottsville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Pottsville.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Pottsville business licenses or permits.",
  "additionalNotes": "Check with the City of Pottsville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Pottsville Hospital and medical facilities",
  "Downtown Pottsville office buildings and businesses",
  "Pottsville school district and educational facilities",
  "Pottsville municipal and county government buildings",
