...
export default function RollingMeadowsIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rolling Meadows.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Rolling Meadows.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rolling Meadows",
