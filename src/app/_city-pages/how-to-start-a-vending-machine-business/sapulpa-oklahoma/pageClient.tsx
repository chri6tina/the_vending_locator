...
export default function SapulpaOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Sapulpa may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Sapulpa.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required Sapulpa business licenses or permits.",
  "additionalNotes": "Check with the City of Sapulpa for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Sapulpa Hospital and medical facilities",
  "Downtown Sapulpa office buildings and businesses",
  "Sapulpa school district and educational facilities",
  "Sapulpa municipal and county government buildings",
