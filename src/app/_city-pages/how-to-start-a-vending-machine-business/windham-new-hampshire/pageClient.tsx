...
export default function WindhamNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Hampshire requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Windham may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Windham.",
  "businessLicense": "Register your LLC with the New Hampshire Secretary of State and obtain any required Windham business licenses or permits.",
  "additionalNotes": "Check with the City of Windham for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Windham Hospital and medical facilities",
  "Downtown Windham office buildings and businesses",
  "Windham school district and educational facilities",
  "Windham municipal and county government buildings",
