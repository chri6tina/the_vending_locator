...
export default function BayonneNewJerseyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Bayonne.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required local business licenses in Bayonne.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Bayonne",
