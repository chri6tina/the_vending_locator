...
export default function KankakeeIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Kankakee.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Kankakee.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Kankakee",
