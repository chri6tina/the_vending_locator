...
export default function GreenvilleNorthCarolinaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Greenville.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required local business licenses in Greenville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Greenville",
