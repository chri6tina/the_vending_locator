...
export default function ScottsValleyCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Scotts Valley.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Scotts Valley.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Scotts Valley",
