...
export default function CookevilleTennesseeHowToStartPage() {
  const cityDisplayName = 'Cookeville'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Cookeville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Cookeville.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Cookeville business licenses or permits.",
  "additionalNotes": "Check with the City of Cookeville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Cookeville Hospital and medical facilities",
  "Downtown Cookeville office buildings and businesses",
  "Cookeville school district and educational facilities",
  "Cookeville municipal and county government buildings",
