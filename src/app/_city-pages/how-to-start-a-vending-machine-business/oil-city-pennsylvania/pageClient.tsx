...
export default function OilCityPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Oil City may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Oil City.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Oil City business licenses or permits.",
  "additionalNotes": "Check with the City of Oil City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Oil City Hospital and medical facilities",
  "Downtown Oil City office buildings and businesses",
  "Oil City school district and educational facilities",
  "Oil City municipal and county government buildings",
