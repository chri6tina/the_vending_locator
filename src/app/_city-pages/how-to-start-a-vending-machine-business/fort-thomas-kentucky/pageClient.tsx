...
export default function FortThomasKentuckyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Fort Thomas.",
  "businessLicense": "Register your LLC with the Kentucky Secretary of State and obtain any required local business licenses in Fort Thomas.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Fort Thomas",
