...
export default function AlamogordoNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Alamogordo may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Alamogordo.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Alamogordo business licenses or permits.",
  "additionalNotes": "Check with the City of Alamogordo for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Alamogordo Hospital and medical facilities",
  "Downtown Alamogordo office buildings and businesses",
  "Alamogordo school district and educational facilities",
  "Alamogordo municipal and county government buildings",
