...
export default function BelAirMarylandHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Bel Air.",
  "businessLicense": "Register your LLC with the Maryland Secretary of State and obtain any required local business licenses in Bel Air.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Bel Air",
