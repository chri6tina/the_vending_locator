...
export default function MountJulietTennesseeHowToStartPage() {
  const cityDisplayName = 'Mount Juliet'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Mount Juliet may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Mount Juliet.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Mount Juliet business licenses or permits.",
  "additionalNotes": "Check with the City of Mount Juliet for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Mount Juliet Hospital and medical facilities",
  "Downtown Mount Juliet office buildings and businesses",
  "Mount Juliet school district and educational facilities",
  "Mount Juliet municipal and county government buildings",
