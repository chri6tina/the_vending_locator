...
export default function GreenfieldCaliforniaHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Greenfield.",
