...
export default function WestMonroeLouisianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in West Monroe.",
  "businessLicense": "Register your LLC with the Louisiana Secretary of State and obtain any required local business licenses in West Monroe.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in West Monroe",
