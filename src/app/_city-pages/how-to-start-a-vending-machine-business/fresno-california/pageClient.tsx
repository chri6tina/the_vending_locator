...
export default function FresnoCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Fresno may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Fresno County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Fresno business licenses or permits.',
    additionalNotes: 'Check with the City of Fresno for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Community Medical Centers and Saint Agnes Medical Center',
      'Fresno Yosemite International Airport',
      'California State University, Fresno',
      'Agriculture and food processing facilities',
      'Downtown Fresno government and business district',
      'Fig Garden Village and Fashion Fair area',
      'Clovis corporate offices and retail',
