...
export default function YorbaLindaCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Yorba Linda.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Yorba Linda.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Yorba Linda",
