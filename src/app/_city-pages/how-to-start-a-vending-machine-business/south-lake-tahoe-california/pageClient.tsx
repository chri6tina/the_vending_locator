...
export default function SouthLakeTahoeCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in South Lake Tahoe.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in South Lake Tahoe.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in South Lake Tahoe",
