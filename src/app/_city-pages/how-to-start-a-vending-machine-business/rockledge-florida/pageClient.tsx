...
export default function RockledgeFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rockledge.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Rockledge.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rockledge",
