...
export default function AuroraColoradoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Colorado requires a sales tax permit. Register your business and collect/remit tax on vending sales. Aurora may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Arapahoe, Adams, and Douglas Counties Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Colorado Secretary of State and obtain any required Aurora business licenses or permits.',
  ...
  const demandDrivers = [
      ...
      'Southlands shopping and business district',
      'Cherry Creek School District facilities',
