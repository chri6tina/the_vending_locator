...
export default function ClintonIowaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Clinton.",
  "businessLicense": "Register your LLC with the Iowa Secretary of State and obtain any required local business licenses in Clinton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Clinton",
