...
export default function PresqueIsleMaineHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Presque Isle.",
  "businessLicense": "Register your LLC with the Maine Secretary of State and obtain any required local business licenses in Presque Isle.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Presque Isle",
