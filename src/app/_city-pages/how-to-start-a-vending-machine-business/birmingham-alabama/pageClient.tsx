...
export default function BirminghamAlabamaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Alabama requires a sales tax permit. Register your business and collect/remit tax on vending sales. Birmingham may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Alabama Secretary of State and obtain any required Birmingham business licenses or permits.',
