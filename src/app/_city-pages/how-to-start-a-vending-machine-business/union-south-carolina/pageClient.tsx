...
export default function UnionSouthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Union may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Union.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Union business licenses or permits.",
  "additionalNotes": "Check with the City of Union for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Union Hospital and medical facilities",
  "Downtown Union office buildings and businesses",
  "Union school district and educational facilities",
  "Union municipal and county government buildings",
