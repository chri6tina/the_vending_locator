...
export default function ApalachicolaFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Apalachicola.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Apalachicola.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Apalachicola",
