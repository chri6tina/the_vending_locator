...
export default function WorcesterMassachusettsHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Massachusetts requires a sales tax permit. Register your business and collect/remit tax on vending sales. Worcester may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Worcester County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Massachusetts Secretary of State and obtain any required Worcester business licenses or permits.',
    additionalNotes: 'Check with the City of Worcester for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Worcester Hospital and medical facilities',
    'Downtown Worcester office buildings and businesses',
    'Worcester school district and educational facilities',
    'Worcester municipal and county government buildings',
