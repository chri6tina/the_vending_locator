...
export default function DanvilleKentuckyHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Kentucky Secretary of State and obtain any required local business licenses in Danville.",
