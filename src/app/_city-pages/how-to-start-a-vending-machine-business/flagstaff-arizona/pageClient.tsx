...
export default function FlagstaffArizonaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Flagstaff.",
  "businessLicense": "Register your LLC with the Arizona Secretary of State and obtain any required local business licenses in Flagstaff.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Flagstaff",
