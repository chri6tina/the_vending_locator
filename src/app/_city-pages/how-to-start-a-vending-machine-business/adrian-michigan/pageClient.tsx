...
export default function AdrianMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Adrian.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Adrian.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Adrian",
