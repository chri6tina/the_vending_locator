...
export default function CarrboroNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Carrboro may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Carrboro.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Carrboro business licenses or permits.",
  "additionalNotes": "Check with the City of Carrboro for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Carrboro Hospital and medical facilities",
  "Downtown Carrboro office buildings and businesses",
  "Carrboro school district and educational facilities",
  "Carrboro municipal and county government buildings",
