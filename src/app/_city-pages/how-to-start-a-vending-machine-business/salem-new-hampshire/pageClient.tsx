...
export default function SalemNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Hampshire requires a sales tax permit. Register your business and collect/remit tax on vending sales. Salem may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the New Hampshire Secretary of State and obtain any required Salem business licenses or permits.',
  ...
  const demandDrivers = [
    ...
    'Salem municipal and county government buildings',
