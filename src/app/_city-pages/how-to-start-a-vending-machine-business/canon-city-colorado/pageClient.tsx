...
export default function CanonCityColoradoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Canon City.",
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in Canon City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Canon City",
