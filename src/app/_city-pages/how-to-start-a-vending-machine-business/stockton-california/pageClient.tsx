...
export default function StocktonCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Stockton may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the San Joaquin County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Stockton business licenses or permits.',
    additionalNotes: 'Check with the City of Stockton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Port of Stockton inland port operations',
      'San Joaquin General Hospital',
      'University of the Pacific campus',
      'Stockton Metropolitan Airport',
      'California Northstate University',
      'St. Josephs Medical Center',
      'Downtown Stockton and waterfront arena',
