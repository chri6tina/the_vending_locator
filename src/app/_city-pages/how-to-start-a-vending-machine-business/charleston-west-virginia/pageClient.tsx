...
export default function CharlestonWestVirginiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'West Virginia requires a sales tax permit. Register your business and collect/remit tax on vending sales. Charleston may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Charleston County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the West Virginia Secretary of State and obtain any required Charleston business licenses or permits.',
    additionalNotes: 'Check with the City of Charleston for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Charleston Hospital and medical facilities',
    'Downtown Charleston office buildings and businesses',
    'Charleston school district and educational facilities',
    'West Virginia state government offices and capitol complex',
    ...
    'Charleston Airport and related businesses'
  ]
