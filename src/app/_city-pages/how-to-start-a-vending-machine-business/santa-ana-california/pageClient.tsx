...
export default function SantaAnaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Santa Ana may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Santa Ana business licenses or permits.',
    additionalNotes: 'Check with the City of Santa Ana for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Orange County government and courthouse complex',
      'CHOC (Childrens Hospital of Orange County)',
      'John Wayne Airport (SNA) - Orange County Airport',
      'South Coast Plaza (highest-grossing mall in US)',
      'Santa Ana College campus',
      'Downtown Santa Ana offices and artists village',
      'MainPlace Mall and retail centers',
