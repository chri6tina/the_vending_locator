...
export default function NorthBayVillageFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in North Bay Village.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in North Bay Village.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in North Bay Village",
