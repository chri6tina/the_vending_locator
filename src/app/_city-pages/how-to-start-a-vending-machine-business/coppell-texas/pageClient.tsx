...
export default function CoppellTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Coppell may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Coppell.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Coppell business licenses or permits.",
  "additionalNotes": "Check with the City of Coppell for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Coppell Hospital and medical facilities",
  "Downtown Coppell office buildings and businesses",
  "Coppell school district and educational facilities",
  "Coppell municipal and county government buildings",
