...
export default function MobileAlabamaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Alabama requires a sales tax permit. Register your business and collect/remit tax on vending sales. Mobile may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Mobile County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Alabama Secretary of State and obtain any required Mobile business licenses or permits.',
    additionalNotes: 'Check with the City of Mobile for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Mobile Hospital and medical facilities',
    'Downtown Mobile office buildings and businesses',
    'Mobile school district and educational facilities',
    'Mobile Regional Airport and Coast Guard facilities',
    'Manufacturing facilities and industrial parks in Mobile',
