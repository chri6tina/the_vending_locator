...
export default function LahainaHawaiiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lahaina.",
  "businessLicense": "Register your LLC with the Hawaii Secretary of State and obtain any required local business licenses in Lahaina.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lahaina",
