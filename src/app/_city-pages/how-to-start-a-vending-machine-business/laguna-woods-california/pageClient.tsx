...
export default function LagunaWoodsCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Laguna Woods.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Laguna Woods.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Laguna Woods",
