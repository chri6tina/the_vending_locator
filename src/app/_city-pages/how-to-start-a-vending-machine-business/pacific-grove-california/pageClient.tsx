...
export default function PacificGroveCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Pacific Grove.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Pacific Grove.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Pacific Grove",
