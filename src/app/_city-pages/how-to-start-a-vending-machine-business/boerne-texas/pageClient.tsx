...
export default function BoerneTexasHowToStartPage() {
  const cityDisplayName = 'Boerne'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Boerne may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Boerne.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Boerne business licenses or permits.",
  "additionalNotes": "Check with the City of Boerne for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Boerne Hospital and medical facilities",
  "Downtown Boerne office buildings and businesses",
  "Boerne school district and educational facilities",
  "Boerne municipal and county government buildings",
