...
export default function SimpsonvilleSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Simpsonville'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Simpsonville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Simpsonville.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Simpsonville business licenses or permits.",
  "additionalNotes": "Check with the City of Simpsonville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Simpsonville Hospital and medical facilities",
  "Downtown Simpsonville office buildings and businesses",
  "Simpsonville school district and educational facilities",
  "Simpsonville municipal and county government buildings",
