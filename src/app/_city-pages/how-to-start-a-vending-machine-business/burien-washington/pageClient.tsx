...
export default function BurienWashingtonHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Burien.",
  "businessLicense": "Register your LLC with the Washington Secretary of State and obtain any required local business licenses in Burien.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Burien",
