...
export default function WichitaKansasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Kansas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Wichita may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Sedgwick County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Kansas Secretary of State and obtain any required Wichita business licenses or permits.',
    additionalNotes: 'Check with the City of Wichita for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Spirit AeroSystems and Textron Aviation (aviation manufacturing)',
      'Wichita Dwight D. Eisenhower Airport',
      'Via Christi and Wesley Healthcare hospitals',
      'Wichita State University',
      'Koch Industries headquarters',
      'Cargill Protein facilities',
      'Downtown Wichita and Delano District',
      'Beechcraft and Cessna aircraft facilities'
  ]
