...
export default function MooreHavenFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Moore Haven.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Moore Haven.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Moore Haven",
