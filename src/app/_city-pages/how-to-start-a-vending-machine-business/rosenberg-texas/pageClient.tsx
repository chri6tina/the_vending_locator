...
export default function RosenbergTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Rosenberg may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Rosenberg.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Rosenberg business licenses or permits.",
  "additionalNotes": "Check with the City of Rosenberg for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Rosenberg Hospital and medical facilities",
  "Downtown Rosenberg office buildings and businesses",
  "Rosenberg school district and educational facilities",
  "Rosenberg municipal and county government buildings",
