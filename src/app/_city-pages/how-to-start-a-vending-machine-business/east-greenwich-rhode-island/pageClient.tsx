...
export default function EastGreenwichRhodeIslandHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in East Greenwich.",
  "businessLicense": "Register your LLC with the Rhode Island Secretary of State and obtain any required local business licenses in East Greenwich.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in East Greenwich",
