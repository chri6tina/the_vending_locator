...
export default function WebbCityMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Webb City.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Webb City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Webb City",
