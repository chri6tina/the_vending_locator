...
export default function GlastonburyConnecticutHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Glastonbury.",
  "businessLicense": "Register your LLC with the Connecticut Secretary of State and obtain any required local business licenses in Glastonbury.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Glastonbury",
