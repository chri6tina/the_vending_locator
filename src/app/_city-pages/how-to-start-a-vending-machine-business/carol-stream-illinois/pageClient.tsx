...
export default function CarolStreamIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Carol Stream.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Carol Stream.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Carol Stream",
