...
export default function PortHuronMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Port Huron.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Port Huron.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Port Huron",
