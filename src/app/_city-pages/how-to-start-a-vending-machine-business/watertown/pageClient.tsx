...
export default function WatertownNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Watertown may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Watertown.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Watertown business licenses or permits.",
  "additionalNotes": "Check with the City of Watertown for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Watertown Hospital and medical facilities",
  "Downtown Watertown office buildings and businesses",
  "Watertown school district and educational facilities",
  "Watertown municipal and county government buildings",
