...
export default function MineralWellsTexasHowToStartPage() {
  const cityDisplayName = 'Mineral Wells'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Mineral Wells may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Mineral Wells.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Mineral Wells business licenses or permits.",
  "additionalNotes": "Check with the City of Mineral Wells for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Mineral Wells Hospital and medical facilities",
  "Downtown Mineral Wells office buildings and businesses",
  "Mineral Wells school district and educational facilities",
  "Mineral Wells municipal and county government buildings",
