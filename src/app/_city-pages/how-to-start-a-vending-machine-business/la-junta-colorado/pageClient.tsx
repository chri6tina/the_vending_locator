...
export default function LaJuntaColoradoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in La Junta.",
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in La Junta.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in La Junta",
