...
export default function ElmiraNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Elmira may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Elmira.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Elmira business licenses or permits.",
  "additionalNotes": "Check with the City of Elmira for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Elmira Hospital and medical facilities",
  "Downtown Elmira office buildings and businesses",
  "Elmira school district and educational facilities",
  "Elmira municipal and county government buildings",
