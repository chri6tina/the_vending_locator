...
export default function GuthrieOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Guthrie may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Guthrie.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required Guthrie business licenses or permits.",
  "additionalNotes": "Check with the City of Guthrie for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Guthrie Hospital and medical facilities",
  "Downtown Guthrie office buildings and businesses",
  "Guthrie school district and educational facilities",
  "Guthrie municipal and county government buildings",
