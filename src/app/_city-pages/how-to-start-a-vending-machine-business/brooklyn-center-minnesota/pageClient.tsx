...
export default function BrooklynCenterMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Brooklyn Center.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Brooklyn Center.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Brooklyn Center",
