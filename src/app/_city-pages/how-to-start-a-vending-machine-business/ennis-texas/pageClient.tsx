...
export default function EnnisTexasHowToStartPage() {
  const cityDisplayName = 'Ennis'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Ennis may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Ennis.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Ennis business licenses or permits.",
  "additionalNotes": "Check with the City of Ennis for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Ennis Hospital and medical facilities",
  "Downtown Ennis office buildings and businesses",
  "Ennis school district and educational facilities",
  "Ennis municipal and county government buildings",
