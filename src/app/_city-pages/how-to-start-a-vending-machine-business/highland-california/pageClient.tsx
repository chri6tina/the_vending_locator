...
export default function HighlandCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Highland.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Highland.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Highland",
