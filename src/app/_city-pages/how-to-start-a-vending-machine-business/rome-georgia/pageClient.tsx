...
export default function RomeGeorgiaHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Rome.",
