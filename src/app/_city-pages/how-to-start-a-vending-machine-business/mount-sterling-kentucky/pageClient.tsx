...
export default function MountSterlingKentuckyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mount Sterling.",
  "businessLicense": "Register your LLC with the Kentucky Secretary of State and obtain any required local business licenses in Mount Sterling.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mount Sterling",
