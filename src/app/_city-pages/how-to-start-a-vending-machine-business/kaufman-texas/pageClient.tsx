...
export default function KaufmanTexasHowToStartPage() {
  const cityDisplayName = 'Kaufman'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Kaufman may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Kaufman.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Kaufman business licenses or permits.",
  "additionalNotes": "Check with the City of Kaufman for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Kaufman Hospital and medical facilities",
  "Downtown Kaufman office buildings and businesses",
  "Kaufman school district and educational facilities",
  "Kaufman municipal and county government buildings",
