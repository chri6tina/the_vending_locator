...
export default function WestonFloridaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Florida requires a sales tax permit through the Department of Revenue. Weston also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Weston.',
    additionalNotes: 'Some locations like the Port of Weston or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Weston Port facilities and logistics operations',
      'Naval Air Station Weston and military contractors',
      ...
      'Weston Beach and coastal tourism areas',
