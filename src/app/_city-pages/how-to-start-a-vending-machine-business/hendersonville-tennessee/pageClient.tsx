...
export default function HendersonvilleTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hendersonville may have additional local sales taxes.",
  ...
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Hendersonville business licenses or permits.",
