...
export default function CarlsbadNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Carlsbad.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required local business licenses in Carlsbad.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Carlsbad",
