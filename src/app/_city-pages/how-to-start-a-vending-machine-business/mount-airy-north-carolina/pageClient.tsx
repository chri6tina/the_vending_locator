...
export default function MountAiryNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Mount Airy may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Mount Airy.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Mount Airy business licenses or permits.",
  "additionalNotes": "Check with the City of Mount Airy for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Mount Airy Hospital and medical facilities",
  "Downtown Mount Airy office buildings and businesses",
  "Mount Airy school district and educational facilities",
  "Mount Airy municipal and county government buildings",
