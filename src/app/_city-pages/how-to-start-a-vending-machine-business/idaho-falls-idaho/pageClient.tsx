...
export default function IdahoFallsIdahoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Idaho requires a sales tax permit. Register your business and collect/remit tax on vending sales. Idaho Falls may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Idaho Falls County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Idaho Secretary of State and obtain any required Idaho Falls business licenses or permits.',
    additionalNotes: 'Check with the City of Idaho Falls for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Idaho Falls Hospital and medical facilities',
    'Downtown Idaho Falls office buildings and businesses',
    'Idaho Falls school district and educational facilities',
    'Idaho Falls municipal and county government buildings',
