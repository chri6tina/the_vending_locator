...
export default function JoplinMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Joplin.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Joplin.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Joplin",
