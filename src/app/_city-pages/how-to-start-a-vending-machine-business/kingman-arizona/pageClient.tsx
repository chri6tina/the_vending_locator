...
export default function KingmanArizonaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Kingman.",
  "businessLicense": "Register your LLC with the Arizona Secretary of State and obtain any required local business licenses in Kingman.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Kingman",
