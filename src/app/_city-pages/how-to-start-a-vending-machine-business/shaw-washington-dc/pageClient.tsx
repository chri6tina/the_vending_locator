...
export default function ShawWashingtonDcHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington DC requires a sales tax permit. Register your business and collect/remit tax on vending sales. Shaw may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Shaw County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Washington DC Secretary of State and obtain any required Shaw business licenses or permits.',
    additionalNotes: 'Check with the City of Shaw for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Shaw Hospital and medical facilities',
    'Downtown Shaw office buildings and businesses',
    'Shaw school district and educational facilities',
    'Shaw municipal and county government buildings',
