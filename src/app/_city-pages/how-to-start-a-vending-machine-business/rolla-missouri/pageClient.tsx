...
export default function RollaMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rolla.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Rolla.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rolla",
