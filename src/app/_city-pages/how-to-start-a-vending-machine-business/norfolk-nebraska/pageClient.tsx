...
export default function NorfolkNebraskaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Norfolk.",
  "businessLicense": "Register your LLC with the Nebraska Secretary of State and obtain any required local business licenses in Norfolk.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Norfolk",
