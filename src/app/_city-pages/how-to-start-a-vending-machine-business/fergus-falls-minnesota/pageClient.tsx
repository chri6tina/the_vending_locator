...
export default function FergusFallsMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Fergus Falls.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Fergus Falls.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Fergus Falls",
