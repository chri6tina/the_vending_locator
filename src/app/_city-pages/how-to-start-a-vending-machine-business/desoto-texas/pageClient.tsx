...
export default function DeSotoTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. DeSoto may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in DeSoto.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required DeSoto business licenses or permits.",
  "additionalNotes": "Check with the City of DeSoto for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "DeSoto Hospital and medical facilities",
  "Downtown DeSoto office buildings and businesses",
  "DeSoto school district and educational facilities",
  "DeSoto municipal and county government buildings",
