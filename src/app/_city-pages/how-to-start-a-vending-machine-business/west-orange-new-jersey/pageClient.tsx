...
export default function WestOrangeNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. West Orange may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in West Orange.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required West Orange business licenses or permits.",
  "additionalNotes": "Check with the City of West Orange for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "West Orange Hospital and medical facilities",
  "Downtown West Orange office buildings and businesses",
  "West Orange school district and educational facilities",
  "West Orange municipal and county government buildings",
