...
export default function BrentwoodTennesseeHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required local business licenses in Brentwood.",
