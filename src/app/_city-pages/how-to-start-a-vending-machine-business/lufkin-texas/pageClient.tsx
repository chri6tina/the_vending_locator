...
export default function LufkinTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Lufkin may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Lufkin.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Lufkin business licenses or permits.",
  "additionalNotes": "Check with the City of Lufkin for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Lufkin Hospital and medical facilities",
  "Downtown Lufkin office buildings and businesses",
  "Lufkin school district and educational facilities",
  "Lufkin municipal and county government buildings",
