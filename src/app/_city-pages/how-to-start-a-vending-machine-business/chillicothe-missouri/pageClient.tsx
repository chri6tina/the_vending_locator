...
export default function ChillicotheMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Chillicothe.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Chillicothe.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Chillicothe",
