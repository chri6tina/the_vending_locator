...
export default function OswegoNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Oswego may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Oswego.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Oswego business licenses or permits.",
  "additionalNotes": "Check with the City of Oswego for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Oswego Hospital and medical facilities",
  "Downtown Oswego office buildings and businesses",
  "Oswego school district and educational facilities",
  "Oswego municipal and county government buildings",
