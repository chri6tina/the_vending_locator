...
export default function KiheiHawaiiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Kihei.",
  "businessLicense": "Register your LLC with the Hawaii Secretary of State and obtain any required local business licenses in Kihei.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Kihei",
