...
export default function WoodwardOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Woodward may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Woodward.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required Woodward business licenses or permits.",
  "additionalNotes": "Check with the City of Woodward for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Woodward Hospital and medical facilities",
  "Downtown Woodward office buildings and businesses",
  "Woodward school district and educational facilities",
  "Woodward municipal and county government buildings",
