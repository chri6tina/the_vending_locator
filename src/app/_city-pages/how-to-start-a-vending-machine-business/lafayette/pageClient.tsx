...
export default function LafayetteIndianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Indiana requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Lafayette may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Lafayette.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required Lafayette business licenses or permits.",
