...
export default function ConwayArkansasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Arkansas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Conway may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Conway County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Arkansas Secretary of State and obtain any required Conway business licenses or permits.',
