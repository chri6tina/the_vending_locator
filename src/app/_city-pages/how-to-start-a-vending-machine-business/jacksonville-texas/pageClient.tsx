...
export default function JacksonvilleTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Jacksonville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Jacksonville.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Jacksonville business licenses or permits.",
  "additionalNotes": "Check with the City of Jacksonville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Jacksonville Hospital and medical facilities",
  "Downtown Jacksonville office buildings and businesses",
  "Jacksonville school district and educational facilities",
  "Jacksonville municipal and county government buildings",
