...
export default function RapidCitySouthDakotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'South Dakota requires a sales tax permit. Register your business and collect/remit tax on vending sales. Rapid City may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Rapid City County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the South Dakota Secretary of State and obtain any required Rapid City business licenses or permits.',
    additionalNotes: 'Check with the City of Rapid City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Rapid City medical centers and healthcare facilities',
    'Downtown Rapid City office buildings and businesses',
    'Rapid City school district and educational facilities',
    'Rapid City municipal and county government buildings',
