...
export default function DelRioTexasHowToStartPage() {
  const cityDisplayName = 'Del Rio'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Del Rio may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Del Rio.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Del Rio business licenses or permits.",
  "additionalNotes": "Check with the City of Del Rio for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Del Rio Hospital and medical facilities",
  "Downtown Del Rio office buildings and businesses",
  "Del Rio school district and educational facilities",
  "Del Rio municipal and county government buildings",
