...
export default function GracevilleFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Graceville.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Graceville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Graceville",
