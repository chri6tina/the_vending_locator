...
export default function SecaucusNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Secaucus may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Secaucus.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Secaucus business licenses or permits.",
  "additionalNotes": "Check with the City of Secaucus for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Secaucus Hospital and medical facilities",
  "Downtown Secaucus office buildings and businesses",
  "Secaucus school district and educational facilities",
  "Secaucus municipal and county government buildings",
