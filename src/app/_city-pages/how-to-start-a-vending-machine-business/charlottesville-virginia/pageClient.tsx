...
export default function CharlottesvilleVirginiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Virginia requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Charlottesville.",
  "businessLicense": "Register your LLC with the Virginia Secretary of State and obtain any required local business licenses in Charlottesville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Charlottesville",
