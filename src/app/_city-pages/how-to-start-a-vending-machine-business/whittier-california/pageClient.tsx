...
export default function WhittierCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Whittier may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Whittier County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Whittier business licenses or permits.',
    additionalNotes: 'Check with the City of Whittier for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Whittier Hospital and medical facilities',
    'Downtown Whittier office buildings and businesses',
    'Whittier school district and educational facilities',
    'Whittier municipal and county government buildings',
