...
export default function BelfastMaineHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Belfast.",
  "businessLicense": "Register your LLC with the Maine Secretary of State and obtain any required local business licenses in Belfast.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Belfast",
