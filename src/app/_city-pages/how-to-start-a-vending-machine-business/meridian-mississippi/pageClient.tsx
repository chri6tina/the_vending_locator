...
export default function MeridianMississippiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Meridian.",
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required local business licenses in Meridian.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Meridian",
