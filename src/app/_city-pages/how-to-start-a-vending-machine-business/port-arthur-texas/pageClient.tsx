...
export default function PortArthurTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Port Arthur may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Port Arthur.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Port Arthur business licenses or permits.",
  "additionalNotes": "Check with the City of Port Arthur for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Port Arthur Hospital and medical facilities",
  "Downtown Port Arthur office buildings and businesses",
  "Port Arthur school district and educational facilities",
  "Port Arthur municipal and county government buildings",
