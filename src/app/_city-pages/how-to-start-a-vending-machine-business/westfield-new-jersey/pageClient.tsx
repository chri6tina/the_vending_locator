...
export default function WestfieldNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Westfield may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Westfield.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Westfield business licenses or permits.",
  "additionalNotes": "Check with the City of Westfield for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Westfield Hospital and medical facilities",
  "Downtown Westfield office buildings and businesses",
  "Westfield school district and educational facilities",
  "Westfield municipal and county government buildings",
