...
export default function LexingtonSouthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Lexington may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Lexington.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Lexington business licenses or permits.",
  "additionalNotes": "Check with the City of Lexington for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Lexington Hospital and medical facilities",
  "Downtown Lexington office buildings and businesses",
  "Lexington school district and educational facilities",
  "Lexington municipal and county government buildings",
