...
export default function TucsonArizonaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Arizona requires a sales tax permit. Register your business and collect/remit tax on vending sales. Tucson may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Pima County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Arizona Secretary of State and obtain any required Tucson business licenses or permits.',
    additionalNotes: 'Check with the City of Tucson for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'University of Arizona (47,000 students)',
      'Raytheon Missiles & Defense headquarters',
      'Davis-Monthan Air Force Base',
      'Banner University Medical Center Tucson',
      'Tucson International Airport',
      'Tech Parks Arizona',
      'Caterpillar surface mining equipment',
      'Downtown Tucson and 4th Avenue district'
  ]
