...
export default function OrangeburgSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Orangeburg'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Orangeburg may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Orangeburg.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Orangeburg business licenses or permits.",
  "additionalNotes": "Check with the City of Orangeburg for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Orangeburg Hospital and medical facilities",
  "Downtown Orangeburg office buildings and businesses",
  "Orangeburg school district and educational facilities",
  "Orangeburg municipal and county government buildings",
