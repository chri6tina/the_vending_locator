...
export default function HinesvilleGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Hinesville.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Hinesville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Hinesville",
