...
export default function WacoTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Waco may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Waco County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required Waco business licenses or permits.',
    additionalNotes: 'Check with the City of Waco for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Waco Hospital and medical facilities',
    'Downtown Waco office buildings and businesses',
    'Waco school district and educational facilities',
    'Waco municipal and county government buildings',
