...
export default function WickliffeOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Wickliffe may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Wickliffe.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Wickliffe business licenses or permits.",
  "additionalNotes": "Check with the City of Wickliffe for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Wickliffe Hospital and medical facilities",
  "Downtown Wickliffe office buildings and businesses",
  "Wickliffe school district and educational facilities",
  "Wickliffe municipal and county government buildings",
