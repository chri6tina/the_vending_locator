...
export default function HurstTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hurst may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Hurst.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Hurst business licenses or permits.",
  "additionalNotes": "Check with the City of Hurst for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Hurst Hospital and medical facilities",
  "Downtown Hurst office buildings and businesses",
  "Hurst school district and educational facilities",
  "Hurst municipal and county government buildings",
