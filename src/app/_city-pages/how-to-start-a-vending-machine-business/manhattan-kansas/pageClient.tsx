...
export default function ManhattanKansasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Kansas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Manhattan may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Manhattan County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Kansas Secretary of State and obtain any required Manhattan business licenses or permits.',
    additionalNotes: 'Check with the City of Manhattan for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Manhattan Hospital and medical facilities',
    'Downtown Manhattan office buildings and businesses',
    'Manhattan school district and educational facilities',
    'Manhattan municipal and county government buildings',
