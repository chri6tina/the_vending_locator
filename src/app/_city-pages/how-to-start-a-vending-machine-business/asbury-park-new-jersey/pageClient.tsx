...
export default function AsburyParkNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Asbury Park may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Asbury Park.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Asbury Park business licenses or permits.",
  "additionalNotes": "Check with the City of Asbury Park for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Asbury Park Hospital and medical facilities",
  "Downtown Asbury Park office buildings and businesses",
  "Asbury Park school district and educational facilities",
  "Asbury Park municipal and county government buildings",
