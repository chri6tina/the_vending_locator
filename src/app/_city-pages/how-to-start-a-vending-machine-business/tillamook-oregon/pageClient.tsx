...
export default function TillamookOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Tillamook may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Tillamook.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Tillamook business licenses or permits.",
  "additionalNotes": "Check with the City of Tillamook for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Tillamook Hospital and medical facilities",
  "Downtown Tillamook office buildings and businesses",
  "Tillamook school district and educational facilities",
  "Tillamook municipal and county government buildings",
