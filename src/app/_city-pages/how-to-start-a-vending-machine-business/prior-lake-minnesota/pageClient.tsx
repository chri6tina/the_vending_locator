...
export default function PriorLakeMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Prior Lake.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Prior Lake.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Prior Lake",
