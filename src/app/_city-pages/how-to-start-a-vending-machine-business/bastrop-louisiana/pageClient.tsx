...
export default function BastropLouisianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Bastrop.",
  "businessLicense": "Register your LLC with the Louisiana Secretary of State and obtain any required local business licenses in Bastrop.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Bastrop",
