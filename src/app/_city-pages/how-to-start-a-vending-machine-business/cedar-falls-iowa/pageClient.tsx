...
export default function CedarFallsIowaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Cedar Falls.",
  "businessLicense": "Register your LLC with the Iowa Secretary of State and obtain any required local business licenses in Cedar Falls.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Cedar Falls",
