...
export default function BakerCityOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Baker City may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Baker City.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Baker City business licenses or permits.",
  "additionalNotes": "Check with the City of Baker City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Baker City Hospital and medical facilities",
  "Downtown Baker City office buildings and businesses",
  "Baker City school district and educational facilities",
  "Baker City municipal and county government buildings",
