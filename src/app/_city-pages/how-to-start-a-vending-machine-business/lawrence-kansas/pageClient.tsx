...
export default function LawrenceKansasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Kansas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Lawrence may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Lawrence County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Kansas Secretary of State and obtain any required Lawrence business licenses or permits.',
    additionalNotes: 'Check with the City of Lawrence for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Lawrence Hospital and medical facilities',
    'Downtown Lawrence office buildings and businesses',
    'University of Kansas campus and facilities',
    'Lawrence municipal and county government buildings',
