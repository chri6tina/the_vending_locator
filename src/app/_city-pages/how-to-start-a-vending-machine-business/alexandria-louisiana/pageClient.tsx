...
export default function AlexandriaLouisianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Louisiana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Alexandria may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Alexandria County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Louisiana Secretary of State and obtain any required Alexandria business licenses or permits.',
    additionalNotes: 'Check with the City of Alexandria for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Alexandria Hospital and medical facilities',
    'Downtown Alexandria office buildings and businesses',
    'Alexandria school district and educational facilities',
    'Alexandria municipal and county government buildings',
