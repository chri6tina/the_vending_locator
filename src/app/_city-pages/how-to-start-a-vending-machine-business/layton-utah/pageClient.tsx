...
export default function LaytonUtahHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Layton.",
  "businessLicense": "Register your LLC with the Utah Secretary of State and obtain any required local business licenses in Layton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Layton",
