...
export default function NorthHavenConnecticutHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in North Haven.",
  "businessLicense": "Register your LLC with the Connecticut Secretary of State and obtain any required local business licenses in North Haven.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in North Haven",
