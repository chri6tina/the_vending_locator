...
export default function WestlandMichiganHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Michigan requires a sales tax permit. Register your business and collect/remit tax on vending sales. Westland may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Westland County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Michigan Secretary of State and obtain any required Westland business licenses or permits.',
    additionalNotes: 'Check with the City of Westland for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Westland Hospital and medical facilities',
    'Downtown Westland office buildings and businesses',
    'Westland school district and educational facilities',
    'Westland municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Westland',
