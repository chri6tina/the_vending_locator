...
export default function BocaRatonFloridaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Florida requires a sales tax permit. Register your business and collect/remit tax on vending sales. Boca Raton may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Boca Raton County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Florida Secretary of State and obtain any required Boca Raton business licenses or permits.',
    additionalNotes: 'Check with the City of Boca Raton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Boca Raton Hospital and medical facilities',
    'Downtown Boca Raton office buildings and businesses',
    'Boca Raton school district and educational facilities',
    'Boca Raton municipal and county government buildings',
