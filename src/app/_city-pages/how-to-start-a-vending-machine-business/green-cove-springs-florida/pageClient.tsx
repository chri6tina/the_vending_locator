...
export default function GreenCoveSpringsFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Green Cove Springs.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Green Cove Springs.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Green Cove Springs",
