...
export default function MaryvilleMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Maryville.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Maryville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Maryville",
