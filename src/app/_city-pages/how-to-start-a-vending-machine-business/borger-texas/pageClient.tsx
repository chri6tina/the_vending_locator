...
export default function BorgerTexasHowToStartPage() {
  const cityDisplayName = 'Borger'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Borger may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Borger.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Borger business licenses or permits.",
  "additionalNotes": "Check with the City of Borger for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Borger Hospital and medical facilities",
  "Downtown Borger office buildings and businesses",
  "Borger school district and educational facilities",
  "Borger municipal and county government buildings",
