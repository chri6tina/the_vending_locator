...
export default function LongviewTexasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Longview.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required local business licenses in Longview.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Longview",
