...
export default function CelinaOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Celina may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Celina.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Celina business licenses or permits.",
  "additionalNotes": "Check with the City of Celina for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Celina Hospital and medical facilities",
  "Downtown Celina office buildings and businesses",
  "Celina school district and educational facilities",
  "Celina municipal and county government buildings",
