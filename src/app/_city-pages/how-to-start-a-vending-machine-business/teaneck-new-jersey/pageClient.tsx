...
export default function TeaneckNewJerseyHowToStartPage() {
  const cityDisplayName = 'Teaneck'
  const stateDisplayName = 'New Jersey'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Teaneck may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Teaneck.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Teaneck business licenses or permits.",
  "additionalNotes": "Check with the City of Teaneck for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Teaneck Hospital and medical facilities",
  "Downtown Teaneck office buildings and businesses",
  "Teaneck school district and educational facilities",
  "Teaneck municipal and county government buildings",
