...
export default function NewBernNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. New Bern may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in New Bern.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required New Bern business licenses or permits.",
  "additionalNotes": "Check with the City of New Bern for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "New Bern Hospital and medical facilities",
  "Downtown New Bern office buildings and businesses",
  "New Bern school district and educational facilities",
  "New Bern municipal and county government buildings",
