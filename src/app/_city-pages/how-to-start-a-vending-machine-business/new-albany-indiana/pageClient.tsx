...
export default function NewAlbanyIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in New Albany.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in New Albany.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in New Albany",
