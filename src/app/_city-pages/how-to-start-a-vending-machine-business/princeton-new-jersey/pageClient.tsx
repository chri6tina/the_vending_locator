...
export default function PrincetonNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Princeton may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Princeton.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Princeton business licenses or permits.",
  "additionalNotes": "Check with the City of Princeton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Princeton Hospital and medical facilities",
  "Downtown Princeton office buildings and businesses",
  "Princeton school district and educational facilities",
  "Princeton municipal and county government buildings",
