...
export default function HamiltonMontanaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Hamilton.",
  "businessLicense": "Register your LLC with the Montana Secretary of State and obtain any required local business licenses in Hamilton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Hamilton",
