...
export default function HendersonNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Henderson may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Henderson.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Henderson business licenses or permits.",
  "additionalNotes": "Check with the City of Henderson for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Henderson Hospital and medical facilities",
  "Downtown Henderson office buildings and businesses",
  "Henderson school district and educational facilities",
  "Henderson municipal and county government buildings",
