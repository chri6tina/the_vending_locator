...
export default function TullahomaTennesseeHowToStartPage() {
  const cityDisplayName = 'Tullahoma'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Tullahoma may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Tullahoma.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Tullahoma business licenses or permits.",
  "additionalNotes": "Check with the City of Tullahoma for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Tullahoma Hospital and medical facilities",
  "Downtown Tullahoma office buildings and businesses",
  "Tullahoma school district and educational facilities",
  "Tullahoma municipal and county government buildings",
