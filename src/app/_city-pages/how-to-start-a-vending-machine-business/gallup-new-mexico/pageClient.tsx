...
export default function GallupNewMexicoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Gallup.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required local business licenses in Gallup.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Gallup",
