...
export default function HarringtonDelawareHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Harrington.",
  "businessLicense": "Register your LLC with the Delaware Secretary of State and obtain any required local business licenses in Harrington.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Harrington",
