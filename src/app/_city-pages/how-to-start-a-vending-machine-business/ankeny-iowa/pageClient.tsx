...
export default function AnkenyIowaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Ankeny.",
  "businessLicense": "Register your LLC with the Iowa Secretary of State and obtain any required local business licenses in Ankeny.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Ankeny",
