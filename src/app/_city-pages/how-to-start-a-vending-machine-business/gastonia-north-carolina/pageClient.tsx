...
export default function GastoniaNorthCarolinaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Gastonia.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required local business licenses in Gastonia.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Gastonia",
