...
export default function BurbankCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Burbank may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Burbank County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Burbank business licenses or permits.',
    additionalNotes: 'Check with the City of Burbank for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Burbank Hospital and medical facilities',
    'Downtown Burbank office buildings and businesses',
    'Burbank school district and educational facilities',
    'Burbank municipal and county government buildings',
