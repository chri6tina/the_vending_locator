...
export default function PerryFloridaHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Perry.",
