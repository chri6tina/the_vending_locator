...
export default function WestHavenConnecticutHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in West Haven.",
  "businessLicense": "Register your LLC with the Connecticut Secretary of State and obtain any required local business licenses in West Haven.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in West Haven",
