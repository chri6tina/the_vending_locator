...
export default function HendersonNevadaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Nevada requires a sales tax permit. Register your business and collect/remit tax on vending sales. Henderson may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Nevada Secretary of State and obtain any required Henderson business licenses or permits.',
  ...
  const demandDrivers = [
      'Henderson Hospital and St. Rose Dominican',
      'Henderson Executive Airport',
      'Las Vegas Motor Speedway area',
      'City of Henderson offices',
      'Green Valley Ranch Resort',
      'Galleria at Sunset shopping',
      'Nevada State College',
      'Lake Las Vegas resort community'
  ]
