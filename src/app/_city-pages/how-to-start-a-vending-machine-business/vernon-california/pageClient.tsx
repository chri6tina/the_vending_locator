...
export default function VernonCaliforniaHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Vernon.",
