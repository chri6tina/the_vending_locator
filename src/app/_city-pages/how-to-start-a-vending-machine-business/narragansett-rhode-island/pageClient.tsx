...
export default function NarragansettRhodeIslandHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Rhode Island requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Narragansett may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Narragansett.",
  "businessLicense": "Register your LLC with the Rhode Island Secretary of State and obtain any required Narragansett business licenses or permits.",
  "additionalNotes": "Check with the City of Narragansett for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Narragansett Hospital and medical facilities",
  "Downtown Narragansett office buildings and businesses",
  "Narragansett school district and educational facilities",
  "Narragansett municipal and county government buildings",
