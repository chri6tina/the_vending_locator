...
export default function MansfieldOhioHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mansfield.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required local business licenses in Mansfield.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mansfield",
