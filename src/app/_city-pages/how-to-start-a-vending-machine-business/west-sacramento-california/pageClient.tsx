...
export default function WestSacramentoCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in West Sacramento.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in West Sacramento.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in West Sacramento",
