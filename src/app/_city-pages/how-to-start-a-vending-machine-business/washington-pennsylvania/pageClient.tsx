...
export default function WashingtonPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Washington may have additional local sales taxes.",
  ...
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Washington business licenses or permits.",
