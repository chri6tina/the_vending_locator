...
export default function CoronaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Corona may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Corona County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Corona business licenses or permits.',
    additionalNotes: 'Check with the City of Corona for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Corona Hospital and medical facilities',
    'Downtown Corona office buildings and businesses',
    'Corona school district and educational facilities',
    'Corona municipal and county government buildings',
