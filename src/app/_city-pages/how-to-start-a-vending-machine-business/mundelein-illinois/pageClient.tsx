...
export default function MundeleinIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mundelein.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Mundelein.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mundelein",
