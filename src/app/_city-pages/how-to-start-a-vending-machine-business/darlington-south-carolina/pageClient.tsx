...
export default function DarlingtonSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Darlington'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Darlington may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Darlington.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Darlington business licenses or permits.",
  "additionalNotes": "Check with the City of Darlington for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Darlington Hospital and medical facilities",
  "Downtown Darlington office buildings and businesses",
  "Darlington school district and educational facilities",
  "Darlington municipal and county government buildings",
