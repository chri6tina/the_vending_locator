...
export default function NantucketMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Nantucket.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Nantucket.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Nantucket",
