...
export default function CoralGablesFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Coral Gables.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Coral Gables.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Coral Gables",
