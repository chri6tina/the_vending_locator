...
export default function LongBranchNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Long Branch may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Long Branch.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Long Branch business licenses or permits.",
  "additionalNotes": "Check with the City of Long Branch for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Long Branch Hospital and medical facilities",
  "Downtown Long Branch office buildings and businesses",
  "Long Branch school district and educational facilities",
  "Long Branch municipal and county government buildings",
