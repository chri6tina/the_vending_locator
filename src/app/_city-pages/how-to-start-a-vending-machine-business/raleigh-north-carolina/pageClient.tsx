...
export default function RaleighNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'North Carolina requires a sales tax permit. Register your business and collect/remit tax on vending sales. Raleigh may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Wake County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the North Carolina Secretary of State and obtain any required Raleigh business licenses or permits.',
    additionalNotes: 'Check with the City of Raleigh for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'North Carolina State Capitol and government offices',
      'NC State University (36,000 students)',
      'WakeMed and Rex Healthcare hospitals',
      'Research Triangle Park (nearby - IBM, Cisco, Biogen)',
      'Raleigh-Durham International Airport (RDU)',
      'Red Hat headquarters',
      'SAS Institute campus (Cary)',
      'Downtown Raleigh and Fayetteville Street district'
  ]
