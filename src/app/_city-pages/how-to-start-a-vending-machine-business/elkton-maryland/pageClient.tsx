...
export default function ElktonMarylandHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Elkton.",
  "businessLicense": "Register your LLC with the Maryland Secretary of State and obtain any required local business licenses in Elkton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Elkton",
