...
export default function MemphisTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Tennessee requires a sales tax permit. Register your business and collect/remit tax on vending sales. Memphis may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Shelby County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Tennessee Secretary of State and obtain any required Memphis business licenses or permits.',
    additionalNotes: 'Check with the City of Memphis for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'FedEx Express World Hub (SuperHub at Memphis Airport)',
      'Memphis International Airport',
      'Methodist Le Bonheur Healthcare and St. Jude Childrens Research Hospital',
      'University of Memphis and University of Tennessee Health Science',
