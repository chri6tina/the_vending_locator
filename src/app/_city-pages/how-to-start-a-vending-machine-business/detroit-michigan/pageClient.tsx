...
export default function DetroitMichiganHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Michigan requires a sales tax permit. Register your business and collect/remit tax on vending sales. Detroit may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Wayne County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Michigan Secretary of State and obtain any required Detroit business licenses or permits.',
    additionalNotes: 'Check with the City of Detroit for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'General Motors Renaissance Center headquarters',
      'Ford Motor Company facilities (Dearborn)',
      'Detroit Medical Center and Henry Ford Health',
      'Detroit Metropolitan Wayne County Airport (DTW)',
      'Stellantis (Chrysler) headquarters',
      'Little Caesars Arena and downtown district',
      'Wayne State University campus',
      'Quicken Loans and Rocket Mortgage headquarters'
  ]
