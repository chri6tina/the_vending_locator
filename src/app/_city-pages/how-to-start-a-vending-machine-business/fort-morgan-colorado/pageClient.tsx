...
export default function FortMorganColoradoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Fort Morgan.",
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in Fort Morgan.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Fort Morgan",
