...
export default function FortDodgeIowaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Fort Dodge.",
  "businessLicense": "Register your LLC with the Iowa Secretary of State and obtain any required local business licenses in Fort Dodge.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Fort Dodge",
