...
export default function OneontaNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Oneonta may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Oneonta.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Oneonta business licenses or permits.",
  "additionalNotes": "Check with the City of Oneonta for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Oneonta Hospital and medical facilities",
  "Downtown Oneonta office buildings and businesses",
  "Oneonta school district and educational facilities",
  "Oneonta municipal and county government buildings",
