...
export default function GrahamTexasHowToStartPage() {
  const cityDisplayName = 'Graham'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Graham may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Graham.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Graham business licenses or permits.",
  "additionalNotes": "Check with the City of Graham for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Graham Hospital and medical facilities",
  "Downtown Graham office buildings and businesses",
  "Graham school district and educational facilities",
  "Graham municipal and county government buildings",
