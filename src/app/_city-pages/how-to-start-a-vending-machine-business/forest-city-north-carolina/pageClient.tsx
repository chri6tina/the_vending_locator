...
export default function ForestCityNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Forest City may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Forest City.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Forest City business licenses or permits.",
  "additionalNotes": "Check with the City of Forest City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Forest City Hospital and medical facilities",
  "Downtown Forest City office buildings and businesses",
  "Forest City school district and educational facilities",
  "Forest City municipal and county government buildings",
