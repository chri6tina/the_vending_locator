...
export default function DurhamNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'North Carolina requires a sales tax permit. Register your business and collect/remit tax on vending sales. Durham may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Durham County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the North Carolina Secretary of State and obtain any required Durham business licenses or permits.',
