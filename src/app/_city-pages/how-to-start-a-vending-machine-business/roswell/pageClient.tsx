...
export default function RoswellNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Roswell may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Roswell.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Roswell business licenses or permits.",
  "additionalNotes": "Check with the City of Roswell for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Roswell Hospital and medical facilities",
  "Downtown Roswell office buildings and businesses",
  "Roswell school district and educational facilities",
  "Roswell municipal and county government buildings",
