...
export default function OwassoOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Owasso may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Owasso.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required Owasso business licenses or permits.",
  "additionalNotes": "Check with the City of Owasso for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Owasso Hospital and medical facilities",
  "Downtown Owasso office buildings and businesses",
  "Owasso school district and educational facilities",
  "Owasso municipal and county government buildings",
