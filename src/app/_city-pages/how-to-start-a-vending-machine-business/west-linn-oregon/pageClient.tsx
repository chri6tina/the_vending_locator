...
export default function WestLinnOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. West Linn may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in West Linn.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required West Linn business licenses or permits.",
  "additionalNotes": "Check with the City of West Linn for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "West Linn Hospital and medical facilities",
  "Downtown West Linn office buildings and businesses",
  "West Linn school district and educational facilities",
  "West Linn municipal and county government buildings",
