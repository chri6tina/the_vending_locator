...
export default function ExcelsiorSpringsMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Excelsior Springs.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Excelsior Springs.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Excelsior Springs",
