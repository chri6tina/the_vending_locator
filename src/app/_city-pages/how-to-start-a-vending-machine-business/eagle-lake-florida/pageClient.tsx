...
export default function EagleLakeFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Eagle Lake.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Eagle Lake.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Eagle Lake",
