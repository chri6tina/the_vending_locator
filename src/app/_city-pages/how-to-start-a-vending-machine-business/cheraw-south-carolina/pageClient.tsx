...
export default function CherawSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Cheraw'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Cheraw may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Cheraw.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Cheraw business licenses or permits.",
  "additionalNotes": "Check with the City of Cheraw for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Cheraw Hospital and medical facilities",
  "Downtown Cheraw office buildings and businesses",
  "Cheraw school district and educational facilities",
  "Cheraw municipal and county government buildings",
