...
export default function StockbridgeGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Stockbridge.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Stockbridge.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Stockbridge",
