...
export default function SumterSouthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Sumter may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Sumter.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Sumter business licenses or permits.",
  "additionalNotes": "Check with the City of Sumter for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Sumter Hospital and medical facilities",
  "Downtown Sumter office buildings and businesses",
  "Sumter school district and educational facilities",
  "Sumter municipal and county government buildings",
