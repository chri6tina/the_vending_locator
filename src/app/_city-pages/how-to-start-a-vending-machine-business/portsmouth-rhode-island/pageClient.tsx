...
export default function PortsmouthRhodeIslandHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Rhode Island requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Portsmouth may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Portsmouth.",
  "businessLicense": "Register your LLC with the Rhode Island Secretary of State and obtain any required Portsmouth business licenses or permits.",
  "additionalNotes": "Check with the City of Portsmouth for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Portsmouth Hospital and medical facilities",
  "Downtown Portsmouth office buildings and businesses",
  "Portsmouth school district and educational facilities",
  "Portsmouth municipal and county government buildings",
