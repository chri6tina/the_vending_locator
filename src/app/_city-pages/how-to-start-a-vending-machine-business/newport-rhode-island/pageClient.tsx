...
export default function NewportRhodeIslandHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Newport.",
  "businessLicense": "Register your LLC with the Rhode Island Secretary of State and obtain any required local business licenses in Newport.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Newport",
