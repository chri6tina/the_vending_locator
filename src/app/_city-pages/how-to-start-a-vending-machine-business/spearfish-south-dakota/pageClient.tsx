...
export default function SpearfishSouthDakotaHowToStartPage() {
  const cityDisplayName = 'Spearfish'
  const stateDisplayName = 'South Dakota'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Dakota requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Spearfish may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Spearfish.",
  "businessLicense": "Register your LLC with the South Dakota Secretary of State and obtain any required Spearfish business licenses or permits.",
  "additionalNotes": "Check with the City of Spearfish for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Spearfish Hospital and medical facilities",
  "Downtown Spearfish office buildings and businesses",
  "Spearfish school district and educational facilities",
  "Spearfish municipal and county government buildings",
