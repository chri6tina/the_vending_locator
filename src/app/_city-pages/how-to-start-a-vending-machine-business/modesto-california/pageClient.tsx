...
export default function ModestoCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Modesto may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Modesto County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Modesto business licenses or permits.',
    additionalNotes: 'Check with the City of Modesto for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Modesto Hospital and medical facilities',
    'Downtown Modesto office buildings and businesses',
    'Modesto school district and educational facilities',
    'Modesto municipal and county government buildings',
