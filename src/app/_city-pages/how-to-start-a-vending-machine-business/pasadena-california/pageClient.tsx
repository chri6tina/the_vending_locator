...
export default function PasadenaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Pasadena may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Pasadena County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Pasadena business licenses or permits.',
    additionalNotes: 'Check with the City of Pasadena for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Pasadena Hospital and medical facilities',
    'Downtown Pasadena office buildings and businesses',
    'Pasadena school district and educational facilities',
    'Pasadena municipal and county government buildings',
