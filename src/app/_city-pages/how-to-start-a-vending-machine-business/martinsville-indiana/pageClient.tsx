...
export default function MartinsvilleIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Martinsville.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Martinsville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Martinsville",
