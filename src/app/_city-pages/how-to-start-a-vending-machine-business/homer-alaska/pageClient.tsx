...
export default function HomerAlaskaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Alaska requires a sales tax permit. Register your business and collect/remit tax on vending sales. Homer may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Homer County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Alaska Secretary of State and obtain any required Homer business licenses or permits.',
    additionalNotes: 'Check with the City of Homer for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Homer Hospital and medical facilities',
    'Downtown Homer office buildings and businesses',
    'Homer school district and educational facilities',
    'Homer municipal and county government buildings',
