...
export default function EwaBeachHawaiiHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Hawaii requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Ewa Beach.",
  "businessLicense": "Register your LLC with the Hawaii Secretary of State and obtain any required local business licenses in Ewa Beach.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Ewa Beach",
