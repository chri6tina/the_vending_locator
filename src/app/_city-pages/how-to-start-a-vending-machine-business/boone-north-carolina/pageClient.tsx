...
export default function BooneNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Boone may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Boone.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Boone business licenses or permits.",
  "additionalNotes": "Check with the City of Boone for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Boone Hospital and medical facilities",
  "Downtown Boone office buildings and businesses",
  "Boone school district and educational facilities",
  "Boone municipal and county government buildings",
