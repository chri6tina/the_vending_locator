...
export default function GrantsNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Grants may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Grants.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Grants business licenses or permits.",
  "additionalNotes": "Check with the City of Grants for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Grants Hospital and medical facilities",
  "Downtown Grants office buildings and businesses",
  "Grants school district and educational facilities",
  "Grants municipal and county government buildings",
