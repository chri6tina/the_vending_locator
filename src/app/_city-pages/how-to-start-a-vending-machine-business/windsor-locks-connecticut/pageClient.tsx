...
export default function WindsorLocksConnecticutHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Connecticut requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Windsor Locks.",
  "businessLicense": "Register your LLC with the Connecticut Secretary of State and obtain any required local business licenses in Windsor Locks.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Windsor Locks",
