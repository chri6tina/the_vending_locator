...
export default function KennerLouisianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Louisiana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Kenner may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Kenner County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Louisiana Secretary of State and obtain any required Kenner business licenses or permits.',
    additionalNotes: 'Check with the City of Kenner for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Kenner Hospital and medical facilities',
    'Downtown Kenner office buildings and businesses',
    'Kenner school district and educational facilities',
    'Kenner municipal and county government buildings',
