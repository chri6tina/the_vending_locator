...
export default function MorristownNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Morristown may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Morristown.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Morristown business licenses or permits.",
  "additionalNotes": "Check with the City of Morristown for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Morristown Hospital and medical facilities",
  "Downtown Morristown office buildings and businesses",
  "Morristown school district and educational facilities",
  "Morristown municipal and county government buildings",
