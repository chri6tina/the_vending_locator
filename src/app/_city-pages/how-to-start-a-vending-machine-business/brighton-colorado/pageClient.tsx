...
export default function BrightonColoradoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Brighton.",
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in Brighton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Brighton",
