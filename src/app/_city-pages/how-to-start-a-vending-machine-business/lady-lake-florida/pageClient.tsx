...
export default function LadyLakeFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lady Lake.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Lady Lake.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lady Lake",
