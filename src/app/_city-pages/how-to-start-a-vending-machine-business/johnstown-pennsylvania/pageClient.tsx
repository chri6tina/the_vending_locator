...
export default function JohnstownPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Johnstown may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Johnstown.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Johnstown business licenses or permits.",
  "additionalNotes": "Check with the City of Johnstown for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Johnstown Hospital and medical facilities",
  "Downtown Johnstown office buildings and businesses",
  "Johnstown school district and educational facilities",
  "Johnstown municipal and county government buildings",
