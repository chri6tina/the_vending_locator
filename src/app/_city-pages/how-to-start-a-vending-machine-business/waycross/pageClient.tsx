...
export default function WaycrossGeorgiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Georgia requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Waycross may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Waycross.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required Waycross business licenses or permits.",
  "additionalNotes": "Check with the City of Waycross for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Waycross Hospital and medical facilities",
  "Downtown Waycross office buildings and businesses",
  "Waycross school district and educational facilities",
  "Waycross municipal and county government buildings",
