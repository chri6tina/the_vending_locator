...
export default function GardenCityIdahoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Idaho requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  ...
  "businessLicense": "Register your LLC with the Idaho Secretary of State and obtain any required local business licenses in Garden City.",
