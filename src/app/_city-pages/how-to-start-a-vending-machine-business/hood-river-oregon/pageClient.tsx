...
export default function HoodRiverOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hood River may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Hood River.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Hood River business licenses or permits.",
  "additionalNotes": "Check with the City of Hood River for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Hood River Hospital and medical facilities",
  "Downtown Hood River office buildings and businesses",
  "Hood River school district and educational facilities",
  "Hood River municipal and county government buildings",
