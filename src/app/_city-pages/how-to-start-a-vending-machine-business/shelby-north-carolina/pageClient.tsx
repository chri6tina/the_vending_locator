...
export default function ShelbyNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Shelby may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Shelby.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Shelby business licenses or permits.",
  "additionalNotes": "Check with the City of Shelby for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Shelby Hospital and medical facilities",
  "Downtown Shelby office buildings and businesses",
  "Shelby school district and educational facilities",
  "Shelby municipal and county government buildings",
