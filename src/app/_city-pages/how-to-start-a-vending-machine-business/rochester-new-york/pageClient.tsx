...
export default function RochesterNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New York requires a sales tax permit. Register your business and collect/remit tax on vending sales. Rochester may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the New York Secretary of State and obtain any required Rochester business licenses or permits.',
