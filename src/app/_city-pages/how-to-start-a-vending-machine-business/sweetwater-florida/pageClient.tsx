...
export default function SweetwaterFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Sweetwater.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Sweetwater.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Sweetwater",
