...
export default function FortLeonardWoodMissouriHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Missouri requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Fort Leonard Wood.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Fort Leonard Wood.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Fort Leonard Wood",
