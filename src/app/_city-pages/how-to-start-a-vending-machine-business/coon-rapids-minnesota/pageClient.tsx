...
export default function CoonRapidsMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Coon Rapids.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Coon Rapids.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Coon Rapids",
