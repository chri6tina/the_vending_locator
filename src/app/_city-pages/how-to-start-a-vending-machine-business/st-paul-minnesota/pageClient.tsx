...
export default function StPaulMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in St. Paul.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in St. Paul.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in St. Paul",
