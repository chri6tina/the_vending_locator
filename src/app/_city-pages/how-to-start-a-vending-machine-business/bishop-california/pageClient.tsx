...
export default function BishopCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Bishop.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Bishop.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Bishop",
