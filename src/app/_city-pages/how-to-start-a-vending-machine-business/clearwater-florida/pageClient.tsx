...
export default function ClearwaterFloridaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Florida requires a sales tax permit. Register your business and collect/remit tax on vending sales. Clearwater may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Clearwater County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Florida Secretary of State and obtain any required Clearwater business licenses or permits.',
    additionalNotes: 'Check with the City of Clearwater for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Clearwater Hospital and medical facilities',
    'Downtown Clearwater office buildings and businesses',
    'Clearwater school district and educational facilities',
    'Clearwater municipal and county government buildings',
