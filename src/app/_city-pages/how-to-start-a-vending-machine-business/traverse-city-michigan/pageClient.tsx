...
export default function TraverseCityMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Traverse City.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Traverse City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Traverse City",
