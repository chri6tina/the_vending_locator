...
export default function FishersIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Fishers.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Fishers.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Fishers",
