...
export default function BethlehemPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Pennsylvania requires a sales tax permit. Register your business and collect/remit tax on vending sales. Bethlehem may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Bethlehem County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Pennsylvania Secretary of State and obtain any required Bethlehem business licenses or permits.',
    additionalNotes: 'Check with the City of Bethlehem for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Bethlehem Hospital and medical facilities',
    'Downtown Bethlehem office buildings and businesses',
    'Bethlehem school district and educational facilities',
    'Bethlehem municipal and county government buildings',
