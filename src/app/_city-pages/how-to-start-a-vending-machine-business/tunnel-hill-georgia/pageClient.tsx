...
export default function TunnelHillGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Tunnel Hill.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Tunnel Hill.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Tunnel Hill",
