...
export default function FortScottMaineHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Fort Scott.",
  "businessLicense": "Register your LLC with the Maine Secretary of State and obtain any required local business licenses in Fort Scott.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Fort Scott",
