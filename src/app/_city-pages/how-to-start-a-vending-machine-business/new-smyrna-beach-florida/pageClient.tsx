...
export default function NewSmyrnaBeachFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in New Smyrna Beach.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in New Smyrna Beach.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in New Smyrna Beach",
