...
export default function VernonHillsIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Vernon Hills.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Vernon Hills.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Vernon Hills",
