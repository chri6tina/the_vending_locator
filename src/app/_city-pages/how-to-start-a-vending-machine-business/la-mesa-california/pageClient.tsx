...
export default function LaMesaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. La Mesa also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of La Mesa.',
    additionalNotes: 'Some locations like the Port of La Mesa or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'La Mesa Port facilities and logistics operations',
      'Naval Air Station La Mesa and military contractors',
      ...
      'La Mesa Beach and coastal tourism areas',
