...
export default function JohnstonRhodeIslandHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Rhode Island requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Johnston may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Johnston.",
  "businessLicense": "Register your LLC with the Rhode Island Secretary of State and obtain any required Johnston business licenses or permits.",
  "additionalNotes": "Check with the City of Johnston for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Johnston Hospital and medical facilities",
  "Downtown Johnston office buildings and businesses",
  "Johnston school district and educational facilities",
  "Johnston municipal and county government buildings",
