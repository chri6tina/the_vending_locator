...
export default function PlymouthMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Plymouth.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Plymouth.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Plymouth",
