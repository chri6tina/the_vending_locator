...
export default function ValdezAlaskaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Valdez.",
  "businessLicense": "Register your LLC with the Alaska Secretary of State and obtain any required local business licenses in Valdez.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Valdez",
