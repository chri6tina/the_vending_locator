...
export default function IrvingtonNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Irvington may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Irvington.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Irvington business licenses or permits.",
  "additionalNotes": "Check with the City of Irvington for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Irvington Hospital and medical facilities",
  "Downtown Irvington office buildings and businesses",
  "Irvington school district and educational facilities",
  "Irvington municipal and county government buildings",
