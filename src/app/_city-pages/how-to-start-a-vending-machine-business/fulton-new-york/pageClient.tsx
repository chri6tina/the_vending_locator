...
export default function FultonNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Fulton may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Fulton.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Fulton business licenses or permits.",
  "additionalNotes": "Check with the City of Fulton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Fulton Hospital and medical facilities",
  "Downtown Fulton office buildings and businesses",
  "Fulton school district and educational facilities",
  "Fulton municipal and county government buildings",
