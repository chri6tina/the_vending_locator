...
export default function ConcordCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Concord may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Concord business licenses or permits.',
  ...
  const demandDrivers = [
    ...
    'Concord municipal and county government buildings',
