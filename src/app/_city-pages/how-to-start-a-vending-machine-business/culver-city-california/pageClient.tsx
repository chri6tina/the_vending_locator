...
export default function CulverCityCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Culver City.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Culver City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Culver City",
