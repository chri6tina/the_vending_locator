...
export default function WeehawkenNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Weehawken may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Weehawken.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Weehawken business licenses or permits.",
  "additionalNotes": "Check with the City of Weehawken for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Weehawken Hospital and medical facilities",
  "Downtown Weehawken office buildings and businesses",
  "Weehawken school district and educational facilities",
  "Weehawken municipal and county government buildings",
