...
export default function GoodlettsvilleTennesseeHowToStartPage() {
  const cityDisplayName = 'Goodlettsville'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Goodlettsville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Goodlettsville.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Goodlettsville business licenses or permits.",
  "additionalNotes": "Check with the City of Goodlettsville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Goodlettsville Hospital and medical facilities",
  "Downtown Goodlettsville office buildings and businesses",
  "Goodlettsville school district and educational facilities",
  "Goodlettsville municipal and county government buildings",
