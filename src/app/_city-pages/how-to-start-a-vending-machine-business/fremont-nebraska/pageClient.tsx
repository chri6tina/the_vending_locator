...
export default function FremontNebraskaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Fremont.",
  "businessLicense": "Register your LLC with the Nebraska Secretary of State and obtain any required local business licenses in Fremont.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Fremont",
