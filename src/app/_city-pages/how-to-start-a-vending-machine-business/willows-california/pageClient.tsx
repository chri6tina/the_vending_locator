...
export default function WillowsCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Willows.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Willows.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Willows",
