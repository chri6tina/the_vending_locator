...
export default function ElCentroCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in El Centro.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in El Centro.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in El Centro",
