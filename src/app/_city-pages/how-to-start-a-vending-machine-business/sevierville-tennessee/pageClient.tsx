...
export default function SeviervilleTennesseeHowToStartPage() {
  const cityDisplayName = 'Sevierville'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Sevierville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Sevierville.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Sevierville business licenses or permits.",
  "additionalNotes": "Check with the City of Sevierville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Sevierville Hospital and medical facilities",
  "Downtown Sevierville office buildings and businesses",
  "Sevierville school district and educational facilities",
  "Sevierville municipal and county government buildings",
