...
export default function EriePennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Pennsylvania requires a sales tax permit. Register your business and collect/remit tax on vending sales. Erie may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Erie County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Pennsylvania Secretary of State and obtain any required Erie business licenses or permits.',
    additionalNotes: 'Check with the City of Erie for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Erie Hospital and medical facilities',
    'Downtown Erie office buildings and businesses',
    'Erie school district and educational facilities',
    'Erie municipal and county government buildings',
