...
export default function CanbyOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Canby may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Canby.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Canby business licenses or permits.",
  "additionalNotes": "Check with the City of Canby for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Canby Hospital and medical facilities",
  "Downtown Canby office buildings and businesses",
  "Canby school district and educational facilities",
  "Canby municipal and county government buildings",
