...
export default function RichmondKentuckyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Kentucky requires a sales tax permit. Register your business and collect/remit tax on vending sales. Richmond may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Kentucky Secretary of State and obtain any required Richmond business licenses or permits.',
