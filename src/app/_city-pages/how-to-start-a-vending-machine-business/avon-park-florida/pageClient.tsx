...
export default function AvonParkFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Avon Park.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Avon Park.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Avon Park",
