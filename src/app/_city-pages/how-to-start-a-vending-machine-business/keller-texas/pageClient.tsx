...
export default function KellerTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Keller may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Keller.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Keller business licenses or permits.",
  "additionalNotes": "Check with the City of Keller for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Keller Hospital and medical facilities",
  "Downtown Keller office buildings and businesses",
  "Keller school district and educational facilities",
  "Keller municipal and county government buildings",
