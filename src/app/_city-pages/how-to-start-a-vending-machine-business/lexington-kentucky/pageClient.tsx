...
export default function LexingtonKentuckyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Kentucky requires a sales tax permit. Register your business and collect/remit tax on vending sales. Lexington may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Fayette County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Kentucky Secretary of State and obtain any required Lexington business licenses or permits.',
  ...
  const demandDrivers = [
      'University of Kentucky (30,000 students) and UK HealthCare',
      'Lexington Clinic and Baptist Health',
      'Blue Grass Airport',
      'Keeneland Race Course and horse industry',
      'Toyota Motor Manufacturing plant (Georgetown)',
      'Downtown Lexington and Rupp Arena',
      'Transylvania University',
      'Amazon fulfillment and distribution centers'
  ]
