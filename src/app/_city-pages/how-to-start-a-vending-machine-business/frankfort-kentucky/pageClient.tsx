...
export default function FrankfortKentuckyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Kentucky requires a sales tax permit. Register your business and collect/remit tax on vending sales. Frankfort may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Frankfort County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Kentucky Secretary of State and obtain any required Frankfort business licenses or permits.',
    additionalNotes: 'Check with the City of Frankfort for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Frankfort Hospital and medical facilities',
    'Downtown Frankfort office buildings and businesses',
    'Frankfort school district and educational facilities',
    'Kentucky state government offices and capitol complex',
    ...
    'Frankfort Airport and related businesses'
  ]
