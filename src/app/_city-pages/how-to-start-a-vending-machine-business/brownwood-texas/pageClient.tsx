...
export default function BrownwoodTexasHowToStartPage() {
  const cityDisplayName = 'Brownwood'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Brownwood may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Brownwood.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Brownwood business licenses or permits.",
  "additionalNotes": "Check with the City of Brownwood for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Brownwood Hospital and medical facilities",
  "Downtown Brownwood office buildings and businesses",
  "Brownwood school district and educational facilities",
  "Brownwood municipal and county government buildings",
