...
export default function NorthBergenNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. North Bergen may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in North Bergen.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required North Bergen business licenses or permits.",
  "additionalNotes": "Check with the City of North Bergen for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "North Bergen Hospital and medical facilities",
  "Downtown North Bergen office buildings and businesses",
  "North Bergen school district and educational facilities",
  "North Bergen municipal and county government buildings",
