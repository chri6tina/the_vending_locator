...
export default function SunnyvaleCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Sunnyvale may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Sunnyvale County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Sunnyvale business licenses or permits.',
    additionalNotes: 'Check with the City of Sunnyvale for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Sunnyvale Hospital and medical facilities',
    'Downtown Sunnyvale office buildings and businesses',
    'Sunnyvale school district and educational facilities',
    'Sunnyvale municipal and county government buildings',
