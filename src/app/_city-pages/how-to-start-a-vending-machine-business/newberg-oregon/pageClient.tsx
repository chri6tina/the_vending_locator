...
export default function NewbergOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Newberg may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Newberg.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Newberg business licenses or permits.",
  "additionalNotes": "Check with the City of Newberg for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Newberg Hospital and medical facilities",
  "Downtown Newberg office buildings and businesses",
  "Newberg school district and educational facilities",
  "Newberg municipal and county government buildings",
