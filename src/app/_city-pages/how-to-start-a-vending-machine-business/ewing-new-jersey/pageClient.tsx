...
export default function EwingNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Ewing may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Ewing.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Ewing business licenses or permits.",
  "additionalNotes": "Check with the City of Ewing for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Ewing Hospital and medical facilities",
  "Downtown Ewing office buildings and businesses",
  "Ewing school district and educational facilities",
  "Ewing municipal and county government buildings",
