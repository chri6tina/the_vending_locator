...
export default function RoxboroNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Roxboro may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Roxboro.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Roxboro business licenses or permits.",
  "additionalNotes": "Check with the City of Roxboro for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Roxboro Hospital and medical facilities",
  "Downtown Roxboro office buildings and businesses",
  "Roxboro school district and educational facilities",
  "Roxboro municipal and county government buildings",
