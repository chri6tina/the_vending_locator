...
export default function HalfMoonBayCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Half Moon Bay.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Half Moon Bay.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Half Moon Bay",
