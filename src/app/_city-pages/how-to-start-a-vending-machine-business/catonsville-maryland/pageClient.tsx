...
export default function CatonsvilleMarylandHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Catonsville.",
  "businessLicense": "Register your LLC with the Maryland Secretary of State and obtain any required local business licenses in Catonsville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Catonsville",
