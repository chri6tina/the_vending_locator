...
export default function LosBanosCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Los Banos.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Los Banos.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Los Banos",
