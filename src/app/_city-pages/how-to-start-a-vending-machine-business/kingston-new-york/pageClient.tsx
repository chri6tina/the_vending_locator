...
export default function KingstonNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Kingston may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Kingston.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Kingston business licenses or permits.",
  "additionalNotes": "Check with the City of Kingston for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Kingston Hospital and medical facilities",
  "Downtown Kingston office buildings and businesses",
  "Kingston school district and educational facilities",
  "Kingston municipal and county government buildings",
