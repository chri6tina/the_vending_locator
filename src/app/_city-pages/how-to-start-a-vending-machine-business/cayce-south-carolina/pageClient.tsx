...
export default function CayceSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Cayce'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Cayce may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Cayce.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Cayce business licenses or permits.",
  "additionalNotes": "Check with the City of Cayce for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Cayce Hospital and medical facilities",
  "Downtown Cayce office buildings and businesses",
  "Cayce school district and educational facilities",
  "Cayce municipal and county government buildings",
