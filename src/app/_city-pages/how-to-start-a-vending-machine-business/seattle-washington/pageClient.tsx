...
export default function SeattleWashingtonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington requires a sales tax permit. Register your business and collect/remit tax on vending sales. Seattle may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the King County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Washington Secretary of State and obtain any required Seattle business licenses or permits.',
    additionalNotes: 'Check with the City of Seattle for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Amazon headquarters and tech campus (South Lake Union)',
      'Microsoft facilities (Bellevue and Redmond nearby)',
      'Seattle-Tacoma International Airport (Sea-Tac)',
      'University of Washington and UW Medicine',
      'Boeing Commercial Airplanes (Renton)',
      'Starbucks headquarters and Support Center',
      'Fred Hutchinson Cancer Center',
      'T-Mobile and Expedia Group offices'
  ]
