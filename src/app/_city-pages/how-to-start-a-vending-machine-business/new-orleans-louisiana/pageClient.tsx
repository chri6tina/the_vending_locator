...
export default function NewOrleansLouisianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Louisiana requires a sales tax permit. Register your business and collect/remit tax on vending sales. New Orleans may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Orleans Parish Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Louisiana Secretary of State and obtain any required New Orleans business licenses or permits.',
    additionalNotes: 'Check with the City of New Orleans for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Port of New Orleans and cruise terminals',
      'Ochsner Medical Center and Tulane Medical Center',
      'Louis Armstrong New Orleans International Airport',
      'Tulane University and Loyola University',
      'French Quarter and tourism industry',
      'Avondale Shipyards',
      'Ernest N. Morial Convention Center',
      'Downtown New Orleans CBD and hotels'
  ]
