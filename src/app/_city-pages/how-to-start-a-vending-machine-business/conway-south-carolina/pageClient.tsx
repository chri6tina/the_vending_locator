...
export default function ConwaySouthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Conway.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required local business licenses in Conway.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Conway",
