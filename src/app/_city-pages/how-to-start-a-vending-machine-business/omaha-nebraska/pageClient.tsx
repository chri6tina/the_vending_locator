...
export default function OmahaNebraskaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Nebraska requires a sales tax permit. Register your business and collect/remit tax on vending sales. Omaha may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Douglas County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Nebraska Secretary of State and obtain any required Omaha business licenses or permits.',
    additionalNotes: 'Check with the City of Omaha for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Berkshire Hathaway and Union Pacific Railroad headquarters',
      'Offutt Air Force Base (Bellevue)',
      'Nebraska Medicine and CHI Health hospitals',
      'Eppley Airfield',
      'University of Nebraska Medical Center',
      'TD Ameritrade Park and CHI Health Center',
      'Mutual of Omaha headquarters',
      'PayPal and LinkedIn operations centers'
  ]
