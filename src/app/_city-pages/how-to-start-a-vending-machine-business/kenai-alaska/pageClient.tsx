...
export default function KenaiAlaskaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Alaska requires a sales tax permit. Register your business and collect/remit tax on vending sales. Kenai may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Kenai County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Alaska Secretary of State and obtain any required Kenai business licenses or permits.',
    additionalNotes: 'Check with the City of Kenai for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Kenai Hospital and medical facilities',
    'Downtown Kenai office buildings and businesses',
    'Kenai school district and educational facilities',
    'Kenai municipal and county government buildings',
