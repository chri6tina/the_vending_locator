...
export default function MarshallTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Marshall may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Marshall.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Marshall business licenses or permits.",
  "additionalNotes": "Check with the City of Marshall for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Marshall Hospital and medical facilities",
  "Downtown Marshall office buildings and businesses",
  "Marshall school district and educational facilities",
  "Marshall municipal and county government buildings",
