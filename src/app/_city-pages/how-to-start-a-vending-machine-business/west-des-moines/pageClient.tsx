...
export default function WestDesMoinesIowaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Iowa requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. West Des Moines may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in West Des Moines.",
  "businessLicense": "Register your LLC with the Iowa Secretary of State and obtain any required West Des Moines business licenses or permits.",
  "additionalNotes": "Check with the City of West Des Moines for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "West Des Moines Hospital and medical facilities",
  "Downtown West Des Moines office buildings and businesses",
  "West Des Moines school district and educational facilities",
  "West Des Moines municipal and county government buildings",
