...
export default function AustinTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Austin may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Travis County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required Austin business licenses or permits.',
    additionalNotes: 'Check with the City of Austin for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Texas State Capitol and government offices',
      'University of Texas at Austin (51,000 students)',
      'Dell Technologies headquarters (Round Rock)',
      'Apple, Google, Meta, Tesla Austin campuses',
      'Austin-Bergstrom International Airport',
      'St. David\'s HealthCare and Ascension Seton',
      'Domain and downtown tech corridor',
      'South by Southwest (SXSW) and Austin Convention Center'
  ]
