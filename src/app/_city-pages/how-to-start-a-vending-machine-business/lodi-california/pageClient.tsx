...
export default function LodiCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Lodi also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Lodi.',
    additionalNotes: 'Some locations like the Port of Lodi or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Lodi Port facilities and logistics operations',
      'Naval Air Station Lodi and military contractors',
      ...
      'Lodi Beach and coastal tourism areas',
