...
export default function HudsonNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hudson may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Hudson.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Hudson business licenses or permits.",
  "additionalNotes": "Check with the City of Hudson for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Hudson Hospital and medical facilities",
  "Downtown Hudson office buildings and businesses",
  "Hudson school district and educational facilities",
  "Hudson municipal and county government buildings",
