...
export default function MontpelierVermontHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Vermont requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Montpelier.",
  "businessLicense": "Register your LLC with the Vermont Secretary of State and obtain any required local business licenses in Montpelier.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Montpelier",
