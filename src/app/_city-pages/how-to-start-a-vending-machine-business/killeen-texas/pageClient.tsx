...
export default function KilleenTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Killeen may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Killeen County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required Killeen business licenses or permits.',
    additionalNotes: 'Check with the City of Killeen for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Killeen Hospital and medical facilities',
    'Downtown Killeen office buildings and businesses',
    'Killeen school district and educational facilities',
    'Fort Hood (Fort Cavazos) Army installation',
