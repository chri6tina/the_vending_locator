...
export default function HarahanLouisianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Harahan.",
  "businessLicense": "Register your LLC with the Louisiana Secretary of State and obtain any required local business licenses in Harahan.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Harahan",
