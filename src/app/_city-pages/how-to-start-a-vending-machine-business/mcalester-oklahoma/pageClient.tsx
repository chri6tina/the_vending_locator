...
export default function McAlesterOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. McAlester may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in McAlester.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required McAlester business licenses or permits.",
  "additionalNotes": "Check with the City of McAlester for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "McAlester Hospital and medical facilities",
  "Downtown McAlester office buildings and businesses",
  "McAlester school district and educational facilities",
  "McAlester municipal and county government buildings",
