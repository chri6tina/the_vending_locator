...
export default function OneidaNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Oneida may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Oneida.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Oneida business licenses or permits.",
  "additionalNotes": "Check with the City of Oneida for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Oneida Hospital and medical facilities",
  "Downtown Oneida office buildings and businesses",
  "Oneida school district and educational facilities",
  "Oneida municipal and county government buildings",
