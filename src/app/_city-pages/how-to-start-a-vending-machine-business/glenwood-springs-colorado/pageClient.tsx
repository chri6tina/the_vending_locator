...
export default function GlenwoodSpringsColoradoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Glenwood Springs.",
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in Glenwood Springs.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Glenwood Springs",
