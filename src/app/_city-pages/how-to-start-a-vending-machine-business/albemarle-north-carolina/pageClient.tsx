...
export default function AlbemarleNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Albemarle may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Albemarle.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Albemarle business licenses or permits.",
  "additionalNotes": "Check with the City of Albemarle for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Albemarle Hospital and medical facilities",
  "Downtown Albemarle office buildings and businesses",
  "Albemarle school district and educational facilities",
  "Albemarle municipal and county government buildings",
