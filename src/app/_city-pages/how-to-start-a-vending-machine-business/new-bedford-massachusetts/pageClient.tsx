...
export default function NewBedfordMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in New Bedford.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in New Bedford.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in New Bedford",
