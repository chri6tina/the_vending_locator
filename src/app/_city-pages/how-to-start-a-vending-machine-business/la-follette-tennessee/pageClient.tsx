...
export default function LaFolletteTennesseeHowToStartPage() {
  const cityDisplayName = 'La Follette'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. La Follette may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in La Follette.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required La Follette business licenses or permits.",
  "additionalNotes": "Check with the City of La Follette for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "La Follette Hospital and medical facilities",
  "Downtown La Follette office buildings and businesses",
  "La Follette school district and educational facilities",
  "La Follette municipal and county government buildings",
