...
export default function PlymouthMinnesotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Minnesota requires a sales tax permit. Register your business and collect/remit tax on vending sales. Plymouth may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Plymouth County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Minnesota Secretary of State and obtain any required Plymouth business licenses or permits.',
    additionalNotes: 'Check with the City of Plymouth for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Plymouth Hospital and medical facilities',
    'Downtown Plymouth office buildings and businesses',
    'Plymouth school district and educational facilities',
    'Plymouth municipal and county government buildings',
