...
export default function BarreVermontHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Barre.",
  "businessLicense": "Register your LLC with the Vermont Secretary of State and obtain any required local business licenses in Barre.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Barre",
