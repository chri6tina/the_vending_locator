...
export default function EdinburgTexasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Edinburg.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required local business licenses in Edinburg.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Edinburg",
