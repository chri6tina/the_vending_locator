...
export default function CarthageTexasHowToStartPage() {
  const cityDisplayName = 'Carthage'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Carthage may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Carthage.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Carthage business licenses or permits.",
  "additionalNotes": "Check with the City of Carthage for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Carthage Hospital and medical facilities",
  "Downtown Carthage office buildings and businesses",
  "Carthage school district and educational facilities",
  "Carthage municipal and county government buildings",
