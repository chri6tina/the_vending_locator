...
export default function AdaOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Ada may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Ada.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required Ada business licenses or permits.",
  "additionalNotes": "Check with the City of Ada for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Ada Hospital and medical facilities",
  "Downtown Ada office buildings and businesses",
  "Ada school district and educational facilities",
  "Ada municipal and county government buildings",
