...
export default function WinterParkFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Winter Park.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Winter Park.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Winter Park",
