...
export default function DuncanOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Duncan may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Duncan.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required Duncan business licenses or permits.",
  "additionalNotes": "Check with the City of Duncan for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Duncan Hospital and medical facilities",
  "Downtown Duncan office buildings and businesses",
  "Duncan school district and educational facilities",
  "Duncan municipal and county government buildings",
