...
export default function ShelbyvilleTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Shelbyville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Shelbyville.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Shelbyville business licenses or permits.",
  "additionalNotes": "Check with the City of Shelbyville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Shelbyville Hospital and medical facilities",
  "Downtown Shelbyville office buildings and businesses",
  "Shelbyville school district and educational facilities",
  "Shelbyville municipal and county government buildings",
