...
export default function EastLansingMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in East Lansing.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in East Lansing.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in East Lansing",
