...
export default function PecosTexasHowToStartPage() {
  const cityDisplayName = 'Pecos'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Pecos may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Pecos.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Pecos business licenses or permits.",
  "additionalNotes": "Check with the City of Pecos for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Pecos Hospital and medical facilities",
  "Downtown Pecos office buildings and businesses",
  "Pecos school district and educational facilities",
  "Pecos municipal and county government buildings",
