...
export default function SomersworthNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Hampshire requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Somersworth may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Somersworth.",
  "businessLicense": "Register your LLC with the New Hampshire Secretary of State and obtain any required Somersworth business licenses or permits.",
  "additionalNotes": "Check with the City of Somersworth for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Somersworth Hospital and medical facilities",
  "Downtown Somersworth office buildings and businesses",
  "Somersworth school district and educational facilities",
  "Somersworth municipal and county government buildings",
