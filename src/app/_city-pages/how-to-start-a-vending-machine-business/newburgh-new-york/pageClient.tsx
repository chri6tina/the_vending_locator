...
export default function NewburghNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Newburgh may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Newburgh.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Newburgh business licenses or permits.",
  "additionalNotes": "Check with the City of Newburgh for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Newburgh Hospital and medical facilities",
  "Downtown Newburgh office buildings and businesses",
  "Newburgh school district and educational facilities",
  "Newburgh municipal and county government buildings",
