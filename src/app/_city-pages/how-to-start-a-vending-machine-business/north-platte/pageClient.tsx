...
export default function NorthPlatteNebraskaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Nebraska requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. North Platte may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in North Platte.",
  "businessLicense": "Register your LLC with the Nebraska Secretary of State and obtain any required North Platte business licenses or permits.",
  "additionalNotes": "Check with the City of North Platte for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "North Platte Hospital and medical facilities",
  "Downtown North Platte office buildings and businesses",
  "North Platte school district and educational facilities",
  "North Platte municipal and county government buildings",
