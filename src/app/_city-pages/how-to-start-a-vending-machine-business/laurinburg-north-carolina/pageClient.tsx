...
export default function LaurinburgNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Laurinburg may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Laurinburg.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Laurinburg business licenses or permits.",
  "additionalNotes": "Check with the City of Laurinburg for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Laurinburg Hospital and medical facilities",
  "Downtown Laurinburg office buildings and businesses",
  "Laurinburg school district and educational facilities",
  "Laurinburg municipal and county government buildings",
