...
export default function FloridaCityFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Florida City.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Florida City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Florida City",
