...
export default function BeaufortSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Beaufort'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Beaufort may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Beaufort.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Beaufort business licenses or permits.",
  "additionalNotes": "Check with the City of Beaufort for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Beaufort Hospital and medical facilities",
  "Downtown Beaufort office buildings and businesses",
  "Beaufort school district and educational facilities",
  "Beaufort municipal and county government buildings",
