...
export default function HelenaMontanaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Montana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Helena may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Helena County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Montana Secretary of State and obtain any required Helena business licenses or permits.',
    additionalNotes: 'Check with the City of Helena for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Helena Hospital and medical facilities',
    'Downtown Helena office buildings and businesses',
    'Helena school district and educational facilities',
    'Montana state government offices and capitol complex',
    ...
    'Helena Airport and related businesses'
  ]
