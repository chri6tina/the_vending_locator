...
export default function HornellNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hornell may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Hornell.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Hornell business licenses or permits.",
  "additionalNotes": "Check with the City of Hornell for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Hornell Hospital and medical facilities",
  "Downtown Hornell office buildings and businesses",
  "Hornell school district and educational facilities",
  "Hornell municipal and county government buildings",
