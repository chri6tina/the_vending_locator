...
export default function BurlingtonNorthCarolinaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Burlington.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required local business licenses in Burlington.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Burlington",
