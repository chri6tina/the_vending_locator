...
export default function HornLakeMississippiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Horn Lake.",
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required local business licenses in Horn Lake.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Horn Lake",
