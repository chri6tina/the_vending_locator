...
export default function SocorroNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Socorro may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Socorro.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Socorro business licenses or permits.",
  "additionalNotes": "Check with the City of Socorro for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Socorro Hospital and medical facilities",
  "Downtown Socorro office buildings and businesses",
  "Socorro school district and educational facilities",
  "Socorro municipal and county government buildings",
