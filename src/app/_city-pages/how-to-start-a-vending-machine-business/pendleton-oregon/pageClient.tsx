...
export default function PendletonOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Pendleton may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Pendleton.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Pendleton business licenses or permits.",
  "additionalNotes": "Check with the City of Pendleton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Pendleton Hospital and medical facilities",
  "Downtown Pendleton office buildings and businesses",
  "Pendleton school district and educational facilities",
  "Pendleton municipal and county government buildings",
