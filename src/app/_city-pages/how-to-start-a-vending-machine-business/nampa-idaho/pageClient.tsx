...
export default function NampaIdahoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Idaho requires a sales tax permit. Register your business and collect/remit tax on vending sales. Nampa may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Nampa County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Idaho Secretary of State and obtain any required Nampa business licenses or permits.',
    additionalNotes: 'Check with the City of Nampa for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Nampa Hospital and medical facilities',
    'Downtown Nampa office buildings and businesses',
    'Nampa school district and educational facilities',
    'Nampa municipal and county government buildings',
