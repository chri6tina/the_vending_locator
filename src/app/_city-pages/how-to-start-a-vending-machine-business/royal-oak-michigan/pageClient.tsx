...
export default function RoyalOakMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Royal Oak.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Royal Oak.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Royal Oak",
