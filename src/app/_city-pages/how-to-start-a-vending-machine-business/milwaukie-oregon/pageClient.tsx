...
export default function MilwaukieOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Milwaukie may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Milwaukie.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Milwaukie business licenses or permits.",
  "additionalNotes": "Check with the City of Milwaukie for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Milwaukie Hospital and medical facilities",
  "Downtown Milwaukie office buildings and businesses",
  "Milwaukie school district and educational facilities",
  "Milwaukie municipal and county government buildings",
