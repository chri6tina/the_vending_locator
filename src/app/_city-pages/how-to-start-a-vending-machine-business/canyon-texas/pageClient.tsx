...
export default function CanyonTexasHowToStartPage() {
  const cityDisplayName = 'Canyon'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Canyon may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Canyon.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Canyon business licenses or permits.",
  "additionalNotes": "Check with the City of Canyon for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Canyon Hospital and medical facilities",
  "Downtown Canyon office buildings and businesses",
  "Canyon school district and educational facilities",
  "Canyon municipal and county government buildings",
