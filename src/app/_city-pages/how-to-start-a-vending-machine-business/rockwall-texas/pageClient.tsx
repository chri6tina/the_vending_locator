...
export default function RockwallTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Rockwall may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Rockwall.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Rockwall business licenses or permits.",
  "additionalNotes": "Check with the City of Rockwall for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Rockwall Hospital and medical facilities",
  "Downtown Rockwall office buildings and businesses",
  "Rockwall school district and educational facilities",
  "Rockwall municipal and county government buildings",
