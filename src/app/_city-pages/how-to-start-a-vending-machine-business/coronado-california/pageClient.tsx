...
export default function CoronadoCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Coronado.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Coronado.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Coronado",
