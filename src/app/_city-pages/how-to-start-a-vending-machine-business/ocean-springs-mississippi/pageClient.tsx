...
export default function OceanSpringsMississippiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Ocean Springs.",
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required local business licenses in Ocean Springs.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Ocean Springs",
