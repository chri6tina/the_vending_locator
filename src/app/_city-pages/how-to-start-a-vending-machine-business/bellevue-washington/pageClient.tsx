...
export default function BellevueWashingtonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington requires a sales tax permit. Register your business and collect/remit tax on vending sales. Bellevue may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Washington Secretary of State and obtain any required Bellevue business licenses or permits.',
