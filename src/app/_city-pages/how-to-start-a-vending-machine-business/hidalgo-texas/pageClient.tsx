...
export default function HidalgoTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hidalgo may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Hidalgo.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Hidalgo business licenses or permits.",
  "additionalNotes": "Check with the City of Hidalgo for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Hidalgo Hospital and medical facilities",
  "Downtown Hidalgo office buildings and businesses",
  "Hidalgo school district and educational facilities",
  "Hidalgo municipal and county government buildings",
