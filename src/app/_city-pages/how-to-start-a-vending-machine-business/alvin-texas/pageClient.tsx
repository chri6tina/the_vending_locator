...
export default function AlvinTexasHowToStartPage() {
  const cityDisplayName = 'Alvin'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Alvin may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Alvin.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Alvin business licenses or permits.",
  "additionalNotes": "Check with the City of Alvin for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Alvin Hospital and medical facilities",
  "Downtown Alvin office buildings and businesses",
  "Alvin school district and educational facilities",
  "Alvin municipal and county government buildings",
