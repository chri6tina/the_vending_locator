...
export default function TualatinOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Tualatin may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Tualatin.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Tualatin business licenses or permits.",
  "additionalNotes": "Check with the City of Tualatin for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Tualatin Hospital and medical facilities",
  "Downtown Tualatin office buildings and businesses",
  "Tualatin school district and educational facilities",
  "Tualatin municipal and county government buildings",
