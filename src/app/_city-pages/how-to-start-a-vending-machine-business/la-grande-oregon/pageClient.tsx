...
export default function LaGrandeOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. La Grande may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in La Grande.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required La Grande business licenses or permits.",
  "additionalNotes": "Check with the City of La Grande for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "La Grande Hospital and medical facilities",
  "Downtown La Grande office buildings and businesses",
  "La Grande school district and educational facilities",
  "La Grande municipal and county government buildings",
