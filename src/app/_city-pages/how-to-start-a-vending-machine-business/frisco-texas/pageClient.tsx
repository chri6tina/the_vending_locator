...
export default function FriscoTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Frisco may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Collin and Denton Counties Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required Frisco business licenses or permits.',
    additionalNotes: 'Check with the City of Frisco for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'The Star (Dallas Cowboys headquarters and Ford Center)',
      'PGA of America headquarters and Omni PGA Frisco Resort',
      'Baylor Scott & White Medical Center - Frisco',
      'Medical City Frisco',
      'Frisco Independent School District',
      'T-Mobile Customer Experience Center',
      'Stonebriar Centre and retail corridor',
      'Dr Pepper Ballpark and sports venues'
  ]
