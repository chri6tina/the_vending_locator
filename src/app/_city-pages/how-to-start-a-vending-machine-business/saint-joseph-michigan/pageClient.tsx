...
export default function SaintJosephMichiganHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Saint Joseph.",
