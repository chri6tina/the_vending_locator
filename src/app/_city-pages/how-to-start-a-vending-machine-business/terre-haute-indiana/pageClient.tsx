...
export default function TerreHauteIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Terre Haute.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Terre Haute.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Terre Haute",
