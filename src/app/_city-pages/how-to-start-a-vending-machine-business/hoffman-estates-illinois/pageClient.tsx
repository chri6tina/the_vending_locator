...
export default function HoffmanEstatesIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Hoffman Estates.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Hoffman Estates.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Hoffman Estates",
