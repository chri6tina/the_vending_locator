...
export default function ThiefRiverFallsMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Thief River Falls.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Thief River Falls.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Thief River Falls",
