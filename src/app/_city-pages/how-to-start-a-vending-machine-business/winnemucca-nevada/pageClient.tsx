...
export default function WinnemuccaNevadaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Nevada requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Winnemucca may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Winnemucca.",
  "businessLicense": "Register your LLC with the Nevada Secretary of State and obtain any required Winnemucca business licenses or permits.",
  "additionalNotes": "Check with the City of Winnemucca for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Winnemucca Hospital and medical facilities",
  "Downtown Winnemucca office buildings and businesses",
  "Winnemucca school district and educational facilities",
  "Winnemucca municipal and county government buildings",
