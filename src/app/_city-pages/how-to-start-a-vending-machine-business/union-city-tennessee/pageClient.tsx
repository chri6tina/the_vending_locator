...
export default function UnionCityTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Union City may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Union City.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Union City business licenses or permits.",
  "additionalNotes": "Check with the City of Union City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Union City Hospital and medical facilities",
  "Downtown Union City office buildings and businesses",
  "Union City school district and educational facilities",
  "Union City municipal and county government buildings",
