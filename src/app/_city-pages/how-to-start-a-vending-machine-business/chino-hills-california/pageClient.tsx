...
export default function ChinoHillsCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Chino Hills.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Chino Hills.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Chino Hills",
