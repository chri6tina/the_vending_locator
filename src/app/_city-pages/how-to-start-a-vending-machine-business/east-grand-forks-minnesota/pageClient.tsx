...
export default function EastGrandForksMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in East Grand Forks.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in East Grand Forks.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in East Grand Forks",
