...
export default function LenexaKansasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Kansas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Lenexa may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Lenexa.",
  "businessLicense": "Register your LLC with the Kansas Secretary of State and obtain any required Lenexa business licenses or permits.",
  "additionalNotes": "Check with the City of Lenexa for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Lenexa Hospital and medical facilities",
  "Downtown Lenexa office buildings and businesses",
  "Lenexa school district and educational facilities",
  "Lenexa municipal and county government buildings",
