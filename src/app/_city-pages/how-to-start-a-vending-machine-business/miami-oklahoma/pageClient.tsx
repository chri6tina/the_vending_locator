...
export default function MiamiOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Miami may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Miami.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required Miami business licenses or permits.",
  ...
  const demandDrivers = [
  "Miami Hospital and medical facilities",
  "Downtown Miami office buildings and businesses",
  "Miami school district and educational facilities",
  "Miami municipal and county government buildings",
