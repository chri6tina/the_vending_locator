...
export default function PharrTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Pharr may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Pharr.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Pharr business licenses or permits.",
  "additionalNotes": "Check with the City of Pharr for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Pharr Hospital and medical facilities",
  "Downtown Pharr office buildings and businesses",
  "Pharr school district and educational facilities",
  "Pharr municipal and county government buildings",
