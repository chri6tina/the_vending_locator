...
export default function WoodburnOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Woodburn may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Woodburn.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Woodburn business licenses or permits.",
  "additionalNotes": "Check with the City of Woodburn for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Woodburn Hospital and medical facilities",
  "Downtown Woodburn office buildings and businesses",
  "Woodburn school district and educational facilities",
  "Woodburn municipal and county government buildings",
