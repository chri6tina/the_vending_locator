...
export default function EastHavenConnecticutHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in East Haven.",
  "businessLicense": "Register your LLC with the Connecticut Secretary of State and obtain any required local business licenses in East Haven.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in East Haven",
