...
export default function CranfordNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Cranford may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Cranford.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Cranford business licenses or permits.",
  "additionalNotes": "Check with the City of Cranford for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Cranford Hospital and medical facilities",
  "Downtown Cranford office buildings and businesses",
  "Cranford school district and educational facilities",
  "Cranford municipal and county government buildings",
