...
export default function PeachtreeCornersGeorgiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Georgia requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Peachtree Corners.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Peachtree Corners.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Peachtree Corners",
