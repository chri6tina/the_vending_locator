...
export default function MaryvilleTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Maryville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Maryville.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Maryville business licenses or permits.",
  "additionalNotes": "Check with the City of Maryville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Maryville Hospital and medical facilities",
  "Downtown Maryville office buildings and businesses",
  "Maryville school district and educational facilities",
  "Maryville municipal and county government buildings",
