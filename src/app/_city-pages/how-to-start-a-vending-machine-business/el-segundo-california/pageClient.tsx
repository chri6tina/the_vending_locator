...
export default function ElSegundoCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in El Segundo.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in El Segundo.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in El Segundo",
