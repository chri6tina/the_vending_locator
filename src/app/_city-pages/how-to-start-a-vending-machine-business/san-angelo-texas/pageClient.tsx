...
export default function SanAngeloTexasHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required local business licenses in San Angelo.",
