...
export default function BoulderColoradoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Colorado requires a sales tax permit. Register your business and collect/remit tax on vending sales. Boulder may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Boulder County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Colorado Secretary of State and obtain any required Boulder business licenses or permits.',
    additionalNotes: 'Check with the City of Boulder for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Boulder Hospital and medical facilities',
    'Downtown Boulder office buildings and businesses',
    'University of Colorado campus and facilities',
    'Boulder municipal and county government buildings',
    'Tech companies and innovation centers',
