...
export default function HobartIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Hobart.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Hobart.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Hobart",
