...
export default function PinevilleNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Pineville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Pineville.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Pineville business licenses or permits.",
  "additionalNotes": "Check with the City of Pineville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Pineville Hospital and medical facilities",
  "Downtown Pineville office buildings and businesses",
  "Pineville school district and educational facilities",
  "Pineville municipal and county government buildings",
