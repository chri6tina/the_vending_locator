...
export default function YeringtonNevadaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Nevada requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Yerington may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Yerington.",
  "businessLicense": "Register your LLC with the Nevada Secretary of State and obtain any required Yerington business licenses or permits.",
  "additionalNotes": "Check with the City of Yerington for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Yerington Hospital and medical facilities",
  "Downtown Yerington office buildings and businesses",
  "Yerington school district and educational facilities",
  "Yerington municipal and county government buildings",
