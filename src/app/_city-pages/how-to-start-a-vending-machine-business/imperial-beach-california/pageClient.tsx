...
export default function ImperialBeachCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Imperial Beach.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Imperial Beach.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Imperial Beach",
