...
export default function TruthorConsequencesNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Truth or Consequences may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Truth or Consequences.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Truth or Consequences business licenses or permits.",
  "additionalNotes": "Check with the City of Truth or Consequences for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Truth or Consequences Hospital and medical facilities",
  "Downtown Truth or Consequences office buildings and businesses",
  "Truth or Consequences school district and educational facilities",
  "Truth or Consequences municipal and county government buildings",
