...
export default function MayfieldKentuckyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mayfield.",
  "businessLicense": "Register your LLC with the Kentucky Secretary of State and obtain any required local business licenses in Mayfield.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mayfield",
