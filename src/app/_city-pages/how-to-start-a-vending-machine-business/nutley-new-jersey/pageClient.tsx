...
export default function NutleyNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Nutley may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Nutley.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Nutley business licenses or permits.",
  "additionalNotes": "Check with the City of Nutley for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Nutley Hospital and medical facilities",
  "Downtown Nutley office buildings and businesses",
  "Nutley school district and educational facilities",
  "Nutley municipal and county government buildings",
