...
export default function VenturaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Ventura may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Ventura County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Ventura business licenses or permits.',
    additionalNotes: 'Check with the City of Ventura for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Ventura Hospital and medical facilities',
    'Downtown Ventura office buildings and businesses',
    'Ventura school district and educational facilities',
    'Ventura municipal and county government buildings',
