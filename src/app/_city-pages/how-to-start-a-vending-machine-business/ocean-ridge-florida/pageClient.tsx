...
export default function OceanRidgeFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Ocean Ridge.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Ocean Ridge.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Ocean Ridge",
