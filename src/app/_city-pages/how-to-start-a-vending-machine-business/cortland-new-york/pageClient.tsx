...
export default function CortlandNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Cortland may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Cortland.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Cortland business licenses or permits.",
  "additionalNotes": "Check with the City of Cortland for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Cortland Hospital and medical facilities",
  "Downtown Cortland office buildings and businesses",
  "Cortland school district and educational facilities",
  "Cortland municipal and county government buildings",
