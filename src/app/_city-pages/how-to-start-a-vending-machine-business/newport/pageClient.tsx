...
export default function NewportRhodeIslandHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Rhode Island requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Newport may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Newport.",
  "businessLicense": "Register your LLC with the Rhode Island Secretary of State and obtain any required Newport business licenses or permits.",
  "additionalNotes": "Check with the City of Newport for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Newport Hospital and medical facilities",
  "Downtown Newport office buildings and businesses",
  "Newport school district and educational facilities",
  "Newport municipal and county government buildings",
