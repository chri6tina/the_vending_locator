...
export default function DurhamNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Hampshire requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Durham may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Durham.",
  "businessLicense": "Register your LLC with the New Hampshire Secretary of State and obtain any required Durham business licenses or permits.",
  "additionalNotes": "Check with the City of Durham for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Durham Hospital and medical facilities",
  "Downtown Durham office buildings and businesses",
  "Durham school district and educational facilities",
  "Durham municipal and county government buildings",
