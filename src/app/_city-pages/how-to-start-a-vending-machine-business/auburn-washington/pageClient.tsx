...
export default function AuburnWashingtonHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Auburn.",
  "businessLicense": "Register your LLC with the Washington Secretary of State and obtain any required local business licenses in Auburn.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Auburn",
