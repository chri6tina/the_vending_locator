...
export default function SanGabrielCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in San Gabriel.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in San Gabriel.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in San Gabriel",
