...
export default function FortLeeNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Fort Lee may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Fort Lee.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Fort Lee business licenses or permits.",
  "additionalNotes": "Check with the City of Fort Lee for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Fort Lee Hospital and medical facilities",
  "Downtown Fort Lee office buildings and businesses",
  "Fort Lee school district and educational facilities",
  "Fort Lee municipal and county government buildings",
