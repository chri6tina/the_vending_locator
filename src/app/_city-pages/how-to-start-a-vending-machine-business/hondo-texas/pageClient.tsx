...
export default function HondoTexasHowToStartPage() {
  const cityDisplayName = 'Hondo'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hondo may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Hondo.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Hondo business licenses or permits.",
  "additionalNotes": "Check with the City of Hondo for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Hondo Hospital and medical facilities",
  "Downtown Hondo office buildings and businesses",
  "Hondo school district and educational facilities",
  "Hondo municipal and county government buildings",
