...
export default function SoldotnaAlaskaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Alaska requires a sales tax permit. Register your business and collect/remit tax on vending sales. Soldotna may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Soldotna County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Alaska Secretary of State and obtain any required Soldotna business licenses or permits.',
    additionalNotes: 'Check with the City of Soldotna for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Soldotna Hospital and medical facilities',
    'Downtown Soldotna office buildings and businesses',
    'Soldotna school district and educational facilities',
    'Soldotna municipal and county government buildings',
