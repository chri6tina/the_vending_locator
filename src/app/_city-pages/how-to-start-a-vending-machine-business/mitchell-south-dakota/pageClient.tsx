...
export default function MitchellSouthDakotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "South Dakota requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mitchell.",
  "businessLicense": "Register your LLC with the South Dakota Secretary of State and obtain any required local business licenses in Mitchell.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mitchell",
