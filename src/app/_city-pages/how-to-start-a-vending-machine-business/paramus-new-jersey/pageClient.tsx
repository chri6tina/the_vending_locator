...
export default function ParamusNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Paramus may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Paramus.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Paramus business licenses or permits.",
  "additionalNotes": "Check with the City of Paramus for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Paramus Hospital and medical facilities",
  "Downtown Paramus office buildings and businesses",
  "Paramus school district and educational facilities",
  "Paramus municipal and county government buildings",
