...
export default function PlanoTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Plano may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Collin County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required Plano business licenses or permits.',
    additionalNotes: 'Check with the City of Plano for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }
  ...
  const demandDrivers = [
      ...
      'Legacy West and The Shops at Legacy',
      'Texas Instruments facilities (Richardson nearby)',
      'Dr Pepper corporate offices'
  ]
