...
export default function ZeelandMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Zeeland.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Zeeland.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Zeeland",
