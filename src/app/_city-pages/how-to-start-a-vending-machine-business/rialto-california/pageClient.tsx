...
export default function RialtoCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Rialto may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Rialto County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Rialto business licenses or permits.',
    additionalNotes: 'Check with the City of Rialto for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Rialto Hospital and medical facilities',
    'Downtown Rialto office buildings and businesses',
    'Rialto school district and educational facilities',
    'Rialto municipal and county government buildings',
