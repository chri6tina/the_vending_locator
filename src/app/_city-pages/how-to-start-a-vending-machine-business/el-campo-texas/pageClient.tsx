...
export default function ElCampoTexasHowToStartPage() {
  const cityDisplayName = 'El Campo'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. El Campo may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in El Campo.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required El Campo business licenses or permits.",
  "additionalNotes": "Check with the City of El Campo for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "El Campo Hospital and medical facilities",
  "Downtown El Campo office buildings and businesses",
  "El Campo school district and educational facilities",
  "El Campo municipal and county government buildings",
