...
export default function SouthPortlandMaineHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Maine requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in South Portland.",
  "businessLicense": "Register your LLC with the Maine Secretary of State and obtain any required local business licenses in South Portland.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in South Portland",
