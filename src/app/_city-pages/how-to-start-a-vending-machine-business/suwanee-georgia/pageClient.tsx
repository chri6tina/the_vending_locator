...
export default function SuwaneeGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Suwanee.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Suwanee.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Suwanee",
