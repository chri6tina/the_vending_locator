...
export default function MaryEstherFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mary Esther.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Mary Esther.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mary Esther",
