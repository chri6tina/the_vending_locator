...
export default function SturgisSouthDakotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "South Dakota requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Sturgis may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Sturgis.",
  "businessLicense": "Register your LLC with the South Dakota Secretary of State and obtain any required Sturgis business licenses or permits.",
  "additionalNotes": "Check with the City of Sturgis for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Sturgis Hospital and medical facilities",
  "Downtown Sturgis office buildings and businesses",
  "Sturgis school district and educational facilities",
  "Sturgis municipal and county government buildings",
