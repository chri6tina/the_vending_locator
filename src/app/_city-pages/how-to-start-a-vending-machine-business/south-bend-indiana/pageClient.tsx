...
export default function SouthBendIndianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Indiana requires a sales tax permit. Register your business and collect/remit tax on vending sales. South Bend may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the South Bend County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Indiana Secretary of State and obtain any required South Bend business licenses or permits.',
    additionalNotes: 'Check with the City of South Bend for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'South Bend Hospital and medical facilities',
    'Downtown South Bend office buildings and businesses',
    'South Bend school district and educational facilities',
    'South Bend municipal and county government buildings',
    'Manufacturing facilities and industrial parks in South Bend',
