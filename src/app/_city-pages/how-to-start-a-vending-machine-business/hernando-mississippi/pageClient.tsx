...
export default function HernandoMississippiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Hernando.",
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required local business licenses in Hernando.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Hernando",
