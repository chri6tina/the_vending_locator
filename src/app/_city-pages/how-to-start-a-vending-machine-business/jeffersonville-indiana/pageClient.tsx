...
export default function JeffersonvilleIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Jeffersonville.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Jeffersonville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Jeffersonville",
