...
export default function WalterboroSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Walterboro'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Walterboro may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Walterboro.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Walterboro business licenses or permits.",
  "additionalNotes": "Check with the City of Walterboro for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Walterboro Hospital and medical facilities",
  "Downtown Walterboro office buildings and businesses",
  "Walterboro school district and educational facilities",
  "Walterboro municipal and county government buildings",
