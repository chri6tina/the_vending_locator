...
export default function SedonaArizonaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Sedona.",
  "businessLicense": "Register your LLC with the Arizona Secretary of State and obtain any required local business licenses in Sedona.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Sedona",
