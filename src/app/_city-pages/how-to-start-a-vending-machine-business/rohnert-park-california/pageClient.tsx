...
export default function RohnertParkCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rohnert Park.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Rohnert Park.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rohnert Park",
