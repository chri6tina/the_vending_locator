...
export default function KailuaHawaiiHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Hawaii requires a sales tax permit. Register your business and collect/remit tax on vending sales. Kailua may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Kailua County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Hawaii Secretary of State and obtain any required Kailua business licenses or permits.',
    additionalNotes: 'Check with the City of Kailua for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Kailua Hospital and medical facilities',
    'Downtown Kailua office buildings and businesses',
    'Kailua school district and educational facilities',
    'Kailua municipal and county government buildings',
