...
export default function SanJoseCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. San Jose may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Santa Clara County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required San Jose business licenses or permits.',
    additionalNotes: 'Check with the City of San Jose for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Apple Park (Cupertino) and tech headquarters',
      'Cisco Systems, Adobe, and eBay campuses',
      'San Jose International Airport (Mineta)',
      'Stanford University and medical facilities (Palo Alto)',
      'Google headquarters (Mountain View)',
      'Santa Clara Valley Medical Center',
      'San Jose State University',
      'Downtown San Jose and SAP Center'
  ]
