...
export default function ChalmetteLouisianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Chalmette.",
  "businessLicense": "Register your LLC with the Louisiana Secretary of State and obtain any required local business licenses in Chalmette.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Chalmette",
