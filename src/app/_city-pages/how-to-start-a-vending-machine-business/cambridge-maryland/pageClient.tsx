...
export default function CambridgeMarylandHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Cambridge.",
  "businessLicense": "Register your LLC with the Maryland Secretary of State and obtain any required local business licenses in Cambridge.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Cambridge",
