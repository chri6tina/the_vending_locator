...
export default function PalmShoresFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Palm Shores.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Palm Shores.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Palm Shores",
