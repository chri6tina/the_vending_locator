...
export default function ElCerritoCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in El Cerrito.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in El Cerrito.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in El Cerrito",
