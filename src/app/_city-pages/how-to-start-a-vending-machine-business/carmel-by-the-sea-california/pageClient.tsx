...
export default function CarmelbytheSeaCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Carmel-by-the-Sea.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Carmel-by-the-Sea.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Carmel-by-the-Sea",
