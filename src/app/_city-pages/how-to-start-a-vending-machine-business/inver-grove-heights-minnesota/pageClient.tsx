...
export default function InverGroveHeightsMinnesotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Minnesota requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Inver Grove Heights.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Inver Grove Heights.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Inver Grove Heights",
