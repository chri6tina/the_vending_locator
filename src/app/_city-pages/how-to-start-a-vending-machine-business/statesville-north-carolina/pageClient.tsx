...
export default function StatesvilleNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Statesville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Statesville.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Statesville business licenses or permits.",
  "additionalNotes": "Check with the City of Statesville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Statesville Hospital and medical facilities",
  "Downtown Statesville office buildings and businesses",
  "Statesville school district and educational facilities",
  "Statesville municipal and county government buildings",
