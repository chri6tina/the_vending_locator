...
export default function FranklinNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Hampshire requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Franklin may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Franklin.",
  "businessLicense": "Register your LLC with the New Hampshire Secretary of State and obtain any required Franklin business licenses or permits.",
