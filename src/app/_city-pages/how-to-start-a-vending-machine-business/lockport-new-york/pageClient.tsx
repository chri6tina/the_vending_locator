...
export default function LockportNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Lockport may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Lockport.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Lockport business licenses or permits.",
  "additionalNotes": "Check with the City of Lockport for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Lockport Hospital and medical facilities",
  "Downtown Lockport office buildings and businesses",
  "Lockport school district and educational facilities",
  "Lockport municipal and county government buildings",
