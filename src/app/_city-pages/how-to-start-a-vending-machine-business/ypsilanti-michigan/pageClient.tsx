...
export default function YpsilantiMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Ypsilanti.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Ypsilanti.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Ypsilanti",
