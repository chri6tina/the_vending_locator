...
export default function SomervilleNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Somerville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Somerville.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Somerville business licenses or permits.",
  "additionalNotes": "Check with the City of Somerville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Somerville Hospital and medical facilities",
  "Downtown Somerville office buildings and businesses",
  "Somerville school district and educational facilities",
  "Somerville municipal and county government buildings",
