...
export default function OakRidgeTennesseeHowToStartPage() {
  const cityDisplayName = 'Oak Ridge'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Oak Ridge may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Oak Ridge.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Oak Ridge business licenses or permits.",
  "additionalNotes": "Check with the City of Oak Ridge for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Oak Ridge Hospital and medical facilities",
  "Downtown Oak Ridge office buildings and businesses",
  "Oak Ridge school district and educational facilities",
  "Oak Ridge municipal and county government buildings",
