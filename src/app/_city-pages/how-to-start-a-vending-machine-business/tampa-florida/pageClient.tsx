...
export default function TampaFloridaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Florida requires a sales tax permit. Register your business and collect/remit tax on vending sales. Tampa may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Hillsborough County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Florida Secretary of State and obtain any required Tampa business licenses or permits.',
    additionalNotes: 'Check with the City of Tampa for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'MacDill Air Force Base (CENTCOM and SOCOM)',
      'Tampa General Hospital and Moffitt Cancer Center',
      'Tampa International Airport (TPA)',
      'University of South Florida (50,000 students)',
      'Amalie Arena and Tampa Convention Center',
      'Port Tampa Bay',
