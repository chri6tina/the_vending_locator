...
export default function LimaOhioHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lima.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required local business licenses in Lima.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lima",
