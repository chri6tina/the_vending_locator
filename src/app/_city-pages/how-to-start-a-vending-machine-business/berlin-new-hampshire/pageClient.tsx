...
export default function BerlinNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Hampshire requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Berlin may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Berlin.",
  "businessLicense": "Register your LLC with the New Hampshire Secretary of State and obtain any required Berlin business licenses or permits.",
  "additionalNotes": "Check with the City of Berlin for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Berlin Hospital and medical facilities",
  "Downtown Berlin office buildings and businesses",
  "Berlin school district and educational facilities",
  "Berlin municipal and county government buildings",
