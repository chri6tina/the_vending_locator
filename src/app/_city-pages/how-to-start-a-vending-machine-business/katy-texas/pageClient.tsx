...
export default function KatyTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Katy may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Katy.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Katy business licenses or permits.",
  "additionalNotes": "Check with the City of Katy for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Katy Hospital and medical facilities",
  "Downtown Katy office buildings and businesses",
  "Katy school district and educational facilities",
  "Katy municipal and county government buildings",
