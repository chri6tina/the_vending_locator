...
export default function SalemOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Oregon requires a sales tax permit. Register your business and collect/remit tax on vending sales. Salem may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Salem County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Oregon Secretary of State and obtain any required Salem business licenses or permits.',
    additionalNotes: 'Check with the City of Salem for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Salem Hospital and medical facilities',
    'Downtown Salem office buildings and businesses',
    'Salem school district and educational facilities',
    'Oregon state government offices and capitol complex',
    ...
    'Salem Airport and related businesses'
  ]
