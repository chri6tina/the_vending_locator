...
export default function EdenPrairieMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Eden Prairie.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Eden Prairie.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Eden Prairie",
