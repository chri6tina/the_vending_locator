...
export default function WheelingIllinoisHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Illinois requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Wheeling may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Wheeling.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required Wheeling business licenses or permits.",
  "additionalNotes": "Check with the City of Wheeling for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Wheeling Hospital and medical facilities",
  "Downtown Wheeling office buildings and businesses",
  "Wheeling school district and educational facilities",
  "Wheeling municipal and county government buildings",
