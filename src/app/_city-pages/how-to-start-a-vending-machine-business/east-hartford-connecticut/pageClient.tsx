...
export default function EastHartfordConnecticutHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in East Hartford.",
  "businessLicense": "Register your LLC with the Connecticut Secretary of State and obtain any required local business licenses in East Hartford.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in East Hartford",
