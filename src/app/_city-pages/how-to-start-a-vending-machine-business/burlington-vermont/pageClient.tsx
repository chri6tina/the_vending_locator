...
export default function BurlingtonVermontHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Vermont requires a sales tax permit. Register your business and collect/remit tax on vending sales. Burlington may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Burlington County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Vermont Secretary of State and obtain any required Burlington business licenses or permits.',
    additionalNotes: 'Check with the City of Burlington for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Burlington Hospital and medical facilities',
    'Downtown Burlington office buildings and businesses',
    'Burlington school district and educational facilities',
    'Burlington municipal and county government buildings',
