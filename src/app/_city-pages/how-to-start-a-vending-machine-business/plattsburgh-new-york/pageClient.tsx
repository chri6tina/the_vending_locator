...
export default function PlattsburghNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Plattsburgh may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Plattsburgh.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Plattsburgh business licenses or permits.",
  "additionalNotes": "Check with the City of Plattsburgh for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Plattsburgh Hospital and medical facilities",
  "Downtown Plattsburgh office buildings and businesses",
  "Plattsburgh school district and educational facilities",
  "Plattsburgh municipal and county government buildings",
