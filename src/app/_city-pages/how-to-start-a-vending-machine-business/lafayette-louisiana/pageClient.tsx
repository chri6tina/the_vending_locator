...
export default function LafayetteLouisianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Louisiana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Lafayette may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Lafayette County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Louisiana Secretary of State and obtain any required Lafayette business licenses or permits.',
    additionalNotes: 'Check with the City of Lafayette for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Lafayette Hospital and medical facilities',
    'Downtown Lafayette office buildings and businesses',
    'Lafayette school district and educational facilities',
    'Lafayette municipal and county government buildings',
