...
export default function CarteretNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Carteret may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Carteret.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Carteret business licenses or permits.",
  "additionalNotes": "Check with the City of Carteret for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Carteret Hospital and medical facilities",
  "Downtown Carteret office buildings and businesses",
  "Carteret school district and educational facilities",
  "Carteret municipal and county government buildings",
