...
export default function RoselleIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Roselle.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Roselle.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Roselle",
