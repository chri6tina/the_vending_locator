...
export default function DemingNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Deming may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Deming.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Deming business licenses or permits.",
  "additionalNotes": "Check with the City of Deming for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Deming Hospital and medical facilities",
  "Downtown Deming office buildings and businesses",
  "Deming school district and educational facilities",
  "Deming municipal and county government buildings",
