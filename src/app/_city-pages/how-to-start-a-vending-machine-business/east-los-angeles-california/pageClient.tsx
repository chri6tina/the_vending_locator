...
export default function EastLosAngelesCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in East Los Angeles.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in East Los Angeles.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in East Los Angeles",
