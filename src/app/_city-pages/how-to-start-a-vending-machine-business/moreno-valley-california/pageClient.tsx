...
export default function MorenoValleyCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Moreno Valley may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Moreno Valley County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Moreno Valley business licenses or permits.',
    additionalNotes: 'Check with the City of Moreno Valley for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Moreno Valley Hospital and medical facilities',
    'Downtown Moreno Valley office buildings and businesses',
    'Moreno Valley school district and educational facilities',
    'Moreno Valley municipal and county government buildings',
