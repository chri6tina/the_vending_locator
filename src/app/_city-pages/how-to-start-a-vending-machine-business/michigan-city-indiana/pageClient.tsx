...
export default function MichiganCityIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Michigan City.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Michigan City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Michigan City",
