...
export default function RamseyNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Ramsey may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Ramsey.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Ramsey business licenses or permits.",
  "additionalNotes": "Check with the City of Ramsey for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Ramsey Hospital and medical facilities",
  "Downtown Ramsey office buildings and businesses",
  "Ramsey school district and educational facilities",
  "Ramsey municipal and county government buildings",
