...
export default function AztecNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Aztec may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Aztec.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Aztec business licenses or permits.",
  "additionalNotes": "Check with the City of Aztec for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Aztec Hospital and medical facilities",
  "Downtown Aztec office buildings and businesses",
  "Aztec school district and educational facilities",
  "Aztec municipal and county government buildings",
