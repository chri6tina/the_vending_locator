...
export default function JamestownNorthDakotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Dakota requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Jamestown.",
  "businessLicense": "Register your LLC with the North Dakota Secretary of State and obtain any required local business licenses in Jamestown.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Jamestown",
