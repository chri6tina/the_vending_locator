...
export default function MammothLakesCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mammoth Lakes.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Mammoth Lakes.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mammoth Lakes",
