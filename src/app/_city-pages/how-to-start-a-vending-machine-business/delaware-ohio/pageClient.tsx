...
export default function DelawareOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Delaware may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Delaware.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Delaware business licenses or permits.",
  "additionalNotes": "Check with the City of Delaware for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Delaware Hospital and medical facilities",
  "Downtown Delaware office buildings and businesses",
  "Delaware school district and educational facilities",
  "Delaware municipal and county government buildings",
