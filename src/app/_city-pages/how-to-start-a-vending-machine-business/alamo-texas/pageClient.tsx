...
export default function AlamoTexasHowToStartPage() {
  const cityDisplayName = 'Alamo'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Alamo may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Alamo.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Alamo business licenses or permits.",
  "additionalNotes": "Check with the City of Alamo for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Alamo Hospital and medical facilities",
  "Downtown Alamo office buildings and businesses",
  "Alamo school district and educational facilities",
  "Alamo municipal and county government buildings",
