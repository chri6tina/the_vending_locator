...
export default function GreatFallsMontanaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Montana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Great Falls may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Great Falls County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Montana Secretary of State and obtain any required Great Falls business licenses or permits.',
    additionalNotes: 'Check with the City of Great Falls for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Great Falls Hospital and medical facilities',
    'Downtown Great Falls office buildings and businesses',
    'Great Falls school district and educational facilities',
