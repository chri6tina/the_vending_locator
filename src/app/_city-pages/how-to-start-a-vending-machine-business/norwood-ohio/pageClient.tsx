...
export default function NorwoodOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Norwood may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Norwood.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Norwood business licenses or permits.",
  "additionalNotes": "Check with the City of Norwood for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Norwood Hospital and medical facilities",
  "Downtown Norwood office buildings and businesses",
  "Norwood school district and educational facilities",
  "Norwood municipal and county government buildings",
