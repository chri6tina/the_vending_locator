...
export default function JasperTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Jasper may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Jasper.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Jasper business licenses or permits.",
  "additionalNotes": "Check with the City of Jasper for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Jasper Hospital and medical facilities",
  "Downtown Jasper office buildings and businesses",
  "Jasper school district and educational facilities",
  "Jasper municipal and county government buildings",
