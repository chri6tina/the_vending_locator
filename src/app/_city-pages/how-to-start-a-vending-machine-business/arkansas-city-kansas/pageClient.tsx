...
export default function ArkansasCityMaineHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Arkansas City.",
  "businessLicense": "Register your LLC with the Maine Secretary of State and obtain any required local business licenses in Arkansas City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Arkansas City",
