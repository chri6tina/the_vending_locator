...
export default function SalinaKansasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Salina.",
  "businessLicense": "Register your LLC with the Kansas Secretary of State and obtain any required local business licenses in Salina.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Salina",
