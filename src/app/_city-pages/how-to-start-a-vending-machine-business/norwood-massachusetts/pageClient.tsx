...
export default function NorwoodMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Norwood.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Norwood.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Norwood",
