...
export default function NewUlmMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in New Ulm.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in New Ulm.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in New Ulm",
