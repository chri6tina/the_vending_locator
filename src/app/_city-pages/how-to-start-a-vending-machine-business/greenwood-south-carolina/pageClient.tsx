...
export default function GreenwoodSouthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Greenwood may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Greenwood.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Greenwood business licenses or permits.",
  "additionalNotes": "Check with the City of Greenwood for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Greenwood Hospital and medical facilities",
  "Downtown Greenwood office buildings and businesses",
  "Greenwood school district and educational facilities",
  "Greenwood municipal and county government buildings",
