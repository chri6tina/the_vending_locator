...
export default function BrookingsSouthDakotaHowToStartPage() {
  const cityDisplayName = 'Brookings'
  const stateDisplayName = 'South Dakota'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Dakota requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Brookings may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Brookings.",
  "businessLicense": "Register your LLC with the South Dakota Secretary of State and obtain any required Brookings business licenses or permits.",
  "additionalNotes": "Check with the City of Brookings for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Brookings Hospital and medical facilities",
  "Downtown Brookings office buildings and businesses",
  "Brookings school district and educational facilities",
  "Brookings municipal and county government buildings",
