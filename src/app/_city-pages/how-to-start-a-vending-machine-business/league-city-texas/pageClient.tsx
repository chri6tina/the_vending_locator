...
export default function LeagueCityTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. League City may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the League City County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required League City business licenses or permits.',
    additionalNotes: 'Check with the City of League City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'League City medical centers and healthcare facilities',
    'Downtown League City office buildings and businesses',
    'League City school district and educational facilities',
    'League City municipal and county government buildings',
