...
export default function IrvineCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Irvine may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Irvine business licenses or permits.',
    additionalNotes: 'Check with the City of Irvine for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'University of California, Irvine (36,000 students) and UCI Medical Center',
      'Irvine Spectrum Center and business parks',
      'John Wayne Airport (Orange County)',
      'Broadcom, Western Digital, and tech campuses',
      'Hoag Hospital Irvine',
      'Irvine Company offices',
