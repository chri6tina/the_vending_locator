...
export default function RanchoSantaMargaritaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "California requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rancho Santa Margarita.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Rancho Santa Margarita.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rancho Santa Margarita",
  ...
  const neighborhoods = [
  "Downtown Rancho Santa Margarita",
  "Business districts",
  "Industrial parks",
