...
export default function CarsonCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Carson may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Carson County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Carson business licenses or permits.',
    additionalNotes: 'Check with the City of Carson for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Carson Hospital and medical facilities',
    'Downtown Carson office buildings and businesses',
    'Carson school district and educational facilities',
    'Carson municipal and county government buildings',
