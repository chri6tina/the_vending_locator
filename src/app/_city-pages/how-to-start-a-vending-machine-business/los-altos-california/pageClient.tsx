...
export default function LosAltosCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Los Altos.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Los Altos.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Los Altos",
