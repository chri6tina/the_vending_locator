...
export default function YazooCityMississippiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Yazoo City.",
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required local business licenses in Yazoo City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Yazoo City",
