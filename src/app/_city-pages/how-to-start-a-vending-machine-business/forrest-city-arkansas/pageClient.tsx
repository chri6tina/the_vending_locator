...
export default function ForrestCityArkansasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Forrest City.",
  "businessLicense": "Register your LLC with the Arkansas Secretary of State and obtain any required local business licenses in Forrest City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Forrest City",
