...
export default function MililaniHawaiiHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Hawaii requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Mililani may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Mililani.",
  "businessLicense": "Register your LLC with the Hawaii Secretary of State and obtain any required Mililani business licenses or permits.",
  "additionalNotes": "Check with the City of Mililani for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Mililani Hospital and medical facilities",
  "Downtown Mililani office buildings and businesses",
  "Mililani school district and educational facilities",
  "Mililani municipal and county government buildings",
