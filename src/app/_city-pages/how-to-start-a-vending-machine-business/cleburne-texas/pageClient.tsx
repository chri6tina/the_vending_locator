...
export default function CleburneTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Cleburne may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Cleburne.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Cleburne business licenses or permits.",
  "additionalNotes": "Check with the City of Cleburne for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Cleburne Hospital and medical facilities",
  "Downtown Cleburne office buildings and businesses",
  "Cleburne school district and educational facilities",
  "Cleburne municipal and county government buildings",
