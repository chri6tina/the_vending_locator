...
export default function TroyAlabamaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Troy.",
  "businessLicense": "Register your LLC with the Alabama Secretary of State and obtain any required local business licenses in Troy.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Troy",
