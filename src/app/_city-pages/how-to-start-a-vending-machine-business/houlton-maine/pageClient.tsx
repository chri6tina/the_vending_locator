...
export default function HoultonMaineHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Houlton.",
  "businessLicense": "Register your LLC with the Maine Secretary of State and obtain any required local business licenses in Houlton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Houlton",
