...
export default function AthensGeorgiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Georgia requires a sales tax permit. Register your business and collect/remit tax on vending sales. Athens may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Athens County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Georgia Secretary of State and obtain any required Athens business licenses or permits.',
  ...
  const demandDrivers = [
    ...
    'University of Georgia campus and facilities',
