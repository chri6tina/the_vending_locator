...
export default function WarrensburgMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Warrensburg.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Warrensburg.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Warrensburg",
