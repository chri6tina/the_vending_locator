...
export default function MauldinSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Mauldin'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Mauldin may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Mauldin.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Mauldin business licenses or permits.",
  "additionalNotes": "Check with the City of Mauldin for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Mauldin Hospital and medical facilities",
  "Downtown Mauldin office buildings and businesses",
  "Mauldin school district and educational facilities",
  "Mauldin municipal and county government buildings",
