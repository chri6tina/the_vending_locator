...
export default function StathamGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Statham.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Statham.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Statham",
