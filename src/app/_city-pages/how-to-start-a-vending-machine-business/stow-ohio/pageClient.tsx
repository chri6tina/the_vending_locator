...
export default function StowOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Stow may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Stow.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Stow business licenses or permits.",
  "additionalNotes": "Check with the City of Stow for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Stow Hospital and medical facilities",
  "Downtown Stow office buildings and businesses",
  "Stow school district and educational facilities",
  "Stow municipal and county government buildings",
