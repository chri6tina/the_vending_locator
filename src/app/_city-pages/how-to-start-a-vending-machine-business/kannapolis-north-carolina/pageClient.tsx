...
export default function KannapolisNorthCarolinaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Kannapolis.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required local business licenses in Kannapolis.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Kannapolis",
