...
export default function SidneyMontanaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Sidney.",
  "businessLicense": "Register your LLC with the Montana Secretary of State and obtain any required local business licenses in Sidney.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Sidney",
