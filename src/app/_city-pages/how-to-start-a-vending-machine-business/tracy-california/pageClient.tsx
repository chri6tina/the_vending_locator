...
export default function TracyCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Tracy also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Tracy.',
    additionalNotes: 'Some locations like the Port of Tracy or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Tracy Port facilities and logistics operations',
      'Naval Air Station Tracy and military contractors',
      ...
      'Tracy Beach and coastal tourism areas',
