...
export default function AthensAlabamaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Athens.",
  "businessLicense": "Register your LLC with the Alabama Secretary of State and obtain any required local business licenses in Athens.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Athens",
