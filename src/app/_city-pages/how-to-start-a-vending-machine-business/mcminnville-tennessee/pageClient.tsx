...
export default function McMinnvilleTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. McMinnville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in McMinnville.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required McMinnville business licenses or permits.",
  "additionalNotes": "Check with the City of McMinnville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "McMinnville Hospital and medical facilities",
  "Downtown McMinnville office buildings and businesses",
  "McMinnville school district and educational facilities",
  "McMinnville municipal and county government buildings",
