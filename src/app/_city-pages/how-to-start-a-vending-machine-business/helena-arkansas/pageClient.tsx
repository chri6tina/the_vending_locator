...
export default function HelenaArkansasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Helena.",
  "businessLicense": "Register your LLC with the Arkansas Secretary of State and obtain any required local business licenses in Helena.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Helena",
