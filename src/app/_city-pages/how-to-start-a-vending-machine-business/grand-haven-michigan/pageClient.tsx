...
export default function GrandHavenMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Grand Haven.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Grand Haven.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Grand Haven",
