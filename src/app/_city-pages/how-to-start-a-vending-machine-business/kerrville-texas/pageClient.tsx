...
export default function KerrvilleTexasHowToStartPage() {
  const cityDisplayName = 'Kerrville'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Kerrville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Kerrville.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Kerrville business licenses or permits.",
  "additionalNotes": "Check with the City of Kerrville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Kerrville Hospital and medical facilities",
  "Downtown Kerrville office buildings and businesses",
  "Kerrville school district and educational facilities",
  "Kerrville municipal and county government buildings",
