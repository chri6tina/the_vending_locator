...
export default function CambridgeMassachusettsHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Massachusetts requires a sales tax permit. Register your business and collect/remit tax on vending sales. Cambridge may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Cambridge County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Massachusetts Secretary of State and obtain any required Cambridge business licenses or permits.',
    additionalNotes: 'Check with the City of Cambridge for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Cambridge Hospital and medical facilities',
    'Downtown Cambridge office buildings and businesses',
    'Cambridge school district and educational facilities',
    'Cambridge municipal and county government buildings',
