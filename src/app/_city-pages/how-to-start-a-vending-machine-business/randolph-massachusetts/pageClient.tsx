...
export default function RandolphMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Randolph.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Randolph.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Randolph",
