...
export default function MasonCityIowaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mason City.",
  "businessLicense": "Register your LLC with the Iowa Secretary of State and obtain any required local business licenses in Mason City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mason City",
