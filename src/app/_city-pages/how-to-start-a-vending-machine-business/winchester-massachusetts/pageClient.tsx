...
export default function WinchesterMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Winchester.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Winchester.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Winchester",
