...
export default function MoscowIdahoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Moscow.",
  "businessLicense": "Register your LLC with the Idaho Secretary of State and obtain any required local business licenses in Moscow.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Moscow",
