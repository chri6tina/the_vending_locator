...
export default function LosAlamosNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Los Alamos may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Los Alamos.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Los Alamos business licenses or permits.",
  "additionalNotes": "Check with the City of Los Alamos for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Los Alamos Hospital and medical facilities",
  "Downtown Los Alamos office buildings and businesses",
  "Los Alamos school district and educational facilities",
  "Los Alamos municipal and county government buildings",
