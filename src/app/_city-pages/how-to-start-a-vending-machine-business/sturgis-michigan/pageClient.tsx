...
export default function SturgisMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Sturgis.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Sturgis.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Sturgis",
