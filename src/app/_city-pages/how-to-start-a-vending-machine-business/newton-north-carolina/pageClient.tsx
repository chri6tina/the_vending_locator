...
export default function NewtonNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Newton may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Newton.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Newton business licenses or permits.",
  "additionalNotes": "Check with the City of Newton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Newton Hospital and medical facilities",
  "Downtown Newton office buildings and businesses",
  "Newton school district and educational facilities",
  "Newton municipal and county government buildings",
