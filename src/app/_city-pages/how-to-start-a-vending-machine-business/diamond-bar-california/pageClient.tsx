...
export default function DiamondBarCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Diamond Bar.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Diamond Bar.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Diamond Bar",
