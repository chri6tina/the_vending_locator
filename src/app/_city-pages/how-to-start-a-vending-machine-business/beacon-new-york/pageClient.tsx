...
export default function BeaconNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Beacon may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Beacon.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Beacon business licenses or permits.",
  "additionalNotes": "Check with the City of Beacon for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Beacon Hospital and medical facilities",
  "Downtown Beacon office buildings and businesses",
  "Beacon school district and educational facilities",
  "Beacon municipal and county government buildings",
