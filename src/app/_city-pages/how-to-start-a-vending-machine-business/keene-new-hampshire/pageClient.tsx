...
export default function KeeneNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Hampshire requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Keene may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Keene.",
  "businessLicense": "Register your LLC with the New Hampshire Secretary of State and obtain any required Keene business licenses or permits.",
  "additionalNotes": "Check with the City of Keene for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Keene Hospital and medical facilities",
  "Downtown Keene office buildings and businesses",
  "Keene school district and educational facilities",
  "Keene municipal and county government buildings",
