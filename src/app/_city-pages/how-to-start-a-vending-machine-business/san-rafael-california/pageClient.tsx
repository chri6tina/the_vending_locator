...
export default function SanRafaelCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. San Rafael also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of San Rafael.',
    additionalNotes: 'Some locations like the Port of San Rafael or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'San Rafael Port facilities and logistics operations',
      'Naval Air Station San Rafael and military contractors',
      ...
      'San Rafael Beach and coastal tourism areas',
