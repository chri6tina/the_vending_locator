...
export default function RanchoCordovaCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rancho Cordova.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Rancho Cordova.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rancho Cordova",
