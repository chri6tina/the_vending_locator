...
export default function GreenevilleTennesseeHowToStartPage() {
  const cityDisplayName = 'Greeneville'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Greeneville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Greeneville.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Greeneville business licenses or permits.",
  "additionalNotes": "Check with the City of Greeneville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Greeneville Hospital and medical facilities",
  "Downtown Greeneville office buildings and businesses",
  "Greeneville school district and educational facilities",
  "Greeneville municipal and county government buildings",
