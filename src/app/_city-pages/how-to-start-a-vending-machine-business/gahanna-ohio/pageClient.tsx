...
export default function GahannaOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Gahanna may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Gahanna.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Gahanna business licenses or permits.",
  "additionalNotes": "Check with the City of Gahanna for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Gahanna Hospital and medical facilities",
  "Downtown Gahanna office buildings and businesses",
  "Gahanna school district and educational facilities",
  "Gahanna municipal and county government buildings",
