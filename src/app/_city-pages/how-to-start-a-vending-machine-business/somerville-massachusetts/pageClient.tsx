...
export default function SomervilleMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Somerville.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Somerville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Somerville",
