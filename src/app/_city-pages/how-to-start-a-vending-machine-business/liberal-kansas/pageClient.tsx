...
export default function LiberalKansasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Liberal.",
  "businessLicense": "Register your LLC with the Kansas Secretary of State and obtain any required local business licenses in Liberal.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Liberal",
