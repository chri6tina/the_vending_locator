...
export default function KalamazooMichiganHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Michigan requires a sales tax permit. Register your business and collect/remit tax on vending sales. Kalamazoo may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Kalamazoo County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Michigan Secretary of State and obtain any required Kalamazoo business licenses or permits.',
    additionalNotes: 'Check with the City of Kalamazoo for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Kalamazoo Hospital and medical facilities',
    'Downtown Kalamazoo office buildings and businesses',
    'Kalamazoo school district and educational facilities',
    'Kalamazoo municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Kalamazoo',
