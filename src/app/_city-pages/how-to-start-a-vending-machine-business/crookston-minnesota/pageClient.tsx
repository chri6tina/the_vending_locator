...
export default function CrookstonMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Crookston.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Crookston.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Crookston",
