...
export default function SierraVistaArizonaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Sierra Vista.",
  "businessLicense": "Register your LLC with the Arizona Secretary of State and obtain any required local business licenses in Sierra Vista.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Sierra Vista",
