...
export default function BunnellFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Bunnell.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Bunnell.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Bunnell",
