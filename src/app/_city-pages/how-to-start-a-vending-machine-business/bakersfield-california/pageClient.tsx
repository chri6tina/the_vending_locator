...
export default function BakersfieldCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Bakersfield may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Kern County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Bakersfield business licenses or permits.',
    additionalNotes: 'Check with the City of Bakersfield for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Kern Medical Center and Adventist Health',
      'Meadows Field Airport',
      'California State University, Bakersfield',
      'Oil and gas industry operations (Chevron, Aera Energy)',
      'Agriculture and food processing facilities',
      'Downtown Bakersfield government and offices',
      'Valley Plaza and retail centers',
      'Kern County government complex'
  ]
