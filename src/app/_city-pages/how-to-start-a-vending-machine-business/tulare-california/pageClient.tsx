...
export default function TulareCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Tulare also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Tulare.',
    additionalNotes: 'Some locations like the Port of Tulare or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Tulare Port facilities and logistics operations',
      'Naval Air Station Tulare and military contractors',
      ...
      'Tulare Beach and coastal tourism areas',
