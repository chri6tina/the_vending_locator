...
export default function PittsburgMaineHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Maine requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Pittsburg may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Pittsburg.",
  "businessLicense": "Register your LLC with the Maine Secretary of State and obtain any required Pittsburg business licenses or permits.",
  "additionalNotes": "Check with the City of Pittsburg for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Pittsburg Hospital and medical facilities",
  "Downtown Pittsburg office buildings and businesses",
  "Pittsburg school district and educational facilities",
  "Pittsburg municipal and county government buildings",
