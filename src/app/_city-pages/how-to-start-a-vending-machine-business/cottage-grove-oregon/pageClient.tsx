...
export default function CottageGroveOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Cottage Grove may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Cottage Grove.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Cottage Grove business licenses or permits.",
  "additionalNotes": "Check with the City of Cottage Grove for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Cottage Grove Hospital and medical facilities",
  "Downtown Cottage Grove office buildings and businesses",
  "Cottage Grove school district and educational facilities",
  "Cottage Grove municipal and county government buildings",
