...
export default function WoodlakeCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Woodlake.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Woodlake.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Woodlake",
