...
export default function WashingtonNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Washington may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Washington.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Washington business licenses or permits.",
  "additionalNotes": "Check with the City of Washington for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Washington Hospital and medical facilities",
  "Downtown Washington office buildings and businesses",
  "Washington school district and educational facilities",
  "Washington municipal and county government buildings",
