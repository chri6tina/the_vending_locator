...
export default function BloomingtonIndianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Indiana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Bloomington may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Indiana Secretary of State and obtain any required Bloomington business licenses or permits.',
  ...
  const demandDrivers = [
    ...
    'Indiana University campus and facilities',
    'Bloomington municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Bloomington',
