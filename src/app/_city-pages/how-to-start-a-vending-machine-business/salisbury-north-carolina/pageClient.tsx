...
export default function SalisburyNorthCarolinaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Salisbury.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required local business licenses in Salisbury.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Salisbury",
