...
export default function IndioCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Indio also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Indio.',
    additionalNotes: 'Some locations like the Port of Indio or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Indio Port facilities and logistics operations',
      'Naval Air Station Indio and military contractors',
      ...
      'Indio Beach and coastal tourism areas',
