...
export default function BaytownTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Baytown may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Baytown.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Baytown business licenses or permits.",
  "additionalNotes": "Check with the City of Baytown for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Baytown Hospital and medical facilities",
  "Downtown Baytown office buildings and businesses",
  "Baytown school district and educational facilities",
  "Baytown municipal and county government buildings",
