...
export default function FlintMichiganHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Michigan requires a sales tax permit. Register your business and collect/remit tax on vending sales. Flint may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Flint County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Michigan Secretary of State and obtain any required Flint business licenses or permits.',
    additionalNotes: 'Check with the City of Flint for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Flint Hospital and medical facilities',
    'Downtown Flint office buildings and businesses',
    'Flint school district and educational facilities',
    'Flint municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Flint',
