...
export default function SaintJosephMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Saint Joseph.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Saint Joseph.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Saint Joseph",
