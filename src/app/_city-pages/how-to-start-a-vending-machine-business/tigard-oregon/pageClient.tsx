...
export default function TigardOregonHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Tigard.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required local business licenses in Tigard.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Tigard",
