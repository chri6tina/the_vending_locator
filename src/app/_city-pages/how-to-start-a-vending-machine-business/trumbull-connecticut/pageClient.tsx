...
export default function TrumbullConnecticutHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Trumbull.",
  "businessLicense": "Register your LLC with the Connecticut Secretary of State and obtain any required local business licenses in Trumbull.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Trumbull",
