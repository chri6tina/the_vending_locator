...
export default function FortWayneIndianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Indiana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Fort Wayne may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Fort Wayne County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Indiana Secretary of State and obtain any required Fort Wayne business licenses or permits.',
    additionalNotes: 'Check with the City of Fort Wayne for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Fort Wayne Hospital and medical facilities',
    'Downtown Fort Wayne office buildings and businesses',
    'Fort Wayne school district and educational facilities',
    'Fort Wayne municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Fort Wayne',
