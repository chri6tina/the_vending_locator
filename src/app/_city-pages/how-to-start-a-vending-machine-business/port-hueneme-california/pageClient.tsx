...
export default function PortHuenemeCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Port Hueneme.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Port Hueneme.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Port Hueneme",
