...
export default function PlainviewTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Plainview may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Plainview.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Plainview business licenses or permits.",
  "additionalNotes": "Check with the City of Plainview for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Plainview Hospital and medical facilities",
  "Downtown Plainview office buildings and businesses",
  "Plainview school district and educational facilities",
  "Plainview municipal and county government buildings",
