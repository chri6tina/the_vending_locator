...
export default function PowderSpringsGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Powder Springs.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Powder Springs.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Powder Springs",
