...
export default function AmesburyMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Amesbury.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Amesbury.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Amesbury",
