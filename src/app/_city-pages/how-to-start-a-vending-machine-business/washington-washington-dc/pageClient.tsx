...
export default function WashingtonWashingtonDcHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington DC requires a sales tax permit. Register your business and collect/remit tax on vending sales. Washington may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the District of Columbia Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Washington DC Secretary of State and obtain any required Washington business licenses or permits.',
  ...
  const demandDrivers = [
      'U.S. Capitol, White House, and federal agencies',
      ...
      'Pentagon and defense contractors (Arlington)'
  ]
