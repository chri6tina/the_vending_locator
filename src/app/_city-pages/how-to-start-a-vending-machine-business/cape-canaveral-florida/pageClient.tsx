...
export default function CapeCanaveralFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Cape Canaveral.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Cape Canaveral.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Cape Canaveral",
