...
export default function GallatinTennesseeHowToStartPage() {
  const cityDisplayName = 'Gallatin'
  const stateDisplayName = 'Tennessee'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Gallatin may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Gallatin.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Gallatin business licenses or permits.",
  "additionalNotes": "Check with the City of Gallatin for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Gallatin Hospital and medical facilities",
  "Downtown Gallatin office buildings and businesses",
  "Gallatin school district and educational facilities",
  "Gallatin municipal and county government buildings",
