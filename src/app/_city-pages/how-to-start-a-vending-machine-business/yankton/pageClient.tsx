...
export default function YanktonSouthDakotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "South Dakota requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Yankton may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Yankton.",
  "businessLicense": "Register your LLC with the South Dakota Secretary of State and obtain any required Yankton business licenses or permits.",
  "additionalNotes": "Check with the City of Yankton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Yankton Hospital and medical facilities",
  "Downtown Yankton office buildings and businesses",
  "Yankton school district and educational facilities",
  "Yankton municipal and county government buildings",
