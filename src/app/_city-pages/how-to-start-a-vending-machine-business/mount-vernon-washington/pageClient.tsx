...
export default function MountVernonWashingtonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Washington requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mount Vernon.",
  "businessLicense": "Register your LLC with the Washington Secretary of State and obtain any required local business licenses in Mount Vernon.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mount Vernon",
