...
export default function OldsmarFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Oldsmar.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Oldsmar.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Oldsmar",
