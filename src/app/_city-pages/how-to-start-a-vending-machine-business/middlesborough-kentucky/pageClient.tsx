...
export default function MiddlesboroughKentuckyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Kentucky requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Middlesborough.",
  "businessLicense": "Register your LLC with the Kentucky Secretary of State and obtain any required local business licenses in Middlesborough.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Middlesborough",
