...
export default function NorthVernonIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in North Vernon.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in North Vernon.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in North Vernon",
