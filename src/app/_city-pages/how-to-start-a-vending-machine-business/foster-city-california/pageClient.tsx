...
export default function FosterCityCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Foster City.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Foster City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Foster City",
