...
export default function PoncaCityOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Ponca City may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Ponca City.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required Ponca City business licenses or permits.",
  "additionalNotes": "Check with the City of Ponca City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Ponca City Hospital and medical facilities",
  "Downtown Ponca City office buildings and businesses",
  "Ponca City school district and educational facilities",
  "Ponca City municipal and county government buildings",
