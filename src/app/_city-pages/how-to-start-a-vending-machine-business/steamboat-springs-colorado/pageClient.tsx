...
export default function SteamboatSpringsColoradoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Steamboat Springs.",
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in Steamboat Springs.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Steamboat Springs",
