...
export default function DevilsLakeNorthDakotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Dakota requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Devils Lake may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Devils Lake.",
  "businessLicense": "Register your LLC with the North Dakota Secretary of State and obtain any required Devils Lake business licenses or permits.",
  "additionalNotes": "Check with the City of Devils Lake for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Devils Lake Hospital and medical facilities",
  "Downtown Devils Lake office buildings and businesses",
  "Devils Lake school district and educational facilities",
  "Devils Lake municipal and county government buildings",
