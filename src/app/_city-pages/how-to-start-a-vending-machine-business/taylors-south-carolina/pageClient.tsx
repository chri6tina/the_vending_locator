...
export default function TaylorsSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Taylors'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Taylors may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Taylors.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Taylors business licenses or permits.",
  "additionalNotes": "Check with the City of Taylors for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Taylors Hospital and medical facilities",
  "Downtown Taylors office buildings and businesses",
  "Taylors school district and educational facilities",
  "Taylors municipal and county government buildings",
