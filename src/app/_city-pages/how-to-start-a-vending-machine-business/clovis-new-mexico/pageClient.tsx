...
export default function ClovisNewMexicoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Clovis.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required local business licenses in Clovis.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Clovis",
