...
export default function GaffneySouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Gaffney'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Gaffney may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Gaffney.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Gaffney business licenses or permits.",
  "additionalNotes": "Check with the City of Gaffney for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Gaffney Hospital and medical facilities",
  "Downtown Gaffney office buildings and businesses",
  "Gaffney school district and educational facilities",
  "Gaffney municipal and county government buildings",
