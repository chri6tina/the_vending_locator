...
export default function AuburnMaineHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Maine Secretary of State and obtain any required local business licenses in Auburn.",
