...
export default function WhitePlainsNewYorkHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in White Plains.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required local business licenses in White Plains.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in White Plains",
