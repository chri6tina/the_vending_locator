...
export default function CedartownGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Cedartown.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Cedartown.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Cedartown",
