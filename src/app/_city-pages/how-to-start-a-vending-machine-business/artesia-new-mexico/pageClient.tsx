...
export default function ArtesiaNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Artesia may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Artesia.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Artesia business licenses or permits.",
  "additionalNotes": "Check with the City of Artesia for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Artesia Hospital and medical facilities",
  "Downtown Artesia office buildings and businesses",
  "Artesia school district and educational facilities",
  "Artesia municipal and county government buildings",
