...
export default function UrbandaleIowaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Urbandale.",
  "businessLicense": "Register your LLC with the Iowa Secretary of State and obtain any required local business licenses in Urbandale.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Urbandale",
