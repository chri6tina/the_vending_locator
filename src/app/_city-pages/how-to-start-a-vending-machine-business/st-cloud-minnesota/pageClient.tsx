...
export default function StCloudMinnesotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Minnesota requires a sales tax permit. Register your business and collect/remit tax on vending sales. St Cloud may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the St Cloud County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Minnesota Secretary of State and obtain any required St Cloud business licenses or permits.',
    additionalNotes: 'Check with the City of St Cloud for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'St Cloud Hospital and medical facilities',
    'Downtown St Cloud office buildings and businesses',
    'St Cloud school district and educational facilities',
    'St Cloud municipal and county government buildings',
