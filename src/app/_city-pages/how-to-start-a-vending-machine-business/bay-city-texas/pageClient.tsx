...
export default function BayCityTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Bay City may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Bay City.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Bay City business licenses or permits.",
  "additionalNotes": "Check with the City of Bay City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Bay City Hospital and medical facilities",
  "Downtown Bay City office buildings and businesses",
  "Bay City school district and educational facilities",
  "Bay City municipal and county government buildings",
