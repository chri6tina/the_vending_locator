...
export default function RiversideCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Riverside may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Riverside County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Riverside business licenses or permits.',
    additionalNotes: 'Check with the City of Riverside for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'University of California, Riverside (26,000 students)',
      'Riverside University Health System Medical Center',
      'March Air Reserve Base',
      'Downtown Riverside and Mission Inn district',
      'Kaiser Permanente Riverside Medical Center',
      'Bourns Inc. manufacturing',
      'Corona Regional Medical Center (nearby)',
      'Riverside County government offices'
  ]
