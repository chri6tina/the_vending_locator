...
export default function MantecaCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Manteca.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Manteca.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Manteca",
