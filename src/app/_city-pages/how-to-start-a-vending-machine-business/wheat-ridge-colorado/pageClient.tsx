...
export default function WheatRidgeColoradoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Wheat Ridge.",
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in Wheat Ridge.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Wheat Ridge",
