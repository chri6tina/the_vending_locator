...
export default function GrovesTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Groves may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Groves.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Groves business licenses or permits.",
  "additionalNotes": "Check with the City of Groves for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Groves Hospital and medical facilities",
  "Downtown Groves office buildings and businesses",
  "Groves school district and educational facilities",
  "Groves municipal and county government buildings",
