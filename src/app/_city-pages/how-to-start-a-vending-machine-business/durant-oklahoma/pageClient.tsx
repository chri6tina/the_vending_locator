...
export default function DurantOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Durant may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Durant.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required Durant business licenses or permits.",
  "additionalNotes": "Check with the City of Durant for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Durant Hospital and medical facilities",
  "Downtown Durant office buildings and businesses",
  "Durant school district and educational facilities",
  "Durant municipal and county government buildings",
