...
export default function DenverColoradoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Colorado requires a sales tax permit. Register your business and collect/remit tax on vending sales. Denver may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Denver and Arapahoe Counties Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Colorado Secretary of State and obtain any required Denver business licenses or permits.',
    additionalNotes: 'Check with the City of Denver for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Denver International Airport (DIA - 5th busiest, 33,000 employees)',
      'State of Colorado Capitol complex',
      'UC Health University of Colorado Hospital',
      'Lockheed Martin Space Systems (Waterton Canyon)',
      'University of Colorado Denver and Anschutz Medical Campus',
      'Denver Health Medical Center',
      'DaVita and Arrow Electronics headquarters',
      'Denver Tech Center (Greenwood Village) offices'
  ]
