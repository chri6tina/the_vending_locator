...
export default function CamdenSouthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Camden may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Camden.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Camden business licenses or permits.",
  "additionalNotes": "Check with the City of Camden for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Camden Hospital and medical facilities",
  "Downtown Camden office buildings and businesses",
  "Camden school district and educational facilities",
  "Camden municipal and county government buildings",
