...
export default function CherryHillNewJerseyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Cherry Hill.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required local business licenses in Cherry Hill.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Cherry Hill",
