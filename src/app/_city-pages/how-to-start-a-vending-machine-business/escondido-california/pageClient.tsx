...
export default function EscondidoCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Escondido may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Escondido County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Escondido business licenses or permits.',
    additionalNotes: 'Check with the City of Escondido for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Escondido Hospital and medical facilities',
    'Downtown Escondido office buildings and businesses',
    'Escondido school district and educational facilities',
    'Escondido municipal and county government buildings',
