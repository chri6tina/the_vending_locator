...
export default function CarpentersvilleIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Carpentersville.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Carpentersville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Carpentersville",
