...
export default function ShawneeOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Shawnee may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Shawnee.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required Shawnee business licenses or permits.",
  "additionalNotes": "Check with the City of Shawnee for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Shawnee Hospital and medical facilities",
  "Downtown Shawnee office buildings and businesses",
  "Shawnee school district and educational facilities",
  "Shawnee municipal and county government buildings",
