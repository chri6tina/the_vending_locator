...
export default function OakForestIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Oak Forest.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Oak Forest.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Oak Forest",
