...
export default function NogalesArizonaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Nogales.",
  "businessLicense": "Register your LLC with the Arizona Secretary of State and obtain any required local business licenses in Nogales.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Nogales",
