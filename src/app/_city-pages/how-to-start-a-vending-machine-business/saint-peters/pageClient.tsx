...
export default function SaintPetersMissouriHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Missouri requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Saint Peters may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Saint Peters.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required Saint Peters business licenses or permits.",
  "additionalNotes": "Check with the City of Saint Peters for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Saint Peters Hospital and medical facilities",
  "Downtown Saint Peters office buildings and businesses",
  "Saint Peters school district and educational facilities",
  "Saint Peters municipal and county government buildings",
