...
export default function NewCastlePennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. New Castle may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in New Castle.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required New Castle business licenses or permits.",
  "additionalNotes": "Check with the City of New Castle for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "New Castle Hospital and medical facilities",
  "Downtown New Castle office buildings and businesses",
  "New Castle school district and educational facilities",
  "New Castle municipal and county government buildings",
