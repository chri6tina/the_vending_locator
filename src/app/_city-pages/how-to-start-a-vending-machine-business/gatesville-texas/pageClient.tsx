...
export default function GatesvilleTexasHowToStartPage() {
  const cityDisplayName = 'Gatesville'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Gatesville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Gatesville.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Gatesville business licenses or permits.",
  "additionalNotes": "Check with the City of Gatesville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Gatesville Hospital and medical facilities",
  "Downtown Gatesville office buildings and businesses",
  "Gatesville school district and educational facilities",
  "Gatesville municipal and county government buildings",
