...
export default function SanPabloCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in San Pablo.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in San Pablo.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in San Pablo",
