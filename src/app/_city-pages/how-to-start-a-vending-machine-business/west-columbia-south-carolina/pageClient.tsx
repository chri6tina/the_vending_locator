...
export default function WestColumbiaSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'West Columbia'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. West Columbia may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in West Columbia.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required West Columbia business licenses or permits.",
  "additionalNotes": "Check with the City of West Columbia for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "West Columbia Hospital and medical facilities",
  "Downtown West Columbia office buildings and businesses",
  "West Columbia school district and educational facilities",
  "West Columbia municipal and county government buildings",
