...
export default function SandyUtahHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Utah requires a sales tax permit. Register your business and collect/remit tax on vending sales. Sandy may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Sandy County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Utah Secretary of State and obtain any required Sandy business licenses or permits.',
    additionalNotes: 'Check with the City of Sandy for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Sandy Hospital and medical facilities',
    'Downtown Sandy office buildings and businesses',
    'Sandy school district and educational facilities',
    'Sandy municipal and county government buildings',
