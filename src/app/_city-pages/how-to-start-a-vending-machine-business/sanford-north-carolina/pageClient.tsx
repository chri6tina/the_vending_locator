...
export default function SanfordNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Sanford may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Sanford.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Sanford business licenses or permits.",
  "additionalNotes": "Check with the City of Sanford for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Sanford Hospital and medical facilities",
  "Downtown Sanford office buildings and businesses",
  "Sanford school district and educational facilities",
  "Sanford municipal and county government buildings",
