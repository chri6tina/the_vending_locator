...
export default function ElDoradoArkansasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in El Dorado.",
  "businessLicense": "Register your LLC with the Arkansas Secretary of State and obtain any required local business licenses in El Dorado.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in El Dorado",
