...
export default function NewportArkansasHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Arkansas Secretary of State and obtain any required local business licenses in Newport.",
