...
export default function CentralFallsRhodeIslandHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Central Falls.",
  "businessLicense": "Register your LLC with the Rhode Island Secretary of State and obtain any required local business licenses in Central Falls.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Central Falls",
