...
export default function FergusonMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Ferguson.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Ferguson.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Ferguson",
