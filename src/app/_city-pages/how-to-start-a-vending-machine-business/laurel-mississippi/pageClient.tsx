...
export default function LaurelMississippiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Laurel.",
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required local business licenses in Laurel.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Laurel",
