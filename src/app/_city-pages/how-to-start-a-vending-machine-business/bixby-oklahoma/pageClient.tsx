...
export default function BixbyOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Bixby may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Bixby.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required Bixby business licenses or permits.",
  "additionalNotes": "Check with the City of Bixby for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Bixby Hospital and medical facilities",
  "Downtown Bixby office buildings and businesses",
  "Bixby school district and educational facilities",
  "Bixby municipal and county government buildings",
