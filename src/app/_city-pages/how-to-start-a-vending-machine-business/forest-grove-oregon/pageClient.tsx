...
export default function ForestGroveOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Forest Grove may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Forest Grove.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Forest Grove business licenses or permits.",
  "additionalNotes": "Check with the City of Forest Grove for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Forest Grove Hospital and medical facilities",
  "Downtown Forest Grove office buildings and businesses",
  "Forest Grove school district and educational facilities",
  "Forest Grove municipal and county government buildings",
