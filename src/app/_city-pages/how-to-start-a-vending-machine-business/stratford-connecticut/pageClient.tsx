...
export default function StratfordConnecticutHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Stratford.",
  "businessLicense": "Register your LLC with the Connecticut Secretary of State and obtain any required local business licenses in Stratford.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Stratford",
