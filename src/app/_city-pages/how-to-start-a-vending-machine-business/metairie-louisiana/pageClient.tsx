...
export default function MetairieLouisianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Louisiana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Metairie may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Metairie County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Louisiana Secretary of State and obtain any required Metairie business licenses or permits.',
    additionalNotes: 'Check with the City of Metairie for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Metairie Hospital and medical facilities',
    'Downtown Metairie office buildings and businesses',
    'Metairie school district and educational facilities',
    'Metairie municipal and county government buildings',
