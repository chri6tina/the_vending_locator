...
export default function FredericksburgTexasHowToStartPage() {
  const cityDisplayName = 'Fredericksburg'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Fredericksburg may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Fredericksburg.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Fredericksburg business licenses or permits.",
  "additionalNotes": "Check with the City of Fredericksburg for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Fredericksburg Hospital and medical facilities",
  "Downtown Fredericksburg office buildings and businesses",
  "Fredericksburg school district and educational facilities",
  "Fredericksburg municipal and county government buildings",
