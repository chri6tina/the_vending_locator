...
export default function WenatcheeWashingtonHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Wenatchee.",
  "businessLicense": "Register your LLC with the Washington Secretary of State and obtain any required local business licenses in Wenatchee.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Wenatchee",
