...
export default function WoosterOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Wooster may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Wooster.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Wooster business licenses or permits.",
  "additionalNotes": "Check with the City of Wooster for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Wooster Hospital and medical facilities",
  "Downtown Wooster office buildings and businesses",
  "Wooster school district and educational facilities",
  "Wooster municipal and county government buildings",
