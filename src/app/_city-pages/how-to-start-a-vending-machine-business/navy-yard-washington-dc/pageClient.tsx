...
export default function NavyYardWashingtonDcHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington DC requires a sales tax permit. Register your business and collect/remit tax on vending sales. Navy Yard may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Navy Yard County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Washington DC Secretary of State and obtain any required Navy Yard business licenses or permits.',
    additionalNotes: 'Check with the City of Navy Yard for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Navy Yard Hospital and medical facilities',
    'Downtown Navy Yard office buildings and businesses',
    'Navy Yard school district and educational facilities',
    'Navy Yard municipal and county government buildings',
