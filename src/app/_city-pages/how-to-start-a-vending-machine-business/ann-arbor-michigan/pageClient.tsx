...
export default function AnnArborMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Ann Arbor.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Ann Arbor.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Ann Arbor",
