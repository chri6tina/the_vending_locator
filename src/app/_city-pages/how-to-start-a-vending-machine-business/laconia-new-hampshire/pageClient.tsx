...
export default function LaconiaNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Hampshire requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Laconia may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Laconia.",
  "businessLicense": "Register your LLC with the New Hampshire Secretary of State and obtain any required Laconia business licenses or permits.",
  "additionalNotes": "Check with the City of Laconia for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Laconia Hospital and medical facilities",
  "Downtown Laconia office buildings and businesses",
  "Laconia school district and educational facilities",
  "Laconia municipal and county government buildings",
