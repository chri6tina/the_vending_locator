...
export default function HanoverNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Hampshire requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hanover may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Hanover.",
  "businessLicense": "Register your LLC with the New Hampshire Secretary of State and obtain any required Hanover business licenses or permits.",
  "additionalNotes": "Check with the City of Hanover for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Hanover Hospital and medical facilities",
  "Downtown Hanover office buildings and businesses",
  "Hanover school district and educational facilities",
  "Hanover municipal and county government buildings",
