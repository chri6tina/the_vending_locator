...
export default function BridgeportConnecticutHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Connecticut requires a sales tax permit. Register your business and collect/remit tax on vending sales. Bridgeport may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Bridgeport County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Connecticut Secretary of State and obtain any required Bridgeport business licenses or permits.',
    additionalNotes: 'Check with the City of Bridgeport for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Bridgeport Hospital and medical facilities',
    'Downtown Bridgeport office buildings and businesses',
    'Bridgeport school district and educational facilities',
    'Bridgeport municipal and county government buildings',
