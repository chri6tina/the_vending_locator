...
export default function PontiacMichiganHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Michigan requires a sales tax permit. Register your business and collect/remit tax on vending sales. Pontiac may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Pontiac County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Michigan Secretary of State and obtain any required Pontiac business licenses or permits.',
    additionalNotes: 'Check with the City of Pontiac for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Pontiac Hospital and medical facilities',
    'Downtown Pontiac office buildings and businesses',
    'Pontiac school district and educational facilities',
    'Pontiac municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Pontiac',
