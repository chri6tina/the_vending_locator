...
export default function PortJervisNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Port Jervis may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Port Jervis.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Port Jervis business licenses or permits.",
  "additionalNotes": "Check with the City of Port Jervis for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Port Jervis Hospital and medical facilities",
  "Downtown Port Jervis office buildings and businesses",
  "Port Jervis school district and educational facilities",
  "Port Jervis municipal and county government buildings",
