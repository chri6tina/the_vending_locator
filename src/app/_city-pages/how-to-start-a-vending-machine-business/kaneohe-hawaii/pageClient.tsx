...
export default function KaneoheHawaiiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Kaneohe.",
  "businessLicense": "Register your LLC with the Hawaii Secretary of State and obtain any required local business licenses in Kaneohe.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Kaneohe",
