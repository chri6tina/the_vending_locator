...
export default function HollySpringsMississippiHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Mississippi requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Holly Springs.",
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required local business licenses in Holly Springs.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Holly Springs",
