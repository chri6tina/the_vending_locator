...
export default function LouisvilleColoradoHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Colorado Secretary of State and obtain any required local business licenses in Louisville.",
