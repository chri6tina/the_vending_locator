...
export default function KapaaHawaiiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Kapaa.",
  "businessLicense": "Register your LLC with the Hawaii Secretary of State and obtain any required local business licenses in Kapaa.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Kapaa",
