...
export default function PatersonNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Jersey requires a sales tax permit. Register your business and collect/remit tax on vending sales. Paterson may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Paterson County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Jersey Secretary of State and obtain any required Paterson business licenses or permits.',
    additionalNotes: 'Check with the City of Paterson for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Paterson Hospital and medical facilities',
    'Downtown Paterson office buildings and businesses',
    'Paterson school district and educational facilities',
    'Paterson municipal and county government buildings',
