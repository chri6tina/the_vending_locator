...
export default function MountVernonNewYorkHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required local business licenses in Mount Vernon.",
