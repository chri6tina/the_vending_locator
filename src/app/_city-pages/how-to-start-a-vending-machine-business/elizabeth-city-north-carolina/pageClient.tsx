...
export default function ElizabethCityNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Elizabeth City may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Elizabeth City.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Elizabeth City business licenses or permits.",
  "additionalNotes": "Check with the City of Elizabeth City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Elizabeth City Hospital and medical facilities",
  "Downtown Elizabeth City office buildings and businesses",
  "Elizabeth City school district and educational facilities",
  "Elizabeth City municipal and county government buildings",
