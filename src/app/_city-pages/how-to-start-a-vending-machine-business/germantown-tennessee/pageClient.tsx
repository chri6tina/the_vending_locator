...
export default function GermantownTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Tennessee requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Germantown may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Germantown.",
  "businessLicense": "Register your LLC with the Tennessee Secretary of State and obtain any required Germantown business licenses or permits.",
  "additionalNotes": "Check with the City of Germantown for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Germantown Hospital and medical facilities",
  "Downtown Germantown office buildings and businesses",
  "Germantown school district and educational facilities",
  "Germantown municipal and county government buildings",
