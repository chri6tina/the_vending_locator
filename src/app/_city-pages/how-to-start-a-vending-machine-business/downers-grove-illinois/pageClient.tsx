...
export default function DownersGroveIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Downers Grove.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Downers Grove.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Downers Grove",
