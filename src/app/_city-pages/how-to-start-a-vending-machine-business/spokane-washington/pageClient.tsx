...
export default function SpokaneWashingtonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington requires a sales tax permit. Register your business and collect/remit tax on vending sales. Spokane may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Spokane County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Washington Secretary of State and obtain any required Spokane business licenses or permits.',
    additionalNotes: 'Check with the City of Spokane for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }
  ...
  const demandDrivers = [
      ...
      'Avista Corporation headquarters',
