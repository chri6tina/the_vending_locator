...
export default function FridleyMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Fridley.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Fridley.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Fridley",
