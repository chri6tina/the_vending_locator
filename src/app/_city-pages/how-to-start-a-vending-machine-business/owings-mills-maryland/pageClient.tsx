...
export default function OwingsMillsMarylandHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Maryland requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Owings Mills.",
  "businessLicense": "Register your LLC with the Maryland Secretary of State and obtain any required local business licenses in Owings Mills.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Owings Mills",
