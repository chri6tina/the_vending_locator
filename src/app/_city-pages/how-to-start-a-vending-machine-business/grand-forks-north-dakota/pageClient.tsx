...
export default function GrandForksNorthDakotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'North Dakota requires a sales tax permit. Register your business and collect/remit tax on vending sales. Grand Forks may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Grand Forks County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the North Dakota Secretary of State and obtain any required Grand Forks business licenses or permits.',
    additionalNotes: 'Check with the City of Grand Forks for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Grand Forks Hospital and medical facilities',
    'Downtown Grand Forks office buildings and businesses',
    'Grand Forks school district and educational facilities',
    'Grand Forks municipal and county government buildings',
