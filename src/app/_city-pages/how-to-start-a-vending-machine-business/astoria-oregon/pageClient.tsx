...
export default function AstoriaOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Astoria may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Astoria.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Astoria business licenses or permits.",
  "additionalNotes": "Check with the City of Astoria for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Astoria Hospital and medical facilities",
  "Downtown Astoria office buildings and businesses",
  "Astoria school district and educational facilities",
  "Astoria municipal and county government buildings",
