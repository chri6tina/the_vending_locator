...
export default function MontclairNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Montclair may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Montclair.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Montclair business licenses or permits.",
  "additionalNotes": "Check with the City of Montclair for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Montclair Hospital and medical facilities",
  "Downtown Montclair office buildings and businesses",
  "Montclair school district and educational facilities",
  "Montclair municipal and county government buildings",
