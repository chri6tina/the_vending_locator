...
export default function CorningNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Corning may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Corning.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Corning business licenses or permits.",
  "additionalNotes": "Check with the City of Corning for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Corning Hospital and medical facilities",
  "Downtown Corning office buildings and businesses",
  "Corning school district and educational facilities",
  "Corning municipal and county government buildings",
