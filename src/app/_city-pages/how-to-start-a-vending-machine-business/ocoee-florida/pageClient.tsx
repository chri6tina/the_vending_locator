...
export default function OcoeeFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Ocoee.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Ocoee.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Ocoee",
