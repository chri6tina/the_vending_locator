...
export default function ManningSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Manning'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Manning may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Manning.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Manning business licenses or permits.",
  "additionalNotes": "Check with the City of Manning for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Manning Hospital and medical facilities",
  "Downtown Manning office buildings and businesses",
  "Manning school district and educational facilities",
  "Manning municipal and county government buildings",
