...
export default function LemonGroveCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lemon Grove.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Lemon Grove.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lemon Grove",
