...
export default function ClemsonSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Clemson'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Clemson may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Clemson.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Clemson business licenses or permits.",
  "additionalNotes": "Check with the City of Clemson for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Clemson Hospital and medical facilities",
  "Downtown Clemson office buildings and businesses",
  "Clemson school district and educational facilities",
  "Clemson municipal and county government buildings",
