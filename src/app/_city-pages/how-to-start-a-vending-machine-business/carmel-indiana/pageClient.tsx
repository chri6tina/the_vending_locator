...
export default function CarmelIndianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Indiana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Carmel may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Carmel County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Indiana Secretary of State and obtain any required Carmel business licenses or permits.',
    additionalNotes: 'Check with the City of Carmel for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Carmel Hospital and medical facilities',
    'Downtown Carmel office buildings and businesses',
    'Carmel school district and educational facilities',
    'Carmel municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Carmel',
