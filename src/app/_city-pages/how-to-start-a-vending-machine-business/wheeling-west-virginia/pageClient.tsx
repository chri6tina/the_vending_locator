...
export default function WheelingWestVirginiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Wheeling.",
  "businessLicense": "Register your LLC with the West Virginia Secretary of State and obtain any required local business licenses in Wheeling.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Wheeling",
