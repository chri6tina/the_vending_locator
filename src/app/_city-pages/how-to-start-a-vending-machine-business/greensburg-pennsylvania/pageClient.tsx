...
export default function GreensburgPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Greensburg may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Greensburg.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Greensburg business licenses or permits.",
  "additionalNotes": "Check with the City of Greensburg for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Greensburg Hospital and medical facilities",
  "Downtown Greensburg office buildings and businesses",
  "Greensburg school district and educational facilities",
  "Greensburg municipal and county government buildings",
