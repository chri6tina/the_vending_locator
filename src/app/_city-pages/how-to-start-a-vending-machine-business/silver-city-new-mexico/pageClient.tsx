...
export default function SilverCityNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Mexico requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Silver City may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Silver City.",
  "businessLicense": "Register your LLC with the New Mexico Secretary of State and obtain any required Silver City business licenses or permits.",
  "additionalNotes": "Check with the City of Silver City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Silver City Hospital and medical facilities",
  "Downtown Silver City office buildings and businesses",
  "Silver City school district and educational facilities",
  "Silver City municipal and county government buildings",
