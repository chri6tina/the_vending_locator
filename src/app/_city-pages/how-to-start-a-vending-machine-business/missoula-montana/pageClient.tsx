...
export default function MissoulaMontanaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Montana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Missoula may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Missoula County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Montana Secretary of State and obtain any required Missoula business licenses or permits.',
    additionalNotes: 'Check with the City of Missoula for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Missoula Hospital and medical facilities',
    'Downtown Missoula office buildings and businesses',
    'University of Montana campus and facilities',
    'Missoula municipal and county government buildings',
