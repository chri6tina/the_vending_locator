...
export default function LehighAcresFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lehigh Acres.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Lehigh Acres.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lehigh Acres",
