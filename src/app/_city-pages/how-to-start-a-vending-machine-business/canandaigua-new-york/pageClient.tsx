...
export default function CanandaiguaNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New York requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Canandaigua may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Canandaigua.",
  "businessLicense": "Register your LLC with the New York Secretary of State and obtain any required Canandaigua business licenses or permits.",
  "additionalNotes": "Check with the City of Canandaigua for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Canandaigua Hospital and medical facilities",
  "Downtown Canandaigua office buildings and businesses",
  "Canandaigua school district and educational facilities",
  "Canandaigua municipal and county government buildings",
