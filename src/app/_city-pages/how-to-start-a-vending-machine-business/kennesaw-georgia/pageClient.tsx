...
export default function KennesawGeorgiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Georgia requires a sales tax permit through the Department of Revenue. Kennesaw also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Kennesaw.',
    additionalNotes: 'Some locations like the Port of Kennesaw or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Kennesaw Port facilities and logistics operations',
      'Naval Air Station Kennesaw and military contractors',
      ...
      'Kennesaw Beach and coastal tourism areas',
