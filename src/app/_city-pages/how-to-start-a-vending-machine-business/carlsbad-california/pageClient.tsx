...
export default function CarlsbadCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Carlsbad may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Carlsbad County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Carlsbad business licenses or permits.',
    additionalNotes: 'Check with the City of Carlsbad for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Carlsbad Hospital and medical facilities',
    'Downtown Carlsbad office buildings and businesses',
    'Carlsbad school district and educational facilities',
    'Carlsbad municipal and county government buildings',
