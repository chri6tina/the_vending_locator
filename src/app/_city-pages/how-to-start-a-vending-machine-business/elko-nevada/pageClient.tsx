...
export default function ElkoNevadaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Elko.",
  "businessLicense": "Register your LLC with the Nevada Secretary of State and obtain any required local business licenses in Elko.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Elko",
