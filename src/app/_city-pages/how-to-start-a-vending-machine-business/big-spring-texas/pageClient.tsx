...
export default function BigSpringTexasHowToStartPage() {
  const cityDisplayName = 'Big Spring'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Big Spring may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Big Spring.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Big Spring business licenses or permits.",
  "additionalNotes": "Check with the City of Big Spring for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Big Spring Hospital and medical facilities",
  "Downtown Big Spring office buildings and businesses",
  "Big Spring school district and educational facilities",
  "Big Spring municipal and county government buildings",
