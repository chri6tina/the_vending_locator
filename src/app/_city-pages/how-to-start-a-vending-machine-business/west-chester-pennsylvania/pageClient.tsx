...
export default function WestChesterPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. West Chester may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in West Chester.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required West Chester business licenses or permits.",
  "additionalNotes": "Check with the City of West Chester for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "West Chester Hospital and medical facilities",
  "Downtown West Chester office buildings and businesses",
  "West Chester school district and educational facilities",
  "West Chester municipal and county government buildings",
