...
export default function GriffithIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Griffith.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Griffith.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Griffith",
