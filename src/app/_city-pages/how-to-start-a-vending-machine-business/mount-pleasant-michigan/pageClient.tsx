...
export default function MountPleasantMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mount Pleasant.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Mount Pleasant.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mount Pleasant",
