...
export default function CouncilBluffsIowaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Council Bluffs.",
  "businessLicense": "Register your LLC with the Iowa Secretary of State and obtain any required local business licenses in Council Bluffs.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Council Bluffs",
