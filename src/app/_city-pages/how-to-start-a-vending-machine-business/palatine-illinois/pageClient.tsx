...
export default function PalatineIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Palatine.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Palatine.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Palatine",
