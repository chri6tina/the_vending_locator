...
export default function PalosVerdesEstatesCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Palos Verdes Estates.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Palos Verdes Estates.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Palos Verdes Estates",
