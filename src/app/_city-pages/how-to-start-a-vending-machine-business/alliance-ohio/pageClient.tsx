...
export default function AllianceOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Ohio requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Alliance may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Alliance.",
  "businessLicense": "Register your LLC with the Ohio Secretary of State and obtain any required Alliance business licenses or permits.",
  "additionalNotes": "Check with the City of Alliance for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Alliance Hospital and medical facilities",
  "Downtown Alliance office buildings and businesses",
  "Alliance school district and educational facilities",
  "Alliance municipal and county government buildings",
