...
export default function PortLavacaTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Port Lavaca may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Port Lavaca.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Port Lavaca business licenses or permits.",
  "additionalNotes": "Check with the City of Port Lavaca for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Port Lavaca Hospital and medical facilities",
  "Downtown Port Lavaca office buildings and businesses",
  "Port Lavaca school district and educational facilities",
  "Port Lavaca municipal and county government buildings",
