...
export default function TrentonNewJerseyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Trenton.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required local business licenses in Trenton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Trenton",
