...
export default function RahwayNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Jersey requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Rahway may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Rahway.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required Rahway business licenses or permits.",
  "additionalNotes": "Check with the City of Rahway for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Rahway Hospital and medical facilities",
  "Downtown Rahway office buildings and businesses",
  "Rahway school district and educational facilities",
  "Rahway municipal and county government buildings",
