...
export default function RockfordIllinoisHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Illinois requires a sales tax permit. Register your business and collect/remit tax on vending sales. Rockford may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Rockford County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Illinois Secretary of State and obtain any required Rockford business licenses or permits.',
    additionalNotes: 'Check with the City of Rockford for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Rockford Hospital and medical facilities',
    'Downtown Rockford office buildings and businesses',
    'Rockford school district and educational facilities',
    'Rockford municipal and county government buildings',
