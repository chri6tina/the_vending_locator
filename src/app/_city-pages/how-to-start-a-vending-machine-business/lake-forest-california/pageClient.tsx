...
export default function LakeForestCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lake Forest.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Lake Forest.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lake Forest",
