...
export default function WinslowArizonaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Winslow.",
  "businessLicense": "Register your LLC with the Arizona Secretary of State and obtain any required local business licenses in Winslow.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Winslow",
