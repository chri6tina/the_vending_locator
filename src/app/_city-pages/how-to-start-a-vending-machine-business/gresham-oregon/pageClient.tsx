...
export default function GreshamOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Oregon requires a sales tax permit. Register your business and collect/remit tax on vending sales. Gresham may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Gresham County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Oregon Secretary of State and obtain any required Gresham business licenses or permits.',
    additionalNotes: 'Check with the City of Gresham for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Gresham Hospital and medical facilities',
    'Downtown Gresham office buildings and businesses',
    'Gresham school district and educational facilities',
    'Gresham municipal and county government buildings',
