...
export default function BrazilIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Brazil.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Brazil.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Brazil",
