...
export default function LakewoodWashingtonHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lakewood.",
  "businessLicense": "Register your LLC with the Washington Secretary of State and obtain any required local business licenses in Lakewood.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lakewood",
