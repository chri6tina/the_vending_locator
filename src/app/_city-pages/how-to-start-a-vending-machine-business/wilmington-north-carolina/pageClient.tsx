...
export default function WilmingtonNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'North Carolina requires a sales tax permit. Register your business and collect/remit tax on vending sales. Wilmington may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Wilmington County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the North Carolina Secretary of State and obtain any required Wilmington business licenses or permits.',
    additionalNotes: 'Check with the City of Wilmington for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Wilmington Hospital and medical facilities',
    'Downtown Wilmington office buildings and businesses',
    'Wilmington school district and educational facilities',
    'Wilmington municipal and county government buildings',
