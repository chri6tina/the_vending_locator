...
export default function HibbingMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Hibbing.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Hibbing.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Hibbing",
