...
export default function HendersonKentuckyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Henderson.",
  "businessLicense": "Register your LLC with the Kentucky Secretary of State and obtain any required local business licenses in Henderson.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Henderson",
