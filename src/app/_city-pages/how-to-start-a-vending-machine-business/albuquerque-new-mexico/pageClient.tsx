...
export default function AlbuquerqueNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Mexico requires a sales tax permit. Register your business and collect/remit tax on vending sales. Albuquerque may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Bernalillo County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Mexico Secretary of State and obtain any required Albuquerque business licenses or permits.',
    additionalNotes: 'Check with the City of Albuquerque for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Sandia National Laboratories (10,000+ employees)',
      'Kirtland Air Force Base',
      'University of New Mexico and UNM Hospital',
      'Albuquerque International Sunport',
      'Presbyterian Healthcare Services',
      'Intel manufacturing facility',
      'Lovelace Health System',
      'Downtown Albuquerque and Old Town businesses'
  ]
