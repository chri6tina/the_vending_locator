...
export default function WeatherfordOklahomaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oklahoma requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Weatherford may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Weatherford.",
  "businessLicense": "Register your LLC with the Oklahoma Secretary of State and obtain any required Weatherford business licenses or permits.",
  "additionalNotes": "Check with the City of Weatherford for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Weatherford Hospital and medical facilities",
  "Downtown Weatherford office buildings and businesses",
  "Weatherford school district and educational facilities",
  "Weatherford municipal and county government buildings",
