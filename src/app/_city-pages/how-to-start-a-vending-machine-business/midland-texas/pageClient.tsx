...
export default function MidlandTexasHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required local business licenses in Midland.",
