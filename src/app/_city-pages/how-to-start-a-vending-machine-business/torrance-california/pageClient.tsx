...
export default function TorranceCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Torrance may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Torrance County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Torrance business licenses or permits.',
    additionalNotes: 'Check with the City of Torrance for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Torrance Hospital and medical facilities',
    'Downtown Torrance office buildings and businesses',
    'Torrance school district and educational facilities',
    'Torrance municipal and county government buildings',
