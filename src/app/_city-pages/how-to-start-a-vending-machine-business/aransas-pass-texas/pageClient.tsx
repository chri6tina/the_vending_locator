...
export default function AransasPassTexasHowToStartPage() {
  const cityDisplayName = 'Aransas Pass'
  const stateDisplayName = 'Texas'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Aransas Pass may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Aransas Pass.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Aransas Pass business licenses or permits.",
  "additionalNotes": "Check with the City of Aransas Pass for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Aransas Pass Hospital and medical facilities",
  "Downtown Aransas Pass office buildings and businesses",
  "Aransas Pass school district and educational facilities",
  "Aransas Pass municipal and county government buildings",
