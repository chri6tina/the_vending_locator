...
export default function WilmingtonIslandFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Wilmington Island.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Wilmington Island.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Wilmington Island",
