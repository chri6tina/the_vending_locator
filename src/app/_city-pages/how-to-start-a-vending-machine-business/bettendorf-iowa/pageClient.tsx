...
export default function BettendorfIowaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Bettendorf.",
  "businessLicense": "Register your LLC with the Iowa Secretary of State and obtain any required local business licenses in Bettendorf.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Bettendorf",
