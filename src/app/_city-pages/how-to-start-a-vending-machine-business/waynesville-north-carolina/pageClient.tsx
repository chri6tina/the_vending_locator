...
export default function WaynesvilleNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "North Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Waynesville may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Waynesville.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required Waynesville business licenses or permits.",
  "additionalNotes": "Check with the City of Waynesville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Waynesville Hospital and medical facilities",
  "Downtown Waynesville office buildings and businesses",
  "Waynesville school district and educational facilities",
  "Waynesville municipal and county government buildings",
