...
export default function NewYorkNewYorkHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New York requires a sales tax permit. Register your business and collect/remit tax on vending sales. New York may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the New York County (Manhattan) Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New York Secretary of State and obtain any required New York business licenses or permits.',
    additionalNotes: 'Check with the City of New York for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Empire State Building and Manhattan office towers',
      'NYU Langone and Mount Sinai Hospital systems',
      'Columbia University and NYU campuses',
      'Wall Street and Financial District (Goldman Sachs, JPMorgan)',
      'Times Square, Midtown, and Rockefeller Center businesses',
      'JFK and LaGuardia International Airports',
      'Brooklyn Navy Yard and DUMBO Tech Triangle',
      'Grand Central Terminal and Penn Station complexes'
  ]
