...
export default function LakeHelenFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lake Helen.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Lake Helen.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lake Helen",
