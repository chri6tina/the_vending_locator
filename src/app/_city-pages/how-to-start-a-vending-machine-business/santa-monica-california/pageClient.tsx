...
export default function SantaMonicaCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Santa Monica.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Santa Monica.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Santa Monica",
