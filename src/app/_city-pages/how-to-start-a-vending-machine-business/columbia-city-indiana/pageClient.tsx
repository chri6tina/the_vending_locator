...
export default function ColumbiaCityIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Columbia City.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Columbia City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Columbia City",
