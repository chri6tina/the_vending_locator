...
export default function IndianapolisIndianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Indiana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Indianapolis may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Marion County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Indiana Secretary of State and obtain any required Indianapolis business licenses or permits.',
    additionalNotes: 'Check with the City of Indianapolis for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Eli Lilly and Company pharmaceutical headquarters',
      'Indianapolis Motor Speedway and motorsports industry',
      'Indiana University Health hospitals',
      'Salesforce Tower and downtown businesses',
      'Indianapolis International Airport',
      'State of Indiana government offices',
      'NCAA headquarters',
      'Rolls-Royce North America manufacturing'
  ]
