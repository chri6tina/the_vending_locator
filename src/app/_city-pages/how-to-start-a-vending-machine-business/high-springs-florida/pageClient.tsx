...
export default function HighSpringsFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in High Springs.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in High Springs.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in High Springs",
