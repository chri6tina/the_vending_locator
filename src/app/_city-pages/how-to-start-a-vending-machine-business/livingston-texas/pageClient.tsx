...
export default function LivingstonTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Livingston may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Livingston.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Livingston business licenses or permits.",
  "additionalNotes": "Check with the City of Livingston for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Livingston Hospital and medical facilities",
  "Downtown Livingston office buildings and businesses",
  "Livingston school district and educational facilities",
  "Livingston municipal and county government buildings",
