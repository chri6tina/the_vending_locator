...
export default function GreerSouthCarolinaHowToStartPage() {
  const cityDisplayName = 'Greer'
  const stateDisplayName = 'South Carolina'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
  "salesTax": "South Carolina requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Greer may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Greer.",
  "businessLicense": "Register your LLC with the South Carolina Secretary of State and obtain any required Greer business licenses or permits.",
  "additionalNotes": "Check with the City of Greer for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Greer Hospital and medical facilities",
  "Downtown Greer office buildings and businesses",
  "Greer school district and educational facilities",
  "Greer municipal and county government buildings",
