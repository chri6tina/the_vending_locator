...
export default function OntarioOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Ontario may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Ontario.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required Ontario business licenses or permits.",
  ...
  const demandDrivers = [
  "Ontario Hospital and medical facilities",
  "Downtown Ontario office buildings and businesses",
  "Ontario school district and educational facilities",
  "Ontario municipal and county government buildings",
