...
export default function MountainViewCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Mountain View also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Mountain View.',
    additionalNotes: 'Some locations like the Port of Mountain View or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Mountain View Port facilities and logistics operations',
      'Naval Air Station Mountain View and military contractors',
      ...
      'Mountain View Beach and coastal tourism areas',
