...
export default function WestminsterCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Westminster also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Westminster.',
    additionalNotes: 'Some locations like the Port of Westminster or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Westminster Port facilities and logistics operations',
      'Naval Air Station Westminster and military contractors',
      ...
      'Westminster Beach and coastal tourism areas',
