...
export default function MolineIllinoisHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Illinois requires a sales tax permit. Register your business and collect/remit tax on vending sales. Moline may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Moline County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Illinois Secretary of State and obtain any required Moline business licenses or permits.',
    additionalNotes: 'Check with the City of Moline for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Moline Hospital and medical facilities',
    'Downtown Moline office buildings and businesses',
    'Moline school district and educational facilities',
    'Moline municipal and county government buildings',
