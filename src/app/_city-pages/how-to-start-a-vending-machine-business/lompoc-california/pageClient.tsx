...
export default function LompocCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Lompoc also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Lompoc.',
    additionalNotes: 'Some locations like the Port of Lompoc or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Lompoc Port facilities and logistics operations',
      'Naval Air Station Lompoc and military contractors',
      ...
      'Lompoc Beach and coastal tourism areas',
