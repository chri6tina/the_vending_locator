...
export default function FarmersBranchTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Farmers Branch may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Farmers Branch.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Farmers Branch business licenses or permits.",
  "additionalNotes": "Check with the City of Farmers Branch for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Farmers Branch Hospital and medical facilities",
  "Downtown Farmers Branch office buildings and businesses",
  "Farmers Branch school district and educational facilities",
  "Farmers Branch municipal and county government buildings",
