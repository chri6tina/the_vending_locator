...
export default function VillageofGolfFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Village of Golf.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Village of Golf.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Village of Golf",
