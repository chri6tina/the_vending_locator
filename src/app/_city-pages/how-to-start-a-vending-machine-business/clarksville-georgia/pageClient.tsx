...
export default function ClarksvilleGeorgiaHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Clarksville.",
