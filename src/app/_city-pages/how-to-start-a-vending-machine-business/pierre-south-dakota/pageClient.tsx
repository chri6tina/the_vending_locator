...
export default function PierreSouthDakotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Pierre.",
  "businessLicense": "Register your LLC with the South Dakota Secretary of State and obtain any required local business licenses in Pierre.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Pierre",
