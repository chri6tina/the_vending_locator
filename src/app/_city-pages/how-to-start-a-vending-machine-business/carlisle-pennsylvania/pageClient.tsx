...
export default function CarlislePennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Carlisle may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Carlisle.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Carlisle business licenses or permits.",
  "additionalNotes": "Check with the City of Carlisle for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Carlisle Hospital and medical facilities",
  "Downtown Carlisle office buildings and businesses",
  "Carlisle school district and educational facilities",
  "Carlisle municipal and county government buildings",
