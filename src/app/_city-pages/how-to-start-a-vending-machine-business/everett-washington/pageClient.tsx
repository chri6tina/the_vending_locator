...
export default function EverettWashingtonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington requires a sales tax permit. Register your business and collect/remit tax on vending sales. Everett may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Everett County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Washington Secretary of State and obtain any required Everett business licenses or permits.',
    additionalNotes: 'Check with the City of Everett for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Everett Hospital and medical facilities',
    'Downtown Everett office buildings and businesses',
    'Everett school district and educational facilities',
    'Everett municipal and county government buildings',
