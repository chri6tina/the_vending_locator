...
export default function GlenEllynIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Glen Ellyn.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Glen Ellyn.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Glen Ellyn",
