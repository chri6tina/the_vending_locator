...
export default function BartowFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Bartow.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Bartow.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Bartow",
