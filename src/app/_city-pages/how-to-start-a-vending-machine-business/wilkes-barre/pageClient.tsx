...
export default function WilkesBarrePennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Pennsylvania requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Wilkes-Barre may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Wilkes-Barre.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required Wilkes-Barre business licenses or permits.",
  "additionalNotes": "Check with the City of Wilkes-Barre for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Wilkes-Barre Hospital and medical facilities",
  "Downtown Wilkes-Barre office buildings and businesses",
  "Wilkes-Barre school district and educational facilities",
  "Wilkes-Barre municipal and county government buildings",
