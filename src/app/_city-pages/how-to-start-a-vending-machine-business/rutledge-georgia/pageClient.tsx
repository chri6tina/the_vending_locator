...
export default function RutledgeGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rutledge.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Rutledge.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rutledge",
