...
export default function MountProspectIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mount Prospect.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Mount Prospect.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mount Prospect",
