...
export default function LongviewTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Texas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Longview may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Longview.",
  "businessLicense": "Register your LLC with the Texas Secretary of State and obtain any required Longview business licenses or permits.",
  "additionalNotes": "Check with the City of Longview for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Longview Hospital and medical facilities",
  "Downtown Longview office buildings and businesses",
  "Longview school district and educational facilities",
  "Longview municipal and county government buildings",
