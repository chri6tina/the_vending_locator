...
export default function HollisNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "New Hampshire requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable. Hollis may have additional local sales taxes.",
  "healthPermit": "If selling food or beverages, contact your local county health department for vending machine permits and inspection requirements in Hollis.",
  "businessLicense": "Register your LLC with the New Hampshire Secretary of State and obtain any required Hollis business licenses or permits.",
  "additionalNotes": "Check with the City of Hollis for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas."
}

  const demandDrivers = [
  "Hollis Hospital and medical facilities",
  "Downtown Hollis office buildings and businesses",
  "Hollis school district and educational facilities",
  "Hollis municipal and county government buildings",
