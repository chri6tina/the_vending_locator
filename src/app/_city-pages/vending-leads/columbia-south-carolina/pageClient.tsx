...
export default function ColumbiaSouthCarolinaVendingLeadsPage() {
  ...
  const cityData = {
    ...
    'rating': '4.5/5',
    'description': 'Major state capital and business center'
  };
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setActiveUsers(prev => {
        ...
        return Math.max(17, Math.min(27, newValue))
      })
    }, 3000)
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Government & State</h3>
              </div>
              <p className="text-gray-600">
                As the state capital, {cityDisplayName} is home to numerous government buildings, state agencies, and legislative offices providing excellent opportunities for government facility vending machine placement.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                University of South Carolina and other educational facilities in {cityDisplayName} provide consistent student and faculty traffic for reliable vending machine revenue.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Business offices and corporate facilities in {cityDisplayName} provide opportunities for office vending machine placement in the state capital region.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Prisma Health and other healthcare facilities in {cityDisplayName} offer steady vending machine traffic throughout the day with patients, visitors, and staff.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                {cityDisplayName} serves as a major transportation hub with airports, bus stations, and transit centers offering high-traffic vending machine opportunities.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                {cityDisplayName} offers excellent opportunities in government buildings, educational institutions, corporate offices, healthcare facilities, retail centers, and transportation hubs. As the state capital, the city provides numerous vending machine placement opportunities.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Vending machine revenue in {cityDisplayName} varies by location type, but our verified locations typically generate $150-600+ per month per machine. Government buildings and educational institutions tend to perform best due to consistent foot traffic.
              </p>
            </div>
      ...
      <CityPageSEO
        ...
        faqs={[
          ...
          },
          {
            ...
            answer: "Vending machine revenue in {cityDisplayName} varies by location type, but our verified locations typically generate $50-600+ per month per machine. Government buildings and educational institutions tend to perform best due to consistent foot traffic."
          },
          {
