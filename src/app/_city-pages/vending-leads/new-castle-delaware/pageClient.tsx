...
export default function NewCastleDelawareVendingLeadsPage() {
  // City and state display names
  const cityDisplayName = 'New Castle';const stateDisplayName = 'Delaware';
  ...
  const cityData = {
    ...
    'businesses': '250-400',
    'industries': '5-8',
    'verifiedLocations': '25-50',
    'rating': '4.7/5',
    'description': 'Historic colonial town with tourism, residential areas, and local businesses'
  };
  ...
  const [userNames, setUserNames] = useState(['Mike from New Castle', 'Sarah in New Castle', 'David in New Castle', 'Lisa in New Castle', 'Tom in New Castle', 'Jennifer in New Castle', 'Robert in New Castle', 'Amanda in New Castle', 'Chris in New Castle', 'Maria in New Castle', 'James in New Castle', 'Emily in New Castle'])
  ...
  const relatedCities = newHampshire ? newHampshire.cities.filter(c => c.slug !== 'new-castle-delaware').slice(0, 8) : [];

  // FAQ items reused for JSON-LD
  const faqItems = [
    { q: 'What types of vending machine locations are available in New Castle?', a: 'New Castle offers historic vending opportunities including tourist attractions, retail shops, restaurants, small office buildings, and residential areas. Each location is pre-verified for optimal vending machine success.' },
    ...
    { q: 'What makes New Castle a good market for vending machines?', a: 'New Castle is a historic colonial town with tourism and strong local character. The town\'s tourist traffic and residential community create ideal conditions for vending machine success.' },
        ...
        <section className="relative py-20 bg-white overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              >
                Connect with qualified vending locations in New Castle, Delaware, spanning technology companies, medical centers, and educational campuses.</motion.p>
...
{/* Social Proof Stats */}
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-stone leading-relaxed">New Castle's healthcare sector includes major medical centers, specialty clinics, and outpatient facilities that generate consistent patient and visitor traffic, creating ideal vending placement opportunities.</p>
              </motion.div>
              <motion.div
                key="Education"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Academic institutions in New Castle feature student centers, libraries, and common areas with consistent foot traffic, making them ideal locations for vending machine placement.</p>
              </motion.div>
              <motion.div
                key="Manufacturing"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Industrial and manufacturing operations throughout New Castle employ substantial workforces with shift-based schedules, offering stable vending placement opportunities with steady traffic.</p>
              </motion.div>
              <motion.div
                key="Retail"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">New Castle's retail sector features shopping centers, strip malls, and commercial districts that offer strategic vending placement in areas with maximum shopper visibility.</p>
              </motion.div>
              <motion.div
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <p className="text-lg text-stone leading-relaxed">
                The New Castle market combines business density with strategic placement opportunities, featuring corporate campuses, medical facilities, and educational institutions that generate reliable vending revenue.</p>
            </motion.div>
          </div>
        </section>
      ...
      <CityPageSEO
        ...
        description="Get verified vending machine leads and locations in New Castle, Delaware. Find qualified businesses for vending machine placement."
        faqs={[
          {
            question: "Healthcare",
            answer: "New Castle's healthcare sector includes major medical centers, specialty clinics, and outpatient facilities that generate consistent patient and visitor traffic, creating ideal vending placement opportunities."
          },
          {
            question: "Education",
            answer: "Academic institutions in New Castle feature student centers, libraries, and common areas with consistent foot traffic, making them ideal locations for vending machine placement."
          },
          {
            question: "Manufacturing",
            answer: "Industrial and manufacturing operations throughout New Castle employ substantial workforces with shift-based schedules, offering stable vending placement opportunities with steady traffic."
          },
          {
            question: "Retail",
            answer: "New Castle's retail sector features shopping centers, strip malls, and commercial districts that offer strategic vending placement in areas with maximum shopper visibility."
          },
          {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Manchester', item: 'https://www.thevendinglocator.com/vending-leads/new-castle-delaware' }
            ]
          })
        }}
      />
