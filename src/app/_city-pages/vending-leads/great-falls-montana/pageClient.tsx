...
export default function GreatFallsMontanaVendingLeadsPage() {
  // City and state display names
  const cityDisplayName = 'Great Falls';const stateDisplayName = 'Montana';
  ...
  rating: '4.8/5',
  description: 'Central Montana hub with Malmstrom Air Force Base',
  majorEmployers: ['Malmstrom Air Force Base', 'Benefis Health System', 'Great Falls Public Schools', 'Montana State University - Great Falls', 'City of Great Falls']
};
  ...
  const [userNames, setUserNames] = useState([
    'Mike from Great Falls', 'Sarah in Great Falls', 'David in Great Falls', 'Lisa in Great Falls',
    'Tom in Great Falls', 'Jennifer in Great Falls', 'Robert in Great Falls', 'Amanda in Great Falls',
    'Chris in Great Falls', 'Maria in Great Falls', 'James in Great Falls', 'Emily in Great Falls'
  ])
  ...
  const relatedCities = currentState ? currentState.cities.filter(c => c.slug !== 'great-falls-montana').slice(0, 8) : [];

  // FAQ items reused for JSON-LD
  const faqItems = [
    { q: "What types of vending machine locations are available in Great Falls?", a: "Great Falls provides vending opportunities in healthcare facilities, educational institutions, retail centers, office buildings, and manufacturing facilities serving the local market." },
    { q: "How quickly can I get vending machine leads for Great Falls?", a: "Our Great Falls vending leads are delivered within 3-5 business days with detailed information about each verified business and placement opportunity." },
    { q: "What makes Great Falls a good market for vending machines?", a: "Great Falls features a strong business community with diverse industries and consistent foot traffic. The city's economic activity creates ideal conditions for vending machine success." },
    { q: "Do you provide ongoing support for Great Falls locations?", a: "Yes, we provide comprehensive support including location research, business verification, contact information, and market-specific placement strategies for Great Falls." },
    { q: "What industries in Great Falls are best for vending machines?", a: "Healthcare, education, manufacturing, retail, and office buildings in Great Falls show strong vending potential with reliable traffic and captive audiences." },
    ...
    <>
        ...
        <section className="relative py-20 bg-white overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              >
                Access targeted vending leads in Great Falls, Montana, covering industrial parks, shopping centers, and professional office complexes.</motion.p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Medical facilities throughout Great Falls serve large patient populations and employ substantial staff, providing steady foot traffic and consistent demand for vending services in waiting areas and break rooms.</p>
              </motion.div>
              <motion.div
                key="Education"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Educational facilities throughout Great Falls serve large student populations and employ substantial staff, providing steady foot traffic and consistent demand for vending services.</p>
              </motion.div>
              <motion.div
                key="Manufacturing"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Manufacturing facilities in Great Falls provide excellent vending locations with large employee bases, multiple shifts, and break areas that generate consistent sales throughout the day.</p>
              </motion.div>
              <motion.div
                key="Retail"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Shopping centers and retail districts in Great Falls offer prime vending locations, with high-traffic areas including food courts, entrances, and common spaces frequented by shoppers.</p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Office complexes in Great Falls provide ideal vending locations with multiple tenants, high employee counts, and break areas that ensure steady machine usage during business hours.</p>
              </motion.div>
              <motion.div
                key="Transportation"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Transit facilities throughout Great Falls provide excellent vending opportunities in terminals, waiting areas, and high-traffic zones with consistent traveler foot traffic.</p>
              </motion.div>
            </div>
          </div>
        </section>        {/* Why Great Falls? */}
        <section className="py-16 bg-warm-white">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              ...
              >
                Why Choose Great Falls for Vending Machines?
              </motion.h2>
            </div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
      ...
      <CityPageSEO
        ...
        faqs={[
          {
            question: "Healthcare",
            answer: "Medical facilities throughout Great Falls serve large patient populations and employ substantial staff, providing steady foot traffic and consistent demand for vending services in waiting areas and break rooms."
          },
          {
            question: "Education",
            answer: "Educational facilities throughout Great Falls serve large student populations and employ substantial staff, providing steady foot traffic and consistent demand for vending services."
          },
          {
            question: "Manufacturing",
            answer: "Manufacturing facilities in Great Falls provide excellent vending locations with large employee bases, multiple shifts, and break areas that generate consistent sales throughout the day."
          },
          {
            question: "Retail",
            answer: "Shopping centers and retail districts in Great Falls offer prime vending locations, with high-traffic areas including food courts, entrances, and common spaces frequented by shoppers."
          },
          {
            question: "Office Buildings",
            answer: "Office complexes in Great Falls provide ideal vending locations with multiple tenants, high employee counts, and break areas that ensure steady machine usage during business hours."
          },
          {
            question: "Transportation",
            answer: "Transit facilities throughout Great Falls provide excellent vending opportunities in terminals, waiting areas, and high-traffic zones with consistent traveler foot traffic."
          },
          {
            question: "{item.q}",
            answer: "{item.a}"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Great Falls', item: `https://www.thevendinglocator.com/vending-leads/great-falls-montana` }
            ]
          })
        }}
      />
