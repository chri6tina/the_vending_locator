...
export default function RexburgIdahoVendingLeadsPage() {
  ...
  const cityDisplayName = 'Rexburg';const stateDisplayName = 'Idaho';
  ...
  const cityData = {
    ...
    'rating': '4.7/5',
    'description': 'University city with agriculture and growing tech sector'
  };
  ...
  const [userNames, setUserNames] = useState([
    'Mike from Rexburg', 'Sarah in Rexburg', 'David in Rexburg', 'Lisa in Rexburg',
    'Tom in Rexburg', 'Jennifer in Rexburg', 'Robert in Rexburg', 'Amanda in Rexburg',
    'Chris in Rexburg', 'Maria in Rexburg', 'James in Rexburg', 'Emily in Rexburg'
  ])
  ...
  const newHampshire = states.find(s => s.slug === 'idaho');
  const relatedCities = newHampshire ? newHampshire.cities.filter(c => c.slug !== 'manchester-idaho').slice(0, 8) : [];

  // FAQ items reused for JSON-LD
  const faqItems = [
    { q: "What types of vending machine locations are available in Rexburg?", a: "Rexburg offers vending opportunities at BYU-Idaho campus buildings, agricultural businesses, retail centers, healthcare facilities, and local offices serving the university community." },
    { q: "How quickly can I get vending machine leads for Rexburg?", a: "Our Rexburg vending leads are delivered within 3-5 business days with detailed information about each location and eastern Idaho market insights." },
    { q: "What makes Rexburg a good market for vending machines?", a: "Rexburg's economy, driven by BYU-Idaho's large enrollment, creates consistent year-round vending demand. The university's growth and the city's agricultural base provide diverse placement opportunities." },
    { q: "Do you provide ongoing support for Rexburg locations?", a: "Yes, we provide comprehensive support including location research, university market insights, contact information, and placement strategies tailored to Rexburg's academic environment." },
    { q: "What industries in Rexburg are best for vending machines?", a: "Higher education (BYU-Idaho), agricultural businesses, retail centers, and healthcare facilities show excellent potential due to large student populations and consistent traffic." },
        ...
        <section className="relative py-20 bg-white overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              >
                Access premium vending machine leads in Rexburg, Idaho, featuring verified locations across healthcare facilities, educational institutions, and commercial centers.</motion.p>
...
{/* Social Proof Stats */}
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Healthcare institutions in Rexburg offer prime vending locations with high visitor counts, extended operating hours, and captive audiences seeking convenient snack and beverage options.</p>
              </motion.div>
              <motion.div
                key="Education"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Rexburg's schools, colleges, and universities create excellent vending opportunities with high student traffic, campus events, and extended hours that maximize machine usage.</p>
              </motion.div>
              <motion.div
                key="Manufacturing"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Industrial operations in Rexburg feature large workforces and shift schedules that create reliable vending revenue through employee break times and shift changes.</p>
              </motion.div>
              <motion.div
                key="Retail"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Retail locations throughout Rexburg provide excellent vending opportunities in malls, shopping centers, and high-traffic commercial areas with consistent customer flow.</p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Corporate office buildings throughout Rexburg feature professional workforces and business operations that create reliable vending revenue through employee break times and meetings.</p>
              </motion.div>
              <motion.div
                key="Transportation"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Airports, bus stations, and transit centers throughout Rexburg generate steady passenger traffic, providing excellent vending placement options in high-traffic areas frequented by travelers.</p>
              </motion.div>
            </div>
          </div>
        </section>        {/* Why Rexburg? */}
        <section className="py-16 bg-warm-white">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              ...
              >
                Why Choose Rexburg for Vending Machines?
              </motion.h2>
            </div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <p className="text-lg text-stone leading-relaxed">
                Rexburg offers strong vending opportunities through its diverse business community, combining local commerce, healthcare facilities, educational institutions, and growing commercial sectors. The city's business mix provides multiple placement options with varying traffic patterns, while Rexburg's economic stability supports consistent consumer demand. The city's combination of established businesses and growing sectors creates reliable vending placement opportunities.
              </p>
            </motion.div>
          </div>
        </section>
      ...
      <CityPageSEO
        ...
        description="Get verified vending machine leads and locations in Rexburg, Idaho. Find qualified businesses for vending machine placement."
        faqs={[
          {
            question: "Healthcare",
            answer: "Healthcare institutions in Rexburg offer prime vending locations with high visitor counts, extended operating hours, and captive audiences seeking convenient snack and beverage options."
          },
          {
            question: "Education",
            answer: "Rexburg's schools, colleges, and universities create excellent vending opportunities with high student traffic, campus events, and extended hours that maximize machine usage."
          },
          {
            question: "Manufacturing",
            answer: "Industrial operations in Rexburg feature large workforces and shift schedules that create reliable vending revenue through employee break times and shift changes."
          },
          {
            question: "Retail",
            answer: "Retail locations throughout Rexburg provide excellent vending opportunities in malls, shopping centers, and high-traffic commercial areas with consistent customer flow."
          },
          {
            question: "Office Buildings",
            answer: "Corporate office buildings throughout Rexburg feature professional workforces and business operations that create reliable vending revenue through employee break times and meetings."
          },
          {
            question: "Transportation",
            answer: "Airports, bus stations, and transit centers throughout Rexburg generate steady passenger traffic, providing excellent vending placement options in high-traffic areas frequented by travelers."
          },
          {
            question: "{item.q}",
            answer: "{item.a}"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'New Hampshire', item: 'https://www.thevendinglocator.com/vending-leads/idaho' },
              { '@type': 'ListItem', position: 4, name: 'Manchester', item: 'https://www.thevendinglocator.com/vending-leads/manchester-idaho' }
            ]
          })
        }}
      />
