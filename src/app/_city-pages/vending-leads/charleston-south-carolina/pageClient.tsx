...
export default function CharlestonSouthCarolinaVendingLeadsPage() {
  ...
  const cityDisplayName = 'Charleston'; const stateDisplayName = 'South Carolina';
  ...
  const cityData = {
    ...
    'rating': '4.6/5',
    'description': 'Major historic port city and business center'
  };
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setActiveUsers(prev => {
        ...
        return Math.max(19, Math.min(29, newValue))
      })
    }, 3000)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Port & Maritime</h3>
              </div>
              <p className="text-gray-600">
                {cityDisplayName} is home to one of the largest ports on the East Coast, providing excellent opportunities for port-related and maritime vending machine placement.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Tourism & Hospitality</h3>
              </div>
              <p className="text-gray-600">
                Historic downtown and tourism venues in {cityDisplayName} provide excellent opportunities for tourism-focused vending machine placement.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Medical University of South Carolina and other healthcare facilities offer steady vending machine traffic throughout the day.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                College of Charleston and other educational facilities provide consistent student and faculty traffic for reliable vending machine revenue.
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                {cityDisplayName} offers excellent opportunities in port and maritime facilities, tourism and hospitality venues, corporate offices, healthcare facilities, educational institutions, and government buildings. The city's historic charm and business environment provide numerous vending machine placement opportunities.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Vending machine revenue in {cityDisplayName} varies by location type, but our verified locations typically generate $180-720+ per month per machine. Port facilities and tourism venues tend to perform best due to consistent foot traffic.
              </p>
            </div>
      ...
      <CityPageSEO
        ...
        description="Get verified vending machine leads and locations in Charleston, South Carolina. Find qualified businesses for vending machine placement."
        faqs={[
          {
            question: "Port & Maritime",
            answer: "{cityDisplayName} is home to one of the largest ports on the East Coast, providing excellent opportunities for port-related and maritime vending machine placement."
          },
          {
            question: "Tourism & Hospitality",
            answer: "Historic downtown and tourism venues in {cityDisplayName} provide excellent opportunities for tourism-focused vending machine placement."
          },
          {
          ...
          },
          {
            ...
            answer: "Medical University of South Carolina and other healthcare facilities offer steady vending machine traffic throughout the day."
          },
          {
            question: "Educational Institutions",
            answer: "College of Charleston and other educational facilities provide consistent student and faculty traffic for reliable vending machine revenue."
          },
          {
          ...
          },
          {
            ...
            answer: "{cityDisplayName} offers excellent opportunities in port and maritime facilities, tourism and hospitality venues, corporate offices, healthcare facilities, educational institutions, and government buildings. The city's historic charm and business environment provide numerous vending machine placement opportunities."
          },
          {
          ...
          },
          {
            ...
            answer: "Vending machine revenue in {cityDisplayName} varies by location type, but our verified locations typically generate $80-720+ per month per machine. Port facilities and tourism venues tend to perform best due to consistent foot traffic."
          },
          {
