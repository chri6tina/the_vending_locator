...
export default function ColumbusOhioVendingLeadsPage() {
  ...
  const cityDisplayName = 'Columbus';const stateDisplayName = 'Ohio';
  ...
  const cityData = {
    ...
    'rating': '4.8/5',
    'description': 'Ohio\'s capital and largest city'
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Government & State Offices</h3>
              </div>
              <p className="text-gray-600">
                As Ohio's capital, {cityDisplayName} is home to numerous government buildings, state agencies, and federal offices providing excellent vending opportunities.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Major corporations and Fortune 500 companies have headquarters in {cityDisplayName}, offering high-traffic office vending machine opportunities.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                {cityDisplayName} is home to The Ohio State University and numerous colleges, providing consistent student and faculty traffic for vending machines.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Major hospitals, medical centers, and healthcare facilities throughout {cityDisplayName} offer steady vending machine traffic throughout the day.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Retail & Shopping Centers</h3>
              </div>
              <p className="text-gray-600">
                Shopping malls, retail districts, and entertainment venues in {cityDisplayName} provide diverse vending machine placement opportunities.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Transportation Hubs</h3>
              </div>
              <p className="text-gray-600">
                {cityDisplayName} International Airport and major transportation centers offer high-traffic vending machine opportunities for travelers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                {cityDisplayName} offers excellent opportunities in government buildings, corporate offices, universities, hospitals, shopping centers, and transportation hubs. As Ohio's capital, the city has diverse business environments perfect for vending machine placement.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Vending machine revenue in {cityDisplayName} varies by location type, but our verified locations typically generate $250-800+ per month per machine. Government buildings and corporate offices tend to perform best due to consistent foot traffic.
              </p>
            </div>
      ...
      <CityPageSEO
        ...
        description="Get verified vending machine leads and locations in Columbus, Ohio. Find qualified businesses for vending machine placement."
        faqs={[
          {
            question: "Government & State Offices",
            answer: "As Ohio's capital, {cityDisplayName} is home to numerous government buildings, state agencies, and federal offices providing excellent vending opportunities."
          },
          {
            question: "Corporate Headquarters",
            answer: "Major corporations and Fortune 500 companies have headquarters in {cityDisplayName}, offering high-traffic office vending machine opportunities."
          },
          {
            question: "Educational Institutions",
            answer: "{cityDisplayName} is home to The Ohio State University and numerous colleges, providing consistent student and faculty traffic for vending machines."
          },
          {
          ...
          {
            question: "Retail & Shopping Centers",
            answer: "Shopping malls, retail districts, and entertainment venues in {cityDisplayName} provide diverse vending machine placement opportunities."
          },
          {
            question: "Transportation Hubs",
            answer: "{cityDisplayName} International Airport and major transportation centers offer high-traffic vending machine opportunities for travelers."
          },
          {
            question: "What types of businesses in {cityDisplayName} are best for vending machines?",
            answer: "{cityDisplayName} offers excellent opportunities in government buildings, corporate offices, universities, hospitals, shopping centers, and transportation hubs. As Ohio's capital, the city has diverse business environments perfect for vending machine placement."
          },
          {
          ...
          },
          {
            ...
            answer: "Vending machine revenue in {cityDisplayName} varies by location type, but our verified locations typically generate $250-800+ per month per machine. Government buildings and corporate offices tend to perform best due to consistent foot traffic."
          },
          {
