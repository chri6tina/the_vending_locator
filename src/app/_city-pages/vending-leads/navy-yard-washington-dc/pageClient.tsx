...
export default function NavyYardWashingtonDCVendingLeadsPage() {
  // City and state display names
  const cityDisplayName = 'Navy Yard';const stateDisplayName = 'Washington DC';
  ...
  const cityData = {
    ...
    'rating': '4.7/5',
    'description': 'Waterfront development with corporate offices, residential towers, and entertainment district'
  };
  ...
  const [userNames, setUserNames] = useState(['Mike from Navy Yard', 'Sarah in Navy Yard', 'David in Navy Yard', 'Lisa in Navy Yard', 'Tom in Navy Yard', 'Jennifer in Navy Yard', 'Robert in Navy Yard', 'Amanda in Navy Yard', 'Chris in Navy Yard', 'Maria in Navy Yard', 'James in Navy Yard', 'Emily in Navy Yard'])
  ...
  const relatedCities = newHampshire ? newHampshire.cities.filter(c => c.slug !== 'navy-yard-washington-dc').slice(0, 8) : [];

  // FAQ items reused for JSON-LD
  const faqItems = [
    { q: 'What types of vending machine locations are available in Navy Yard?', a: 'Navy Yard offers modern vending opportunities including corporate office buildings, residential towers, entertainment venues, waterfront restaurants, and retail locations. Each location is pre-verified for optimal vending machine success.' },
    { q: 'How quickly can I get vending machine leads for Navy Yard?', a: 'Our Navy Yard vending leads are delivered within 3-5 business days. We provide comprehensive research including business details, contact information, and placement opportunities to accelerate your market entry.' },
    { q: 'What makes Navy Yard a good market for vending machines?', a: 'Navy Yard features modern corporate offices, new residential developments, and Nationals Park drawing crowds. The area\'s rapid development and entertainment activity create ideal conditions for vending machine success.' },
    { q: 'Do you provide ongoing support for Navy Yard locations?', a: 'Yes, we offer comprehensive support including location research, contact information, placement strategies, and ongoing consultation to ensure your vending machines thrive in Navy Yard.' },
        ...
        <section className="relative py-20 bg-white overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              >
                Connect with qualified vending locations in Navy Yard, Washington DC, spanning technology companies, medical centers, and educational campuses.</motion.p>
...
{/* Social Proof Stats */}
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Navy Yard's healthcare sector includes major medical centers, specialty clinics, and outpatient facilities that generate consistent patient and visitor traffic, creating ideal vending placement opportunities.</p>
              </motion.div>
              <motion.div
                key="Education"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Academic institutions in Navy Yard feature student centers, libraries, and common areas with consistent foot traffic, making them ideal locations for vending machine placement.</p>
              </motion.div>
              <motion.div
                key="Manufacturing"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Industrial and manufacturing operations throughout Navy Yard employ substantial workforces with shift-based schedules, offering stable vending placement opportunities with steady traffic.</p>
              </motion.div>
              <motion.div
                key="Retail"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Navy Yard's retail sector features shopping centers, strip malls, and commercial districts that offer strategic vending placement in areas with maximum shopper visibility.</p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Commercial office spaces in Navy Yard offer excellent vending opportunities, with professional tenants and business operations generating consistent foot traffic throughout the workday.</p>
              </motion.div>
              <motion.div
                key="Transportation"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Transportation hubs in Navy Yard offer prime vending locations with high passenger volumes, extended operating hours, and captive audiences waiting for departures.</p>
              </motion.div>
            </div>
          </div>
        </section>        {/* Why Navy Yard? */}
        <section className="py-16 bg-warm-white">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              ...
              >
                Why Choose Navy Yard for Vending Machines?
              </motion.h2>
            </div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <p className="text-lg text-stone leading-relaxed">
                Navy Yard offers strong vending opportunities through its diverse business community, combining local commerce, healthcare facilities, educational institutions, and growing commercial sectors. The city's business mix provides multiple placement options with varying traffic patterns, while Navy Yard's economic stability supports consistent consumer demand. The city's combination of established businesses and growing sectors creates reliable vending placement opportunities.
              </p>
            </motion.div>
          </div>
        </section>
      ...
      <CityPageSEO
        ...
        description="Get verified vending machine leads and locations in Navy Yard, Washington DC. Find qualified businesses for vending machine placement."
        faqs={[
          {
            question: "Healthcare",
            answer: "Navy Yard's healthcare sector includes major medical centers, specialty clinics, and outpatient facilities that generate consistent patient and visitor traffic, creating ideal vending placement opportunities."
          },
          {
            question: "Education",
            answer: "Academic institutions in Navy Yard feature student centers, libraries, and common areas with consistent foot traffic, making them ideal locations for vending machine placement."
          },
          {
            question: "Manufacturing",
            answer: "Industrial and manufacturing operations throughout Navy Yard employ substantial workforces with shift-based schedules, offering stable vending placement opportunities with steady traffic."
          },
          {
            question: "Retail",
            answer: "Navy Yard's retail sector features shopping centers, strip malls, and commercial districts that offer strategic vending placement in areas with maximum shopper visibility."
          },
          {
            question: "Office Buildings",
            answer: "Commercial office spaces in Navy Yard offer excellent vending opportunities, with professional tenants and business operations generating consistent foot traffic throughout the workday."
          },
          {
            question: "Transportation",
            answer: "Transportation hubs in Navy Yard offer prime vending locations with high passenger volumes, extended operating hours, and captive audiences waiting for departures."
          },
          {
            question: "{item.q}",
            answer: "{item.a}"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Manchester', item: 'https://www.thevendinglocator.com/vending-leads/navy-yard-washington-dc' }
            ]
          })
        }}
      />
