...
export default function NorthCharlestonSouthCarolinaVendingLeadsPage() {
  ...
  const cityData = {
    ...
    'rating': '4.4/5',
    'description': 'Major industrial and business center'
  };
  ...
  const [userNames, setUserNames] = useState([
    'Mike from North Charleston', 'Sarah in Downtown', 'David in North Charleston', 'Lisa in North Charleston',
    'Tom in North Charleston', 'Jennifer in North Charleston', 'Robert in North Charleston', 'Amanda in North Charleston',
    'Chris in North Charleston', 'Maria in North Charleston', 'James in North Charleston', 'Emily in North Charleston'
  ])
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Port & Industrial</h3>
              </div>
              <p className="text-gray-600">
                {cityDisplayName} is home to major port facilities and industrial complexes, providing excellent opportunities for industrial and port-related vending machine placement.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Educational facilities and training centers in {cityDisplayName} provide consistent student and faculty traffic for reliable vending machine revenue.
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                {cityDisplayName} offers excellent opportunities in port and industrial facilities, corporate offices, retail centers, healthcare facilities, educational institutions, and government buildings. The city's industrial and business environment provides numerous vending machine placement opportunities.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Vending machine revenue in {cityDisplayName} varies by location type, but our verified locations typically generate $120-480+ per month per machine. Industrial facilities and corporate offices tend to perform best due to consistent foot traffic.
              </p>
            </div>
      ...
      <CityPageSEO
        ...
        description="Get verified vending machine leads and locations in North Charleston, South Carolina. Find qualified businesses for vending machine placement."
        faqs={[
          {
            question: "Port & Industrial",
            answer: "{cityDisplayName} is home to major port facilities and industrial complexes, providing excellent opportunities for industrial and port-related vending machine placement."
          },
          {
          ...
          },
          {
            ...
            answer: "Educational facilities and training centers in {cityDisplayName} provide consistent student and faculty traffic for reliable vending machine revenue."
          },
          {
          ...
          },
          {
            ...
            answer: "{cityDisplayName} offers excellent opportunities in port and industrial facilities, corporate offices, retail centers, healthcare facilities, educational institutions, and government buildings. The city's industrial and business environment provides numerous vending machine placement opportunities."
          },
          {
