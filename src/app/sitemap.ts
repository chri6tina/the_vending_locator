...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const cityPages = [
    ...
    { url: 'https://thevendinglocator.com/vending-leads/fort-worth-texas', lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },
    { url: 'https://thevendinglocator.com/vending-leads/arlington-texas', lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },
    { url: 'https://thevendinglocator.com/vending-leads/plano-texas', lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },
    ...
    { url: 'https://thevendinglocator.com/vending-leads/oakland-california', lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },
    ...
    { url: 'https://thevendinglocator.com/vending-leads/fort-lauderdale-florida', lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },
