...
export default function NashvilleTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Tennessee requires a sales tax permit. Register your business and collect/remit tax on vending sales. Nashville may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Davidson County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Tennessee Secretary of State and obtain any required Nashville business licenses or permits.',
    additionalNotes: 'Check with the City of Nashville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Vanderbilt University Medical Center (largest employer)',
      'Tennessee State Capitol and Metro government',
      'Nashville International Airport (BNA)',
      'HCA Healthcare headquarters (largest health system)',
      'Nissan North America headquarters',
      'Music Row (Sony, Warner, Universal studios)',
      'Bridgestone Americas headquarters',
      'Grand Ole Opry and Opryland complex'
  ]
