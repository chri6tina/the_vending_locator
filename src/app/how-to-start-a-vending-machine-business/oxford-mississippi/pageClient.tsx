...
export default function OxfordMississippiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Oxford.",
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required local business licenses in Oxford.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Oxford",
