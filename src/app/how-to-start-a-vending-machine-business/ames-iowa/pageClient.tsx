...
export default function AmesIowaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Iowa requires a sales tax permit. Register your business and collect/remit tax on vending sales. Ames may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Ames County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Iowa Secretary of State and obtain any required Ames business licenses or permits.',
    additionalNotes: 'Check with the City of Ames for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Ames Hospital and medical facilities',
    'Downtown Ames office buildings and businesses',
    'Ames school district and educational facilities',
    'Ames municipal and county government buildings',
