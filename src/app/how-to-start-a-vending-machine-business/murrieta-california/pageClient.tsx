...
export default function MurrietaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Murrieta may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Murrieta County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Murrieta business licenses or permits.',
    additionalNotes: 'Check with the City of Murrieta for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Murrieta Hospital and medical facilities',
    'Downtown Murrieta office buildings and businesses',
    'Murrieta school district and educational facilities',
    'Murrieta municipal and county government buildings',
