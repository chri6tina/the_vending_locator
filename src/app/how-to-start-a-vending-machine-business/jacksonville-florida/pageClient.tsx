...
export default function JacksonvilleFloridaHowToStartPage() {
  ...
  const permitInfo = {
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Jacksonville.',
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Apply for food vending permits through Duval County Health Department if selling food/beverages. Confirm all local requirements for your specific locations.',
  ...
  const faqs = [
    {
      ...
      a: `You'll need a Florida sales tax permit, a ${cityDisplayName} business tax receipt, and if selling food/beverages, a Duval County health permit for each machine. Also register your LLC with the state.`
    },
    {
    ...
    },
    {
      ...
      a: `High-traffic areas like port facilities, office buildings downtown, healthcare campuses (Mayo Clinic, Baptist), manufacturing/logistics centers, UNF campus, and corporate parks in Southside and Town Center.`
    },
    {
