...
export default function NewBritainConnecticutHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Connecticut requires a sales tax permit. Register your business and collect/remit tax on vending sales. New Britain may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the New Britain County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Connecticut Secretary of State and obtain any required New Britain business licenses or permits.',
    additionalNotes: 'Check with the City of New Britain for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'New Britain Hospital and medical facilities',
    'Downtown New Britain office buildings and businesses',
    'New Britain school district and educational facilities',
    'New Britain municipal and county government buildings',
