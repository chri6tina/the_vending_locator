...
export default function SandpointIdahoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Sandpoint.",
  "businessLicense": "Register your LLC with the Idaho Secretary of State and obtain any required local business licenses in Sandpoint.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Sandpoint",
