...
export default function SanBernardinoCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. San Bernardino may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the San Bernardino County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required San Bernardino business licenses or permits.',
    additionalNotes: 'Check with the City of San Bernardino for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'San Bernardino Hospital and medical facilities',
    'Downtown San Bernardino office buildings and businesses',
    'San Bernardino school district and educational facilities',
    'San Bernardino municipal and county government buildings',
