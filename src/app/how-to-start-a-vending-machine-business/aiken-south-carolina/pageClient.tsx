...
export default function AikenSouthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'South Carolina requires a sales tax permit. Register your business and collect/remit tax on vending sales. Aiken may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Aiken County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the South Carolina Secretary of State and obtain any required Aiken business licenses or permits.',
    additionalNotes: 'Check with the City of Aiken for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Aiken Hospital and medical facilities',
    'Downtown Aiken office buildings and businesses',
    'Aiken school district and educational facilities',
    'Aiken municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Aiken',
