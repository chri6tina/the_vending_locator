...
export default function KirksvilleMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Kirksville.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Kirksville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Kirksville",
