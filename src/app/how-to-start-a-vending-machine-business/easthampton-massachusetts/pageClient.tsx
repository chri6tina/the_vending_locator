...
export default function EasthamptonMassachusettsHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Massachusetts requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Easthampton.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Easthampton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Easthampton",
