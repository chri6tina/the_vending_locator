...
export default function LewistonMaineHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Maine requires a sales tax permit. Register your business and collect/remit tax on vending sales. Lewiston may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Lewiston County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Maine Secretary of State and obtain any required Lewiston business licenses or permits.',
    additionalNotes: 'Check with the City of Lewiston for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Lewiston Hospital and medical facilities',
    'Downtown Lewiston office buildings and businesses',
    'Lewiston school district and educational facilities',
    'Lewiston municipal and county government buildings',
