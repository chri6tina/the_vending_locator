...
export default function HarrisonArkansasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Harrison.",
  "businessLicense": "Register your LLC with the Arkansas Secretary of State and obtain any required local business licenses in Harrison.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Harrison",
