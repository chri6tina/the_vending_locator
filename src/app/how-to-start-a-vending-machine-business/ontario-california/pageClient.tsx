...
export default function OntarioCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Ontario may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Ontario business licenses or permits.',
    additionalNotes: 'Check with the City of Ontario for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Ontario International Airport (ONT - fastest growing in US)',
      'Kaiser Permanente Ontario Medical Center',
      'Prime Healthcare Ontario Medical Center',
      'Citizens Business Bank Arena',
      'Ontario Mills mega-mall',
      'UPS Ontario distribution hub',
      'Amazon fulfillment and sortation centers',
      'Auto Club Speedway area (Fontana)'
  ]
