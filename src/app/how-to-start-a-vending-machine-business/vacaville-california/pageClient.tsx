...
export default function VacavilleCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Vacaville may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Vacaville County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Vacaville business licenses or permits.',
    additionalNotes: 'Check with the City of Vacaville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Vacaville Hospital and medical facilities',
    'Downtown Vacaville office buildings and businesses',
    'Vacaville school district and educational facilities',
    'Vacaville municipal and county government buildings',
