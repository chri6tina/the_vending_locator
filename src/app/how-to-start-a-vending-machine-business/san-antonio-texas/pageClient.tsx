...
export default function SanAntonioTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. San Antonio may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Bexar County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required San Antonio business licenses or permits.',
    additionalNotes: 'Check with the City of San Antonio for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Joint Base San Antonio (Lackland, Fort Sam Houston, Randolph)',
      'USAA headquarters and financial services',
      'South Texas Medical Center',
      'University of Texas at San Antonio (UTSA)',
      'Toyota manufacturing plant',
      'San Antonio International Airport',
      'The Alamo and downtown tourism district',
