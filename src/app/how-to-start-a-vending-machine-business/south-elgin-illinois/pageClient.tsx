...
export default function SouthElginIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in South Elgin.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in South Elgin.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in South Elgin",
