...
export default function GeorgetownWashingtonDcHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington DC requires a sales tax permit. Register your business and collect/remit tax on vending sales. Georgetown may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Georgetown County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Washington DC Secretary of State and obtain any required Georgetown business licenses or permits.',
    additionalNotes: 'Check with the City of Georgetown for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Georgetown Hospital and medical facilities',
    'Downtown Georgetown office buildings and businesses',
    'Georgetown school district and educational facilities',
    'Georgetown municipal and county government buildings',
