...
export default function SpringfieldOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Oregon requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Springfield.",
  "businessLicense": "Register your LLC with the Oregon Secretary of State and obtain any required local business licenses in Springfield.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Springfield",
