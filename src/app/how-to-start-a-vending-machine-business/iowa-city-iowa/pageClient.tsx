...
export default function IowaCityIowaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Iowa requires a sales tax permit. Register your business and collect/remit tax on vending sales. Iowa City may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Iowa City County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Iowa Secretary of State and obtain any required Iowa City business licenses or permits.',
    additionalNotes: 'Check with the City of Iowa City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Iowa City medical centers and healthcare facilities',
    'Downtown Iowa City office buildings and businesses',
    'University of Iowa campus and facilities',
    'Iowa City municipal and county government buildings',
