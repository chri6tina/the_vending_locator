...
export default function MissionViejoCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Mission Viejo also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Mission Viejo.',
    additionalNotes: 'Some locations like the Port of Mission Viejo or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Mission Viejo Port facilities and logistics operations',
      'Naval Air Station Mission Viejo and military contractors',
      ...
      'Mission Viejo Beach and coastal tourism areas',
      'Corporate parks in local business districts'
  ]

  const neighborhoods = [
      'Downtown Mission Viejo',
