...
export default function CitrusHeightsCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Citrus Heights also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Citrus Heights.',
    additionalNotes: 'Some locations like the Port of Citrus Heights or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Citrus Heights Port facilities and logistics operations',
      'Naval Air Station Citrus Heights and military contractors',
      'Major healthcare systems (local healthcare systems)',
      'Downtown office buildings and financial services',
      'Manufacturing and distribution centers',
      'University of North California campus',
      'Citrus Heights Beach and coastal tourism areas',
      'Corporate parks in local business districts'
  ]

  const neighborhoods = [
      'Downtown Citrus Heights',
