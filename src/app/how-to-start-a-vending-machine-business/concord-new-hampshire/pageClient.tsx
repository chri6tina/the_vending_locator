...
export default function ConcordNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Hampshire requires a sales tax permit. Register your business and collect/remit tax on vending sales. Concord may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Concord County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Hampshire Secretary of State and obtain any required Concord business licenses or permits.',
    additionalNotes: 'Check with the City of Concord for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Concord Hospital and medical facilities',
    'Downtown Concord office buildings and businesses',
    'Concord school district and educational facilities',
    'New Hampshire state government offices and capitol complex',
    ...
    'Concord Airport and related businesses'
  ]
