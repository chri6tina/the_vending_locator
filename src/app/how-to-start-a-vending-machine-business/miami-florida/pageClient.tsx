...
export default function MiamiFloridaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Florida requires a sales tax permit. Register your business and collect/remit tax on vending sales. Miami may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Miami-Dade County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Florida Secretary of State and obtain any required Miami business licenses or permits.',
    additionalNotes: 'Check with the City of Miami for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Miami International Airport (MIA - top cargo hub)',
      'PortMiami (cruise capital - 7M passengers/year)',
      'Jackson Memorial Hospital and Bascom Palmer Eye Institute',
      'University of Miami and Miller School of Medicine',
      'Downtown Miami Brickell financial district',
      'Miami Beach Convention Center',
      'Royal Caribbean and Norwegian Cruise Lines HQs',
      'Wynwood Arts District businesses'
  ]
