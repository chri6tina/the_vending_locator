...
export default function LocustGroveGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Locust Grove.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Locust Grove.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Locust Grove",
