...
export default function DahlonegaGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Dahlonega.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Dahlonega.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Dahlonega",
