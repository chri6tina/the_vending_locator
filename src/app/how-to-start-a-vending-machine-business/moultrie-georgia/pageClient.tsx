...
export default function MoultrieGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Moultrie.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Moultrie.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Moultrie",
