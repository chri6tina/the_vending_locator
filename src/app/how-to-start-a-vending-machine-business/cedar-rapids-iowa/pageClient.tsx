...
export default function CedarRapidsIowaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Iowa requires a sales tax permit. Register your business and collect/remit tax on vending sales. Cedar Rapids may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Cedar Rapids County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Iowa Secretary of State and obtain any required Cedar Rapids business licenses or permits.',
    additionalNotes: 'Check with the City of Cedar Rapids for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Cedar Rapids Hospital and medical facilities',
    'Downtown Cedar Rapids office buildings and businesses',
    'Cedar Rapids school district and educational facilities',
    'Cedar Rapids municipal and county government buildings',
