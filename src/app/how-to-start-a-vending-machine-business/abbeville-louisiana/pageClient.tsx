...
export default function AbbevilleLouisianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Abbeville.",
  "businessLicense": "Register your LLC with the Louisiana Secretary of State and obtain any required local business licenses in Abbeville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Abbeville",
