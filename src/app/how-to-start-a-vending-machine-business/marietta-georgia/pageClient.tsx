...
export default function MariettaGeorgiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Georgia requires a sales tax permit. Register your business and collect/remit tax on vending sales. Marietta may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Marietta County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Georgia Secretary of State and obtain any required Marietta business licenses or permits.',
    additionalNotes: 'Check with the City of Marietta for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Marietta Hospital and medical facilities',
    'Downtown Marietta office buildings and businesses',
    'Marietta school district and educational facilities',
    'Marietta municipal and county government buildings',
