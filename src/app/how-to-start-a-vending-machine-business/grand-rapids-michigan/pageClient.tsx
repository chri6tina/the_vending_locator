...
export default function GrandRapidsMichiganHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Michigan requires a sales tax permit. Register your business and collect/remit tax on vending sales. Grand Rapids may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Grand Rapids County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Michigan Secretary of State and obtain any required Grand Rapids business licenses or permits.',
    additionalNotes: 'Check with the City of Grand Rapids for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Grand Rapids Hospital and medical facilities',
    'Downtown Grand Rapids office buildings and businesses',
    'Grand Rapids school district and educational facilities',
    'Grand Rapids municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Grand Rapids',
