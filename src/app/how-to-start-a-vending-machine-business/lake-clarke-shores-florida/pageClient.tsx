...
export default function LakeClarkeShoresFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lake Clarke Shores.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Lake Clarke Shores.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lake Clarke Shores",
