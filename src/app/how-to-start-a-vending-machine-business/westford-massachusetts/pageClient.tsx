...
export default function WestfordMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Westford.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Westford.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Westford",
