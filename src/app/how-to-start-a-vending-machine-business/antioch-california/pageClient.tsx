...
export default function AntiochCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Antioch may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Antioch County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Antioch business licenses or permits.',
    additionalNotes: 'Check with the City of Antioch for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Antioch Hospital and medical facilities',
    'Downtown Antioch office buildings and businesses',
    'Antioch school district and educational facilities',
    'Antioch municipal and county government buildings',
