...
export default function PuebloColoradoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Colorado requires a sales tax permit. Register your business and collect/remit tax on vending sales. Pueblo may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Pueblo County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Colorado Secretary of State and obtain any required Pueblo business licenses or permits.',
    additionalNotes: 'Check with the City of Pueblo for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Pueblo Hospital and medical facilities',
    'Downtown Pueblo office buildings and businesses',
    'Pueblo school district and educational facilities',
    'Pueblo municipal and county government buildings',
