...
export default function StCharlesIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in St. Charles.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in St. Charles.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in St. Charles",
