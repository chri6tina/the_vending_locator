...
export default function LaPorteIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in La Porte.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in La Porte.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in La Porte",
