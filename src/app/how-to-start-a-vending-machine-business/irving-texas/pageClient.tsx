...
export default function IrvingTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Irving may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required Irving business licenses or permits.',
    additionalNotes: 'Check with the City of Irving for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Dallas/Fort Worth International Airport (DFW)',
      'Las Colinas business district and urban center',
