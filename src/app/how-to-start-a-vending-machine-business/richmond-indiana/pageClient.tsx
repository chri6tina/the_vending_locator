...
export default function RichmondIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Richmond.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Richmond.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Richmond",
