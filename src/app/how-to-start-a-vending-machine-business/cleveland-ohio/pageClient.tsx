...
export default function ClevelandOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Ohio requires a sales tax permit. Register your business and collect/remit tax on vending sales. Cleveland may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Cuyahoga County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Ohio Secretary of State and obtain any required Cleveland business licenses or permits.',
