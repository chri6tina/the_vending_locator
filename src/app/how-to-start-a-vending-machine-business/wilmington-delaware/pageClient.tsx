...
export default function WilmingtonDelawareHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Delaware requires a sales tax permit. Register your business and collect/remit tax on vending sales. Wilmington may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Delaware Secretary of State and obtain any required Wilmington business licenses or permits.',
