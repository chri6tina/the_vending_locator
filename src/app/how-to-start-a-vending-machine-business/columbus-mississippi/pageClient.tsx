...
export default function ColumbusMississippiHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required local business licenses in Columbus.",
