...
export default function PortStLucieFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Port St. Lucie.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Port St. Lucie.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Port St. Lucie",
