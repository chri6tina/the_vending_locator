...
export default function ManchesterNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Hampshire requires a sales tax permit. Register your business and collect/remit tax on vending sales. Manchester may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Manchester County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Hampshire Secretary of State and obtain any required Manchester business licenses or permits.',
    additionalNotes: 'Check with the City of Manchester for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Manchester Hospital and medical facilities',
    'Downtown Manchester office buildings and businesses',
    'Manchester school district and educational facilities',
    'Manchester municipal and county government buildings',
