...
export default function UplandCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Upland also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Upland.',
    additionalNotes: 'Some locations like the Port of Upland or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Upland Port facilities and logistics operations',
      'Naval Air Station Upland and military contractors',
      ...
      'Upland Beach and coastal tourism areas',
