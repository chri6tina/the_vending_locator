...
export default function ShowLowArizonaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Show Low.",
  "businessLicense": "Register your LLC with the Arizona Secretary of State and obtain any required local business licenses in Show Low.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Show Low",
