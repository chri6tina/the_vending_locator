...
export default function PostFallsIdahoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Post Falls.",
  "businessLicense": "Register your LLC with the Idaho Secretary of State and obtain any required local business licenses in Post Falls.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Post Falls",
