...
export default function TylerTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Tyler may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Tyler County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required Tyler business licenses or permits.',
    additionalNotes: 'Check with the City of Tyler for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Tyler Hospital and medical facilities',
    'Downtown Tyler office buildings and businesses',
    'Tyler school district and educational facilities',
    'Tyler municipal and county government buildings',
