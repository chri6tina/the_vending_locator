...
export default function CostaMesaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Costa Mesa may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Costa Mesa County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Costa Mesa business licenses or permits.',
    additionalNotes: 'Check with the City of Costa Mesa for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Costa Mesa Hospital and medical facilities',
    'Downtown Costa Mesa office buildings and businesses',
    'Costa Mesa school district and educational facilities',
    'Costa Mesa municipal and county government buildings',
