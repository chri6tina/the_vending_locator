...
export default function FarmingtonNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Mexico requires a sales tax permit. Register your business and collect/remit tax on vending sales. Farmington may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Farmington County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Mexico Secretary of State and obtain any required Farmington business licenses or permits.',
    additionalNotes: 'Check with the City of Farmington for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Farmington Hospital and medical facilities',
    'Downtown Farmington office buildings and businesses',
    'Farmington school district and educational facilities',
    'Farmington municipal and county government buildings',
