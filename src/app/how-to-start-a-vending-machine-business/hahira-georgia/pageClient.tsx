...
export default function HahiraGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Hahira.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Hahira.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Hahira",
