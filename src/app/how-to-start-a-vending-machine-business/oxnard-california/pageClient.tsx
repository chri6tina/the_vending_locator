...
export default function OxnardCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Oxnard may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Oxnard County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Oxnard business licenses or permits.',
    additionalNotes: 'Check with the City of Oxnard for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Oxnard Hospital and medical facilities',
    'Downtown Oxnard office buildings and businesses',
    'Oxnard school district and educational facilities',
    'Oxnard municipal and county government buildings',
