...
export default function LivingstonMontanaHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Montana Secretary of State and obtain any required local business licenses in Livingston.",
