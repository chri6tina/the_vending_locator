...
export default function NewHavenConnecticutHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Connecticut requires a sales tax permit. Register your business and collect/remit tax on vending sales. New Haven may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the New Haven County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Connecticut Secretary of State and obtain any required New Haven business licenses or permits.',
    additionalNotes: 'Check with the City of New Haven for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'New Haven Hospital and medical facilities',
    'Downtown New Haven office buildings and businesses',
    'New Haven school district and educational facilities',
    'New Haven municipal and county government buildings',
