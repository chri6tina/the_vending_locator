...
export default function WaterburyConnecticutHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Connecticut requires a sales tax permit. Register your business and collect/remit tax on vending sales. Waterbury may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Waterbury County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Connecticut Secretary of State and obtain any required Waterbury business licenses or permits.',
    additionalNotes: 'Check with the City of Waterbury for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Waterbury Hospital and medical facilities',
    'Downtown Waterbury office buildings and businesses',
    'Waterbury school district and educational facilities',
    'Waterbury municipal and county government buildings',
