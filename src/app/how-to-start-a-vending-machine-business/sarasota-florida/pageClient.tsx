...
export default function SarasotaFloridaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Florida requires a sales tax permit. Register your business and collect/remit tax on vending sales. Sarasota may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Sarasota County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Florida Secretary of State and obtain any required Sarasota business licenses or permits.',
    additionalNotes: 'Check with the City of Sarasota for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Sarasota Hospital and medical facilities',
    'Downtown Sarasota office buildings and businesses',
    'Sarasota school district and educational facilities',
    'Sarasota municipal and county government buildings',
