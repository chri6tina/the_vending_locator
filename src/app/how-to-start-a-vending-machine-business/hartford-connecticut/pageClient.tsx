...
export default function HartfordConnecticutHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Connecticut requires a sales tax permit. Register your business and collect/remit tax on vending sales. Hartford may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Hartford County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Connecticut Secretary of State and obtain any required Hartford business licenses or permits.',
    additionalNotes: 'Check with the City of Hartford for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Hartford Hospital and medical facilities',
    'Downtown Hartford office buildings and businesses',
    'Hartford school district and educational facilities',
    'Connecticut state government offices and capitol complex',
    ...
    'Hartford Airport and related businesses'
  ]
