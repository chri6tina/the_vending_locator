...
export default function LawrenceMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lawrence.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Lawrence.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lawrence",
