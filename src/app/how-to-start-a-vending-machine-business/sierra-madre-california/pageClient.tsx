...
export default function SierraMadreCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Sierra Madre.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Sierra Madre.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Sierra Madre",
