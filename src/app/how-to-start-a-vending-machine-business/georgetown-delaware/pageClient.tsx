...
export default function GeorgetownDelawareHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Delaware requires a sales tax permit. Register your business and collect/remit tax on vending sales. Georgetown may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Delaware Secretary of State and obtain any required Georgetown business licenses or permits.',
