...
export default function RichmondCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Richmond may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Richmond County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Richmond business licenses or permits.',
    additionalNotes: 'Check with the City of Richmond for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Richmond Hospital and medical facilities',
    'Downtown Richmond office buildings and businesses',
    'Richmond school district and educational facilities',
    'Richmond municipal and county government buildings',
