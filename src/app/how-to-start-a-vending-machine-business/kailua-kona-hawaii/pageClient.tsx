...
export default function KailuaKonaHawaiiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Kailua-Kona.",
  "businessLicense": "Register your LLC with the Hawaii Secretary of State and obtain any required local business licenses in Kailua-Kona.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Kailua-Kona",
