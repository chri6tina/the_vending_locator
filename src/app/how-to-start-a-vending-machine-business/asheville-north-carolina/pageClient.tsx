...
export default function AshevilleNorthCarolinaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Asheville.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required local business licenses in Asheville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Asheville",
