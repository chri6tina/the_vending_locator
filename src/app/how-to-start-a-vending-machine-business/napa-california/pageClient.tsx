...
export default function NapaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Napa also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Napa.',
    additionalNotes: 'Some locations like the Port of Napa or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Napa Port facilities and logistics operations',
      'Naval Air Station Napa and military contractors',
      ...
      'Napa Beach and coastal tourism areas',
