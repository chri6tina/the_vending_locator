...
export default function SouthBayFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in South Bay.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in South Bay.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in South Bay",
