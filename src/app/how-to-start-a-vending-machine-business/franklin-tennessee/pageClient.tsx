...
export default function FranklinTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Tennessee requires a sales tax permit. Register your business and collect/remit tax on vending sales. Franklin may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Franklin County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Tennessee Secretary of State and obtain any required Franklin business licenses or permits.',
    additionalNotes: 'Check with the City of Franklin for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Franklin Hospital and medical facilities',
    'Downtown Franklin office buildings and businesses',
    'Franklin school district and educational facilities',
    'Franklin municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Franklin',
