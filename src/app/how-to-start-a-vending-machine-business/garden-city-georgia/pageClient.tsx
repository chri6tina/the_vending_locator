...
export default function GardenCityGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Garden City.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Garden City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Garden City",
