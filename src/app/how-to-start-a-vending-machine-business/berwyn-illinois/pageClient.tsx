...
export default function BerwynIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Berwyn.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Berwyn.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Berwyn",
