...
export default function OttawaKansasHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Kansas Secretary of State and obtain any required local business licenses in Ottawa.",
