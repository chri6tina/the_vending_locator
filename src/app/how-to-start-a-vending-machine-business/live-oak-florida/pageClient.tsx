...
export default function LiveOakFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Live Oak.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Live Oak.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Live Oak",
