...
export default function MedfordOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Oregon requires a sales tax permit. Register your business and collect/remit tax on vending sales. Medford may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Medford County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Oregon Secretary of State and obtain any required Medford business licenses or permits.',
    additionalNotes: 'Check with the City of Medford for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Medford Hospital and medical facilities',
    'Downtown Medford office buildings and businesses',
    'Medford school district and educational facilities',
    'Medford municipal and county government buildings',
