...
export default function BayCityMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Bay City.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Bay City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Bay City",
