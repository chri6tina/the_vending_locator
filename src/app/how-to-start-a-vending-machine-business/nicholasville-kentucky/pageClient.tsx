...
export default function NicholasvilleKentuckyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Nicholasville.",
  "businessLicense": "Register your LLC with the Kentucky Secretary of State and obtain any required local business licenses in Nicholasville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Nicholasville",
