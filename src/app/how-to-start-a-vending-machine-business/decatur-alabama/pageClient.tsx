...
export default function DecaturAlabamaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Alabama requires a sales tax permit. Register your business and collect/remit tax on vending sales. Decatur may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Decatur County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Alabama Secretary of State and obtain any required Decatur business licenses or permits.',
    additionalNotes: 'Check with the City of Decatur for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Decatur Hospital and medical facilities',
    'Downtown Decatur office buildings and businesses',
    'Decatur school district and educational facilities',
    'Decatur municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Decatur',
