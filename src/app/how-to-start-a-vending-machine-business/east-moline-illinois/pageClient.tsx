...
export default function EastMolineIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in East Moline.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in East Moline.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in East Moline",
