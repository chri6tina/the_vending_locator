...
export default function PhiladelphiaPennsylvaniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Pennsylvania requires a sales tax permit. Register your business and collect/remit tax on vending sales. Philadelphia may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Philadelphia County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Pennsylvania Secretary of State and obtain any required Philadelphia business licenses or permits.',
    additionalNotes: 'Check with the City of Philadelphia for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'University of Pennsylvania and Penn Medicine',
      'Comcast Center and downtown office towers',
      'Philadelphia International Airport',
      'Thomas Jefferson University and Hospitals',
      'Navy Yard corporate campus',
      'Temple University Health System',
      'Children\'s Hospital of Philadelphia (CHOP)',
      'Liberty Place and Center City businesses'
  ]
