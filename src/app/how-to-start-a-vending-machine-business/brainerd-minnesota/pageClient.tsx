...
export default function BrainerdMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Brainerd.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Brainerd.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Brainerd",
