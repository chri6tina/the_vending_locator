...
export default function HammondIndianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Indiana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Hammond may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Hammond County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Indiana Secretary of State and obtain any required Hammond business licenses or permits.',
    additionalNotes: 'Check with the City of Hammond for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Hammond Hospital and medical facilities',
    'Downtown Hammond office buildings and businesses',
    'Hammond school district and educational facilities',
    'Hammond municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Hammond',
