...
export default function RockyMountNorthCarolinaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rocky Mount.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required local business licenses in Rocky Mount.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rocky Mount",
