...
export default function CentennialColoradoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Colorado requires a sales tax permit. Register your business and collect/remit tax on vending sales. Centennial may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Centennial County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Colorado Secretary of State and obtain any required Centennial business licenses or permits.',
    additionalNotes: 'Check with the City of Centennial for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Centennial Hospital and medical facilities',
    'Downtown Centennial office buildings and businesses',
    'Centennial school district and educational facilities',
    'Centennial municipal and county government buildings',
