...
export default function LancasterCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Lancaster also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Lancaster.',
    additionalNotes: 'Some locations like the Port of Lancaster or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Lancaster Port facilities and logistics operations',
      'Naval Air Station Lancaster and military contractors',
      ...
      'Lancaster Beach and coastal tourism areas',
