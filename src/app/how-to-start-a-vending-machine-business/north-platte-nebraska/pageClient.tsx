...
export default function NorthPlatteNebraskaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Nebraska requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in North Platte.",
  "businessLicense": "Register your LLC with the Nebraska Secretary of State and obtain any required local business licenses in North Platte.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in North Platte",
