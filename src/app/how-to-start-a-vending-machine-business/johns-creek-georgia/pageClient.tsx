...
export default function JohnsCreekGeorgiaHowToStartPage() {
  const cityDisplayName = 'Johns Creek'
  const stateDisplayName = 'Georgia'
  const cityStateDisplay = `${cityDisplayName}, ${stateDisplayName}`

  // City-specific data
  const permitInfo = {
    salesTax: 'Georgia requires a sales tax permit through the Department of Revenue. Johns Creek also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Johns Creek.',
    additionalNotes: 'Some locations like the Port of Johns Creek or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Johns Creek Port facilities and logistics operations',
      'Naval Air Station Johns Creek and military contractors',
      ...
      'Johns Creek Beach and coastal tourism areas',
      'Corporate parks in local business districts'
  ]

  const neighborhoods = [
      'Downtown Johns Creek',
  ...
  const faqs = [
    {
      ...
      a: `You'll need a Georgia sales tax permit, a ${cityDisplayName} business tax receipt, and if selling food/beverages, a local county health permit for each machine. Also register your LLC with the state.`
    },
    {
    ...
    },
    {
      ...
      a: `You need a business tax receipt from ${cityDisplayName}, a Georgia sales tax permit, and health permits if selling food. No special vending-specific license is required beyond standard business registration.`
    },
    {
