...
export default function QuincyFloridaHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Quincy.",
