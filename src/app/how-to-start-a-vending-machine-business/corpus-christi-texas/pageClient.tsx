...
export default function CorpusChristiTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Corpus Christi may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Nueces County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required Corpus Christi business licenses or permits.',
    additionalNotes: 'Check with the City of Corpus Christi for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Port of Corpus Christi (3rd largest in US by tonnage)',
      'Naval Air Station Corpus Christi',
      'Corpus Christi International Airport',
      'Christus Spohn Health System',
      'Texas A&M University-Corpus Christi',
      'Flint Hills Resources refinery',
      'Downtown Corpus Christi and bayfront',
      'Cheniere Energy LNG terminal'
  ]
