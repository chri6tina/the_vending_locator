...
export default function RochesterMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Rochester.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Rochester.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Rochester",
