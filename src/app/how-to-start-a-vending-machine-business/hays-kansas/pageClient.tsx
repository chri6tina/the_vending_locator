...
export default function HaysKansasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Hays.",
  "businessLicense": "Register your LLC with the Kansas Secretary of State and obtain any required local business licenses in Hays.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Hays",
