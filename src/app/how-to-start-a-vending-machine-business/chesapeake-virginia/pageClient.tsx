...
export default function ChesapeakeVirginiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Virginia requires a sales tax permit. Register your business and collect/remit tax on vending sales. Chesapeake may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Independent City Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Virginia Secretary of State and obtain any required Chesapeake business licenses or permits.',
    additionalNotes: 'Check with the City of Chesapeake for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Chesapeake Regional Medical Center',
      'Dollar Tree corporate headquarters',
      'Sentara Albemarle Medical Center',
      'Greenbrier Parkway shopping and offices',
      'Chesapeake City Hall and government complex',
      'Battlefield Boulevard business corridor',
      'South Norfolk area businesses',
      'Western Branch Medical Center'
  ]
