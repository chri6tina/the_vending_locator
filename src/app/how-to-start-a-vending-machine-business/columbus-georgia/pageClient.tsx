...
export default function ColumbusGeorgiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Georgia requires a sales tax permit. Register your business and collect/remit tax on vending sales. Columbus may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Columbus County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Georgia Secretary of State and obtain any required Columbus business licenses or permits.',
    additionalNotes: 'Check with the City of Columbus for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Columbus Hospital and medical facilities',
    'Downtown Columbus office buildings and businesses',
    'Columbus school district and educational facilities',
    'Columbus municipal and county government buildings',
