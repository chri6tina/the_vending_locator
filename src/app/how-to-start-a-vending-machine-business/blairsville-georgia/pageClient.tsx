...
export default function BlairsvilleGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Blairsville.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Blairsville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Blairsville",
