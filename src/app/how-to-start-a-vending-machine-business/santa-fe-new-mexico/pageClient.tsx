...
export default function SantaFeNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Mexico requires a sales tax permit. Register your business and collect/remit tax on vending sales. Santa Fe may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Santa Fe County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Mexico Secretary of State and obtain any required Santa Fe business licenses or permits.',
    additionalNotes: 'Check with the City of Santa Fe for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Santa Fe Hospital and medical facilities',
    'Downtown Santa Fe office buildings and businesses',
    'Santa Fe school district and educational facilities',
    'New Mexico state government offices and capitol complex',
    ...
    'Santa Fe Airport and related businesses'
  ]
