...
export default function LewistonIdahoHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lewiston.",
  "businessLicense": "Register your LLC with the Idaho Secretary of State and obtain any required local business licenses in Lewiston.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lewiston",
