...
export default function PocatelloIdahoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Idaho requires a sales tax permit. Register your business and collect/remit tax on vending sales. Pocatello may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Pocatello County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Idaho Secretary of State and obtain any required Pocatello business licenses or permits.',
    additionalNotes: 'Check with the City of Pocatello for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Pocatello Hospital and medical facilities',
    'Downtown Pocatello office buildings and businesses',
    'Pocatello school district and educational facilities',
    'Pocatello municipal and county government buildings',
