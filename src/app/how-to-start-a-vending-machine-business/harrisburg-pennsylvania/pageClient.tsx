...
export default function HarrisburgPennsylvaniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Harrisburg.",
  "businessLicense": "Register your LLC with the Pennsylvania Secretary of State and obtain any required local business licenses in Harrisburg.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Harrisburg",
