...
export default function OremUtahHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Utah requires a sales tax permit. Register your business and collect/remit tax on vending sales. Orem may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Orem County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Utah Secretary of State and obtain any required Orem business licenses or permits.',
    additionalNotes: 'Check with the City of Orem for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Orem Hospital and medical facilities',
    'Downtown Orem office buildings and businesses',
    'Orem school district and educational facilities',
    'Orem municipal and county government buildings',
