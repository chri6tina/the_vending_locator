...
export default function MountainHomeArkansasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Arkansas requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mountain Home.",
  "businessLicense": "Register your LLC with the Arkansas Secretary of State and obtain any required local business licenses in Mountain Home.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mountain Home",
