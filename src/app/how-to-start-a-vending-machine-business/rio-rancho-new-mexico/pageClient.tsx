...
export default function RioRanchoNewMexicoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Mexico requires a sales tax permit. Register your business and collect/remit tax on vending sales. Rio Rancho may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Rio Rancho County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Mexico Secretary of State and obtain any required Rio Rancho business licenses or permits.',
    additionalNotes: 'Check with the City of Rio Rancho for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Rio Rancho Hospital and medical facilities',
    'Downtown Rio Rancho office buildings and businesses',
    'Rio Rancho school district and educational facilities',
    'Rio Rancho municipal and county government buildings',
