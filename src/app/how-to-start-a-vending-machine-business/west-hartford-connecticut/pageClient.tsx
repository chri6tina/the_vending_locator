...
export default function WestHartfordConnecticutHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Connecticut requires a sales tax permit through the Department of Revenue. West Hartford also has a local surtax. Register your business and collect/remit tax on vending sales.',
    healthPermit: 'If selling food or beverages, contact the local county Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of West Hartford.',
    additionalNotes: 'Some locations like the Port of West Hartford or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'West Hartford Port facilities and logistics operations',
      'Naval Air Station West Hartford and military contractors',
      'Major healthcare systems (local healthcare systems)',
      'Downtown office buildings and financial services',
      'Manufacturing and distribution centers',
      'University of North Connecticut campus',
      'West Hartford Beach and coastal tourism areas',
      'Corporate parks in local business districts'
  ]
  ...
  const neighborhoods = [
      ...
      'Westside',
      'Arlington',
      'Beaches (local beach communities)',
      'local neighborhoods',
      'Airport area'
  ]
  ...
  const steps = [
    {
      ...
      description: `Register your LLC with your state, obtain an EIN from the IRS, and get your sales tax permit from the your state tax authority. Register for the ${cityDisplayName} business tax receipt.`,
      icon: BuildingOffice2Icon
    },
    {
      title: '2. Permits & Licensing',
      description: 'Apply for food vending permits through local county Health Department if selling food/beverages. Confirm all local requirements for your specific locations.',
    ...
    },
    {
      ...
      description: `Target office buildings (50+ employees), healthcare facilities, logistics warehouses, gyms, and municipal facilities across ${cityStateDisplay}. Focus on the Port area, Southside corporate parks, and downtown offices.`,
      icon: MapPinIcon
    },
    {
  ...
  const faqs = [
    {
      ...
      a: `You'll need a Connecticut sales tax permit, a ${cityDisplayName} business tax receipt, and if selling food/beverages, a local county health permit for each machine. Also register your LLC with the state.`
    },
    {
    ...
    },
    {
      ...
      a: `High-traffic areas like port facilities, office buildings downtown, healthcare campuses (Mayo Clinic, Baptist), manufacturing/logistics centers, UNF campus, and corporate parks in local business districts.`
    },
    {
    ...
    },
    {
      ...
      a: `You need a business tax receipt from ${cityDisplayName}, a Connecticut sales tax permit, and health permits if selling food. No special vending-specific license is required beyond standard business registration.`
    },
    {
