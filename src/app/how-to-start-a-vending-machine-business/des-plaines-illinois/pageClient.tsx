...
export default function DesPlainesIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Des Plaines.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Des Plaines.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Des Plaines",
