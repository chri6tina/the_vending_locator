...
export default function BendOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Oregon requires a sales tax permit. Register your business and collect/remit tax on vending sales. Bend may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Bend County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Oregon Secretary of State and obtain any required Bend business licenses or permits.',
    additionalNotes: 'Check with the City of Bend for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Bend Hospital and medical facilities',
    'Downtown Bend office buildings and businesses',
    'Bend school district and educational facilities',
    'Bend municipal and county government buildings',
