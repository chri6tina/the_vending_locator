...
export default function DerryNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Hampshire requires a sales tax permit. Register your business and collect/remit tax on vending sales. Derry may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Derry County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Hampshire Secretary of State and obtain any required Derry business licenses or permits.',
    additionalNotes: 'Check with the City of Derry for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Derry Hospital and medical facilities',
    'Downtown Derry office buildings and businesses',
    'Derry school district and educational facilities',
    'Derry municipal and county government buildings',
