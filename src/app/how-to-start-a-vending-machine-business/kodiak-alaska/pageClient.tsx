...
export default function KodiakAlaskaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Alaska requires a sales tax permit. Register your business and collect/remit tax on vending sales. Kodiak may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Kodiak County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Alaska Secretary of State and obtain any required Kodiak business licenses or permits.',
    additionalNotes: 'Check with the City of Kodiak for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Kodiak Hospital and medical facilities',
    'Downtown Kodiak office buildings and businesses',
    'Kodiak school district and educational facilities',
    'Kodiak municipal and county government buildings',
