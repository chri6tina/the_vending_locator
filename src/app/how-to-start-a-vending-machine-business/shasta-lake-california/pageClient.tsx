...
export default function ShastaLakeCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Shasta Lake.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Shasta Lake.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Shasta Lake",
