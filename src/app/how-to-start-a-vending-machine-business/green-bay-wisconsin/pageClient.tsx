...
export default function GreenBayWisconsinHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Wisconsin requires a sales tax permit. Register your business and collect/remit tax on vending sales. Green Bay may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Green Bay County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Wisconsin Secretary of State and obtain any required Green Bay business licenses or permits.',
    additionalNotes: 'Check with the City of Green Bay for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Green Bay Hospital and medical facilities',
    'Downtown Green Bay office buildings and businesses',
    'Green Bay school district and educational facilities',
    'Green Bay municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Green Bay',
