...
export default function AdamsMorganWashingtonDcHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington DC requires a sales tax permit. Register your business and collect/remit tax on vending sales. Adams Morgan may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Adams Morgan County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Washington DC Secretary of State and obtain any required Adams Morgan business licenses or permits.',
    additionalNotes: 'Check with the City of Adams Morgan for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Adams Morgan Hospital and medical facilities',
    'Downtown Adams Morgan office buildings and businesses',
    'Adams Morgan school district and educational facilities',
    'Adams Morgan municipal and county government buildings',
