...
export default function DillinghamAlaskaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Alaska requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Dillingham.",
  "businessLicense": "Register your LLC with the Alaska Secretary of State and obtain any required local business licenses in Dillingham.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Dillingham",
