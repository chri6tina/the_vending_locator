...
export default function WasillaAlaskaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Alaska requires a sales tax permit. Register your business and collect/remit tax on vending sales. Wasilla may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Wasilla County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Alaska Secretary of State and obtain any required Wasilla business licenses or permits.',
    additionalNotes: 'Check with the City of Wasilla for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Wasilla Hospital and medical facilities',
    'Downtown Wasilla office buildings and businesses',
    'Wasilla school district and educational facilities',
    'Wasilla municipal and county government buildings',
