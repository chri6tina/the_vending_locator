...
export default function LakeMaryFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Lake Mary.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Lake Mary.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Lake Mary",
