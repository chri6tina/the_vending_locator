...
export default function PrescottArizonaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Arizona requires a sales tax permit through the Department of Revenue. Prescott also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Prescott.',
    additionalNotes: 'Some locations like the Port of Prescott or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Prescott Port facilities and logistics operations',
      'Naval Air Station Prescott and military contractors',
      'Major healthcare systems (local healthcare systems)',
      'Downtown office buildings and financial services',
      'Manufacturing and distribution centers',
      'University of North Arizona campus',
      'Prescott Beach and coastal tourism areas',
  ...
  const faqs = [
    {
      ...
      a: `You'll need a Arizona sales tax permit, a ${cityDisplayName} business tax receipt, and if selling food/beverages, a local county health permit for each machine. Also register your LLC with the state.`
    },
    {
    ...
    },
    {
      ...
      a: `You need a business tax receipt from ${cityDisplayName}, a Arizona sales tax permit, and health permits if selling food. No special vending-specific license is required beyond standard business registration.`
    },
    {
