...
export default function StoneMountainGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Stone Mountain.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Stone Mountain.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Stone Mountain",
