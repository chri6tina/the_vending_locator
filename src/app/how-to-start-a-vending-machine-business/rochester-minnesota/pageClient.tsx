...
export default function RochesterMinnesotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Minnesota requires a sales tax permit. Register your business and collect/remit tax on vending sales. Rochester may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Rochester County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Minnesota Secretary of State and obtain any required Rochester business licenses or permits.',
    additionalNotes: 'Check with the City of Rochester for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Rochester Hospital and medical facilities',
    'Downtown Rochester office buildings and businesses',
    'Rochester school district and educational facilities',
    'Rochester municipal and county government buildings',
