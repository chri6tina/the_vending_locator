...
export default function JupiterInletColonyFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Jupiter Inlet Colony.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Jupiter Inlet Colony.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Jupiter Inlet Colony",
