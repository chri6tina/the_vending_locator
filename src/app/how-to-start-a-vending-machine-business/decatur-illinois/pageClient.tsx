...
export default function DecaturIllinoisHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Illinois requires a sales tax permit. Register your business and collect/remit tax on vending sales. Decatur may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Illinois Secretary of State and obtain any required Decatur business licenses or permits.',
