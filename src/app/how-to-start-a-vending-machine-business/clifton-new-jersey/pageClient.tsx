...
export default function CliftonNewJerseyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Clifton.",
  "businessLicense": "Register your LLC with the New Jersey Secretary of State and obtain any required local business licenses in Clifton.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Clifton",
