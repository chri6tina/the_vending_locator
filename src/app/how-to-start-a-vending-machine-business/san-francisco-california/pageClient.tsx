...
export default function SanFranciscoCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. San Francisco may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the San Francisco County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required San Francisco business licenses or permits.',
    additionalNotes: 'Check with the City of San Francisco for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Salesforce Tower and downtown tech headquarters',
      'UCSF Medical Center and Zuckerberg General Hospital',
      'San Francisco International Airport (SFO)',
      'Twitter/X, Uber, Airbnb, and Lyft headquarters',
      'Wells Fargo and Charles Schwab Financial District',
      'Oracle Park and Chase Center sports venues',
      'Moscone Convention Center',
      'Biotechnology companies in Mission Bay'
  ]
