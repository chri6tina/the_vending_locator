...
export default function ArlingtonMassachusettsHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Arlington.",
  "businessLicense": "Register your LLC with the Massachusetts Secretary of State and obtain any required local business licenses in Arlington.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Arlington",
