...
export default function AlexandriaVirginiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Virginia requires a sales tax permit. Register your business and collect/remit tax on vending sales. Alexandria may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Virginia Secretary of State and obtain any required Alexandria business licenses or permits.',
