...
export default function BowlingGreenKentuckyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Kentucky requires a sales tax permit. Register your business and collect/remit tax on vending sales. Bowling Green may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Bowling Green County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Kentucky Secretary of State and obtain any required Bowling Green business licenses or permits.',
    additionalNotes: 'Check with the City of Bowling Green for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Bowling Green Hospital and medical facilities',
    'Downtown Bowling Green office buildings and businesses',
    'Bowling Green school district and educational facilities',
    'Bowling Green municipal and county government buildings',
