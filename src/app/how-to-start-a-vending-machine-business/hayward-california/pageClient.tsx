...
export default function HaywardCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Hayward may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Hayward County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Hayward business licenses or permits.',
    additionalNotes: 'Check with the City of Hayward for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Hayward Hospital and medical facilities',
    'Downtown Hayward office buildings and businesses',
    'Hayward school district and educational facilities',
    'Hayward municipal and county government buildings',
