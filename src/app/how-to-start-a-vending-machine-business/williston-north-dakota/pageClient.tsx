...
export default function WillistonNorthDakotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Williston.",
  "businessLicense": "Register your LLC with the North Dakota Secretary of State and obtain any required local business licenses in Williston.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Williston",
