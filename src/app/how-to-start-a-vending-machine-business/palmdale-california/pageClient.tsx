...
export default function PalmdaleCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Palmdale may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Palmdale County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Palmdale business licenses or permits.',
    additionalNotes: 'Check with the City of Palmdale for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Palmdale Hospital and medical facilities',
    'Downtown Palmdale office buildings and businesses',
    'Palmdale school district and educational facilities',
    'Palmdale municipal and county government buildings',
