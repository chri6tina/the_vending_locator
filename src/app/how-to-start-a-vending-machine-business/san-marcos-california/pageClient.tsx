...
export default function SanMarcosCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in San Marcos.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in San Marcos.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in San Marcos",
