...
export default function ColumbiaMissouriHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Missouri requires a sales tax permit. Register your business and collect/remit tax on vending sales. Columbia may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Missouri Secretary of State and obtain any required Columbia business licenses or permits.',
