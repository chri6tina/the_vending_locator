...
export default function JacksonMichiganHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Jackson.",
