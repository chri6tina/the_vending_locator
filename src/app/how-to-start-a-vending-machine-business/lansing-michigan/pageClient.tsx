...
export default function LansingMichiganHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Michigan requires a sales tax permit. Register your business and collect/remit tax on vending sales. Lansing may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Lansing County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Michigan Secretary of State and obtain any required Lansing business licenses or permits.',
    additionalNotes: 'Check with the City of Lansing for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Lansing Hospital and medical facilities',
    'Downtown Lansing office buildings and businesses',
    'Lansing school district and educational facilities',
    'Michigan state government offices and capitol complex',
    'Manufacturing facilities and industrial parks in Lansing',
    'Retail centers and shopping districts',
    'Gyms, fitness centers, and recreational facilities',
    'Lansing Airport and related businesses'
  ]
