...
export default function ColumbiaSouthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'South Carolina requires a sales tax permit. Register your business and collect/remit tax on vending sales. Columbia may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Columbia County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the South Carolina Secretary of State and obtain any required Columbia business licenses or permits.',
    additionalNotes: 'Check with the City of Columbia for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Columbia Hospital and medical facilities',
    'Downtown Columbia office buildings and businesses',
    'Columbia school district and educational facilities',
    'South Carolina state government offices and capitol complex',
    'Manufacturing facilities and industrial parks in Columbia',
    'Retail centers and shopping districts',
    'Gyms, fitness centers, and recreational facilities',
    'Columbia Airport and related businesses'
  ]
