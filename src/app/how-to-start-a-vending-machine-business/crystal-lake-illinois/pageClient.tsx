...
export default function CrystalLakeIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Crystal Lake.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Crystal Lake.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Crystal Lake",
