...
export default function RichlandWashingtonHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Richland.",
  "businessLicense": "Register your LLC with the Washington Secretary of State and obtain any required local business licenses in Richland.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Richland",
