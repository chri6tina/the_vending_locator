...
export default function TustinCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Tustin also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Tustin.',
    additionalNotes: 'Some locations like the Port of Tustin or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Tustin Port facilities and logistics operations',
      'Naval Air Station Tustin and military contractors',
      ...
      'Tustin Beach and coastal tourism areas',
