...
export default function DodgeCityKansasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Dodge City.",
  "businessLicense": "Register your LLC with the Kansas Secretary of State and obtain any required local business licenses in Dodge City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Dodge City",
