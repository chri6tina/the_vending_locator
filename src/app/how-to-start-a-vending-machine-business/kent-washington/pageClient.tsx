...
export default function KentWashingtonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington requires a sales tax permit. Register your business and collect/remit tax on vending sales. Kent may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Kent County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Washington Secretary of State and obtain any required Kent business licenses or permits.',
    additionalNotes: 'Check with the City of Kent for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Kent Hospital and medical facilities',
    'Downtown Kent office buildings and businesses',
    'Kent school district and educational facilities',
    'Kent municipal and county government buildings',
