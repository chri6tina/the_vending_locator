...
export default function OaklandCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Oakland may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Alameda County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Oakland business licenses or permits.',
    additionalNotes: 'Check with the City of Oakland for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Port of Oakland (4th busiest container port)',
      'Oakland International Airport',
      'Kaiser Permanente Oakland Medical Center',
      'University of California, Berkeley (adjacent city)',
      'Highland Hospital and Alta Bates Summit',
      'Oracle Arena and Oakland-Alameda Coliseum',
