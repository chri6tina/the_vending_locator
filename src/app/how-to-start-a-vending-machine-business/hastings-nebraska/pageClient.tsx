...
export default function HastingsNebraskaHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Nebraska Secretary of State and obtain any required local business licenses in Hastings.",
