...
export default function JuneauAlaskaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Alaska requires a sales tax permit. Register your business and collect/remit tax on vending sales. Juneau may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Juneau County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Alaska Secretary of State and obtain any required Juneau business licenses or permits.',
    additionalNotes: 'Check with the City of Juneau for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Juneau Hospital and medical facilities',
    'Downtown Juneau office buildings and businesses',
    'Juneau school district and educational facilities',
    'Alaska state government offices and capitol complex',
    ...
    'Juneau Airport and related businesses'
  ]
