...
export default function BaltimoreMarylandHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Maryland requires a sales tax permit. Register your business and collect/remit tax on vending sales. Baltimore may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Baltimore City Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Maryland Secretary of State and obtain any required Baltimore business licenses or permits.',
    additionalNotes: 'Check with the City of Baltimore for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Johns Hopkins Hospital (ranked #1 in US)',
