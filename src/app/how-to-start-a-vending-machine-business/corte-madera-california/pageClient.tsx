...
export default function CorteMaderaCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Corte Madera.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Corte Madera.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Corte Madera",
