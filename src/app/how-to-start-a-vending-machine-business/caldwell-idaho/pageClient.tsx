...
export default function CaldwellIdahoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Idaho requires a sales tax permit. Register your business and collect/remit tax on vending sales. Caldwell may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Caldwell County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Idaho Secretary of State and obtain any required Caldwell business licenses or permits.',
    additionalNotes: 'Check with the City of Caldwell for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Caldwell Hospital and medical facilities',
    'Downtown Caldwell office buildings and businesses',
    'Caldwell school district and educational facilities',
    'Caldwell municipal and county government buildings',
