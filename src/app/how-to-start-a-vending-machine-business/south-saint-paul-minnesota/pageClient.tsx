...
export default function SouthSaintPaulMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in South Saint Paul.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in South Saint Paul.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in South Saint Paul",
