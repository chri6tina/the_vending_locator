...
export default function WoodbridgeNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Jersey requires a sales tax permit. Register your business and collect/remit tax on vending sales. Woodbridge may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Woodbridge County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Jersey Secretary of State and obtain any required Woodbridge business licenses or permits.',
    additionalNotes: 'Check with the City of Woodbridge for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Woodbridge Hospital and medical facilities',
    'Downtown Woodbridge office buildings and businesses',
    'Woodbridge school district and educational facilities',
    'Woodbridge municipal and county government buildings',
