...
export default function RexburgIdahoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Idaho requires a sales tax permit. Register your business and collect/remit tax on vending sales. Rexburg may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Rexburg County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Idaho Secretary of State and obtain any required Rexburg business licenses or permits.',
    additionalNotes: 'Check with the City of Rexburg for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Rexburg Hospital and medical facilities',
    'Downtown Rexburg office buildings and businesses',
    'Rexburg school district and educational facilities',
    'Rexburg municipal and county government buildings',
