...
export default function WoodburyMinnesotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Minnesota requires a sales tax permit. Register your business and collect/remit tax on vending sales. Woodbury may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Woodbury County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Minnesota Secretary of State and obtain any required Woodbury business licenses or permits.',
    additionalNotes: 'Check with the City of Woodbury for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Woodbury Hospital and medical facilities',
    'Downtown Woodbury office buildings and businesses',
    'Woodbury school district and educational facilities',
    'Woodbury municipal and county government buildings',
