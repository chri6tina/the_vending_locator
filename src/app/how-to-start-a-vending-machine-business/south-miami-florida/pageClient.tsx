...
export default function SouthMiamiFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in South Miami.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in South Miami.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in South Miami",
