...
export default function GrassValleyCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Grass Valley.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Grass Valley.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Grass Valley",
