...
export default function SanJuanCapistranoCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in San Juan Capistrano.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in San Juan Capistrano.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in San Juan Capistrano",
