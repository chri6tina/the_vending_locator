...
export default function MaconGeorgiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Georgia requires a sales tax permit. Register your business and collect/remit tax on vending sales. Macon may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Macon County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Georgia Secretary of State and obtain any required Macon business licenses or permits.',
    additionalNotes: 'Check with the City of Macon for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Macon Hospital and medical facilities',
    'Downtown Macon office buildings and businesses',
    'Macon school district and educational facilities',
    'Macon municipal and county government buildings',
