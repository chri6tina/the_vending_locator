...
export default function CamarilloCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Camarillo also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Camarillo.',
    additionalNotes: 'Some locations like the Port of Camarillo or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Camarillo Port facilities and logistics operations',
      'Naval Air Station Camarillo and military contractors',
      ...
      'Camarillo Beach and coastal tourism areas',
