...
export default function NashuaNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Hampshire requires a sales tax permit. Register your business and collect/remit tax on vending sales. Nashua may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Nashua County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Hampshire Secretary of State and obtain any required Nashua business licenses or permits.',
    additionalNotes: 'Check with the City of Nashua for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Nashua Hospital and medical facilities',
    'Downtown Nashua office buildings and businesses',
    'Nashua school district and educational facilities',
    'Nashua municipal and county government buildings',
