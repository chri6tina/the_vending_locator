...
export default function TarponSpringsFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Tarpon Springs.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Tarpon Springs.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Tarpon Springs",
