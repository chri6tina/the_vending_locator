...
export default function CaryNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'North Carolina requires a sales tax permit. Register your business and collect/remit tax on vending sales. Cary may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Cary County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the North Carolina Secretary of State and obtain any required Cary business licenses or permits.',
    additionalNotes: 'Check with the City of Cary for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Cary Hospital and medical facilities',
    'Downtown Cary office buildings and businesses',
    'Cary school district and educational facilities',
    'Cary municipal and county government buildings',
