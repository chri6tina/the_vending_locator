...
export default function AlbanyGeorgiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Georgia requires a sales tax permit. Register your business and collect/remit tax on vending sales. Albany may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Georgia Secretary of State and obtain any required Albany business licenses or permits.',
  ...
  const demandDrivers = [
    ...
    'Albany municipal and county government buildings',
