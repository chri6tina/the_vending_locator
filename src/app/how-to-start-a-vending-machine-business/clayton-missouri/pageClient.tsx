...
export default function ClaytonMissouriHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Clayton.",
