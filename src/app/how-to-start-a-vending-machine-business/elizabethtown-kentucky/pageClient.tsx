...
export default function ElizabethtownKentuckyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Elizabethtown.",
  "businessLicense": "Register your LLC with the Kentucky Secretary of State and obtain any required local business licenses in Elizabethtown.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Elizabethtown",
