...
export default function EaganMinnesotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Minnesota requires a sales tax permit. Register your business and collect/remit tax on vending sales. Eagan may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Eagan County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Minnesota Secretary of State and obtain any required Eagan business licenses or permits.',
    additionalNotes: 'Check with the City of Eagan for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Eagan Hospital and medical facilities',
    'Downtown Eagan office buildings and businesses',
    'Eagan school district and educational facilities',
    'Eagan municipal and county government buildings',
