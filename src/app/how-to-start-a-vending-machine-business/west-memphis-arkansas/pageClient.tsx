...
export default function WestMemphisArkansasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in West Memphis.",
  "businessLicense": "Register your LLC with the Arkansas Secretary of State and obtain any required local business licenses in West Memphis.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in West Memphis",
