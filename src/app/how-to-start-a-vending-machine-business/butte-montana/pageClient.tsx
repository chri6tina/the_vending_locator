...
export default function ButteMontanaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Montana requires a sales tax permit. Register your business and collect/remit tax on vending sales. Butte may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Butte County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Montana Secretary of State and obtain any required Butte business licenses or permits.',
    additionalNotes: 'Check with the City of Butte for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Butte Hospital and medical facilities',
    'Downtown Butte office buildings and businesses',
    'Butte school district and educational facilities',
    'Butte municipal and county government buildings',
