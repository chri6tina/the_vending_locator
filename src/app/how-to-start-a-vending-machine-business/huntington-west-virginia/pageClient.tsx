...
export default function HuntingtonWestVirginiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'West Virginia requires a sales tax permit. Register your business and collect/remit tax on vending sales. Huntington may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Huntington County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the West Virginia Secretary of State and obtain any required Huntington business licenses or permits.',
    additionalNotes: 'Check with the City of Huntington for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Huntington Hospital and medical facilities',
    'Downtown Huntington office buildings and businesses',
    'Huntington school district and educational facilities',
    'Huntington municipal and county government buildings',
