...
export default function QuitmanGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Quitman.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Quitman.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Quitman",
