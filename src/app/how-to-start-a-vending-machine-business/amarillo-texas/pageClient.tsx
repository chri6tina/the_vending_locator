...
export default function AmarilloTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Amarillo may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Amarillo County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required Amarillo business licenses or permits.',
    additionalNotes: 'Check with the City of Amarillo for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Amarillo Hospital and medical facilities',
    'Downtown Amarillo office buildings and businesses',
    'Amarillo school district and educational facilities',
    'Amarillo municipal and county government buildings',
