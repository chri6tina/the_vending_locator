...
export default function PlainfieldIllinoisHowToStartPage() {
  ...
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Plainfield.",
