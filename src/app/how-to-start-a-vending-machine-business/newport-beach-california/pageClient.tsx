...
export default function NewportBeachCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit through the Department of Revenue. Newport Beach also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Newport Beach.',
    additionalNotes: 'Some locations like the Port of Newport Beach or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Newport Beach Port facilities and logistics operations',
      'Naval Air Station Newport Beach and military contractors',
      ...
      'Newport Beach Beach and coastal tourism areas',
