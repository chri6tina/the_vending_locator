...
export default function WestminsterColoradoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Colorado requires a sales tax permit. Register your business and collect/remit tax on vending sales. Westminster may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Westminster County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Colorado Secretary of State and obtain any required Westminster business licenses or permits.',
    additionalNotes: 'Check with the City of Westminster for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Westminster Hospital and medical facilities',
    'Downtown Westminster office buildings and businesses',
    'Westminster school district and educational facilities',
    'Westminster municipal and county government buildings',
