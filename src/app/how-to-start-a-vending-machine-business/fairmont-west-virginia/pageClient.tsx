...
export default function FairmontWestVirginiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Fairmont.",
  "businessLicense": "Register your LLC with the West Virginia Secretary of State and obtain any required local business licenses in Fairmont.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Fairmont",
