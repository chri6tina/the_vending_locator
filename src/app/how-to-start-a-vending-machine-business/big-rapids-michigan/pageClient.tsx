...
export default function BigRapidsMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Big Rapids.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Big Rapids.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Big Rapids",
