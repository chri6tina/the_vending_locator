...
export default function ZionsvilleIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Zionsville.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Zionsville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Zionsville",
