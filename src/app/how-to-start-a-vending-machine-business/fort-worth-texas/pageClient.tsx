...
export default function FortWorthTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Fort Worth may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required Fort Worth business licenses or permits.',
    additionalNotes: 'Check with the City of Fort Worth for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Lockheed Martin Aeronautics (F-35 Lightning II production)',
      'Naval Air Station Fort Worth JRB',
      'American Airlines headquarters (former)',
