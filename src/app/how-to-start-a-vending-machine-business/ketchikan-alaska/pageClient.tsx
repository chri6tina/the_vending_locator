...
export default function KetchikanAlaskaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Alaska requires a sales tax permit. Register your business and collect/remit tax on vending sales. Ketchikan may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Ketchikan County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Alaska Secretary of State and obtain any required Ketchikan business licenses or permits.',
    additionalNotes: 'Check with the City of Ketchikan for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Ketchikan Hospital and medical facilities',
    'Downtown Ketchikan office buildings and businesses',
    'Ketchikan school district and educational facilities',
    'Ketchikan municipal and county government buildings',
