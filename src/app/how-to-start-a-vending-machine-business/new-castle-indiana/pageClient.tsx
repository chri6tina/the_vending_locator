...
export default function NewCastleIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in New Castle.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in New Castle.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in New Castle",
