...
export default function HighPointNorthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'North Carolina requires a sales tax permit. Register your business and collect/remit tax on vending sales. High Point may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the High Point County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the North Carolina Secretary of State and obtain any required High Point business licenses or permits.',
    additionalNotes: 'Check with the City of High Point for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'High Point Hospital and medical facilities',
    'Downtown High Point office buildings and businesses',
    'High Point school district and educational facilities',
    'High Point municipal and county government buildings',
