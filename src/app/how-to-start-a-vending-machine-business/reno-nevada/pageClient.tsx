...
export default function RenoNevadaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Nevada requires a sales tax permit. Register your business and collect/remit tax on vending sales. Reno may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Washoe County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Nevada Secretary of State and obtain any required Reno business licenses or permits.',
    additionalNotes: 'Check with the City of Reno for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Tesla Gigafactory Nevada (Sparks - worlds largest building)',
      'Renown Regional Medical Center',
      'Reno-Tahoe International Airport',
      'University of Nevada, Reno',
      'Panasonic energy operations',
      'Grand Sierra Resort and casino gaming industry',
      'Apple data center (Reno Technology Park)',
      'Google, Switch, and eBay data centers'
  ]
