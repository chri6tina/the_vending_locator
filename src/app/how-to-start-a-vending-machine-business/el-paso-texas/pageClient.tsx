...
export default function ElPasoTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. El Paso may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the El Paso County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required El Paso business licenses or permits.',
    additionalNotes: 'Check with the City of El Paso for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'El Paso Hospital and medical facilities',
    'Downtown El Paso office buildings and businesses',
    'El Paso school district and educational facilities',
    'El Paso municipal and county government buildings',
