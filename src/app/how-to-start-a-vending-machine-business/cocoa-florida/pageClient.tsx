...
export default function CocoaFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Cocoa.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Cocoa.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Cocoa",
