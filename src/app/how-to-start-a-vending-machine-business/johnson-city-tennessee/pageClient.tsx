...
export default function JohnsonCityTennesseeHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Tennessee requires a sales tax permit. Register your business and collect/remit tax on vending sales. Johnson City may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Johnson City County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Tennessee Secretary of State and obtain any required Johnson City business licenses or permits.',
    additionalNotes: 'Check with the City of Johnson City for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Johnson City medical centers and healthcare facilities',
    'Downtown Johnson City office buildings and businesses',
    'Johnson City school district and educational facilities',
    'Johnson City municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Johnson City',
