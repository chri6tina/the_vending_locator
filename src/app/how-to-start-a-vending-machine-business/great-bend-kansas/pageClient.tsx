...
export default function GreatBendMaineHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Great Bend.",
  "businessLicense": "Register your LLC with the Maine Secretary of State and obtain any required local business licenses in Great Bend.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Great Bend",
