...
export default function BardstownKentuckyHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Bardstown.",
  "businessLicense": "Register your LLC with the Kentucky Secretary of State and obtain any required local business licenses in Bardstown.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Bardstown",
