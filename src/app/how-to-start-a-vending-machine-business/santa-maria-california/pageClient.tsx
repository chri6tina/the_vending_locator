...
export default function SantaMariaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Santa Maria may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Santa Maria County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Santa Maria business licenses or permits.',
    additionalNotes: 'Check with the City of Santa Maria for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Santa Maria Hospital and medical facilities',
    'Downtown Santa Maria office buildings and businesses',
    'Santa Maria school district and educational facilities',
    'Santa Maria municipal and county government buildings',
