...
export default function ComptonCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Compton may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Compton County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Compton business licenses or permits.',
    additionalNotes: 'Check with the City of Compton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Compton Hospital and medical facilities',
    'Downtown Compton office buildings and businesses',
    'Compton school district and educational facilities',
    'Compton municipal and county government buildings',
