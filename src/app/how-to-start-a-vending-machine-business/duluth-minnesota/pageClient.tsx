...
export default function DuluthMinnesotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Minnesota requires a sales tax permit. Register your business and collect/remit tax on vending sales. Duluth may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Duluth County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Minnesota Secretary of State and obtain any required Duluth business licenses or permits.',
    additionalNotes: 'Check with the City of Duluth for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Duluth Hospital and medical facilities',
    'Downtown Duluth office buildings and businesses',
    'Duluth school district and educational facilities',
    'Duluth municipal and county government buildings',
