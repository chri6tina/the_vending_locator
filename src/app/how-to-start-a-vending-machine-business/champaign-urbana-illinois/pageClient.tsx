...
export default function ChampaignUrbanaIllinoisHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Illinois requires a sales tax permit. Register your business and collect/remit tax on vending sales. Champaign Urbana may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Champaign Urbana County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Illinois Secretary of State and obtain any required Champaign Urbana business licenses or permits.',
    additionalNotes: 'Check with the City of Champaign Urbana for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Champaign Urbana Hospital and medical facilities',
    'Downtown Champaign Urbana office buildings and businesses',
    'Champaign Urbana school district and educational facilities',
    'Champaign Urbana municipal and county government buildings',
