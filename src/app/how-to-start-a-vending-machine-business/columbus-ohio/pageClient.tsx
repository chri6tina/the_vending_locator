...
export default function ColumbusOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Ohio requires a sales tax permit. Register your business and collect/remit tax on vending sales. Columbus may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Ohio Secretary of State and obtain any required Columbus business licenses or permits.',
  ...
  const demandDrivers = [
      'Ohio State University (66,000 students - largest campus in US)',
      'Ohio State Wexner Medical Center',
      'State of Ohio government and capitol complex',
