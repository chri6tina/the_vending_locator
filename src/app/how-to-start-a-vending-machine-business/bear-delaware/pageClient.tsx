...
export default function BearDelawareHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Delaware requires a sales tax permit. Register your business and collect/remit tax on vending sales. Bear may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Bear County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Delaware Secretary of State and obtain any required Bear business licenses or permits.',
    additionalNotes: 'Check with the City of Bear for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Bear Hospital and medical facilities',
    'Downtown Bear office buildings and businesses',
    'Bear school district and educational facilities',
    'Bear municipal and county government buildings',
