...
export default function MeridianIdahoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Idaho requires a sales tax permit. Register your business and collect/remit tax on vending sales. Meridian may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Meridian County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Idaho Secretary of State and obtain any required Meridian business licenses or permits.',
    additionalNotes: 'Check with the City of Meridian for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Meridian Hospital and medical facilities',
    'Downtown Meridian office buildings and businesses',
    'Meridian school district and educational facilities',
    'Meridian municipal and county government buildings',
