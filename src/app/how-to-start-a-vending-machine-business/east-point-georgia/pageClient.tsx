...
export default function EastPointGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in East Point.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in East Point.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in East Point",
