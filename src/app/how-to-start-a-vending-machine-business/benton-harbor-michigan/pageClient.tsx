...
export default function BentonHarborMichiganHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Benton Harbor.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Benton Harbor.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Benton Harbor",
