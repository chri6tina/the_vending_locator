...
export default function WilsonNorthCarolinaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Wilson.",
  "businessLicense": "Register your LLC with the North Carolina Secretary of State and obtain any required local business licenses in Wilson.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Wilson",
