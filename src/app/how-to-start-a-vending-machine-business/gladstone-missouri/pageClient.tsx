...
export default function GladstoneMissouriHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Gladstone.",
  "businessLicense": "Register your LLC with the Missouri Secretary of State and obtain any required local business licenses in Gladstone.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Gladstone",
