...
export default function WestHollywoodCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in West Hollywood.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in West Hollywood.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in West Hollywood",
