...
export default function MiramarFloridaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Florida requires a sales tax permit. Register your business and collect/remit tax on vending sales. Miramar may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Miramar County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Florida Secretary of State and obtain any required Miramar business licenses or permits.',
    additionalNotes: 'Check with the City of Miramar for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Miramar Hospital and medical facilities',
    'Downtown Miramar office buildings and businesses',
    'Miramar school district and educational facilities',
    'Miramar municipal and county government buildings',
