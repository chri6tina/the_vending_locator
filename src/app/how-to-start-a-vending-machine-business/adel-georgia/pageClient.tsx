...
export default function AdelGeorgiaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Adel.",
  "businessLicense": "Register your LLC with the Georgia Secretary of State and obtain any required local business licenses in Adel.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Adel",
