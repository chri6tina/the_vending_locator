...
export default function OlatheKansasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Kansas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Olathe may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Olathe County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Kansas Secretary of State and obtain any required Olathe business licenses or permits.',
    additionalNotes: 'Check with the City of Olathe for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Olathe Hospital and medical facilities',
    'Downtown Olathe office buildings and businesses',
    'Olathe school district and educational facilities',
    'Olathe municipal and county government buildings',
