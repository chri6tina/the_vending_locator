...
export default function AllianceNebraskaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Alliance.",
  "businessLicense": "Register your LLC with the Nebraska Secretary of State and obtain any required local business licenses in Alliance.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Alliance",
