...
export default function KeyLargoFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Key Largo.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Key Largo.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Key Largo",
