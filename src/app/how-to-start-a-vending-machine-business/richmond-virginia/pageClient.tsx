...
export default function RichmondVirginiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Virginia requires a sales tax permit. Register your business and collect/remit tax on vending sales. Richmond may have additional local sales taxes.',
    ...
    businessLicense: 'Register your LLC with the Virginia Secretary of State and obtain any required Richmond business licenses or permits.',
  ...
  const demandDrivers = [
      ...
      'Capital One headquarters and operations center',
      'Virginia State Capitol complex',
      'Richmond International Airport (RIC)',
      'Bon Secours Richmond Health System',
      'Philip Morris USA (Altria) manufacturing',
      'CarMax corporate headquarters',
