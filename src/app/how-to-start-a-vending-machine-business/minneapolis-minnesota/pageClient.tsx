...
export default function MinneapolisMinnesotaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Minnesota requires a sales tax permit. Register your business and collect/remit tax on vending sales. Minneapolis may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Hennepin County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Minnesota Secretary of State and obtain any required Minneapolis business licenses or permits.',
    additionalNotes: 'Check with the City of Minneapolis for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Target Corporation headquarters',
      'University of Minnesota and Fairview Medical Center',
      'Minneapolis-St. Paul International Airport (MSP)',
      'Hennepin Healthcare and Abbott Northwestern Hospital',
      'U.S. Bank Stadium and Target Center',
      'Wells Fargo operations center',
      'General Mills and Cargill offices',
      'IDS Center and downtown skyway system'
  ]
