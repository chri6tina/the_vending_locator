...
export default function CoffeyvilleMaineHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Coffeyville.",
  "businessLicense": "Register your LLC with the Maine Secretary of State and obtain any required local business licenses in Coffeyville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Coffeyville",
