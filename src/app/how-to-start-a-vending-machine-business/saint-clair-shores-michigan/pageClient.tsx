...
export default function SaintClairShoresMichiganHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Michigan requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Saint Clair Shores.",
  "businessLicense": "Register your LLC with the Michigan Secretary of State and obtain any required local business licenses in Saint Clair Shores.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Saint Clair Shores",
