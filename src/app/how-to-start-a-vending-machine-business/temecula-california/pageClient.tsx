...
export default function TemeculaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Temecula may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Temecula County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Temecula business licenses or permits.',
    additionalNotes: 'Check with the City of Temecula for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Temecula Hospital and medical facilities',
    'Downtown Temecula office buildings and businesses',
    'Temecula school district and educational facilities',
    'Temecula municipal and county government buildings',
