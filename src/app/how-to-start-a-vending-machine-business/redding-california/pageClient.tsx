...
export default function ReddingCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Redding may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Redding County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Redding business licenses or permits.',
    additionalNotes: 'Check with the City of Redding for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Redding Hospital and medical facilities',
    'Downtown Redding office buildings and businesses',
    'Redding school district and educational facilities',
    'Redding municipal and county government buildings',
