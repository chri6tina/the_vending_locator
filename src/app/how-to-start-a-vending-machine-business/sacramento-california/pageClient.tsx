...
export default function SacramentoCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Sacramento may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Sacramento County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Sacramento business licenses or permits.',
    additionalNotes: 'Check with the City of Sacramento for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'California State Capitol and government offices (2nd largest employer)',
      'UC Davis Medical Center',
      'Sacramento International Airport',
      'Sutter Health and Dignity Health hospitals',
      'California State University, Sacramento',
      'Intel folsom campus',
      'Kaiser Permanente facilities',
      'Downtown Sacramento and Capitol Mall businesses'
  ]
