...
export default function SantaBarbaraCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Santa Barbara may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Santa Barbara County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Santa Barbara business licenses or permits.',
    additionalNotes: 'Check with the City of Santa Barbara for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Santa Barbara Hospital and medical facilities',
    'Downtown Santa Barbara office buildings and businesses',
    'Santa Barbara school district and educational facilities',
    'Santa Barbara municipal and county government buildings',
