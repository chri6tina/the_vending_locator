...
export default function SycamoreIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Sycamore.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Sycamore.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Sycamore",
