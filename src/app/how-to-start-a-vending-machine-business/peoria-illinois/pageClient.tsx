...
export default function PeoriaIllinoisHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Illinois requires a sales tax permit. Register your business and collect/remit tax on vending sales. Peoria may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Peoria County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Illinois Secretary of State and obtain any required Peoria business licenses or permits.',
    additionalNotes: 'Check with the City of Peoria for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Peoria Hospital and medical facilities',
    'Downtown Peoria office buildings and businesses',
    'Peoria school district and educational facilities',
    'Peoria municipal and county government buildings',
