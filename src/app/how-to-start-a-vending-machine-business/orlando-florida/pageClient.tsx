...
export default function OrlandoFloridaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Florida requires a sales tax permit. Register your business and collect/remit tax on vending sales. Orlando may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Orange County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Florida Secretary of State and obtain any required Orlando business licenses or permits.',
    additionalNotes: 'Check with the City of Orlando for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Walt Disney World Resort and Universal Studios',
      'Orlando International Airport (MCO - top 10 busiest)',
      'Orlando Health and AdventHealth hospital systems',
      'University of Central Florida (68,000 students - 2nd largest)',
      'Orange County Convention Center (2nd largest in US)',
      'Electronic Arts, Lockheed Martin simulation facilities',
      'Lake Nona Medical City district',
