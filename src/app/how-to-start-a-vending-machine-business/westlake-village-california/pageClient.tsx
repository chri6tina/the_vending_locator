...
export default function WestlakeVillageCaliforniaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Westlake Village.",
  "businessLicense": "Register your LLC with the California Secretary of State and obtain any required local business licenses in Westlake Village.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Westlake Village",
