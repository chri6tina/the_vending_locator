...
export default function DowneyCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Downey may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Downey County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Downey business licenses or permits.',
    additionalNotes: 'Check with the City of Downey for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Downey Hospital and medical facilities',
    'Downtown Downey office buildings and businesses',
    'Downey school district and educational facilities',
    'Downey municipal and county government buildings',
