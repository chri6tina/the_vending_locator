...
export default function HawthorneCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Hawthorne may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Hawthorne County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Hawthorne business licenses or permits.',
    additionalNotes: 'Check with the City of Hawthorne for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Hawthorne Hospital and medical facilities',
    'Downtown Hawthorne office buildings and businesses',
    'Hawthorne school district and educational facilities',
    'Hawthorne municipal and county government buildings',
