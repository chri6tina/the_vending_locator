...
export default function WellingtonFloridaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Florida requires a sales tax permit through the Department of Revenue. Wellington also has a local surtax. Register your business and collect/remit tax on vending sales.',
    ...
    businessLicense: 'Register your LLC with your state and obtain a local business tax receipt from the City of Wellington.',
    additionalNotes: 'Some locations like the Port of Wellington or government buildings may have additional facility-specific requirements.'
  }

  const demandDrivers = [
      'Wellington Port facilities and logistics operations',
      'Naval Air Station Wellington and military contractors',
      ...
      'Wellington Beach and coastal tourism areas',
