...
export default function RacineWisconsinHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Wisconsin requires a sales tax permit. Register your business and collect/remit tax on vending sales. Racine may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Racine County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Wisconsin Secretary of State and obtain any required Racine business licenses or permits.',
    additionalNotes: 'Check with the City of Racine for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Racine Hospital and medical facilities',
    'Downtown Racine office buildings and businesses',
    'Racine school district and educational facilities',
    'Racine municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Racine',
