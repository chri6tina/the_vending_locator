...
export default function GreeleyColoradoHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Colorado requires a sales tax permit. Register your business and collect/remit tax on vending sales. Greeley may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Greeley County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Colorado Secretary of State and obtain any required Greeley business licenses or permits.',
    additionalNotes: 'Check with the City of Greeley for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Greeley Hospital and medical facilities',
    'Downtown Greeley office buildings and businesses',
    'Greeley school district and educational facilities',
    'Greeley municipal and county government buildings',
