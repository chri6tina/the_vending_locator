...
export default function EastChicagoIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in East Chicago.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in East Chicago.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in East Chicago",
