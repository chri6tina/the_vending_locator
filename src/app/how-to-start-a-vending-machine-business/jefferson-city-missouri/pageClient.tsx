...
export default function JeffersonCityMontanaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Montana requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Jefferson City.",
  "businessLicense": "Register your LLC with the Montana Secretary of State and obtain any required local business licenses in Jefferson City.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Jefferson City",
