...
export default function SuffolkVirginiaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Virginia requires a sales tax permit. Register your business and collect/remit tax on vending sales. Suffolk may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Suffolk County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Virginia Secretary of State and obtain any required Suffolk business licenses or permits.',
    additionalNotes: 'Check with the City of Suffolk for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Suffolk Hospital and medical facilities',
    'Downtown Suffolk office buildings and businesses',
    'Suffolk school district and educational facilities',
    'Suffolk municipal and county government buildings',
