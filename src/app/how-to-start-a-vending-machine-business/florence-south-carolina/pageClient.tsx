...
export default function FlorenceSouthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'South Carolina requires a sales tax permit. Register your business and collect/remit tax on vending sales. Florence may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Florence County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the South Carolina Secretary of State and obtain any required Florence business licenses or permits.',
    additionalNotes: 'Check with the City of Florence for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Florence Hospital and medical facilities',
    'Downtown Florence office buildings and businesses',
    'Florence school district and educational facilities',
    'Florence municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Florence',
