...
export default function WaterlooIowaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Iowa requires a sales tax permit. Register your business and collect/remit tax on vending sales. Waterloo may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Waterloo County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Iowa Secretary of State and obtain any required Waterloo business licenses or permits.',
    additionalNotes: 'Check with the City of Waterloo for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Waterloo Hospital and medical facilities',
    'Downtown Waterloo office buildings and businesses',
    'Waterloo school district and educational facilities',
    'Waterloo municipal and county government buildings',
