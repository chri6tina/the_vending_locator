...
export default function PittsburgMaineHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Pittsburg.",
  "businessLicense": "Register your LLC with the Maine Secretary of State and obtain any required local business licenses in Pittsburg.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Pittsburg",
