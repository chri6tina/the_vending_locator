...
export default function NatchitochesLouisianaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
  "salesTax": "Louisiana requires a sales tax permit through the state Department of Revenue. Register your business and collect/remit tax on vending sales where applicable.",
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Natchitoches.",
  "businessLicense": "Register your LLC with the Louisiana Secretary of State and obtain any required local business licenses in Natchitoches.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Natchitoches",
