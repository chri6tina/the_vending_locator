...
export default function SantaRosaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Santa Rosa may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Santa Rosa County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Santa Rosa business licenses or permits.',
    additionalNotes: 'Check with the City of Santa Rosa for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Santa Rosa Hospital and medical facilities',
    'Downtown Santa Rosa office buildings and businesses',
    'Santa Rosa school district and educational facilities',
    'Santa Rosa municipal and county government buildings',
