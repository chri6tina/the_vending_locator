...
export default function PortlandOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Oregon requires a sales tax permit. Register your business and collect/remit tax on vending sales. Portland may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Multnomah County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Oregon Secretary of State and obtain any required Portland business licenses or permits.',
  ...
  const demandDrivers = [
      'Intel campuses (Hillsboro - largest private employer)',
      'Oregon Health & Science University (OHSU)',
      'Portland International Airport (PDX)',
      'Nike World Headquarters (Beaverton)',
      'Kaiser Permanente Northwest facilities',
      'Portland State University campus',
      'Adidas North America headquarters',
      'Pearl District and downtown tech startups'
  ]
