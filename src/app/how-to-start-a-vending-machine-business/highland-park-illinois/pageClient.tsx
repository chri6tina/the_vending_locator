...
export default function HighlandParkIllinoisHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Highland Park.",
  "businessLicense": "Register your LLC with the Illinois Secretary of State and obtain any required local business licenses in Highland Park.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Highland Park",
