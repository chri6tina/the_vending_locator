...
export default function JolietIllinoisHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Illinois requires a sales tax permit. Register your business and collect/remit tax on vending sales. Joliet may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Joliet County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Illinois Secretary of State and obtain any required Joliet business licenses or permits.',
    additionalNotes: 'Check with the City of Joliet for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Joliet Hospital and medical facilities',
    'Downtown Joliet office buildings and businesses',
    'Joliet school district and educational facilities',
    'Joliet municipal and county government buildings',
