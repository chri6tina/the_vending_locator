...
export default function CantonOhioHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Ohio requires a sales tax permit. Register your business and collect/remit tax on vending sales. Canton may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Canton County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Ohio Secretary of State and obtain any required Canton business licenses or permits.',
    additionalNotes: 'Check with the City of Canton for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Canton Hospital and medical facilities',
    'Downtown Canton office buildings and businesses',
    'Canton school district and educational facilities',
    'Canton municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Canton',
