...
export default function PortsmouthNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Hampshire requires a sales tax permit. Register your business and collect/remit tax on vending sales. Portsmouth may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Portsmouth County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Hampshire Secretary of State and obtain any required Portsmouth business licenses or permits.',
