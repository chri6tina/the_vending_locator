...
export default function KearneyNebraskaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Kearney.",
  "businessLicense": "Register your LLC with the Nebraska Secretary of State and obtain any required local business licenses in Kearney.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Kearney",
