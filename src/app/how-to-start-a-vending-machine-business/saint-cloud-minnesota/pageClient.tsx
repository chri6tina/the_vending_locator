...
export default function SaintCloudMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Saint Cloud.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Saint Cloud.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Saint Cloud",
