...
export default function ChicagoIllinoisHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Illinois requires a sales tax permit. Register your business and collect/remit tax on vending sales. Chicago may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Cook County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Illinois Secretary of State and obtain any required Chicago business licenses or permits.',
    additionalNotes: 'Check with the City of Chicago for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
      'Chicago Loop corporate HQs (Boeing, United Airlines, McDonald\'s)',
      'Northwestern Memorial and Rush University Medical Centers',
      'OHare International Airport (2nd busiest in US)',
      'Willis Tower, Aon Center, and downtown office buildings',
      'University of Chicago and Northwestern campuses',
      'Navy Pier and McCormick Place Convention Center',
      'Merchandise Mart and River North design district',
      'Chicago Board of Trade and financial institutions'
  ]
