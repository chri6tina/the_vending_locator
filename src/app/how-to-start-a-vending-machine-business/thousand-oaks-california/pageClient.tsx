...
export default function ThousandOaksCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Thousand Oaks may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Thousand Oaks County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Thousand Oaks business licenses or permits.',
    additionalNotes: 'Check with the City of Thousand Oaks for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Thousand Oaks Hospital and medical facilities',
    'Downtown Thousand Oaks office buildings and businesses',
    'Thousand Oaks school district and educational facilities',
    'Thousand Oaks municipal and county government buildings',
