...
export default function MoundsViewMinnesotaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Mounds View.",
  "businessLicense": "Register your LLC with the Minnesota Secretary of State and obtain any required local business licenses in Mounds View.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Mounds View",
