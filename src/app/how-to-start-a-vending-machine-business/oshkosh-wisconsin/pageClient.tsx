...
export default function OshkoshWisconsinHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Wisconsin requires a sales tax permit. Register your business and collect/remit tax on vending sales. Oshkosh may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Oshkosh County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Wisconsin Secretary of State and obtain any required Oshkosh business licenses or permits.',
    additionalNotes: 'Check with the City of Oshkosh for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Oshkosh Hospital and medical facilities',
    'Downtown Oshkosh office buildings and businesses',
    'Oshkosh school district and educational facilities',
    'Oshkosh municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Oshkosh',
