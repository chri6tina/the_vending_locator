...
export default function IndianRocksBeachFloridaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Indian Rocks Beach.",
  "businessLicense": "Register your LLC with the Florida Secretary of State and obtain any required local business licenses in Indian Rocks Beach.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Indian Rocks Beach",
