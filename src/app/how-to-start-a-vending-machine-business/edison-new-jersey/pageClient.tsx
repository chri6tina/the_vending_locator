...
export default function EdisonNewJerseyHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Jersey requires a sales tax permit. Register your business and collect/remit tax on vending sales. Edison may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Edison County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Jersey Secretary of State and obtain any required Edison business licenses or permits.',
    additionalNotes: 'Check with the City of Edison for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Edison Hospital and medical facilities',
    'Downtown Edison office buildings and businesses',
    'Edison school district and educational facilities',
    'Edison municipal and county government buildings',
