...
export default function RosevilleCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Roseville may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Roseville County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Roseville business licenses or permits.',
    additionalNotes: 'Check with the City of Roseville for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Roseville Hospital and medical facilities',
    'Downtown Roseville office buildings and businesses',
    'Roseville school district and educational facilities',
    'Roseville municipal and county government buildings',
