...
export default function DowntownWashingtonDcHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington DC requires a sales tax permit. Register your business and collect/remit tax on vending sales. Downtown may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Downtown County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Washington DC Secretary of State and obtain any required Downtown business licenses or permits.',
    additionalNotes: 'Check with the City of Downtown for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Downtown Hospital and medical facilities',
    'Downtown Downtown office buildings and businesses',
    'Downtown school district and educational facilities',
    'Downtown municipal and county government buildings',
