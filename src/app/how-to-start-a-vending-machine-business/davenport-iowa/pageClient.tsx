...
export default function DavenportIowaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Iowa requires a sales tax permit. Register your business and collect/remit tax on vending sales. Davenport may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Davenport County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Iowa Secretary of State and obtain any required Davenport business licenses or permits.',
    additionalNotes: 'Check with the City of Davenport for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Davenport Hospital and medical facilities',
    'Downtown Davenport office buildings and businesses',
    'Davenport school district and educational facilities',
    'Davenport municipal and county government buildings',
