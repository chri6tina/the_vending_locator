...
export default function StarkvilleMississippiHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Starkville.",
  "businessLicense": "Register your LLC with the Mississippi Secretary of State and obtain any required local business licenses in Starkville.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Starkville",
