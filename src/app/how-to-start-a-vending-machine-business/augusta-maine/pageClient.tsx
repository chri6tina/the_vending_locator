...
export default function AugustaMaineHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Maine requires a sales tax permit. Register your business and collect/remit tax on vending sales. Augusta may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Augusta County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Maine Secretary of State and obtain any required Augusta business licenses or permits.',
    additionalNotes: 'Check with the City of Augusta for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Augusta Hospital and medical facilities',
    'Downtown Augusta office buildings and businesses',
    'Augusta school district and educational facilities',
    'Maine state government offices and capitol complex',
    ...
    'Augusta Airport and related businesses'
  ]
