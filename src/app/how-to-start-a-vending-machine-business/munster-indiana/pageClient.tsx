...
export default function MunsterIndianaHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Munster.",
  "businessLicense": "Register your LLC with the Indiana Secretary of State and obtain any required local business licenses in Munster.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Munster",
