...
export default function ShawneeKansasHowToStartPage() {
  ...
  "healthPermit": "Contact your local county health department for food and beverage vending permits if selling consumable products in Shawnee.",
  "businessLicense": "Register your LLC with the Kansas Secretary of State and obtain any required local business licenses in Shawnee.",
  ...
  const demandDrivers = [
  "Office buildings and corporate parks in Shawnee",
