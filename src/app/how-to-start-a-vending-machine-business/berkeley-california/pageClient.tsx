...
export default function BerkeleyCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Berkeley may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Berkeley County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Berkeley business licenses or permits.',
    additionalNotes: 'Check with the City of Berkeley for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Berkeley Hospital and medical facilities',
    'Downtown Berkeley office buildings and businesses',
    'University of California Berkeley campus and facilities',
    'Berkeley municipal and county government buildings',
