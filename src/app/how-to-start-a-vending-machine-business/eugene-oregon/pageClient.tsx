...
export default function EugeneOregonHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Oregon requires a sales tax permit. Register your business and collect/remit tax on vending sales. Eugene may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Eugene County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Oregon Secretary of State and obtain any required Eugene business licenses or permits.',
    additionalNotes: 'Check with the City of Eugene for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Eugene Hospital and medical facilities',
    'Downtown Eugene office buildings and businesses',
    'University of Oregon campus and facilities',
    'Eugene municipal and county government buildings',
