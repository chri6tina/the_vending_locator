...
export default function MerrimackNewHampshireHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'New Hampshire requires a sales tax permit. Register your business and collect/remit tax on vending sales. Merrimack may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Merrimack County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the New Hampshire Secretary of State and obtain any required Merrimack business licenses or permits.',
    additionalNotes: 'Check with the City of Merrimack for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Merrimack Hospital and medical facilities',
    'Downtown Merrimack office buildings and businesses',
    'Merrimack school district and educational facilities',
    'Merrimack municipal and county government buildings',
