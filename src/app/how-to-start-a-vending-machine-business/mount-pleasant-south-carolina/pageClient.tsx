...
export default function MountPleasantSouthCarolinaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'South Carolina requires a sales tax permit. Register your business and collect/remit tax on vending sales. Mount Pleasant may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Mount Pleasant County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the South Carolina Secretary of State and obtain any required Mount Pleasant business licenses or permits.',
    additionalNotes: 'Check with the City of Mount Pleasant for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Mount Pleasant Hospital and medical facilities',
    'Downtown Mount Pleasant office buildings and businesses',
    'Mount Pleasant school district and educational facilities',
    'Mount Pleasant municipal and county government buildings',
    'Manufacturing facilities and industrial parks in Mount Pleasant',
