...
export default function CapitolHillWashingtonDcHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Washington DC requires a sales tax permit. Register your business and collect/remit tax on vending sales. Capitol Hill may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Capitol Hill County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Washington DC Secretary of State and obtain any required Capitol Hill business licenses or permits.',
    additionalNotes: 'Check with the City of Capitol Hill for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Capitol Hill Hospital and medical facilities',
    'Downtown Capitol Hill office buildings and businesses',
    'Capitol Hill school district and educational facilities',
    'Capitol Hill municipal and county government buildings',
