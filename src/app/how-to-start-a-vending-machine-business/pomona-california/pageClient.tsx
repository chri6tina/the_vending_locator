...
export default function PomonaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. Pomona may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Pomona County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required Pomona business licenses or permits.',
    additionalNotes: 'Check with the City of Pomona for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Pomona Hospital and medical facilities',
    'Downtown Pomona office buildings and businesses',
    'Pomona school district and educational facilities',
    'Pomona municipal and county government buildings',
