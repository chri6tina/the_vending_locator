...
export default function StLouisMissouriHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Missouri requires a sales tax permit. Register your business and collect/remit tax on vending sales. St Louis may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the St Louis County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Missouri Secretary of State and obtain any required St Louis business licenses or permits.',
    additionalNotes: 'Check with the City of St Louis for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'St Louis Hospital and medical facilities',
    'Downtown St Louis office buildings and businesses',
    'St Louis school district and educational facilities',
    'St Louis municipal and county government buildings',
