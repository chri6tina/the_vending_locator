...
export default function LubbockTexasHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'Texas requires a sales tax permit. Register your business and collect/remit tax on vending sales. Lubbock may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the Lubbock County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the Texas Secretary of State and obtain any required Lubbock business licenses or permits.',
    additionalNotes: 'Check with the City of Lubbock for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'Lubbock Hospital and medical facilities',
    'Downtown Lubbock office buildings and businesses',
    'Lubbock school district and educational facilities',
    'Lubbock municipal and county government buildings',
