...
export default function WestCovinaCaliforniaHowToStartPage() {
  ...
  // City-specific data
  const permitInfo = {
    salesTax: 'California requires a sales tax permit. Register your business and collect/remit tax on vending sales. West Covina may have additional local sales taxes.',
    healthPermit: 'If selling food or beverages, contact the West Covina County Health Department for vending machine permits and inspection requirements.',
    businessLicense: 'Register your LLC with the California Secretary of State and obtain any required West Covina business licenses or permits.',
    additionalNotes: 'Check with the City of West Covina for specific local requirements, zoning regulations, and any restrictions on vending machine placement in certain areas.'
  }

  const demandDrivers = [
    'West Covina Hospital and medical facilities',
    'Downtown West Covina office buildings and businesses',
    'West Covina school district and educational facilities',
    'West Covina municipal and county government buildings',
