            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  >
                    Connect with professional vending machine operators serving {cityDisplayName}'s residential growth and retail. Get free installation, regular stocking, and full maintenance—at no cost to your business.
                  </motion.p>
