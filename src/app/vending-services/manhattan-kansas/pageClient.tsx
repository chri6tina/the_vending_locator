...
export default function ManhattanKansasVendingServicesPage() {
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  >
                    Keep Fort Riley, Kansas State University, OrthoKansas medical campuses, and Aggieville businesses stocked without pulling staff away from mission-critical work. Our vetted operators already service animal health corridor labs, aviation suppliers near MHK airport, city offices, and Prairie Village hospitality venues—delivering telemetry-enabled machines, curated product assortments, and responsive Flint Hills support.
                  </motion.p>
                  ...
                  >
                    ...
                    <div className="bg-warm-white rounded-lg p-4 border border-gray-200">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium text-chocolate">Trusted Flint Hills Operators</span>
                      </div>
                    </div>
                    <div className="bg-warm-white rounded-lg p-4 border border-gray-200">
                      <div className="flex items-center gap-3">
                    ...
                    <div className="bg-warm-white rounded-lg p-4 border border-gray-200">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium text-chocolate">Riley & Pottawatomie Coverage</span>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-charcoal/80">Menus tailored for Fort Riley soldiers, biosecurity labs, and agri-science companies in the Animal Health Corridor.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircleIcon className="h-6 w-6 text-coral flex-shrink-0 mt-0.5" />
                      <span className="text-charcoal/80">Healthy, student-approved options for K-State, Manhattan Christian College, and USD 383 campuses.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircleIcon className="h-6 w-6 text-coral flex-shrink-0 mt-0.5" />
                      <span className="text-charcoal/80">Telemetry alerts keep machines stocked during Big 12 game days, conference season, and storm response operations.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircleIcon className="h-6 w-6 text-coral flex-shrink-0 mt-0.5" />
                      <span className="text-charcoal/80">Service extends through Wamego, Junction City, Ogden, and tech startups along the K-177 corridor.</span>
                    </li>
                  </motion.ul>
                </div>
                ...
                >
                  {formSubmitted ? (
                    <div className="text-center py-8">
                      ...
                      <h3 className="text-2l font-playfair font-bold text-navy mb-2">
                        Request Received!
                      </h3>
                    ...
                    <>
                      <h3 className="text-2l font-playfair font-bold text-navy mb-2 text-center">
                        Get Vending Services in {cityDisplayName}, KS
                      </h3>
                      <p className="text-charcoal/70 mb-6 text-center text-sm">
                        Share a few details and we&apos;ll match you with operators already maintaining Flint Hills and Fort Riley routes.
                      </p>
            ...
            <div className="max-w-6l mx-auto">
              ...
              >
                ...
                <p className="text-lg text-chocolate/70 max-w-3xl mx-auto">
                  From Great Plains training exercises to K-State research labs, we pair Flint Hills organizations with vending partners who understand defense, agriculture, and higher education operations.
                </p>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                {[
                  {
                    step: '1',
                    title: 'Outline Priorities',
                    copy: 'Tell us about your facility footprint, shift cadence, compliance needs, and the refreshment experience you want.'
                  },
                  {
                    step: '2',
                    title: 'Meet Local Vendors',
                    copy: 'We introduce background-checked operators servicing Manhattan, Fort Riley, Wamego, Junction City, and the I-70 corridor.'
                  },
                  {
                    step: '3',
                    title: 'Review Programs',
                    copy: 'Compare machine mixes, micro markets, telemetry tools, and service cadence aligned with each site.'
                  },
                  {
                    step: '4',
                    title: 'Launch & Optimize',
                    copy: 'Operators install, stock, and maintain equipment, then refine menus using telemetry insights and staff feedback.'
                  }
                ].map((item, idx) => (
                  <motion.div
                    key={item.step}
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  {
                    title: 'Defense & Research Experience',
                    copy:
                      'Technicians service Fort Riley training centers, National Bio and Agro-Defense Facility support labs, and agri-science companies across the Flint Hills.'
                  },
                  {
                    title: 'Telemetry Restocking',
                    copy:
                      'Smart machines alert operators before field exercises, storm events, or Big 12 sports weekends empty high-demand items.'
                  },
                  {
                    title: 'Local & Seasonal Options',
                    copy:
                      'Feature Kansas-roasted coffee, K-State dining favorites, and seasonal produce from regional growers.'
                  },
                  {
                    title: 'Compliance Confidence',
                    copy:
                      'Vendors manage USDA, DOD security, and healthcare sanitation standards common to the Manhattan area.'
                  },
                  {
                  ...
                  },
                  {
                    ...
                    copy:
                      'Deploy portable vending for K-State research field days, Aggieville festivals, and emergency response staging areas.'
                  }
                ].map((item, idx) => (
                  <motion.div
                    key={item.title}
