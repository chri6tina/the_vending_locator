            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  >
                    Keep Fort Sill training ranges, Comanche County Memorial Hospital, Cameron University, and Red River industrial corridors stocked with zero hassle. Our vetted partners already service aviation suppliers, oilfield service yards along I-44, hospitality venues near Medicine Park, and logistics hubs supporting the Wichita Mountains—delivering telemetry-enabled machines, curated product assortments, and responsive Southwest Oklahoma support.
                  </motion.p>
