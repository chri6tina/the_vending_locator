...
export default function QuincyIllinoisVendingServicesPage() {
        ...
        <nav className="bg-white border-b border-gray-200 py-3">
          <div className="container mx-auto px-4">
            <div className="flex items-center space-x-2 text-sm text-stone">
              ...
              <span>/</span>
              <Link href="/vending-services/illinois" className="hover:text-navy transition-colors">
                Illinois
              </Link>
              <span>/</span>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  >
                    ...
                    <span className="text-navy">{cityDisplayName}, IL</span>
                  </motion.h1>
                  ...
                  >
                    ...
                    <div className="bg-warm-white rounded-lg p-4 border border-gray-200">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium text-chocolate">Trusted River Bend Operators</span>
                      </div>
                    </div>
                    <div className="bg-warm-white rounded-lg p-4 border border-gray-200">
                      <div className="flex items-center gap-3">
                    ...
                    <div className="bg-warm-white rounded-lg p-4 border border-gray-200">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium text-chocolate">Adams County Routes</span>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-charcoal/80">Menus tailored to riverport manufacturing shifts, healthcare staff, and hybrid tech teams.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircleIcon className="h-6 w-6 text-coral flex-shrink-0 mt-0.5" />
                      <span className="text-charcoal/80">Better-for-you selections for Quincy University, JWCC, and area school campuses.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircleIcon className="h-6 w-6 text-coral flex-shrink-0 mt-0.5" />
                      <span className="text-charcoal/80">Telemetry alerts keep machines full during river commerce peaks, festivals, and home basketball weekends.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircleIcon className="h-6 w-6 text-coral flex-shrink-0 mt-0.5" />
                      <span className="text-charcoal/80">Service extends through Hannibal, Camp Point, Pittsfield, and the Tri-State logistics corridor.</span>
                    </li>
                  </motion.ul>
                </div>
                  ...
                  {formSubmitted ? (
                    ...
                    <>
                      <h3 className="text-2xl font-playfair font-bold text-navy mb-2 text-center">
                        Get Vending Services in {cityDisplayName}, IL
                      </h3>
                      <p className="text-charcoal/70 mb-6 text-center text-sm">
                        Share a few details and we&apos;ll match you with operators already running Mississippi River routes.
                      </p>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-chocolate/70 max-w-3xl mx-auto">
                  We pair Gem City organizations with vending partners who understand Mississippi River logistics, healthcare shift work, and the growing tech and arts scene.
                </p>
              </motion.div>
                ...
                {[
                  {
                    ...
                    copy: 'Tell us about headcount, visitor volume, compliance needs, and your breakroom goals.'
                  },
                  {
                    step: '2',
                    title: 'Meet Local Vendors',
                    copy: 'We introduce screened operators servicing Adams County, Pike County, Marion County, and nearby Missouri markets.'
                  },
                  {
                    step: '3',
                    title: 'Compare Programs',
                    copy: 'Review machine packages, micro market concepts, telemetry tools, and restock schedules aligned to each location.'
                  },
                  {
                    step: '4',
                    title: 'Launch & Optimize',
                    copy: 'Operators install, stock, and maintain everything, then refine menus with telemetry insights and staff feedback.'
                  }
                ].map((item, idx) => (
                  <motion.div
                    key={item.step}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    title: 'Tourism & Downtown Revitalization',
                    copy:
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <motion.h2
                ...
                className="text-3xl font-playfair font-bold text-chocolate mb-12 text-center"
              >
                Why Tri-State Teams Choose Our Partners
              </motion.h2>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <motion.h2
                ...
                className="text-3xl font-playfair font-bold text-chocolate mb-8 text-center"
              >
                Quincy Vending Services – FAQ
              </motion.h2>

              {[
                {
                  question: 'How quickly can vending machines be installed in Quincy?',
                  answer:
                ...
                {
                  question: 'Do you service nearby communities like Hannibal and Pittsfield?',
                  answer:
                ...
                {
                  question: 'What product mixes work well for Quincy employees?',
                  answer:
                ...
                {
                  question: 'Can machines handle riverfront events and festival weekends?',
                  answer:
                ...
                {
                  question: 'How are refunds handled for remote locations?',
                  answer:
