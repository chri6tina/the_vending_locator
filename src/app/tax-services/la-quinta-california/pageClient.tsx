...
export default function La QuintaCaliforniaTaxServicesPage() {
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  >
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircleIcon className="h-6 w-6 text-coral flex-shrink-0 mt-0.5" />
                      <span className="text-charcoal/80">California and La Quinta-specific tax expertise</span>
                    </li>
                  </motion.ul>
                </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-charcoal/80 text-sm leading-relaxed">
                        Professional tax preparation for your La Quinta vending business, including federal and California state returns, 
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <p className="text-charcoal/80">
                    Local professionals familiar with La Quinta and California tax requirements, business regulations, and economic landscape.
                  </p>
                </motion.div>
