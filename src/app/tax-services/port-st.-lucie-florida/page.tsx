...
export const metadata: Metadata = {
  ...
  keywords: "vending machine taxes Port St. Lucie Florida, vending business bookkeeping Port St. Lucie, tax services vending machines Port St. Lucie FL, vending machine accounting Port St. Lucie, tax preparation vending business Port St. Lucie",
  alternates: {
