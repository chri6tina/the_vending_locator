...
export const metadata: Metadata = {
  title: 'Get Vending Machine Leads and Locations in Phoenix, AZ | The Vending Locator',
  description: 'Get vending machine leads and locations in Phoenix, Arizona. Find qualified businesses ready for vending machine placement. Access verified locations with business details and contact information.',
  keywords: 'Phoenix vending machine leads, Arizona vending locations, Phoenix vending opportunities, vending machine placement Phoenix, Phoenix business locations, vending leads Arizona',
  openGraph: {
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-playfair font-bold tracking-tight text-white sm:text-6xl">
              Get Vending Machine Leads and Locations in Phoenix, AZ
            </h1>
            <p className="mt-6 text-xl leading-8 text-white/90 max-w-3xl mx-auto">
              Find qualified vending machine placement opportunities across Phoenix. From healthcare to technology, discover businesses ready for vending machine placement with verified contact information.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-playfair font-bold text-charcoal">
              Why Phoenix for Vending Machine Placement?
            </h2>
            <p className="mt-4 text-lg text-stone max-w-3xl mx-auto">
              Phoenix offers a growing business environment with healthcare, technology, and diverse industries perfect for vending machine opportunities.
            </p>
          </div>
