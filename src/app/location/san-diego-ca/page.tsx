...
export const metadata: Metadata = {
  title: 'Get Vending Machine Leads and Locations in San Diego, CA | The Vending Locator',
  description: 'Get vending machine leads and locations in San Diego, California. Find qualified businesses ready for vending machine placement. Access verified locations with business details and contact information.',
  keywords: 'San Diego vending machine leads, California vending locations, San Diego vending opportunities, vending machine placement San Diego, San Diego business locations, vending leads California',
  openGraph: {
    title: 'Get Vending Machine Leads and Locations in San Diego, CA',
    ...
    url: 'https://thevendinglocator.com/location/san-diego-ca',
  },
}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-playfair font-bold tracking-tight text-white sm:text-6xl">
              Get Vending Machine Leads and Locations in San Diego, CA
            </h1>
            <p className="mt-6 text-xl leading-8 text-white/90 max-w-3xl mx-auto">
              Find qualified vending machine placement opportunities across San Diego. From biotechnology to tourism, discover businesses ready for vending machine placement with verified contact information.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-playfair font-bold text-charcoal">
              Why San Diego for Vending Machine Placement?
            </h2>
            <p className="mt-4 text-lg text-stone max-w-3xl mx-auto">
              San Diego offers a diverse business environment with biotechnology, healthcare, and diverse industries perfect for vending machine opportunities.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <h3 className="text-lg font-semibold text-charcoal mb-3">Biotechnology & Life Sciences</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <p className="text-stone text-sm">
                Hotels, resorts, and entertainment venues with tourist traffic and visitor engagement throughout the year.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
