...
export const metadata: Metadata = {
  title: 'Get Vending Machine Leads and Locations in San Jose, CA | The Vending Locator',
  description: 'Get vending machine leads and locations in San Jose, California. Find qualified businesses ready for vending machine placement. Access verified locations with business details and contact information.',
  keywords: 'San Jose vending machine leads, California vending locations, San Jose vending opportunities, vending machine placement San Jose, San Jose business locations, vending leads California',
  openGraph: {
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-playfair font-bold tracking-tight text-white sm:text-6xl">
              Get Vending Machine Leads and Locations in San Jose, CA
            </h1>
            <p className="mt-6 text-xl leading-8 text-white/90 max-w-3xl mx-auto">
              Find qualified vending machine placement opportunities across San Jose. From technology companies to manufacturing, discover businesses ready for vending machine placement with verified contact information.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-playfair font-bold text-charcoal">
              Why San Jose for Vending Machine Placement?
            </h2>
            <p className="mt-4 text-lg text-stone max-w-3xl mx-auto">
              San Jose offers a dynamic business environment with technology, manufacturing, and diverse industries perfect for vending machine opportunities.
            </p>
          </div>
