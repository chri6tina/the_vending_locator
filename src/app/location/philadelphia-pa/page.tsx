...
export const metadata: Metadata = {
  title: 'Get Vending Machine Leads and Locations in Philadelphia, PA | The Vending Locator',
  description: 'Get vending machine leads and locations in Philadelphia, Pennsylvania. Find qualified businesses ready for vending machine placement. Access verified locations with business details and contact information.',
  keywords: 'Philadelphia vending machine leads, Pennsylvania vending locations, Philly vending opportunities, vending machine placement Philadelphia, Philly business locations, vending leads Pennsylvania',
  openGraph: {
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-playfair font-bold tracking-tight text-white sm:text-6xl">
              Get Vending Machine Leads and Locations in Philadelphia, PA
            </h1>
            <p className="mt-6 text-xl leading-8 text-white/90 max-w-3xl mx-auto">
              Find qualified vending machine placement opportunities across Philadelphia. From healthcare to education, discover businesses ready for vending machine placement with verified contact information.
            </p>
      ...
      <div className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              <div className="text-3xl font-bold text-navy">14+</div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-playfair font-bold text-charcoal">
              Why Philadelphia for Vending Machine Placement?
            </h2>
            <p className="mt-4 text-lg text-stone max-w-3xl mx-auto">
              Philadelphia offers a diverse business environment with healthcare, education, and diverse industries perfect for vending machine opportunities.
            </p>
          </div>
