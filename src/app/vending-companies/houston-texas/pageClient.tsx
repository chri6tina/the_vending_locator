...
const companies: VendingCompany[] = [
  {
    name: "Pro City Vending",
    website: "https://www.procityvending.com/",
    phone: "(713) 534-4591",
    description: "Pro City Vending provides state-of-the-art vending machines with free installation and fast setup for businesses throughout Houston. They offer office vending services with modern equipment and reliable service.",
    services: [
  ...
  {
    name: "Free Vendors",
    website: "https://freevendors.com/",
    phone: "(281) 601-4600",
    description: "Free Vendors offers complimentary delivery, setup, and installation of vending machines in Houston. They provide free vending machine placement for qualified businesses, making it easy to get started with vending services.",
    services: [
    ...
    rating: 4.6,
    verified: false,
    coverage: "Houston metropolitan area"
  },
  {
    name: "Mcliff Coffee + Vending",
    website: "https://mcliff.com/houston-tx/",
    phone: "(713) 975-6359",
    description: "Mcliff Coffee + Vending provides premium vending, coffee, pantry, and micro-market services throughout Houston. They focus on high-quality products and brands, offering comprehensive break room solutions for businesses.",
    services: [
      "Premium Vending",
      "Coffee Services",
      "Pantry Services",
  ...
  {
    name: "Empire Vending",
    website: "https://www.empirevending.com/",
    phone: "Coming Soon",
    description: "Empire Vending provides customized vending solutions with modern equipment and technology throughout Texas. They offer 24/7 service and tailor their solutions to meet specific client needs for businesses of all sizes.",
    services: [
    ...
    rating: 4.4,
    verified: false,
    coverage: "Houston and all of Texas"
  },
  {
    name: "Apollo's Healthy SmartMart",
    website: "https://apolloshoustonvending.com/",
    phone: "Coming Soon",
    description: "Apollo's Healthy SmartMart specializes in micro-market vending services in Houston, offering a variety of healthy snack and beverage options. They provide modern technology solutions with free installation for qualified locations.",
    services: [
      "Micro-Markets",
      ...
      <div className="bg-gradient-to-br from-navy/5 via-cream to-coral/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            ...
            >
              Connect with verified vending machine companies serving Houston and surrounding areas.
            </motion.p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center justify-between flex-col sm:flex-row gap-4">
              <div className="text-center sm:text-left flex-1">
                <p className="text-base sm:text-lg font-playfair font-semibold text-charcoal mb-1">
                  Own a vending company in Houston?
                </p>
                <p className="text-sm text-stone">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base text-stone max-w-2xl mx-auto">
              We've curated Houston's top vending machine companies to help businesses find the perfect 
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
              Get listed on our directory and reach more businesses in Houston. 
