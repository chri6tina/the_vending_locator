...
export default function AustinVendingServicesPage() {
  const company = {
    name: "Austin Vending Services",
    city: "Austin",
    state: "Texas",
    stateAbbr: "TX",
    ...
    description: "Professional vending services for Austin area businesses, offering snack machines, beverages, and coffee service with free installation and regular restocking.",
    services: ["Snack Machines", "Beverage Machines", "Coffee Service", "Break Room Solutions", "Free Installation", "Regular Restocking", "Machine Maintenance"],
    serviceArea: ["Austin", "Round Rock", "Cedar Park", "Pflugerville", "Georgetown"],
    machineTypes: ["Snack Vending Machines", "Beverage Vending Machines", "Coffee Machines", "Combination Machines"],
    rating: 4.5,
    reviewCount: 23,
    source: "Google Maps"
  }
