...
const companies: VendingCompany[] = [
  {
    name: "Uber Vending",
    website: "https://ubermiamivending.com/",
    phone: "(786) 663-7650",
    description: "Uber Vending offers traditional and healthy vending options in Miami and surrounding areas. They provide comprehensive vending solutions with a focus on both traditional snacks and healthier alternatives for businesses throughout South Florida.",
    services: [
      "Traditional Vending",
    ...
    rating: 4.4,
    verified: false,
    coverage: "Miami and surrounding areas"
  },
  {
    name: "Biscayne Vending",
    website: "https://www.biscaynevending.com/",
    phone: "Coming Soon",
    description: "Biscayne Vending provides AI-powered smart vending machines offering a wide range of products including snacks and fresh meals. They serve South Florida from Downtown Miami to Aventura with cutting-edge technology and modern convenience.",
    services: [
    ...
    rating: 4.6,
    verified: false,
    coverage: "Downtown Miami to Aventura"
  },
  {
    name: "Clutch Snacks",
    website: "https://www.clutchsnacksmiami.com/",
    phone: "Coming Soon",
    description: "Clutch Snacks provides vending machine solutions with free placement, focusing on high-traffic locations throughout Miami. They offer a variety of snacks and beverages with convenient service for businesses seeking reliable vending solutions.",
    services: [
  ...
  {
    name: "Felix Vending",
    website: "https://felixvending.com/",
    phone: "Coming Soon",
    description: "Felix Vending offers modern vending machine installations at zero cost, featuring cash and cashless payment options. They stock a wide assortment of products including cold beverages, snacks, and frozen treats for businesses throughout Miami.",
    services: [
  ...
  {
    name: "Belly Vending",
    website: "https://www.bellyvending.com/",
    phone: "Coming Soon",
    description: "Belly Vending offers a full suite of vending products including beverage machines, snack machines, and coffee/tea machines with free delivery and installation. They provide comprehensive vending solutions for businesses throughout South Florida.",
    services: [
      "Beverage Machines",
      "Snack Machines",
      "Coffee & Tea Machines",
      ...
      <div className="bg-gradient-to-br from-navy/5 via-cream to-coral/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            ...
            >
              Connect with verified vending machine companies serving Miami and surrounding areas.
            </motion.p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base text-stone max-w-2xl mx-auto">
              We've curated Miami's top vending machine companies to help businesses find the perfect 
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
              Get listed on our directory and reach more businesses in Miami. 
