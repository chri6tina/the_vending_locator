              ...
              <ol className="flex items-center space-x-4">
                ...
                <li>
                  <div className="flex items-center">
                    ...
                    <span className="ml-4 text-sm font-medium text-gray-500">Virginia</span>
                  </div>
                </li>
              </ol>
            </nav>
            ...
            <div className="text-center">
              ...
              >
                ...
                <div className="flex items-center justify-center gap-3 p-3 bg-cream/30 rounded-lg">
                  ...
                  <span className="text-sm font-medium text-chocolate">55,000+ Businesses</span>
                </div>
                <div className="flex items-center justify-center gap-3 p-3 bg-cream/30 rounded-lg">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-stone leading-relaxed max-w-3xl mx-auto">
                Get access to qualified vending machine locations in Virginia with flexible pricing options. 
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Virginia offers diverse vending opportunities across multiple thriving industries with a strong focus on healthcare, government, and technology.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              >
                ...
                <p className="text-stone">Tech companies, data centers, and innovation hubs with high employee density.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-stone">Federal agencies, state offices, and government facilities with steady operations.</p>
              </motion.div>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              >
                ...
                <p className="text-gray-600">
                  Virginia offers diverse opportunities including government facilities, healthcare centers, 
                  technology companies, and educational institutions. The strong government sector and growing tech 
              ...
              >
                ...
                <p className="text-gray-600">
                  Virginia has a growing vending presence, but there's still significant opportunity 
                  for expansion, especially in new business developments and emerging technology areas.
                </p>
              </motion.div>
              ...
              >
                <h3 className="text-xl font-semibold mb-3 text-navy">
                  What are the peak business hours for vending in Virginia?
                </h3>
                <p className="text-gray-600">
                  Virginia businesses typically operate from 8 AM to 6 PM, with peak vending activity 
