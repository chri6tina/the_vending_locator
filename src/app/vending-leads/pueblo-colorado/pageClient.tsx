        ...
        <section className="relative py-20 bg-white overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              >
                Get pre-qualified vending machine locations in Pueblo's diverse manufacturing and healthcare economy. 
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Steel manufacturing, aerospace, and industrial operations providing large employee bases and excellent vending opportunities.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Medical facilities, hospitals, and healthcare services providing consistent patient and staff traffic.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Colorado State University Pueblo and school districts providing large student populations and consistent foot traffic.</p>
              </motion.div>
