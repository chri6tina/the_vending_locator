...
export default function AlabamaVendingLeadsPage() {
  ...
  const stateData = {
    ...
    'rating': '4.8/5',
    'description': 'Yellowhammer State with manufacturing, healthcare, and aerospace'
  };
  ...
  const [userNames, setUserNames] = useState([
    'Mike from Alabama', 'Sarah in Downtown', 'David in Alabama', 'Lisa in Alabama',
    'Tom in Alabama', 'Jennifer in Alabama', 'Robert in Alabama', 'Amanda in Alabama',
    'Chris in Alabama', 'Maria in Alabama', 'James in Alabama', 'Emily in Alabama'
  ])
