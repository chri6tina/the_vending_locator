...
export default function AlabamaVendingLeadsPage() {
  const structuredData = generateCityStructuredData({
    ...
    industries: ['Automotive', 'Aerospace', 'Healthcare', 'Manufacturing', 'Education'],
    description: 'Alabama offers excellent opportunities for vending machine placement with its automotive sector, aerospace industry, and diverse business landscape.'
  })
  ...
  const cities = [
    {
      ...
      vendorCount: '160+',
      businessCount: '200+',
      description: 'Largest city with healthcare and manufacturing',
    ...
    },
    {
      ...
      vendorCount: '140+',
      businessCount: '180+',
      description: 'Aerospace and technology hub',
      highlights: ['Aerospace', 'Technology', 'Healthcare']
    },
    {
      name: 'Mobile',
      slug: 'mobile-alabama',
    ...
    },
    {
      ...
      vendorCount: '80+',
      businessCount: '100+',
      description: 'University and automotive center',
      highlights: ['Education', 'Automotive', 'Healthcare']
    }
  ]
      ...
      <div className="min-h-screen bg-warm-white">
          ...
          <div className="mx-auto max-w-2xl px-4 sm:px-6 py-12 sm:py-16 lg:py-24">
            <div className="text-center">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-playfair font-bold tracking-tight text-charcoal leading-tight">
                Alabama Vending Machine Locations
              </h1>
              
              <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-stone px-2 sm:px-0">
                Discover premium vending machine placement opportunities across Alabama. 
                Access 150,000+ businesses and the heart of the Southeast's automotive and aerospace hub.
              </p>

              {/* State Stats - Matching Homepage Counter Style */}
              <div className="mt-10 sm:mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-4 sm:px-0">
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-bronze">150,000+</div>
                  <div className="text-xs sm:text-sm text-stone leading-tight">Businesses</div>
                </div>
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-bronze">5.1M+</div>
                  <div className="text-xs sm:text-sm text-stone leading-tight">Population</div>
                </div>
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-bronze">600+</div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Alabama is a major automotive and aerospace hub in the Southeast, offering diverse vending opportunities across multiple thriving industries.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-charcoal mb-2">Automotive & Manufacturing</h3>
                <p className="text-stone">Automotive plants, manufacturing facilities, and industrial operations with high employee density and consistent operational hours.</p>
              </div>
        ...
        <div className="bg-warm-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Explore vending machine opportunities in Alabama's most active business areas.
              </p>
            </div>
        ...
        <div className="bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold text-charcoal mb-4">
                Get Alabama Vending Machine Leads
              </h2>
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Access verified vending locations across Alabama with our flexible pricing options designed for vending machine entrepreneurs.
              </p>
            </div>
            <PricingTable />
          </div>
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone">
                Everything you need to know about vending machine opportunities in Alabama.
              </p>
            </div>
            <div className="space-y-6">
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  What types of businesses are best for vending machines in Alabama?
                </h3>
                <p className="text-stone">
                  Alabama offers diverse opportunities including automotive plants, aerospace companies,
                  healthcare centers, and manufacturing facilities. The major automotive and aerospace sectors
                  provide excellent placement opportunities.
                </p>
              </div>
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  How competitive is the vending machine market in Alabama?
                </h3>
                <p className="text-stone">
                  Alabama has a moderate vending presence with significant opportunity for expansion,
                  especially in new automotive developments and growing aerospace areas.
                </p>
              </div>
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  What are the best vending machine types for Alabama businesses?
                </h3>
                <p className="text-stone">
                  For Alabama automotive locations, industrial-grade beverage and snack machines work best. Aerospace facilities need reliable machines, while
