...
export default function PageClient() {
  ...
  const faqs = [
    {
        "q": "How many vending machine locations are available in Concord?",
        "a": "Our Concord database includes hundreds of verified vending locations across state capital with government offices, healthcare facilities, and growing business district. We continuously update our listings to ensure you have access to the most current opportunities in New Hampshire's capital city."
    },
    {
        "q": "What types of locations are included in Concord's vending leads?",
        "a": "Concord's leads span government & public services, healthcare & medical centers, education & training, and more. Our database focuses on high-traffic venues with ~44,000 residents and visitors providing consistent customer flow throughout the year."
    },
    {
        "q": "How current are the Concord vending location leads?",
        "a": "All Concord leads are verified and updated regularly. Our team actively monitors Concord's business landscape to ensure you receive accurate, actionable information about venues seeking vending services in this New Hampshire community."
    },
    {
        "q": "Can I target specific industries in Concord?",
        "a": "Yes! Our Concord database allows filtering by industry type, including government & public services, healthcare & medical centers, education & training, and other sectors. This targeting helps you focus on locations that align with your vending machine offerings and business strategy in the Concord area."
    },
    {
        "q": "What makes Concord a good market for vending machines?",
        "a": "Concord offers excellent vending opportunities with its state capital with government offices, healthcare facilities, and growing business district. The city's diverse economy, steady population of ~44,000, and mix of government workers and residents create consistent demand for convenient vending services."
    },
    {
        "q": "How do I get started with Concord vending leads?",
        "a": "Simply choose your preferred plan, and you'll gain immediate access to our complete Concord location database. You can begin contacting venues right away. Our platform provides all the details you need to connect with decision-makers at Concord locations actively seeking vending services."
    },
    {
        "q": "Are Concord locations exclusive to one vending operator?",
        "a": "No, our Concord leads are available to all subscribers. However, acting quickly gives you a competitive advantage. Many successful vending operators in Concord have secured multiple locations by being proactive and professional in their outreach to New Hampshire venues."
    },
    {
        "q": "What support is available for placing machines in Concord?",
        "a": "Beyond our Concord location database, we provide negotiation guides, contract templates, and industry best practices. Our resources help you successfully approach Concord venues, present professional proposals, and establish profitable vending partnerships throughout the Concord area and broader New Hampshire market."
    }
];
