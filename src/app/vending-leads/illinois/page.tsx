...
export default function AuroraColoradoColoradoVendingLeadsPage() {
  ...
  const cityDisplayName = 'Illinois';
  ...
  const [userNames, setUserNames] = useState([
    'Mike from Illinois', 'Sarah in Downtown', 'David in Illinois', 'Lisa in Illinois',
    'Tom in Illinois', 'Jennifer in Illinois', 'Robert in Illinois', 'Amanda in Illinois',
