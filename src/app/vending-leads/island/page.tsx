...
export default function IslandVendingLeadsPage() {
  // State display name
  ...
  const stateData = {
    ...
    'rating': '4.8/5',
    'description': 'Coastal business hub with diverse economic opportunities'
  };
  ...
  const [userNames, setUserNames] = useState([
    'Mike from Island', 'Sarah in Downtown', 'David in Island', 'Lisa in Island',
  ...
  return (
    <>
      <Head>
        <title>Vending Machine Leads in Island - Business Locations & Opportunities</title>
        <meta name="description" content="Discover premium vending machine opportunities across Island. Access verified business locations with industry insights and growth potential data." />
        <meta name="keywords" content="vending machine leads island, island business locations, vending machine business island, verified business locations island" />
      </Head>
      <Header />
        ...
        <section className="relative py-20 bg-white overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              >
                Get pre-qualified vending machine locations across {stateDisplayName}'s diverse and growing business economy. 
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                >
                  ...
                  <p className="text-stone">
                    Complete coverage of major business districts across {stateDisplayName}, 
                ...
                >
                  ...
                  <p className="text-stone">
                    Join {activeUsers} active users currently exploring vending opportunities across {stateDisplayName}. 
