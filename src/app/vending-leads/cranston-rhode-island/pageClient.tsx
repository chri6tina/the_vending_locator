        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Rhode Island', item: `https://www.thevendinglocator.com/vending-leads/${stateSlug}` },
              { '@type': 'ListItem', position: 4, name: 'Cranston', item: `https://www.thevendinglocator.com/vending-leads/${slug}` }
            ]
          })
        }}
      />
