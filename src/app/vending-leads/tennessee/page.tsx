  ...
  const cities = [
    {
      ...
      vendorCount: '150+',
      businessCount: '220+',
      description: 'Music industry and healthcare excellence',
      highlights: ['Music Industry', 'Healthcare', 'Entertainment']
    },
    {
      name: 'Memphis',
      ...
      vendorCount: '140+',
      businessCount: '200+',
      description: 'Logistics hub and healthcare excellence',
      highlights: ['Logistics', 'Healthcare', 'Manufacturing']
    },
    {
      name: 'Knoxville',
      ...
      vendorCount: '120+',
      businessCount: '180+',
      description: 'University town with technology innovation',
        ...
        <div className="bg-warm-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                Tennessee Vending Machine Leads
              </motion.h1>
              ...
              >
                Access verified vending machine locations across Tennessee's thriving music industry, 
                healthcare excellence, and educational institutions. Get business details and placement opportunities.
              </motion.p>
            </div>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-playfair font-bold tracking-tight text-chocolate mb-6">
                Tennessee Cities with Vending Opportunities
              </h2>
        ...
        <div className="bg-warm-white py-16 sm:py-20 lg:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-playfair font-bold text-chocolate mb-6">
              Ready to Expand Your Vending Business in Tennessee?
            </h2>
            <p className="text-lg sm:text-xl text-chocolate/70 max-w-3xl mx-auto mb-10 leading-relaxed">
              Get access to verified Tennessee locations with business details, contact information, 
