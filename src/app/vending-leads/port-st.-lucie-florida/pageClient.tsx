...
export default function PortStLucieFloridaVendingLeadsPage() {
  ...
  const [userNames, setUserNames] = useState([
    'Mike from Port St. Lucie', 'Sarah in Downtown', 'David in Port St. Lucie', 'Lisa in Port St. Lucie', 'Tom in Port St. Lucie', 'Jennifer in Port St. Lucie', 'Robert in Port St. Lucie', 'Amanda in Port St. Lucie', 'Chris in Port St. Lucie', 'Maria in Port St. Lucie', 'James in Port St. Lucie', 'Emily in Port St. Lucie'
  ])
  ...
  const relatedCities = state ? state.cities.filter(c => c.slug !== 'port-st.-lucie-florida').slice(0, 8) : [];

  // FAQ items reused for JSON-LD
  const faqItems = [
    { q: 'What types of vending machine locations are available in Port St. Lucie?\', a: 'Port St. Lucie offers diverse vending opportunities including healthcare facilities, educational institutions, retail locations, office buildings, and manufacturing facilities. Each location is pre-verified for optimal vending machine success.' },
    { q: 'How quickly can I get vending machine leads for Port St. Lucie?\', a: 'Our Port St. Lucie vending leads are delivered within 3-5 business days. We provide comprehensive research including business details, contact information, and placement opportunities to accelerate your market entry.' },
    { q: 'What makes Port St. Lucie a good market for vending machines?\', a: "Port St. Lucie features a thriving business community with diverse industries and strong economic activity. The city's business density and diverse demographics create ideal conditions for vending machine success." },
    { q: 'Do you provide ongoing support for Port St. Lucie locations?\', a: 'Yes, we offer comprehensive support including location research, contact information, placement strategies, and ongoing consultation to ensure your vending machines thrive in Port St. Lucie.' },
    { q: 'What industries in Port St. Lucie are best for vending machines?\', a: 'Healthcare, education, retail, office buildings, and manufacturing in Port St. Lucie show the highest potential for vending machine success due to consistent foot traffic and diverse demographics.' },
    { q: 'How do you verify the quality of Port St. Lucie vending locations?\', a: 'We conduct thorough research on each Port St. Lucie location including business verification, foot traffic analysis, employee count validation, and industry research to ensure only high-quality opportunities are included.' },
    { q: 'Can I get customized vending leads for specific areas of Port St. Lucie?\', a: 'Absolutely! We can provide targeted vending leads for specific neighborhoods, business districts, or industrial areas within Port St. Lucie based on your preferences and target market requirements.' },
    { q: "What's the typical ROI for vending machines in Port St. Lucie?", a: "Vending machines in Port St. Lucie typically show strong ROI due to the city's business density and diverse economy. Our research shows average payback periods of 12-18 months for well-placed machines." }
  ];
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Port St. Lucie', item: 'https://www.thevendinglocator.com/vending-leads/port-st.-lucie-florida' }
            ]
          })
        }}
      />
