...
export default function RhodeIslandVendingLeadsPage() {
  const structuredData = generateCityStructuredData({
    ...
    industries: ['Healthcare', 'Education', 'Manufacturing', 'Tourism', 'Technology'],
    description: 'Rhode Island offers excellent opportunities for vending machine placement with its healthcare sector, education industry, and diverse business landscape.'
  })
  ...
  const cities = [
    {
      ...
      highlights: ['Healthcare', 'Education', 'Technology']
    },
    {
      name: 'Warwick',
      ...
      <div className="min-h-screen bg-warm-white">
          ...
          <div className="mx-auto max-w-2xl px-4 sm:px-6 py-12 sm:py-16 lg:py-24">
            <div className="text-center">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-playfair font-bold tracking-tight text-charcoal leading-tight">
                Rhode Island Vending Machine Locations
              </h1>
              
              <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-stone px-2 sm:px-0">
                Discover premium vending machine placement opportunities across Rhode Island. 
                Access 40,000+ businesses and the heart of New England's healthcare and education hub.
              </p>
              ...
              <div className="mt-10 sm:mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-4 sm:px-0">
                ...
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-bronze">550+</div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Rhode Island is a healthcare and education hub in New England, offering diverse vending opportunities across multiple thriving industries.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-stone">Universities, colleges, and research institutions with students, faculty, and staff.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-charcoal mb-2">Manufacturing & Technology</h3>
                <p className="text-stone">Manufacturing plants, technology companies, and industrial facilities with workers and operational staff.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-warm-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold text-charcoal mb-4">
                Major Rhode Island Cities
              </h2>
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Explore vending machine opportunities in Rhode Island's most active business areas.
              </p>
            </div>
        ...
        <div className="bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold text-charcoal mb-4">
                Get Rhode Island Vending Machine Leads
              </h2>
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Access verified vending locations across Rhode Island with our flexible pricing options designed for vending machine entrepreneurs.
              </p>
            </div>
            <PricingTable />
          </div>
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone">
                Everything you need to know about vending machine opportunities in Rhode Island.
              </p>
            </div>
            <div className="space-y-6">
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  What types of businesses are best for vending machines in Rhode Island?
                </h3>
                <p className="text-stone">
                  Rhode Island offers diverse opportunities including healthcare facilities, educational institutions,
                  manufacturing plants, and technology companies. The healthcare and education sectors
                  provide excellent placement opportunities.
                </p>
              </div>
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  How competitive is the vending machine market in Rhode Island?
                </h3>
                <p className="text-stone">
                  Rhode Island has a moderate vending presence with significant opportunity for expansion,
                  especially in growing healthcare and education areas.
                </p>
              </div>
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  What are the best vending machine types for Rhode Island businesses?
                </h3>
                <p className="text-stone">
                  For Rhode Island healthcare locations, professional beverage and snack machines work best. Educational institutions need reliable machines, while
                  manufacturing facilities prefer industrial options. We provide specific recommendations for each business type.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                { name: 'Massachusetts', slug: 'massachusetts', count: '720+ leads' },
                { name: 'New Hampshire', slug: 'new-hampshire', count: '530+ leads' },
              ].map((state) => (
