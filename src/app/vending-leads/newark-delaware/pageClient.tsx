        ...
        <section className="relative py-20 bg-white overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              >
                Get pre-qualified vending machine locations in Newark's vibrant university and business community. 
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Newark's university and educational institutions provide consistent student and staff populations for vending machine opportunities.</p>
              </motion.div>
              <motion.div
                key="Healthcare"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Healthcare facilities in Newark offer stable operations with high foot traffic from patients, visitors, and staff.</p>
              </motion.div>
              <motion.div
                key="Retail"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Newark's transportation hubs including bus stations and transit centers provide high-volume foot traffic.</p>
              </motion.div>
            </div>
          </div>
        </section>
