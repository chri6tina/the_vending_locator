        ...
        <section className="relative py-20 bg-white overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              >
                Get pre-qualified vending machine locations in Irvine's thriving technology and business economy. 
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Medical facilities, research institutions, and healthcare services providing consistent patient and staff traffic.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-stone leading-relaxed">UC Irvine, school districts, and educational institutions providing large student populations and consistent foot traffic.</p>
              </motion.div>
