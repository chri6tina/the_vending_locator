...
export default function FloridaVendingLeadsPage() {
  ...
  const [userNames, setUserNames] = useState([
    'Tom from Jacksonville', 'Sarah from Miami', 'Mike from Tampa', 'Lisa from Orlando',
    'David from St. Petersburg', 'Jennifer from Hialeah', 'Robert from Tallahassee', 'Amanda from Fort Lauderdale',
    'Chris from Port St. Lucie', 'Maria from Cape Coral', 'James from Gainesville', 'Emily from Clearwater'
  ])
      ...
      <div className="min-h-screen bg-warm-white">
        ...
        <div className="bg-warm-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                Get pre-qualified vending machine locations in Florida's thriving healthcare and tourism economy. 
        ...
        <section id="pricing" className="py-16 bg-cream/20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              >
                Choose Your Florida Vending Leads Plan
              </motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                Get access to verified vending machine locations across Florida with our comprehensive lead packages.
              </motion.p>
            </div>
            <PricingTable />
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-playfair font-bold text-charcoal">
                Florida Business Landscape
              </h2>
              <p className="mt-4 text-lg text-stone max-w-3xl mx-auto">
                Florida offers diverse opportunities across multiple thriving industries, making it an ideal location for vending machine placement.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {[
                ...
                { icon: SunIcon, title: 'Tourism', description: 'Hotels, resorts, and attractions', color: 'text-yellow-600' },
                ...
                { icon: TruckIcon, title: 'Manufacturing', description: 'Aerospace and manufacturing operations', color: 'text-green-600' }
              ].map((industry, index) => (
                <motion.div
                  key={industry.title}
                  initial={{ opacity: 0, y: 20 }}
        ...
        <section className="py-16 bg-cream/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { label: 'Population', value: '21.8M+', description: 'Residents across the state' },
        ...
        <section id="hot-leads" className="py-16 bg-warm-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-playfair font-bold text-charcoal">
                Hot Florida Vending Leads
              </h2>
              <p className="mt-4 text-lg text-stone max-w-2xl mx-auto">
                Get immediate access to the most promising vending machine placement opportunities in Florida.
              </p>
            </motion.div>
            <HotLeads />
          </div>
        ...
        <section className="py-16 bg-warm-white">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {[
                {
                  question: "What types of businesses are available for vending machine placement in Florida?",
                  answer: "Florida offers diverse opportunities including healthcare facilities, tourism businesses, educational institutions, retail businesses, technology companies, and manufacturing operations. Our leads cover all major industries across the state."
                },
                {
                  question: "How quickly can I start placing vending machines in Florida?",
                ...
                {
                  question: "Are the Florida leads pre-qualified for vending machine placement?",
                  answer: "Yes, all our Florida leads are pre-qualified businesses that have shown interest in vending machine services or have suitable locations for placement."
                },
                {
                  question: "What support do you provide for Florida vending machine placement?",
                  answer: "We provide comprehensive support including lead verification, business contact information, placement guidance, and ongoing assistance to ensure successful vending machine placement across Florida."
                }
              ].map((faq, index) => (
                <motion.div
                  key={index}
        ...
        <section className="py-16 bg-cream/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mt-4 text-lg text-stone max-w-2xl mx-auto">
                Explore vending machine opportunities in Florida's key cities and metropolitan areas.
              </p>
            </motion.div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { name: 'Jacksonville', slug: 'jacksonville-florida', description: 'Healthcare and manufacturing center' },
                { name: 'Miami', slug: 'miami-florida', description: 'Tourism and healthcare hub' },
                { name: 'Tampa', slug: 'tampa-florida', description: 'Healthcare and technology center' },
                { name: 'Orlando', slug: 'orlando-florida', description: 'Tourism and healthcare hub' },
                { name: 'St. Petersburg', slug: 'st-petersburg-florida', description: 'Healthcare and tourism center' },
                { name: 'Hialeah', slug: 'hialeah-florida', description: 'Healthcare and retail hub' }
              ].map((city, index) => (
                <motion.div
                  key={city.name}
                  initial={{ opacity: 0, y: 20 }}
