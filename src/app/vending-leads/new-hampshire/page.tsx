...
export default function NewHampshireVendingLeadsPage() {
  const structuredData = generateCityStructuredData({
    ...
    industries: ['Technology', 'Healthcare', 'Manufacturing', 'Education', 'Tourism'],
    description: 'New Hampshire offers excellent opportunities for vending machine placement with its technology sector, healthcare industry, and diverse business landscape.'
  })
  ...
  const cities = [
    {
      ...
      highlights: ['Healthcare', 'Technology', 'Manufacturing']
    },
    {
      name: 'Nashua',
      ...
      vendorCount: '130+',
      businessCount: '180+',
      description: 'Technology and healthcare hub',
      highlights: ['Technology', 'Healthcare', 'Education']
    },
    {
      name: 'Concord',
    ...
    },
    {
      ...
      vendorCount: '80+',
      businessCount: '110+',
      description: 'Education and healthcare center',
      ...
      <div className="min-h-screen bg-warm-white">
          ...
          <div className="mx-auto max-w-2xl px-4 sm:px-6 py-12 sm:py-16 lg:py-24">
            <div className="text-center">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-playfair font-bold tracking-tight text-charcoal leading-tight">
                New Hampshire Vending Machine Locations
              </h1>
              
              <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-stone px-2 sm:px-0">
                Discover premium vending machine placement opportunities across New Hampshire. 
                Access 45,000+ businesses and the heart of New England's technology and healthcare hub.
              </p>
              ...
              <div className="mt-10 sm:mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-4 sm:px-0">
                ...
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-bronze">530+</div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                New Hampshire is a technology and healthcare hub in New England, offering diverse vending opportunities across multiple thriving industries.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-stone">Tech companies, software firms, and innovation centers with employees and operational staff.</p>
              </div>
        ...
        <div className="bg-warm-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold text-charcoal mb-4">
                Major New Hampshire Cities
              </h2>
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Explore vending machine opportunities in New Hampshire's most active business areas.
              </p>
            </div>
        ...
        <div className="bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold text-charcoal mb-4">
                Get New Hampshire Vending Machine Leads
              </h2>
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Access verified vending locations across New Hampshire with our flexible pricing options designed for vending machine entrepreneurs.
              </p>
            </div>
            <PricingTable />
          </div>
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone">
                Everything you need to know about vending machine opportunities in New Hampshire.
              </p>
            </div>
            <div className="space-y-6">
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  What types of businesses are best for vending machines in New Hampshire?
                </h3>
                <p className="text-stone">
                  New Hampshire offers diverse opportunities including technology companies, healthcare facilities,
                  educational institutions, and manufacturing plants. The technology and healthcare sectors
                  provide excellent placement opportunities.
                </p>
              </div>
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  How competitive is the vending machine market in New Hampshire?
                </h3>
                <p className="text-stone">
                  New Hampshire has a moderate vending presence with significant opportunity for expansion,
                  especially in growing technology and healthcare areas.
                </p>
              </div>
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  What are the best vending machine types for New Hampshire businesses?
                </h3>
                <p className="text-stone">
                  For New Hampshire technology locations, modern beverage and snack machines work best. Healthcare facilities need professional machines, while
                  educational institutions prefer reliable options. We provide specific recommendations for each business type.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-warm-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { name: 'Maine', slug: 'maine', count: '380+ leads' },
                { name: 'Vermont', slug: 'vermont', count: '320+ leads' },
