...
export default function ColumbiaMissouriVendingLeadsPage() {
  ...
  const cityData = {
    ...
    'rating': '4.4/5',
    'description': 'Major university and healthcare center'
  };
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">University of Missouri</h3>
              </div>
              <p className="text-gray-600">
                {cityDisplayName} is home to the University of Missouri (Mizzou), providing excellent opportunities for campus and student center vending machines.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Major healthcare systems and medical facilities throughout {cityDisplayName} offer steady vending machine traffic throughout the day.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Research & Technology</h3>
              </div>
              <p className="text-gray-600">
                Research facilities and technology companies in {cityDisplayName} provide opportunities for modern office and laboratory vending machine placement.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                {cityDisplayName} offers excellent opportunities in university facilities, healthcare centers, corporate offices, retail centers, government buildings, and research facilities. The city's strong educational and healthcare sectors provide diverse vending machine placement opportunities.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Vending machine revenue in {cityDisplayName} varies by location type, but our verified locations typically generate $140-550+ per month per machine. University facilities and healthcare centers tend to perform best due to consistent foot traffic.
              </p>
            </div>
