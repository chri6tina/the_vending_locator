...
export default function NorthCarolinaVendingLeadsPage() {
  ...
  const [userNames, setUserNames] = useState([
    'Tom from Charlotte', 'Sarah from Raleigh', 'Mike from Greensboro', 'Lisa from Durham',
    'David from Winston-Salem', 'Jennifer from Fayetteville', 'Robert from Cary', 'Amanda from Wilmington',
    'Chris from High Point', 'Maria from Greenville', 'James from Asheville', 'Emily from Concord'
  ])
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-warm-white">
        {/* Enhanced Hero Section - North Carolina-Specific */}
        <div className="bg-warm-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                <div className="flex items-center justify-center gap-3">
                  ...
                  <span className="text-sm font-medium text-chocolate">
                    <span className="font-bold text-coral">{activeUsers}</span> North Carolina vendors are choosing plans right now
                  </span>
                </div>
                <div
              ...
              >
                Vending Machine Locations<br />in North Carolina
              </motion.h1>
              ...
              >
                Get pre-qualified vending machine locations in North Carolina's thriving healthcare and manufacturing economy. 
                Access verified businesses with detailed contact information and placement opportunities.
              </motion.p>

              {/* Trust Signals - North Carolina-Specific */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        <section id="pricing" className="py-16 bg-cream/20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              >
                Choose Your North Carolina Vending Leads Plan
              </motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                Get access to verified vending machine locations across North Carolina with our comprehensive lead packages.
              </motion.p>
            </div>
            <PricingTable />
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mt-4 text-lg text-stone max-w-3xl mx-auto">
                North Carolina offers diverse opportunities across multiple thriving industries, making it an ideal location for vending machine placement.
              </p>
            </motion.div>
        ...
        <section className="py-16 bg-cream/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { label: 'Population', value: '10.4M+', description: 'Residents across the state' },
        ...
        <section id="hot-leads" className="py-16 bg-warm-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-playfair font-bold text-charcoal">
                Hot North Carolina Vending Leads
              </h2>
              <p className="mt-4 text-lg text-stone max-w-2xl mx-auto">
                Get immediate access to the most promising vending machine placement opportunities in North Carolina.
              </p>
            </motion.div>
            <HotLeads />
          </div>
        ...
        <section className="py-16 bg-warm-white">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {[
                {
                  question: "What types of businesses are available for vending machine placement in North Carolina?",
                  answer: "North Carolina offers diverse opportunities including healthcare facilities, manufacturing operations, educational institutions, retail businesses, technology companies, and solar energy operations. Our leads cover all major industries across the state."
                },
                {
                  question: "How quickly can I start placing vending machines in North Carolina?",
                ...
                {
                  question: "Are the North Carolina leads pre-qualified for vending machine placement?",
                  answer: "Yes, all our North Carolina leads are pre-qualified businesses that have shown interest in vending machine services or have suitable locations for placement."
                },
                {
                  question: "What support do you provide for North Carolina vending machine placement?",
                  answer: "We provide comprehensive support including lead verification, business contact information, placement guidance, and ongoing assistance to ensure successful vending machine placement across North Carolina."
                }
              ].map((faq, index) => (
                <motion.div
                  key={index}
        ...
        <section className="py-16 bg-cream/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mt-4 text-lg text-stone max-w-2xl mx-auto">
                Explore vending machine opportunities in North Carolina's key cities and metropolitan areas.
              </p>
            </motion.div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { name: 'Charlotte', slug: 'charlotte-north-carolina', description: 'Healthcare and technology center' },
                { name: 'Raleigh', slug: 'raleigh-north-carolina', description: 'Healthcare and education hub' },
                { name: 'Greensboro', slug: 'greensboro-north-carolina', description: 'Healthcare and manufacturing center' },
                { name: 'Durham', slug: 'durham-north-carolina', description: 'Healthcare and education hub' },
                { name: 'Winston-Salem', slug: 'winston-salem-north-carolina', description: 'Healthcare and retail center' },
                { name: 'Fayetteville', slug: 'fayetteville-north-carolina', description: 'Healthcare and military hub' }
              ].map((city, index) => (
                <motion.div
                  key={city.name}
                  initial={{ opacity: 0, y: 20 }}
