        ...
        <div className="bg-warm-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                Get pre-qualified vending machine locations in Indianapolis' thriving healthcare and logistics economy. 
              ...
              >
                ...
                >
                  Learn About Indianapolis <span aria-hidden="true">→</span>
                </Link>
              </motion.div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mt-4 text-lg text-stone max-w-2xl mx-auto">
                Discover the diverse industries and opportunities that make Indianapolis perfect for vending machine placement.
              </p>
            </motion.div>
        ...
        <section className="py-16 bg-cream/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { label: 'Population', value: '887,000+', description: 'Capital and largest city in Indiana' },
                { label: 'Businesses', value: '45,000+', description: 'Diverse business ecosystem' },
                { label: 'Major Industries', value: '6+', description: 'Healthcare, logistics, manufacturing, education, office, technology' }
              ].map((stat, index) => (
                <motion.div
                  key={stat.label}
                  initial={{ opacity: 0, y: 20 }}
        ...
        <section className="py-16 bg-warm-white">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {[
                {
                  question: "What types of businesses are available for vending machine placement in Indianapolis?",
                  answer: "Indianapolis offers diverse opportunities including healthcare facilities, logistics centers, manufacturing companies, educational institutions, corporate offices, and technology firms. Our leads cover all major industries across the city."
                },
                {
                  question: "How quickly can I start placing vending machines in Indianapolis?",
                ...
                {
                  question: "Are the Indianapolis leads pre-qualified for vending machine placement?",
                  answer: "Yes, all our Indianapolis leads are pre-qualified businesses that have shown interest in vending machine services or have suitable locations for placement."
                },
                {
                  question: "What support do you provide for Indianapolis vending machine placement?",
                  answer: "We provide comprehensive support including lead verification, business contact information, placement guidance, and ongoing assistance to ensure successful vending machine placement across Indianapolis."
                }
              ].map((faq, index) => (
                <motion.div
                  key={index}
        ...
        <section className="py-16 bg-cream/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mt-4 text-lg text-stone max-w-2xl mx-auto">
                Explore vending machine opportunities in Indiana's other major cities and metropolitan areas.
              </p>
            </motion.div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { name: 'Fort Wayne', slug: 'fort-wayne-indiana', description: 'Manufacturing and healthcare hub' },
                { name: 'Evansville', slug: 'evansville-indiana', description: 'Port city with manufacturing and healthcare' },
                { name: 'South Bend', slug: 'south-bend-indiana', description: 'University town with manufacturing' },
                { name: 'Carmel', slug: 'carmel-indiana', description: 'Suburban business center with healthcare' },
                { name: 'Fishers', slug: 'fishers-indiana', description: 'Technology and corporate hub' },
                { name: 'Bloomington', slug: 'bloomington-indiana', description: 'University town with healthcare' }
              ].map((city, index) => (
                <motion.div
                  key={city.name}
                  initial={{ opacity: 0, y: 20 }}
