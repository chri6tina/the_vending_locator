...
const cityData = {
  ...
  state: 'Tennessee',
  population: '166,722',
  description: 'Clarksville, Tennessee is a rapidly growing city located near the Kentucky border and home to Fort Campbell military base. Known for its strong military presence, manufacturing sector, and proximity to Nashville, Clarksville offers excellent vending opportunities in defense, healthcare, education, and retail sectors.',
  keyIndustries: ['Defense', 'Manufacturing', 'Healthcare', 'Education', 'Retail'],
  majorEmployers: ['Fort Campbell', 'Austin Peay State University', 'Clarksville-Montgomery County School System', 'City of Clarksville', 'Trane Technologies'],
  ...
  transportation: {
    majorHighways: ['I-24', 'US-41A', 'US-79', 'SR-76'],
    publicTransit: 'Clarksville Transit System',
...
export default function ClarksvilleTennesseePageClient() {
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  ...
                  <p className="text-gray-700">
                    {cityData.name} offers diverse vending opportunities including military installations, 
                    manufacturing facilities, healthcare centers, educational institutions, and retail centers. 
                    The city's strong military presence and growing economy provide excellent potential for vending machine placement.
                  </p>
                </div>
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">
                  ...
                  <p className="text-gray-700">
                    ...
                    Focus on areas with high foot traffic like military facilities, manufacturing plants, and educational institutions. 
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  ...
                  <p className="text-gray-700">
                    ...
                    business owners, and providing reliable service. The city's military presence and diverse economy 
