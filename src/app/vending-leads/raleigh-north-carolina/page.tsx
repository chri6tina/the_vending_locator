...
export default function RaleighNorthCarolinaVendingLeadsPage() {
  ...
  const [userNames, setUserNames] = useState([
    'Mike from Raleigh', 'Sarah in Downtown', 'David in North Hills', 'Lisa in Cameron Village',
    'Tom in Five Points', 'Jennifer in Oakwood', 'Robert in Mordecai', 'Amanda in Boylan Heights'
  ])
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-warm-white">
        ...
        {/* Raleigh Content Section */}
        <div id="raleigh-content" className="py-16 sm:py-24 bg-warm-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-playfair font-bold text-chocolate mb-6">
                Why Raleigh is Perfect for Vending Machines
              </h2>
              <p className="text-lg sm:text-xl text-chocolate/70 max-w-4xl mx-auto leading-relaxed">
                Raleigh's unique combination of technology excellence, research innovation, and educational institutions creates 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              <div>
                ...
                <div className="space-y-4 text-chocolate/80">
                  <p>
                    Raleigh is home to major technology companies and research institutions, including North Carolina State University 
                    and Research Triangle Park, creating consistent demand for snacks and beverages across research facilities and corporate campuses.
                  </p>
                  <p>
                    The city hosts numerous technology startups, healthcare facilities, and educational institutions, 
              ...
              <div>
                <h4 className="text-xl sm:text-2xl font-playfair font-bold text-chocolate mb-6">
                  Vending Machine Opportunities in Raleigh
                </h4>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-coral rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h5 className="font-semibold text-chocolate mb-1">Research Institutions</h5>
                      <p className="text-sm text-chocolate/70">Research Triangle Park and university facilities</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-coral rounded-full mt-2 flex-shrink-0"></div>
