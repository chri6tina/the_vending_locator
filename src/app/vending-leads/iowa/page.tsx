...
export default function IowaVendingLeadsPage() {
  const [activeUsers, setActiveUsers] = useState(9)
  const [currentUserIndex, setCurrentUserIndex] = useState(0)

  const users = [
    'John from Des Moines',
    'Sarah from Cedar Rapids',
    'Mike from Davenport',
    'Lisa from Sioux City',
    'David from Iowa City'
  ]
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone">
                Get access to Iowa's top vending machine opportunities
              </p>
            </div>
            <PricingTable />
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Iowa's agricultural heritage, manufacturing sector, and growing insurance industry 
                create ideal opportunities for vending machine placement.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-stone">Leading agricultural state with food processing facilities</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-stone">Diverse manufacturing sector with aerospace and food processing</p>
              </motion.div>
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <CloudIcon className="w-12 h-12 text-bronze mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-charcoal mb-2">Insurance</h3>
                <p className="text-stone">Major insurance industry hub in Des Moines</p>
              </motion.div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <div className="text-4xl font-bold text-bronze mb-2">3.2M+</div>
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <div className="text-4xl font-bold text-bronze mb-2">100,000+</div>
            ...
            <div className="space-y-6">
              ...
              >
                <h3 className="text-lg font-semibold text-charcoal mb-2">
                  What makes Iowa a good market for vending machines?
                </h3>
                <p className="text-stone">
                  Iowa's strong agricultural sector, manufacturing industry, and growing insurance 
              ...
              >
                <h3 className="text-lg font-semibold text-charcoal mb-2">
                  Which cities in Iowa have the best opportunities?
                </h3>
                <p className="text-stone">
                  Des Moines, Cedar Rapids, and Davenport offer the highest concentration of businesses 
              ...
              >
                <h3 className="text-lg font-semibold text-charcoal mb-2">
                  How do I get started with vending machines in Iowa?
                </h3>
                <p className="text-stone">
        ...
        <section className="py-16 bg-stone-50">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-stone">
                Explore vending opportunities in Iowa's key metropolitan areas
              </p>
            </motion.div>
