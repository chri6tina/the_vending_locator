...
export default function IowaVendingLeadsPage() {
  const structuredData = generateCityStructuredData({
    ...
    industries: ['Agriculture', 'Manufacturing', 'Healthcare', 'Insurance', 'Education'],
    description: 'Iowa offers excellent opportunities for vending machine placement with its agricultural sector, manufacturing industry, and diverse business landscape.'
  })
  ...
  const cities = [
    ...
    },
    {
      ...
      vendorCount: '100+',
      businessCount: '130+',
      description: 'Manufacturing and aerospace hub',
      highlights: ['Manufacturing', 'Aerospace', 'Healthcare']
    },
    {
      name: 'Davenport',
      slug: 'davenport-iowa',
      vendorCount: '90+',
      businessCount: '110+',
      description: 'Quad Cities manufacturing center',
      ...
      <div className="min-h-screen bg-warm-white">
          ...
          <div className="mx-auto max-w-2xl px-4 sm:px-6 py-12 sm:py-16 lg:py-24">
            <div className="text-center">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-playfair font-bold tracking-tight text-charcoal leading-tight">
                Iowa Vending Machine Locations
              </h1>
              
              <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-stone px-2 sm:px-0">
                Discover premium vending machine placement opportunities across Iowa. 
                Access 100,000+ businesses and the heart of America's agricultural and manufacturing hub.
              </p>
              ...
              <div className="mt-10 sm:mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-4 sm:px-0">
                ...
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-bronze">3.2M+</div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Iowa is a major agricultural and manufacturing hub in the Midwest, offering diverse vending opportunities across multiple thriving industries.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-charcoal mb-2">Manufacturing & Aerospace</h3>
                <p className="text-stone">Manufacturing companies, aerospace facilities, and industrial operations with engineers, technicians, and professionals.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-charcoal mb-2">Insurance & Healthcare</h3>
                <p className="text-stone">Insurance companies, medical centers, and healthcare facilities with staff, patients, and visitor traffic throughout the year.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-warm-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Explore vending machine opportunities in Iowa's most active business areas.
              </p>
            </div>
        ...
        <div className="bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold text-charcoal mb-4">
                Get Iowa Vending Machine Leads
              </h2>
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Access verified vending locations across Iowa with our flexible pricing options designed for vending machine entrepreneurs.
              </p>
            </div>
            <PricingTable />
          </div>
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone">
                Everything you need to know about vending machine opportunities in Iowa.
              </p>
            </div>
            <div className="space-y-6">
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  What types of businesses are best for vending machines in Iowa?
                </h3>
                <p className="text-stone">
                  Iowa offers diverse opportunities including agricultural facilities, manufacturing plants,
                  healthcare centers, and insurance companies. The major agricultural and manufacturing sectors
                  provide excellent placement opportunities.
                </p>
              </div>
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  How competitive is the vending machine market in Iowa?
                </h3>
                <p className="text-stone">
                  Iowa has a moderate vending presence with significant opportunity for expansion,
                  especially in new agricultural developments and growing manufacturing areas.
                </p>
              </div>
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  What are the best vending machine types for Iowa businesses?
                </h3>
                <p className="text-stone">
                  For Iowa agricultural locations, industrial-grade beverage and snack machines work best. Manufacturing facilities need reliable machines, while
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                { name: 'Nebraska', slug: 'nebraska', count: '150+ leads' },
              ].map((state) => (
