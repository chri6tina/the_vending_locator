  ...
  const cities = [
    {
      ...
      vendorCount: '140+',
      businessCount: '200+',
      description: 'Hospitality and entertainment hub',
      highlights: ['Hospitality', 'Entertainment', '24/7 Operations']
    }
  ]
        ...
        <div className="bg-warm-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                Access verified vending machine locations across Nevada's thriving hospitality, 
                entertainment, and 24/7 economy. Get business details and placement opportunities.
              </motion.p>
            </div>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-playfair font-bold tracking-tight text-chocolate mb-6">
                Nevada Cities with Vending Opportunities
              </h2>
        ...
        <div className="bg-warm-white py-16 sm:py-20 lg:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-playfair font-bold text-chocolate mb-6">
              Ready to Expand Your Vending Business in Nevada?
            </h2>
            <p className="text-lg sm:text-xl text-chocolate/70 max-w-3xl mx-auto mb-10 leading-relaxed">
              Get access to verified Nevada locations with business details, contact information, 
