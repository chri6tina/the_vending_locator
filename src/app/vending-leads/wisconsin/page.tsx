              ...
              <ol className="flex items-center space-x-4">
                ...
                <li>
                  <div className="flex items-center">
                    ...
                    <span className="ml-4 text-sm font-medium text-gray-500">Wisconsin</span>
                  </div>
                </li>
              </ol>
            </nav>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone">
                Get access to Wisconsin's top vending machine opportunities
              </p>
            </div>
            <PricingTable />
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Wisconsin's strong manufacturing heritage, agricultural industry, and growing healthcare sector 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-stone">Strong industrial base with advanced manufacturing facilities</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-stone">Leading dairy and agricultural production state</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-stone">Top universities and educational institutions</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-stone">Lakes, outdoor recreation, and cultural attractions</p>
              </motion.div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <div className="text-4xl font-bold text-bronze mb-2">5.9M+</div>
            ...
            <div className="space-y-6">
              ...
              >
                <h3 className="text-lg font-semibold text-charcoal mb-2">
                  What makes Wisconsin a good market for vending machines?
                </h3>
                <p className="text-stone">
                  Wisconsin's strong manufacturing sector, agricultural industry, and growing healthcare 
              ...
              >
                <h3 className="text-lg font-semibold text-charcoal mb-2">
                  Which cities in Wisconsin have the best opportunities?
                </h3>
                <p className="text-stone">
                  Milwaukee, Madison, and Green Bay offer the highest concentration of businesses 
              ...
              >
                <h3 className="text-lg font-semibold text-charcoal mb-2">
                  How do I get started with vending machines in Wisconsin?
                </h3>
                <p className="text-stone">
        ...
        <section className="py-16 bg-stone-50">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-stone">
                Explore vending opportunities in Wisconsin's key metropolitan areas
              </p>
            </motion.div>
