...
export default function NewYorkNewYorkVendingLeadsPage() {
  ...
  const cityDisplayName = 'New York New York';
  ...
  const [userNames, setUserNames] = useState([
    'Mike from New York New York', 'Sarah in Downtown', 'David in New York New York', 'Lisa in New York New York',
    'Tom in New York New York', 'Jennifer in New York New York', 'Robert in New York New York', 'Amanda in New York New York',
    'Chris in New York New York', 'Maria in New York New York', 'James in New York New York', 'Emily in New York New York'
  ])
