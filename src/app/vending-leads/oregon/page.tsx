  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-warm-white">
        {/* Enhanced Hero Section - Oregon-Specific */}
        <div className="bg-warm-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                Vending Machine Locations<br />in Oregon
              </motion.h1>
              ...
              >
                Get pre-qualified vending machine locations in Oregon's thriving technology and manufacturing economy. 
                Access verified businesses with detailed contact information and placement opportunities.
              </motion.p>

              {/* Trust Signals - Oregon-Specific */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="flex items-center justify-center gap-3 p-3 bg-cream/30 rounded-lg">
                  ...
                  <span className="text-sm font-medium text-chocolate">1,800+ Verified Locations</span>
                </div>
                <div className="flex items-center justify-center gap-3 p-3 bg-cream/30 rounded-lg">
                  <UsersIcon className="w-5 h-5 text-coral" />
                  <span className="text-sm font-medium text-chocolate">140,000+ Businesses</span>
                </div>
                <div className="flex items-center justify-center gap-3 p-3 bg-cream/30 rounded-lg">
        ...
        <section id="pricing" className="py-16 bg-cream/20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              >
                Choose Your Oregon Vending Leads Plan
              </motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                Get access to verified vending machine locations across Oregon with our comprehensive lead packages.
              </motion.p>
            </div>
            <PricingTable />
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mt-4 text-lg text-stone max-w-3xl mx-auto">
                Oregon offers diverse opportunities across multiple thriving industries, making it an ideal location for vending machine placement.
              </p>
            </motion.div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {[
                { icon: CpuChipIcon, title: 'Technology', description: 'Silicon Forest, software companies, and tech startups', color: 'text-blue-600' },
                ...
                { icon: FilmIcon, title: 'Tourism & Recreation', description: 'Outdoor recreation and tourism destinations', color: 'text-purple-600' },
        ...
        <section className="py-16 bg-cream/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { label: 'Population', value: '4.2M+', description: 'Residents across the state' },
                { label: 'Businesses', value: '140,000+', description: 'Companies and organizations' },
        ...
        <section id="hot-leads" className="py-16 bg-warm-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-playfair font-bold text-charcoal">
                Hot Oregon Vending Leads
              </h2>
              <p className="mt-4 text-lg text-stone max-w-2xl mx-auto">
                Get immediate access to the most promising vending machine placement opportunities in Oregon.
              </p>
            </motion.div>
            <HotLeads />
          </div>
        ...
        <section className="py-16 bg-warm-white">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {[
                {
                  question: "What types of businesses are available for vending machine placement in Oregon?",
                  answer: "Oregon offers diverse opportunities including technology companies, manufacturing facilities, healthcare centers, educational institutions, tourism businesses, and agricultural operations. Our leads cover all major industries across the state."
                },
                {
                  question: "How quickly can I start placing vending machines in Oregon?",
                ...
                {
                  question: "Are the Oregon leads pre-qualified for vending machine placement?",
                  answer: "Yes, all our Oregon leads are pre-qualified businesses that have shown interest in vending machine services or have suitable locations for placement."
                },
                {
                  question: "What support do you provide for Oregon vending machine placement?",
                  answer: "We provide comprehensive support including lead verification, business contact information, placement guidance, and ongoing assistance to ensure successful vending machine placement across Oregon."
                }
              ].map((faq, index) => (
                <motion.div
                  key={index}
        ...
        {/* Other Cities in Oregon Section */}
        <section className="py-16 bg-cream/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <p className="mt-4 text-lg text-stone max-w-2xl mx-auto">
                Explore vending machine opportunities in Oregon's key cities and metropolitan areas.
              </p>
            </motion.div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { name: 'Portland', slug: 'portland-oregon', description: 'Largest city with technology and manufacturing' },
                { name: 'Salem', slug: 'salem-oregon', description: 'State capital with government and healthcare' },
                { name: 'Eugene', slug: 'eugene-oregon', description: 'University town and healthcare center' },
                { name: 'Gresham', slug: 'gresham-oregon', description: 'Suburban Portland with retail and healthcare' },
                { name: 'Hillsboro', slug: 'hillsboro-oregon', description: 'Technology corridor and Intel campus' },
                { name: 'Beaverton', slug: 'beaverton-oregon', description: 'Technology and healthcare hub' }
              ].map((city, index) => (
                <motion.div
                  key={city.name}
                  initial={{ opacity: 0, y: 20 }}
