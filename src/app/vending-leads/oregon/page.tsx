  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-warm-white">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-playfair font-bold tracking-tight text-charcoal leading-tight">
                Oregon Vending Machine Locations
              </h1>
              
              <p className="mt-6 sm:mt-8 text-lg sm:text-xl leading-8 text-stone max-w-4xl mx-auto">
                Discover premium vending machine placement opportunities across Oregon. 
              ...
              <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
                ...
                >
                  View Oregon Cities <span aria-hidden="true">→</span>
                </Link>
              </div>
            </div>
          </div>
        ...
        {/* Oregon Cities Section */}
        <div id="oregon-cities" className="bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold text-charcoal mb-4">
                Oregon Cities with Vending Opportunities
              </h2>
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Explore vending machine leads in major Oregon cities
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-charcoal">Portland</h3>
                </div>
                <p className="text-stone mb-4">Major tech and creative industries hub</p>
                <div className="text-navy hover:text-navy-light font-medium">
                  View Portland vending leads →
                </div>
              </Link>
            </div>
          </div>
        ...
        <div id="pricing" className="bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold text-charcoal mb-4">
                Get Oregon Vending Machine Leads
              </h2>
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Choose the plan that fits your business needs and start receiving qualified vending machine location leads in Oregon.
              </p>
            </div>
            <PricingTable />
          </div>
