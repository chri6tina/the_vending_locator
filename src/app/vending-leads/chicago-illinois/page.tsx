        ...
        <div className="bg-warm-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                Get pre-qualified vending machine locations in Chicago's thriving business and transportation economy. 
              ...
              <div>
                ...
                <div className="space-y-4 text-chocolate/80">
                  <p>
                    ...
                    United Airlines, and McDonald's, creating a massive workforce of professionals who frequent vending machines 
