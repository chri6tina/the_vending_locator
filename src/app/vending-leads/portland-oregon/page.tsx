...
export default function PortlandOregonVendingLeadsPage() {
  ...
  const [userNames, setUserNames] = useState([
    'Mike from Portland', 'Sarah in Pearl District', 'David from Northwest', 'Lisa in Southeast',
    'Tom from Northeast', 'Jennifer in Southwest', 'Robert from Alberta Arts', 'Amanda in Mississippi'
  ])
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-warm-white">
              ...
              >
                <div className="flex items-center justify-center gap-3">
                  ...
                  <span className="text-sm font-medium text-chocolate">
                    <span className="font-bold text-coral">{activeUsers}</span> Portland vendors are choosing plans right now
                  </span>
                </div>
        ...
        {/* Portland Content Section */}
        <div id="portland-content" className="py-16 sm:py-24 bg-warm-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-playfair font-bold text-chocolate mb-6">
                Why Portland is Perfect for Vending Machines
              </h2>
              <p className="text-lg sm:text-xl text-chocolate/70 max-w-4xl mx-auto leading-relaxed">
                Portland's unique combination of technology innovation, sustainability focus, and creative industries creates 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              <div>
                ...
                <div className="space-y-4 text-chocolate/80">
                  <p>
                    Portland is home to major technology companies like Intel, Nike, and Columbia Sportswear, creating a massive 
                    workforce of tech and creative professionals who frequent vending machines throughout the workday.
                  </p>
                  <p>
                    Portland State University, University of Portland, and Oregon Health & Science University, with over 70,000 
              ...
              <div>
                <h4 className="text-xl sm:text-2xl font-playfair font-bold text-chocolate mb-6">
                  Vending Machine Opportunities in Portland
                </h4>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-coral rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h5 className="font-semibold text-chocolate mb-1">Creative Industries</h5>
                      <p className="text-sm text-chocolate/70">Design firms, advertising agencies, and creative studios</p>
                    </div>
                  </div>
                </div>
              </div>
