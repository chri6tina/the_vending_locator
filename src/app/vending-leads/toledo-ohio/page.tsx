          ...
          <div className="mx-auto max-w-2xl px-4 sm:px-6 py-12 sm:py-16 lg:py-24">
            <div className="text-center">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-playfair font-bold tracking-tight text-charcoal leading-tight">
                Toledo Vending Machine Locations
              </h1>
              
              <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-stone px-2 sm:px-0">
                Discover premium vending machine placement opportunities in Toledo, Ohio. 
                Access 28,000+ businesses in the heart of Ohio's fourth-largest city and business hub.
              </p>
              ...
              <div className="mt-10 sm:mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-4 sm:px-0">
                ...
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-bronze">275K+</div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Toledo is Ohio's fourth-largest city and a major business, manufacturing, and healthcare hub, offering diverse vending opportunities across multiple thriving industries.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-cream/30 p-6 rounded-xl border border-gray-200">
                ...
                <p className="text-stone">Major manufacturing hub with automotive and glass industries.</p>
              </div>
              ...
              <div className="bg-cream/30 p-6 rounded-xl border border-gray-200">
                ...
                <p className="text-stone">Home to University of Toledo and multiple colleges.</p>
              </div>
              ...
              <div className="bg-cream/30 p-6 rounded-xl border border-gray-200">
                ...
                <p className="text-stone">Major transportation hub with port and logistics companies.</p>
              </div>
            </div>
          </div>
        </div>
