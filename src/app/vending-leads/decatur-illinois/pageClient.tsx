...
export default function DecaturIllinoisVendingLeadsPage() {
  ...
  return (
    <>
      <Head>
        <title>Vending Machine Leads in Decatur, Illinois - Business Locations & Opportunities</title>
        <meta name="description" content="Discover premium vending machine opportunities in Decatur, Illinois. Access verified business locations with industry insights and growth potential data." />
        <meta name="keywords" content="vending machine leads decatur illinois, decatur il business locations, vending machine business decatur, verified business locations decatur illinois" />
      </Head>
      <Header />
