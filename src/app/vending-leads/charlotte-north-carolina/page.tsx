      ...
      <div className="min-h-screen bg-warm-white">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              Business Landscape in Charlotte
            </motion.h2>
        ...
        <section className="py-16 bg-warm-white">
          <div className="container mx-auto px-4">
            ...
            >
              <div>
                <div className="text-4xl font-bold text-navy mb-2">875K+</div>
                <div className="text-gray-600">Population</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-navy mb-2">65,000+</div>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              >
                ...
                <p className="text-gray-600">
                  Charlotte offers excellent opportunities in financial services, technology, healthcare, and retail sectors. The banking headquarters, tech companies, and healthcare facilities provide stable employee bases for vending machines.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  Charlotte has moderate competition with significant growth potential, especially in the expanding financial and technology sectors, as well as new commercial developments throughout the metro area.
                </p>
              </motion.div>
              ...
              >
                <h3 className="text-xl font-semibold mb-3 text-navy">
                  What are the best vending machine types for Charlotte businesses?
                </h3>
                <p className="text-gray-600">
                  For financial offices, reliable snack and beverage machines work best. Tech companies need healthy options, while healthcare facilities prefer healthy machines. We provide specific recommendations for each business type.
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <motion.a 
                ...
                transition={{ duration: 0.8, delay: 0.1 }}
                viewport={{ once: true }}
                href="/vending-leads/raleigh-north-carolina" 
                className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <h3 className="font-semibold text-navy">Raleigh</h3>
              ...
              <motion.a 
                ...
                transition={{ duration: 0.8, delay: 0.2 }}
                viewport={{ once: true }}
                href="/vending-leads/greensboro-north-carolina" 
                className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <h3 className="font-semibold text-navy">Greensboro</h3>
              ...
              <motion.a 
                ...
                transition={{ duration: 0.8, delay: 0.3 }}
                viewport={{ once: true }}
                href="/vending-leads/winston-salem-north-carolina" 
                className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <h3 className="font-semibold text-navy">Winston-Salem</h3>
              ...
              <motion.a 
                ...
                transition={{ duration: 0.8, delay: 0.4 }}
                viewport={{ once: true }}
                href="/vending-leads/durham-north-carolina" 
                className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <h3 className="font-semibold text-navy">Durham</h3>
                <p className="text-sm text-gray-600">Research and technology hub</p>
              </motion.a>
              ...
              <motion.a 
                ...
                transition={{ duration: 0.8, delay: 0.5 }}
                viewport={{ once: true }}
                href="/vending-leads/fayetteville-north-carolina" 
                className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <h3 className="font-semibold text-navy">Fayetteville</h3>
              ...
              <motion.a 
                ...
                transition={{ duration: 0.8, delay: 0.6 }}
                viewport={{ once: true }}
                href="/vending-leads/cary-north-carolina" 
                className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <h3 className="font-semibold text-navy">Cary</h3>
