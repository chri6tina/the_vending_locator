        ...
        <div className="bg-warm-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                Get pre-qualified vending machine locations in Boulder's thriving university and technology economy. 
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg sm:text-xl text-chocolate/70 max-w-4xl mx-auto leading-relaxed">
                Boulder's unique combination of university excellence, technology innovation, and outdoor recreation culture creates 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              <div>
                ...
                <div className="space-y-4 text-chocolate/80">
                  <p>
                    Boulder is home to the University of Colorado Boulder, with over 35,000 students and faculty, 
                    creating consistent demand for snacks and beverages across campus locations, student centers, and research facilities.
                  </p>
                  <p>
                    The city hosts major technology companies like Google, Microsoft, and numerous startups, 
                    providing high-traffic corporate environments with modern amenities and 24/7 operations.
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-chocolate/70">Tourism and recreation facilities</p>
                    </div>
                  </div>
                </div>
              </div>
