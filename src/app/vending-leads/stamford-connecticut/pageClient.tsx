        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Connecticut', item: `https://www.thevendinglocator.com/vending-leads/${stateSlug}` },
              { '@type': 'ListItem', position: 4, name: 'Stamford', item: `https://www.thevendinglocator.com/vending-leads/${slug}` }
            ]
          })
        }}
      />
