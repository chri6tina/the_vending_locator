...
export default function PageClient() {
  ...
  const faqs = [
    {
        "q": "How many vending machine locations are available in Portsmouth?",
        "a": "Our Portsmouth database includes hundreds of verified vending locations across historic seaport with tourism, professional services, and thriving restaurant scene. We continuously update our listings to ensure you have access to the most current opportunities in New Hampshire's historic seaport."
    },
    {
        "q": "What types of locations are included in Portsmouth's vending leads?",
        "a": "Portsmouth's leads span tourism & hospitality, professional services, healthcare & medical, and more. Our database focuses on high-traffic venues with ~22,000 residents and visitors providing consistent customer flow throughout the year."
    },
    {
        "q": "How current are the Portsmouth vending location leads?",
        "a": "All Portsmouth leads are verified and updated regularly. Our team actively monitors Portsmouth's business landscape to ensure you receive accurate, actionable information about venues seeking vending services in this historic coastal city."
    },
    {
        "q": "Can I target specific industries in Portsmouth?",
        "a": "Yes! Our Portsmouth database allows filtering by industry type, including tourism & hospitality, professional services, healthcare & medical, and other sectors. This targeting helps you focus on locations that align with your vending machine offerings and business strategy in the Portsmouth area."
    },
    {
        "q": "What makes Portsmouth a good market for vending machines?",
        "a": "Portsmouth offers excellent vending opportunities with its historic seaport with tourism, professional services, and thriving restaurant scene. The city's diverse economy, steady population of ~22,000, and mix of tourists and professionals create consistent demand for convenient vending services."
    },
    {
        "q": "How do I get started with Portsmouth vending leads?",
        "a": "Simply choose your preferred plan, and you'll gain immediate access to our complete Portsmouth location database. You can begin contacting venues right away. Our platform provides all the details you need to connect with decision-makers at Portsmouth locations actively seeking vending services."
    },
    {
        "q": "Are Portsmouth locations exclusive to one vending operator?",
        "a": "No, our Portsmouth leads are available to all subscribers. However, acting quickly gives you a competitive advantage. Many successful vending operators in Portsmouth have secured multiple locations by being proactive and professional in their outreach to New Hampshire venues."
    },
    {
        "q": "What support is available for placing machines in Portsmouth?",
        "a": "Beyond our Portsmouth location database, we provide negotiation guides, contract templates, and industry best practices. Our resources help you successfully approach Portsmouth venues, present professional proposals, and establish profitable vending partnerships throughout the Portsmouth area and broader New Hampshire market."
    }
];
