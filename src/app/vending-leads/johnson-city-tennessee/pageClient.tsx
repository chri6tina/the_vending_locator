...
const cityData = {
  ...
  state: 'Tennessee',
  population: '71,046',
  description: 'Johnson City, Tennessee is a vibrant city located in the heart of the Tri-Cities region of Northeast Tennessee. Known for its healthcare industry, educational institutions, and growing technology sector, Johnson City offers excellent vending opportunities in healthcare, education, manufacturing, and retail sectors.',
  keyIndustries: ['Healthcare', 'Education', 'Manufacturing', 'Technology', 'Retail'],
  majorEmployers: ['East Tennessee State University', 'Ballad Health', 'City of Johnson City', 'Johnson City Schools', 'Niswonger Foundation'],
  ...
  demographics: {
    medianAge: 35.8,
    medianHouseholdIncome: '$42,567',
    educationLevel: 'Some college or associate degree',
    employmentRate: '61.2%'
  },
  transportation: {
    majorHighways: ['I-26', 'I-81', 'US-11E', 'US-321'],
...
export default function JohnsonCityTennesseePageClient() {
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  ...
                  <p className="text-gray-700">
                    {cityData.name} offers diverse vending opportunities including healthcare facilities, 
                    educational institutions, manufacturing facilities, technology companies, and retail centers. 
                    The city's strong healthcare industry and growing technology sector provide excellent potential for vending machine placement.
                  </p>
                </div>
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">
                  ...
                  <p className="text-gray-700">
                    ...
                    Focus on areas with high foot traffic like healthcare facilities, educational institutions, and manufacturing plants. 
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  ...
                  <p className="text-gray-700">
                    ...
                    business owners, and providing reliable service. The city's diverse economy and strong healthcare industry 
