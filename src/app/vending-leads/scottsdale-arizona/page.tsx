    ...
    businessLandscape: [
      {
        ...
        description: 'Luxury resorts, golf courses, spas, and entertainment venues throughout the city',
        icon: '🏌️'
      },
      {
      ...
      {
        title: 'Luxury Retail',
        description: 'Scottsdale Fashion Square and high-end shopping districts',
        icon: '🛍️'
      },
      {
        title: 'Education & Research',
        description: 'Arizona State University and multiple educational institutions',
        icon: '🎓'
      },
      {
        title: 'Professional Services',
        description: 'Finance, consulting, and business services sectors',
        icon: '💼'
      }
    ],
    faq: [
      {
        question: 'What types of businesses in Scottsdale are good for vending machines?',
        answer: 'Resorts, healthcare facilities, educational institutions, office buildings, retail centers, and technology companies in Scottsdale are excellent locations for vending machines due to high foot traffic and captive audiences.'
      },
      {
        question: 'How do I approach businesses in Scottsdale for vending machine placement?',
        answer: 'Start with resorts, healthcare facilities, educational institutions, and technology companies. Present the benefits of increased revenue, customer convenience, and our guaranteed placement service.'
      },
      {
        question: 'What are the best areas in Scottsdale for vending machine placement?',
        answer: 'Focus on areas around resorts, medical districts, educational campuses, shopping centers, and business districts where there\'s consistent foot traffic and employee populations.'
      },
      {
        question: 'How long does it take to get vending machines placed in Scottsdale?',
        answer: 'With our expert team handling outreach and negotiations, most placements in Scottsdale are completed within 1-6 months, depending on the specific location and business type.'
      }
    ]
  };
