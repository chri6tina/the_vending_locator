...
export default function NewMexicoVendingLeadsPage() {
  ...
  const [userNames, setUserNames] = useState([
    'Tom from Albuquerque', 'Sarah from Las Cruces', 'Mike from Santa Fe', 'Lisa from Rio Rancho',
    'David from Roswell', 'Jennifer from Farmington', 'Robert from Clovis', 'Amanda from Hobbs',
    'Chris from Alamogordo', 'Maria from Carlsbad', 'James from Gallup', 'Emily from Deming'
  ])
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-warm-white">
        {/* Enhanced Hero Section - New Mexico-Specific */}
        <div className="bg-warm-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                Vending Machine Locations<br />in New Mexico
              </motion.h1>
              ...
              >
                Get pre-qualified vending machine locations in New Mexico's thriving healthcare and government economy. 
                Access verified businesses with detailed contact information and placement opportunities.
              </motion.p>

              {/* Trust Signals - New Mexico-Specific */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        <section id="pricing" className="py-16 bg-cream/20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              >
                Choose Your New Mexico Vending Leads Plan
              </motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                Get access to verified vending machine locations across New Mexico with our comprehensive lead packages.
              </motion.p>
            </div>
            <PricingTable />
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-playfair font-bold text-charcoal">
                New Mexico Business Landscape
              </h2>
              <p className="mt-4 text-lg text-stone max-w-3xl mx-auto">
                New Mexico offers diverse opportunities across multiple thriving industries, making it an ideal location for vending machine placement.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {[
                ...
                { icon: BuildingOfficeIcon, title: 'Government', description: 'Federal and state government facilities', color: 'text-purple-600' },
                { icon: AcademicCapIcon, title: 'Education', description: 'Universities and educational institutions', color: 'text-indigo-600' },
                { icon: CpuChipIcon, title: 'Technology', description: 'Tech companies and research labs', color: 'text-blue-600' },
                { icon: SunIcon, title: 'Solar Energy', description: 'Solar power and renewable energy', color: 'text-yellow-600' },
                { icon: FilmIcon, title: 'Tourism', description: 'Cultural sites and tourist attractions', color: 'text-green-600' }
              ].map((industry, index) => (
                <motion.div
                  key={industry.title}
                  initial={{ opacity: 0, y: 20 }}
        ...
        <section className="py-16 bg-cream/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { label: 'Population', value: '2.1M+', description: 'Residents across the state' },
        ...
        <section id="hot-leads" className="py-16 bg-warm-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-playfair font-bold text-charcoal">
                Hot New Mexico Vending Leads
              </h2>
              <p className="mt-4 text-lg text-stone max-w-2xl mx-auto">
                Get immediate access to the most promising vending machine placement opportunities in New Mexico.
              </p>
            </motion.div>
            <HotLeads />
          </div>
        ...
        <section className="py-16 bg-warm-white">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {[
                {
                  question: "What types of businesses are available for vending machine placement in New Mexico?",
                  answer: "New Mexico offers diverse opportunities including healthcare facilities, government facilities, educational institutions, technology companies, solar energy operations, and tourism businesses. Our leads cover all major industries across the state."
                },
                {
                  question: "How quickly can I start placing vending machines in New Mexico?",
                ...
                {
                  question: "Are the New Mexico leads pre-qualified for vending machine placement?",
                  answer: "Yes, all our New Mexico leads are pre-qualified businesses that have shown interest in vending machine services or have suitable locations for placement."
                },
                {
                  question: "What support do you provide for New Mexico vending machine placement?",
                  answer: "We provide comprehensive support including lead verification, business contact information, placement guidance, and ongoing assistance to ensure successful vending machine placement across New Mexico."
                }
              ].map((faq, index) => (
                <motion.div
                  key={index}
        ...
        <section className="py-16 bg-cream/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mt-4 text-lg text-stone max-w-2xl mx-auto">
                Explore vending machine opportunities in New Mexico's key cities and metropolitan areas.
              </p>
            </motion.div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { name: 'Albuquerque', slug: 'albuquerque-new-mexico', description: 'Healthcare and technology center' },
                { name: 'Las Cruces', slug: 'las-cruces-new-mexico', description: 'Education and healthcare hub' },
                { name: 'Santa Fe', slug: 'santa-fe-new-mexico', description: 'Government and tourism center' },
                { name: 'Rio Rancho', slug: 'rio-rancho-new-mexico', description: 'Technology and healthcare hub' },
                { name: 'Roswell', slug: 'roswell-new-mexico', description: 'Healthcare and retail center' },
                { name: 'Farmington', slug: 'farmington-new-mexico', description: 'Energy and healthcare hub' }
              ].map((city, index) => (
                <motion.div
                  key={city.name}
                  initial={{ opacity: 0, y: 20 }}
