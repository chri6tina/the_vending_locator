        ...
        <section className="relative py-20 bg-white overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              >
                Get comprehensive vending leads for Burbank's thriving California market, combining local businesses, healthcare systems, and educational facilities for reliable vending machine placement.
              </motion.p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Burbank's healthcare sector includes major hospitals, specialty clinics, and medical offices that generate consistent visitor and employee traffic, ideal for vending machine placement.</p>
              </motion.div>
              <motion.div
                key="Education"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Educational facilities throughout Burbank serve large student populations and employ substantial staff, providing steady foot traffic and consistent demand for vending services.</p>
              </motion.div>
              <motion.div
                key="Manufacturing"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Industrial and manufacturing operations throughout Burbank employ substantial workforces with shift-based schedules, offering stable vending placement opportunities with steady traffic.</p>
              </motion.div>
              <motion.div
                key="Retail"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Shopping centers and retail districts in Burbank offer prime vending locations, with high-traffic areas including food courts, entrances, and common spaces frequented by shoppers.</p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Commercial office spaces in Burbank offer excellent vending opportunities, with professional tenants and business operations generating consistent foot traffic throughout the workday.</p>
              </motion.div>
              <motion.div
                key="Transportation"
                initial={{ opacity: 0, y: 20 }}
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <p className="text-lg text-stone leading-relaxed">
                Burbank offers reliable vending opportunities through its thriving business community, featuring diverse industries, commercial centers, and growing economic sectors. The city's business mix provides stable placement locations with consistent traffic patterns, while Burbank's economic activity supports steady consumer spending. The city's combination of established businesses and emerging sectors creates multiple vending placement strategies.
              </p>
            </motion.div>
          </div>
        </section>
