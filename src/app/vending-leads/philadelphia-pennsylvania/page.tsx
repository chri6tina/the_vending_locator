...
export default function PhiladelphiaPennsylvaniaVendingLeadsPage() {
  ...
  const [userNames, setUserNames] = useState([
    'Mike from Philadelphia', 'Sarah in Center City', 'David from University City', 'Lisa in Old City',
    'Tom in Rittenhouse', 'Jennifer in Society Hill', 'Robert from Northern Liberties', 'Amanda in Fishtown'
  ])
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-warm-white">
        ...
        {/* Philadelphia Content Section */}
        <div id="philadelphia-content" className="py-16 sm:py-24 bg-warm-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-playfair font-bold text-chocolate mb-6">
                Why Philadelphia is Perfect for Vending Machines
              </h2>
              <p className="text-lg sm:text-xl text-chocolate/70 max-w-4xl mx-auto leading-relaxed">
                Philadelphia's unique combination of healthcare excellence, educational institutions, and financial services creates 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              <div>
                ...
                <div className="space-y-4 text-chocolate/80">
                  <p>
                    Philadelphia is home to major healthcare systems like Penn Medicine, Jefferson Health, and Temple Health, 
                    creating a massive workforce of healthcare professionals who frequent vending machines throughout the workday.
                  </p>
                  <p>
                    The University of Pennsylvania, Drexel University, and Temple University, with over 80,000 combined students, 
              ...
              <div>
                <h4 className="text-xl sm:text-2xl font-playfair font-bold text-chocolate mb-6">
                  Vending Machine Opportunities in Philadelphia
                </h4>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-chocolate/70">Corporate offices and financial institutions</p>
                    </div>
                  </div>
                </div>
              </div>
