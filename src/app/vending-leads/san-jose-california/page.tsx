...
export default function SanJoseCaliforniaVendingLeadsPage() {
  ...
  const [userNames, setUserNames] = useState([
    'Mike from San Jose', 'Sarah in Willow Glen', 'David from Almaden Valley', 'Lisa in Cambrian',
    'Tom from Rose Garden', 'Jennifer in Naglee Park', 'Robert from Downtown', 'Amanda in North San Jose'
  ])
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-warm-white">
        ...
        <div className="bg-warm-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                Get pre-qualified vending machine locations in San Jose's thriving technology and innovation economy. 
              ...
              >
                ...
                >
                  Learn About San Jose <span aria-hidden="true">→</span>
                </Link>
              </motion.div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-4xl text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-chocolate/70 leading-relaxed max-w-3xl mx-auto">
                Access our comprehensive database of qualified San Jose vending machine locations with flexible pricing options. 
                No long-term contracts, just results that help you grow your San Jose vending business.
              </p>
            </div>
            <PricingTable />
          </div>
        ...
        {/* San Jose Content Section */}
        <div id="sanjose-content" className="py-16 sm:py-24 bg-warm-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-playfair font-bold text-chocolate mb-6">
                Why San Jose is Perfect for Vending Machines
              </h2>
              <p className="text-lg sm:text-xl text-chocolate/70 max-w-4xl mx-auto leading-relaxed">
                San Jose's unique combination of technology innovation, corporate headquarters, and educational institutions creates 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              <div>
                <h3 className="text-2xl sm:text-3xl font-playfair font-bold text-chocolate mb-6">
                  San Jose's Business Landscape
                </h3>
                <div className="space-y-4 text-chocolate/80">
                  <p>
                    San Jose is the heart of Silicon Valley, home to major technology companies like Adobe, Cisco Systems, 
                    and eBay, creating a massive workforce of tech professionals who frequent vending machines throughout the workday.
                  </p>
                  <p>
                    San Jose State University, with over 35,000 students across multiple campuses, provides consistent demand 
                    for snacks and beverages across student centers, libraries, and academic buildings.
                  </p>
                </div>
              </div>
              ...
              <div>
                <h4 className="text-xl sm:text-2xl font-playfair font-bold text-chocolate mb-6">
                  Vending Machine Opportunities in San Jose
                </h4>
