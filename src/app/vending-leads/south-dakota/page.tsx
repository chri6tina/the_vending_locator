      ...
      <div className="min-h-screen bg-warm-white">
        ...
        <section id="pricing" className="py-16 bg-cream/20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              >
                Choose Your South Dakota Vending Leads Plan
              </motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                Get access to verified vending machine locations across South Dakota with our comprehensive lead packages.
              </motion.p>
            </div>
            <PricingTable />
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mt-4 text-lg text-stone max-w-3xl mx-auto">
                South Dakota offers diverse opportunities across multiple thriving industries, making it an ideal location for vending machine placement.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {[
                ...
                { icon: FilmIcon, title: 'Tourism', description: 'Mount Rushmore and tourist attractions', color: 'text-green-600' },
                ...
                { icon: TruckIcon, title: 'Agriculture', description: 'Farming and food processing operations', color: 'text-yellow-600' },
        ...
        <section className="py-16 bg-cream/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { label: 'Population', value: '900K+', description: 'Residents across the state' },
        ...
        <section id="hot-leads" className="py-16 bg-warm-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-playfair font-bold text-charcoal">
                Hot South Dakota Vending Leads
              </h2>
              <p className="mt-4 text-lg text-stone max-w-2xl mx-auto">
                Get immediate access to the most promising vending machine placement opportunities in South Dakota.
              </p>
            </motion.div>
            <HotLeads />
          </div>
        ...
        <section className="py-16 bg-warm-white">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {[
                {
                  question: "What types of businesses are available for vending machine placement in South Dakota?",
                  answer: "South Dakota offers diverse opportunities including healthcare facilities, tourism businesses, educational institutions, manufacturing operations, agricultural businesses, and technology companies. Our leads cover all major industries across the state."
                },
                {
                  question: "How quickly can I start placing vending machines in South Dakota?",
                ...
                {
                  question: "Are the South Dakota leads pre-qualified for vending machine placement?",
                  answer: "Yes, all our South Dakota leads are pre-qualified businesses that have shown interest in vending machine services or have suitable locations for placement."
                },
                {
                  question: "What support do you provide for South Dakota vending machine placement?",
                  answer: "We provide comprehensive support including lead verification, business contact information, placement guidance, and ongoing assistance to ensure successful vending machine placement across South Dakota."
                }
              ].map((faq, index) => (
                <motion.div
                  key={index}
        ...
        {/* Other Cities in South Dakota Section */}
        <section className="py-16 bg-cream/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <p className="mt-4 text-lg text-stone max-w-2xl mx-auto">
                Explore vending machine opportunities in South Dakota's key cities and metropolitan areas.
              </p>
            </motion.div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { name: 'Sioux Falls', slug: 'sioux-falls-south-dakota', description: 'Healthcare and retail center' },
                { name: 'Rapid City', slug: 'rapid-city-south-dakota', description: 'Tourism and healthcare hub' },
                { name: 'Aberdeen', slug: 'aberdeen-south-dakota', description: 'Education and healthcare center' },
                { name: 'Brookings', slug: 'brookings-south-dakota', description: 'Education and healthcare hub' },
                { name: 'Watertown', slug: 'watertown-south-dakota', description: 'Healthcare and retail center' },
                { name: 'Mitchell', slug: 'mitchell-south-dakota', description: 'Healthcare and tourism hub' }
              ].map((city, index) => (
                <motion.div
                  key={city.name}
                  initial={{ opacity: 0, y: 20 }}
