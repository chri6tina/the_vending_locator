...
export default function SanDiegoCaliforniaVendingLeadsPage() {
  ...
  const [userNames, setUserNames] = useState([
    ...
    'Tom in Pacific Beach', 'Jennifer in Ocean Beach', 'Robert from Point Loma', 'Amanda in Hillcrest',
    'Chris in North Park', 'Maria in South Park', 'James in Gaslamp', 'Emily in Coronado'
  ])
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-warm-white">
        {/* Enhanced Hero Section - San Diego-Specific */}
        <div className="bg-warm-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                Get pre-qualified vending machine locations in San Diego's thriving healthcare and technology economy. 
                Access verified businesses with detailed contact information and placement opportunities.
              </motion.p>

              {/* Trust Signals - San Diego-Specific */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="flex items-center gap-2 text-sm text-stone">
                  ...
                  <span>210+ Verified Locations</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-stone">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-stone leading-relaxed max-w-3xl mx-auto">
                Get access to qualified vending machine locations in San Diego with flexible pricing options. 
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              >
                ...
                <p className="text-stone">Major hospitals, medical centers, and healthcare facilities with 24/7 operations.</p>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-warm-white p-6 rounded-xl text-center"
              >
                <BeakerIcon className="h-12 w-12 text-navy mx-auto mb-4" />
              ...
              >
                ...
                <p className="text-stone">Naval bases, military installations, and defense contractors with service members and civilians.</p>
              </motion.div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Key statistics that make San Diego an excellent market for vending machine placement.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                <div className="text-4xl font-bold text-navy mb-2">1,386,932</div>
              ...
              <motion.div
                ...
                className="text-center"
              >
                <div className="text-4xl font-bold text-navy mb-2">52,000+</div>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              >
                ...
                <p className="text-gray-600">
                  San Diego offers diverse opportunities including healthcare facilities, tech companies, office buildings, 
                  manufacturing plants, and tourist destinations. The major healthcare industry and growing technology sector 
              ...
              >
                ...
                <p className="text-gray-600">
                  San Diego has a growing vending presence, but there's still significant opportunity 
