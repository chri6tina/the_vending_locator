          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                San Francisco is a major technology and financial services hub, offering diverse vending opportunities across multiple thriving industries.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              >
                ...
                <p className="text-stone">Banking, fintech, and financial services companies with steady operations.</p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-charcoal mb-2">Biotech</h3>
                <p className="text-stone">Biotechnology companies, research labs, and healthcare innovation with growing operations.</p>
              </motion.div>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              >
                ...
                <p className="text-gray-600">
                  San Francisco offers diverse opportunities including tech companies, financial services, 
                  biotech firms, and office buildings. The strong technology sector and growing biotech 
