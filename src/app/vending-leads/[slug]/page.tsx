...
export default async function VendingLeadsCityPage({ params }: { params: { slug: string } }) {
  ...
  try {
    ...
    const module = await import(`@/app/_city-pages/vending-leads/${params.slug}/pageClient`)
    ...
    console.error(`[Vending Leads] Failed to load pageClient for ${params.slug}:`, error)
