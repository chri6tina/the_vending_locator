...
const cityData = {
  ...
  state: 'Tennessee',
  population: '83,454',
  description: 'Franklin, Tennessee is a historic and affluent city located just south of Nashville. Known for its charming downtown, excellent schools, and thriving business community, Franklin offers premium vending opportunities in corporate offices, healthcare facilities, retail centers, and educational institutions.',
  keyIndustries: ['Healthcare', 'Finance', 'Technology', 'Education', 'Retail'],
  majorEmployers: ['Williamson Medical Center', 'Franklin Special School District', 'City of Franklin', 'Mars Petcare', 'Nissan North America'],
  ...
  transportation: {
    majorHighways: ['I-65', 'US-31', 'SR-96', 'SR-397'],
    publicTransit: 'WeGo Public Transit',
...
export default function FranklinTennesseePageClient() {
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  ...
                  <p className="text-gray-700">
                    ...
                    educational institutions, upscale retail centers, and technology companies. The city's affluent demographics 
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  ...
                  <p className="text-gray-700">
                    ...
                    business owners, and providing reliable service. The city's affluent demographics and strong business environment 
