          ...
          <div className="mx-auto max-w-2xl px-4 sm:px-6 py-12 sm:py-16 lg:py-24">
            <div className="text-center">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-playfair font-bold tracking-tight text-charcoal leading-tight">
                Boise Vending Machine Locations
              </h1>
              
              <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-stone px-2 sm:px-0">
                Discover premium vending machine placement opportunities in Boise, Idaho. 
                Access 28,000+ businesses in the heart of Idaho's capital and business hub.
              </p>
              ...
              <div className="mt-10 sm:mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-4 sm:px-0">
                ...
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-bronze">235K+</div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold text-charcoal mb-4">
                Boise Business Landscape
              </h2>
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Boise is Idaho's capital city and a major business, technology, and healthcare hub, offering diverse vending opportunities across multiple thriving industries.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-cream/30 p-6 rounded-xl border border-gray-200">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-charcoal">Government</h3>
                </div>
                <p className="text-stone">Idaho's state capital with extensive government offices and agencies.</p>
              </div>
              ...
              <div className="bg-cream/30 p-6 rounded-xl border border-gray-200">
                ...
                <p className="text-stone">Growing tech sector with Micron Technology and startups.</p>
              </div>
              ...
              <div className="bg-cream/30 p-6 rounded-xl border border-gray-200">
                ...
                <p className="text-stone">Home to Boise State University and multiple colleges.</p>
              </div>
              ...
              <div className="bg-cream/30 p-6 rounded-xl border border-gray-200">
                ...
                <p className="text-stone">Growing manufacturing sector with diverse industrial companies.</p>
              </div>
            </div>
          </div>
        </div>
