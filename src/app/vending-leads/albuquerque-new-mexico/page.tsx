...
export default function AlbuquerqueNewMexicoVendingLeadsPage() {
  ...
  const cityDisplayName = 'Albuquerque New Mexico';
  ...
  const [userNames, setUserNames] = useState([
    'Mike from Albuquerque New Mexico', 'Sarah in Downtown', 'David in Albuquerque New Mexico', 'Lisa in Albuquerque New Mexico',
    'Tom in Albuquerque New Mexico', 'Jennifer in Albuquerque New Mexico', 'Robert in Albuquerque New Mexico', 'Amanda in Albuquerque New Mexico',
    'Chris in Albuquerque New Mexico', 'Maria in Albuquerque New Mexico', 'James in Albuquerque New Mexico', 'Emily in Albuquerque New Mexico'
  ])
