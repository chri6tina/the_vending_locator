          ...
          <div className="mx-auto max-w-2xl px-4 sm:px-6 py-12 sm:py-16 lg:py-24">
            <div className="text-center">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-playfair font-bold tracking-tight text-charcoal leading-tight">
                Tucson Vending Machine Locations
              </h1>
              
              <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-stone px-2 sm:px-0">
                Discover premium vending machine placement opportunities in Tucson, Arizona. 
                Access 35,000+ businesses in the heart of Arizona's second-largest city and business hub.
              </p>
              ...
              <div className="mt-10 sm:mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-4 sm:px-0">
                ...
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-bronze">548K+</div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-cream/30 p-6 rounded-xl border border-gray-200">
                ...
                <p className="text-stone">Home to University of Arizona and multiple colleges.</p>
              </div>
              ...
              <div className="bg-cream/30 p-6 rounded-xl border border-gray-200">
                ...
                <p className="text-stone">Growing tourism sector with hotels and attractions.</p>
              </div>
            </div>
          </div>
        </div>
