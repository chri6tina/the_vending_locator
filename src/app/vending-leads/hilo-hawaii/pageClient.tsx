        ...
        <section className="relative py-20 bg-white overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              >
                Get pre-qualified vending machine locations in Hilo's historic and diverse business community. 
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Healthcare facilities in Hilo offer stable operations with high foot traffic from patients, visitors, and staff.</p>
              </motion.div>
              <motion.div
                key="Education"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Educational institutions in Hilo provide consistent student and staff populations for vending machine opportunities.</p>
              </motion.div>
              <motion.div
                key="Retail"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Retail locations throughout Hilo provide high customer traffic and diverse demographics for vending machine success.</p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Professional office spaces in Hilo offer captive audiences during business hours with consistent daily traffic.</p>
              </motion.div>
              <motion.div
                key="Tourism"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Hilo's transportation hubs including airports and bus stations provide high-volume foot traffic.</p>
              </motion.div>
            </div>
          </div>
        </section>
