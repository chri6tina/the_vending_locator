...
export default function LasVegasNevadaVendingLeadsPage() {
  ...
  const [userNames, setUserNames] = useState([
    'Mike from Las Vegas', 'Sarah in Summerlin', 'David from Henderson', 'Lisa in Green Valley',
    'Tom from Centennial Hills', 'Jennifer in Anthem', 'Robert from Southern Highlands', 'Amanda in Mountains Edge'
  ])
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-warm-white">
        ...
        <div className="bg-warm-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                <div className="flex items-center justify-center gap-3">
                  ...
                  <span className="text-sm font-medium text-chocolate">
                    <span className="font-bold text-coral">{activeUsers}</span> Las Vegas vendors are choosing plans right now
                  </span>
                </div>
              ...
              >
                Get pre-qualified vending machine locations in Las Vegas's thriving hospitality and entertainment economy. 
        ...
        {/* Las Vegas Content Section */}
        <div id="lasvegas-content" className="py-16 sm:py-24 bg-warm-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-playfair font-bold text-chocolate mb-6">
                Why Las Vegas is Perfect for Vending Machines
              </h2>
              <p className="text-lg sm:text-xl text-chocolate/70 max-w-4xl mx-auto leading-relaxed">
                Las Vegas's unique combination of hospitality, entertainment, and corporate business creates 
                exceptional vending machine opportunities across diverse sectors with 24/7 demand.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              <div>
                <h3 className="text-2xl sm:text-3xl font-playfair font-bold text-chocolate mb-6">
                  Las Vegas's Business Landscape
                </h3>
                <div className="space-y-4 text-chocolate/80">
                  <p>
                    Las Vegas is home to major casino resorts like MGM Grand, Caesars Palace, and Bellagio, creating a massive 
                    workforce of hospitality professionals who frequent vending machines throughout their shifts.
                  </p>
                    <p>
                    The University of Nevada, Las Vegas (UNLV) and College of Southern Nevada, with over 50,000 combined students, 
              ...
              <div>
                <h4 className="text-xl sm:text-2xl font-playfair font-bold text-chocolate mb-6">
                  Vending Machine Opportunities in Las Vegas
                </h4>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-coral rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h5 className="font-semibold text-chocolate mb-1">Casino Resorts</h5>
                      <p className="text-sm text-chocolate/70">High-traffic hospitality environments with 24/7 operations</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-coral rounded-full mt-2 flex-shrink-0"></div>
