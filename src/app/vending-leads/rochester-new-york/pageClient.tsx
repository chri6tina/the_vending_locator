        ...
        <section className="relative py-20 bg-white overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              >
                Get pre-qualified vending machine locations in Rochester's manufacturing and tech hub with strong business economy. 
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Rochester features strong manufacturing facilities, industrial plants, and production centers with high foot traffic and stable operations.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-stone leading-relaxed">Growing educational sector with universities, colleges, and schools with captive student and staff populations.</p>
              </motion.div>
