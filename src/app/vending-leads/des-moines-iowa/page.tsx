...
export default function DesMoinesIowaVendingLeadsPage() {
  const structuredData = generateCityStructuredData({
    ...
    industries: ['Insurance', 'Financial Services', 'Healthcare', 'Government', 'Manufacturing'],
    description: 'Des Moines offers excellent opportunities for vending machine placement with its major insurance and financial services sector, healthcare industry, and diverse business landscape.'
  })
      ...
      <div className="min-h-screen bg-warm-white">
          ...
          <div className="mx-auto max-w-2xl px-4 sm:px-6 py-12 sm:py-16 lg:py-24">
            <div className="text-center">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-playfair font-bold tracking-tight text-charcoal leading-tight">
                Des Moines Vending Machine Locations
              </h1>
              
              <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-stone px-2 sm:px-0">
                Discover premium vending machine placement opportunities in Des Moines, Iowa. 
                Access 18,000+ businesses and the heart of Iowa's insurance and financial services hub.
              </p>
              ...
              <div className="mt-10 sm:mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-4 sm:px-0">
                ...
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-bronze">214K+</div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Des Moines is Iowa's capital and largest city, offering diverse vending opportunities across insurance, financial services, and business sectors.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-charcoal mb-2">Insurance Hub</h3>
                <p className="text-stone">
                  Major insurance companies including Principal Financial, Nationwide, and EMC, 
                  providing opportunities in corporate headquarters and office buildings.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-stone">
                  Major medical centers including UnityPoint Health and MercyOne, 
              ...
              <div className="text-center">
                ...
                <p className="text-stone">
                  Drake University and other educational institutions, 
        ...
        <div className="bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold text-charcoal mb-4">
                Get Des Moines Vending Machine Leads
              </h2>
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Choose the plan that fits your business needs and start receiving qualified vending machine location leads in Des Moines.
              </p>
            </div>
            <PricingTable />
          </div>
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone">
                Everything you need to know about vending machine opportunities in Des Moines.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  What types of businesses are best for vending machines in Des Moines?
                </h3>
                <p className="text-stone">
                  Des Moines offers diverse opportunities including insurance companies, financial institutions, 
                  healthcare facilities, and government offices. The major insurance sector and financial services 
              ...
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  How competitive is the vending machine market in Des Moines?
                </h3>
                <p className="text-stone">
                  Des Moines has a growing vending presence, but there's still significant opportunity 
              ...
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  What are the peak business hours for vending in Des Moines?
                </h3>
                <p className="text-stone">
                  Des Moines businesses typically operate from 8 AM to 6 PM, with peak vending activity 
              ...
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  Are there seasonal considerations for vending in Des Moines?
                </h3>
                <p className="text-stone">
                  Yes, Des Moines experiences four distinct seasons with cold winters and hot summers. Indoor locations 
              ...
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  What permits are required for vending machines in Des Moines?
                </h3>
                <p className="text-stone">
                  You'll need a business license from the City of Des Moines and potentially health permits 
