...
export default function ColoradoVendingLeadsPage() {
  const structuredData = generateCityStructuredData({
    ...
    industries: ['Technology', 'Healthcare', 'Outdoor Recreation', 'Energy', 'Aerospace'],
    description: 'Colorado offers excellent opportunities for vending machine placement with its technology sector, healthcare industry, and diverse business landscape.'
  })
  ...
  const cities = [
    {
      ...
      highlights: ['Technology', 'Healthcare', 'Finance']
    },
    {
      ...
      vendorCount: '200+',
      businessCount: '250+',
      description: 'Military and technology center',
    ...
    },
    {
      ...
      vendorCount: '180+',
      businessCount: '220+',
      description: 'Healthcare and aerospace hub',
      highlights: ['Healthcare', 'Aerospace', 'Education']
    },
    {
      name: 'Fort Collins',
      ...
      <div className="min-h-screen bg-warm-white">
          ...
          <div className="mx-auto max-w-2xl px-4 sm:px-6 py-12 sm:py-16 lg:py-24">
            <div className="text-center">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-playfair font-bold tracking-tight text-charcoal leading-tight">
                Colorado Vending Machine Locations
              </h1>
              
              <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-stone px-2 sm:px-0">
                Discover premium vending machine placement opportunities across Colorado. 
                Access 100,000+ businesses and the heart of America's technology and outdoor recreation hub.
              </p>

              {/* State Stats - Matching Homepage Counter Style */}
              <div className="mt-10 sm:mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-4 sm:px-0">
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-bronze">100,000+</div>
                  <div className="text-xs sm:text-sm text-stone leading-tight">Businesses</div>
                </div>
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-bronze">5.8M+</div>
                  <div className="text-xs sm:text-sm text-stone leading-tight">Population</div>
                </div>
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-bronze">990+</div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Colorado is a major technology and outdoor recreation hub in the West, offering diverse vending opportunities across multiple thriving industries.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-charcoal mb-2">Outdoor Recreation & Energy</h3>
                <p className="text-stone">Outdoor companies, energy facilities, and recreation centers with active professionals and operational schedules.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-warm-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Explore vending machine opportunities in Colorado's most active business areas.
              </p>
            </div>
        ...
        <div className="bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-playfair font-bold text-charcoal mb-4">
                Get Colorado Vending Machine Leads
              </h2>
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Access verified vending locations across Colorado with our flexible pricing options designed for vending machine entrepreneurs.
              </p>
            </div>
            <PricingTable />
          </div>
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-stone">
                Everything you need to know about vending machine opportunities in Colorado.
              </p>
            </div>
            <div className="space-y-6">
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  What types of businesses are best for vending machines in Colorado?
                </h3>
                <p className="text-stone">
                  Colorado offers diverse opportunities including technology companies, healthcare facilities,
                  outdoor recreation companies, and energy facilities. The major technology and healthcare sectors
                  provide excellent placement opportunities.
                </p>
              </div>
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  How competitive is the vending machine market in Colorado?
                </h3>
                <p className="text-stone">
                  Colorado has a moderate vending presence with significant opportunity for expansion,
                  especially in new technology developments and growing healthcare areas.
                </p>
              </div>
              <div className="bg-warm-white p-6 rounded-xl">
                <h3 className="text-xl font-semibold text-charcoal mb-3">
                  What are the best vending machine types for Colorado businesses?
                </h3>
                <p className="text-stone">
                  For Colorado technology locations, healthy snack and beverage machines work best. Healthcare facilities need reliable machines, while
                  outdoor recreation companies prefer durable options. We provide specific recommendations for each business type.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                { name: 'New Mexico', slug: 'new-mexico', count: '380+ leads' },
                { name: 'Wyoming', slug: 'wyoming', count: '180+ leads' },
              ].map((state) => (
