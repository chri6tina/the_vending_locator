    ...
    <div className="min-h-screen bg-cream">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            ...
            >
              Vending Machine Leads in Dallas, Texas
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Find qualified vending machine locations and business leads in Dallas, TX. Get pre-researched locations with contact information for decision makers.
            </motion.p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-warm-white py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            ...
            >
              <div className="text-3xl font-bold text-navy mb-2">180+</div>
            ...
            <motion.div
              ...
              className="bg-white rounded-xl p-6 shadow-lg border border-gray-200"
            >
              <div className="text-3xl font-bold text-navy mb-2">25-mile</div>
              <div className="text-stone font-medium">Search Radius</div>
              <div className="text-sm text-stone/70 mt-1">Covering Dallas metro</div>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-white rounded-xl p-6 shadow-lg border border-gray-200"
            >
              <div className="text-3xl font-bold text-navy mb-2">3 Days</div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl font-playfair font-bold text-charcoal mb-4">
              What You Get with Dallas Vending Leads
            </h2>
            <p className="text-lg text-stone max-w-2xl mx-auto">
              Comprehensive location research specifically for the Dallas, Texas market
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <CheckIcon className="h-5 w-5 text-bronze mt-0.5 flex-shrink-0" />
                  <span className="text-stone">Market analysis for Dallas area</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckIcon className="h-5 w-5 text-bronze mt-0.5 flex-shrink-0" />
      ...
      <div className="bg-navy py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Ready to Get Dallas Vending Machine Leads?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Choose your plan and get qualified vending machine locations in Dallas, Texas delivered to your inbox
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            >
              View Dallas Vending Leads Pricing
            </Link>
            <Link
              href="/contact"
      ...
      <div className="bg-warm-white py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: 'Austin', slug: 'austin-texas', count: '150+ leads' },
