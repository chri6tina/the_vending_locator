            ...
            >
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-chocolate mb-2">Contact Methods</h4>
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <svg className="h-5 w-5 text-coral" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a 
                          ...
                          className="text-coral hover:text-navy transition-colors duration-200 font-medium"
                        >
                          @thevendinglocator
                        </a>
                      </div>
                      <p className="text-chocolate/70 text-sm">
                        Get quick responses and real-time updates via Telegram
                      </p>
                    </div>
                  </div>
