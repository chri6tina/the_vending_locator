  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className={`lg:relative lg:translate-x-0 lg:animate-none h-full w-72 bg-white border-r border-stone shadow-xl lg:shadow-none ${
          collapsed ? 'w-20' : 'w-72'
        }`}
      >
        {/* Header */}
        <div className="flex h-16 items-center justify-between border-b border-stone px-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={onToggle}
              className="p-1.5 rounded-lg text-stone hover:text-charcoal hover:bg-warm-white transition-colors lg:hidden"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="border-b border-stone p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-stone">Administrator</p>
              </div>
            </div>
          </div>
        )}
