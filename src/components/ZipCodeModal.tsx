            ...
            >
              ...
              <div className="bg-navy px-3 sm:px-6 py-2.5 sm:py-4">
                <div className="flex items-center justify-between">
                  <h2 className="text-base sm:text-xl font-playfair font-bold text-white">
              ...
              {/* Package Summary */}
              <div className="bg-warm-white px-3 sm:px-6 py-2.5 sm:py-4 border-b border-stone/20">
                <div className="flex items-center justify-between">
                  <div>
              ...
              <form onSubmit={handleSubmit} className="p-3 sm:p-6 space-y-3 sm:space-y-4">
                {/* Zip Code Input */}
                <div>
                  <label htmlFor="zipCode" className="block text-xs sm:text-sm font-medium text-charcoal mb-1">
                    Your Zip Code *
                  </label>
                  <div className="relative">
                    <MapPinIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-stone" />
                    <input
                      type="text"
                      id="zipCode"
                      value={zipCode}
                      ...
                      className={`w-full pl-8 pr-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-navy focus:border-navy transition-colors text-sm ${
                ...
                {/* Email Input */}
                <div>
                  <label htmlFor="email" className="block text-xs sm:text-sm font-medium text-charcoal mb-1">
                    Email Address *
                  </label>
                  <div className="relative">
                    <EnvelopeIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-stone" />
                    <input
                      type="email"
                      id="email"
                      value={email}
                ...
                {/* Benefits */}
                <div className="bg-warm-white rounded-lg p-2.5 sm:p-4">
                  <h3 className="font-semibold text-charcoal text-sm mb-1.5">What happens next:</h3>
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-navy text-white py-2.5 px-4 rounded-lg font-semibold hover:bg-navy-light transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm"
                >
                  {isSubmitting ? (
                    <>
