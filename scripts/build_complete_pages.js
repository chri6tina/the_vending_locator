...
export default function ${cityDisplayName.replace(/\s+/g, '')}${stateDisplayName.replace(/\s+/g, '')}VendingLeadsPage() {
  ...
  const [recentPurchases, setRecentPurchases] = useState([
    'Just purchased ${cityDisplayName} vending leads',
    'Got ${cityDisplayName} location package',
    'Bought ${cityDisplayName} business leads',
    'Acquired ${cityDisplayName} vending spots',
    'Secured ${cityDisplayName} locations'
  ])
