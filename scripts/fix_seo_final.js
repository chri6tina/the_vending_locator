  ...
  for (const item of items) {
    ...
    if (stat.isDirectory()) {
      ...
      try {
        ...
        // Force overwrite with new metadata
...
// Main execution
console.log('🚀 Starting FINAL SEO fix for all pages...\n');

try {
  processPages(PAGES_DIR);
  console.log('\n🎉 FINAL SEO fix completed successfully!');
  console.log('\n📋 What was fixed:');
  ...
  console.log('✅ Removed duplicate metadata blocks');
  console.log('\n🔍 Next steps:');
