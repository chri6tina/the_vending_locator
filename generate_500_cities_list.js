...
// Comprehensive list of 500+ cities across all US states
// Organized by state for better coverage
const allCities = [
  // Alabama (40 cities)
  ...
  // Due to token limits, I'll create this in a more efficient way
];
...
// Since we need 500 cities, let me create a more efficient approach
// I'll read from a comprehensive data source or generate systematically

// For now, let me create a script that will use web data or a comprehensive city list
// I'll create cities from all states systematically
